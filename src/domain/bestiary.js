...
export const ZONES = {
  ...
  cyclops_camp:  { city: 'thais', name: 'zone.cyclops_camp', icon: '🗿', worldReq: 'auroria', monsters: ['cyclops', 'cyclops_drone', 'cyclops_smith'], goldMult: 1.5, xpMult: 1.4, theme: ['#8a6a4a', '#4a3524'], boss: 'cyclops_smith', requiresBossOf: 'minotaur_den' },
