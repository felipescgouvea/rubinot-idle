...
export const ZONES = {
  ...
  old_graveyard: { city: 'thais', name: 'zone.old_graveyard', icon: '💀', worldReq: 'auroria', monsters: ['skeleton', 'ghoul'], goldMult: 1.45, xpMult: 1.38, theme: ['#5a5560', '#211f28'], boss: 'ghoul', requiresBossOf: 'elf_woods' },
  minotaur_den:  { city: 'thais', name: 'zone.minotaur_den', icon: '🐂', worldReq: 'auroria', monsters: ['minotaur', 'minotaur_archer', 'minotaur_mage', 'minotaur_guard'], goldMult: 1.48, xpMult: 1.39, theme: ['#7a5a3a', '#3a2818'], boss: 'minotaur_guard', requiresBossOf: 'old_graveyard' },
  cyclops_camp:  { city: 'thais', name: 'zone.cyclops_camp', icon: '🗿', worldReq: 'auroria', monsters: ['cyclops', 'juvenile_cyclops', 'cyclops_drone', 'cyclops_smith'], goldMult: 1.5, xpMult: 1.4, theme: ['#8a6a4a', '#4a3524'], boss: 'cyclops_smith', requiresBossOf: 'minotaur_den' },
  amazon_camp:   { city: 'carlin', name: 'zone.amazon_camp', icon: '🏹', worldReq: 'auroria', monsters: ['amazon', 'valkyrie'], goldMult: 1.8, xpMult: 1.6, theme: ['#5e7d3f', '#2e4a1f'], boss: 'valkyrie', requiresBossOf: 'cyclops_camp' },
  bandit_hideout:{ city: 'carlin', name: 'zone.bandit_hideout', icon: '🏴', worldReq: 'auroria', monsters: ['bandit', 'poacher'], goldMult: 1.9, xpMult: 1.7, theme: ['#6b5a3f', '#332a1c'], boss: 'poacher', requiresBossOf: 'amazon_camp' },
  scarab_desert: { city: 'ankrahmun', name: 'zone.scarab_desert', icon: '🪲', worldReq: 'auroria', monsters: ['scarab', 'larva'], goldMult: 2.0, xpMult: 1.8, theme: ['#c9a35c', '#8a6a30'], boss: 'scarab', requiresBossOf: 'bandit_hideout' },
  orc_fortress:  { city: 'venore', name: 'zone.orc_fortress', icon: '🏹', worldReq: 'auroria', monsters: ['orc', 'orc_rider', 'orc_shaman'], goldMult: 2.1, xpMult: 1.9, theme: ['#6b3f2f', '#2e1a12'], boss: 'orc_shaman', requiresBossOf: 'scarab_desert' },

  // --- Spectrum (PvP opcional, reqLevel 20) ---
  spider_lair:   { city: 'venore', name: 'zone.spider_lair', icon: '🕷️', worldReq: 'spectrum', monsters: ['giant_spider', 'tarantula'], goldMult: 2.2, xpMult: 2.0, theme: ['#4a3a5c', '#1c1526'], boss: 'giant_spider' },
  wyvern_ridge:  { city: 'carlin', name: 'zone.wyvern_ridge', icon: '🐲', worldReq: 'spectrum', monsters: ['wyvern'], goldMult: 2.5, xpMult: 2.2, theme: ['#4a6b6b', '#1c2e2e'], boss: 'wyvern', requiresBossOf: 'spider_lair' },
  haunted_ruins: { city: 'ankrahmun', name: 'zone.haunted_ruins', icon: '👻', worldReq: 'spectrum', monsters: ['ghost', 'mummy', 'bonelord'], goldMult: 2.8, xpMult: 2.4, theme: ['#4a3a5c', '#1c1526'], boss: 'mummy', requiresBossOf: 'wyvern_ridge' },
  golem_workshop:{ city: 'darashia', name: 'zone.golem_workshop', icon: '🗿', worldReq: 'spectrum', monsters: ['stone_golem', 'ice_golem', 'fire_elemental'], goldMult: 3.2, xpMult: 2.7, theme: ['#5a5a52', '#232320'], boss: 'stone_golem', requiresBossOf: 'haunted_ruins' },
  djinn_oasis:   { city: 'darashia', name: 'zone.djinn_oasis', icon: '🧞', worldReq: 'spectrum', monsters: ['efreet', 'marid'], goldMult: 3.6, xpMult: 3.1, theme: ['#c9a35c', '#1f4a45'], boss: 'marid', requiresBossOf: 'golem_workshop' },
  worm_hive:     { city: 'venore', name: 'zone.worm_hive', icon: '🪱', worldReq: 'spectrum', monsters: ['larva', 'carrion_worm', 'rotworm'], goldMult: 3.9, xpMult: 3.3, theme: ['#5a4a35', '#2e2419'], boss: 'carrion_worm', requiresBossOf: 'djinn_oasis' },

  // --- Bellum (PvP opcional, reqLevel 25) ---
  scorpion_flats:{ city: 'ankrahmun', name: 'zone.scorpion_flats', icon: '🦂', worldReq: 'bellum', monsters: ['scorpion', 'centipede', 'cobra'], goldMult: 2.6, xpMult: 2.3, theme: ['#c98a4a', '#5c3a1a'], boss: 'scorpion' },
  crypt_shamblers_den:{ city: 'darashia', name: 'zone.crypt_shamblers_den', icon: '⚰️', worldReq: 'bellum', monsters: ['crypt_shambler', 'priestess'], goldMult: 2.85, xpMult: 2.45, theme: ['#4a4a5c', '#1c1c26'], boss: 'crypt_shambler', requiresBossOf: 'scorpion_flats' },
  dragon_lair:   { city: 'darashia', name: 'zone.dragon_lair', icon: '🔥', worldReq: 'bellum',  monsters: ['dragon', 'dragon_lord'], goldMult: 3.0, xpMult: 2.5, theme: ['#a53d2b', '#4a1810'], boss: 'dragon_lord', requiresBossOf: 'crypt_shamblers_den' },
  frost_peak:    { city: 'svargrond', name: 'zone.frost_peak', icon: '🧊', worldReq: 'bellum',  monsters: ['frost_dragon', 'frost_dragon_hatchling'], goldMult: 3.5, xpMult: 3.0, theme: ['#6fa3c9', '#294a63'], boss: 'frost_dragon', requiresBossOf: 'dragon_lair' },
  black_knight_hall:{ city: 'venore', name: 'zone.black_knight_hall', icon: '⚔️', worldReq: 'bellum', monsters: ['black_knight'], goldMult: 3.9, xpMult: 3.35, theme: ['#3a4a5c', '#151c26'], boss: 'black_knight', requiresBossOf: 'frost_peak' },
  werewolf_woods:{ city: 'svargrond', name: 'zone.werewolf_woods', icon: '🌕', worldReq: 'bellum', monsters: ['werewolf', 'werelion'], goldMult: 4.3, xpMult: 3.9, theme: ['#2e3d24', '#141c10'], boss: 'werewolf', requiresBossOf: 'black_knight_hall' },
  ghastly_ruins: { city: 'porthope', name: 'zone.ghastly_ruins', icon: '🐉', worldReq: 'bellum', monsters: ['ghastly_dragon', 'undead_dragon'], goldMult: 4.8, xpMult: 4.1, theme: ['#5c2b3a', '#26101a'], boss: 'ghastly_dragon', requiresBossOf: 'werewolf_woods' },

  // --- Solarian (PvP retro, reqLevel 35) ---
  poison_marsh:  { city: 'porthope', name: 'zone.poison_marsh', icon: '🕸️', worldReq: 'solarian', monsters: ['wasp', 'poison_spider'], goldMult: 3.5, xpMult: 3.0, theme: ['#5c7d3a', '#243315'], boss: 'poison_spider' },
  braindeath_bog:{ city: 'porthope', name: 'zone.braindeath_bog', icon: '🧠', worldReq: 'solarian', monsters: ['braindeath', 'crypt_shambler'], goldMult: 3.7, xpMult: 3.2, theme: ['#3a4a35', '#161f14'], boss: 'braindeath', requiresBossOf: 'poison_marsh' },
  hydra_swamp:   { city: 'porthope', name: 'zone.hydra_swamp', icon: '🐍', worldReq: 'solarian', monsters: ['hydra', 'medusa', 'serpent_spawn'], goldMult: 4.2, xpMult: 3.8, theme: ['#3c6b5e', '#173a30'], boss: 'medusa', requiresBossOf: 'braindeath_bog' },
  wraith_hollow: { city: 'edron', name: 'zone.wraith_hollow', icon: '👤', worldReq: 'solarian', monsters: ['betrayed_wraith', 'crypt_defiler'], goldMult: 4.6, xpMult: 4.0, theme: ['#4a3a5c', '#1a1424'], boss: 'betrayed_wraith', requiresBossOf: 'hydra_swamp' },
  nightmare_den: { city: 'edron', name: 'zone.nightmare_den', icon: '🌑', worldReq: 'solarian', monsters: ['nightmare', 'nightmare_scion'], goldMult: 5.6, xpMult: 4.6, theme: ['#3a1f2e', '#150a12'], boss: 'nightmare', requiresBossOf: 'wraith_hollow' },
  hellfire_bastion:{ city: 'cormaya', name: 'zone.hellfire_bastion', icon: '🔥', worldReq: 'solarian', monsters: ['hellfire_fighter', 'dark_torturer'], goldMult: 6.5, xpMult: 5.2, theme: ['#a5391f', '#3a1208'], boss: 'hellfire_fighter', requiresBossOf: 'nightmare_den' },

  // --- Elysian (PvP retro, reqLevel 40) ---
  undead_crypt:  { city: 'edron', name: 'zone.undead_crypt', icon: '🦴', worldReq: 'elysian', monsters: ['bonebeast', 'banshee', 'vampire', 'blightwalker', 'vampire_bride'], goldMult: 3.8, xpMult: 3.3, theme: ['#5a5560', '#211f28'], boss: 'banshee' },
  lich_lair:     { city: 'edron', name: 'zone.lich_lair', icon: '☠️', worldReq: 'elysian', monsters: ['lich', 'grim_reaper', 'undead_dragon'], goldMult: 4.0, xpMult: 3.5, theme: ['#4a3a63', '#1a1424'], boss: 'undead_dragon', requiresBossOf: 'undead_crypt' },
  demon_fortress:{ city: 'cormaya', name: 'zone.demon_fortress', icon: '💀', worldReq: 'elysian', monsters: ['demon', 'fury', 'hellhound'], goldMult: 5.0, xpMult: 4.0, theme: ['#7a1f1f', '#2b0a0a'], boss: 'demon', requiresBossOf: 'lich_lair' },
  war_golem_yard:{ city: 'cormaya', name: 'zone.war_golem_yard', icon: '🤖', worldReq: 'elysian', monsters: ['war_golem', 'rustheap_golem'], goldMult: 6.8, xpMult: 5.4, theme: ['#5c5c52', '#242420'], boss: 'war_golem', requiresBossOf: 'demon_fortress' },
  falcon_bastion:{ city: 'cormaya', name: 'zone.falcon_bastion', icon: '🦅', worldReq: 'elysian', monsters: ['falcon_knight', 'falcon_paladin'], goldMult: 7.6, xpMult: 5.9, theme: ['#4a6b8a', '#1c2e3f'], boss: 'falcon_knight', requiresBossOf: 'war_golem_yard' },
  vexclaw_canyon:{ city: 'yalahar', name: 'zone.vexclaw_canyon', icon: '🦞', worldReq: 'elysian', monsters: ['vexclaw', 'retching_horror', 'nightstalker'], goldMult: 9.0, xpMult: 6.5, theme: ['#8a4a2f', '#3a1c10'], boss: 'vexclaw', requiresBossOf: 'falcon_bastion' },
  feversleep_marsh:{ city: 'yalahar', name: 'zone.feversleep_marsh', icon: '💤', worldReq: 'elysian', monsters: ['feversleep', 'nightmare'], goldMult: 10.0, xpMult: 7.0, theme: ['#6b7d3a', '#2b3315'], boss: 'feversleep', requiresBossOf: 'vexclaw_canyon' },
  grorlam_grotto:{ city: 'yalahar', name: 'zone.grorlam_grotto', icon: '🐖', worldReq: 'elysian', monsters: ['grorlam'], goldMult: 11.5, xpMult: 7.8, theme: ['#2f4a4a', '#101f1f'], boss: 'grorlam', requiresBossOf: 'feversleep_marsh' },
  zorvorax_sanctum:{ city: 'yalahar', name: 'zone.zorvorax_sanctum', icon: '🔮', worldReq: 'elysian', monsters: ['zorvorax'], goldMult: 13.0, xpMult: 8.5, theme: ['#6b4a8a', '#251536'], boss: 'zorvorax', requiresBossOf: 'grorlam_grotto' },

  // --- Mystian (PvP retro, reqLevel 60, o mundo com os melhores bônus) ---
  hell_gate:     { city: 'roshamuul', name: 'zone.hell_gate', icon: '🔥', worldReq: 'mystian', monsters: ['juggernaut', 'plaguesmith', 'behemoth', 'gazharagoth'], goldMult: 6.0, xpMult: 5.0, theme: ['#a52a1f', '#1f0a08'], boss: 'juggernaut' },
  roshamuul_valley:{ city: 'roshamuul', name: 'zone.roshamuul_valley', icon: '👹', worldReq: 'mystian', monsters: ['frazzlemaw', 'guzzlemaw'], goldMult: 6.5, xpMult: 5.3, theme: ['#7a2a1f', '#2b0a08'], boss: 'guzzlemaw' },
  boss_sanctum:  { city: 'roshamuul', name: 'zone.boss_sanctum', icon: '🌀', worldReq: 'mystian', monsters: ['lothlorien', 'executioner', 'morgul', 'corrupted_one', 'nzoth'], goldMult: 8.0, xpMult: 6.0, theme: ['#6b4a9c', '#2a1a42'], boss: 'nzoth', requiresBossOf: 'hell_gate' },
  draken_wastes: { city: 'zao', name: 'zone.draken_wastes', icon: '🐲', worldReq: 'mystian', monsters: ['draken_abomination', 'draken_warmaster'], goldMult: 14.0, xpMult: 9.0, theme: ['#5c2f2f', '#241010'], boss: 'draken_warmaster', requiresBossOf: 'boss_sanctum' },
  corruption_spire:{ city: 'zao', name: 'zone.corruption_spire', icon: '🕸️', worldReq: 'mystian', monsters: ['zulazza', 'latrivan'], goldMult: 15.5, xpMult: 9.8, theme: ['#3a2050', '#140a1f'], boss: 'latrivan', requiresBossOf: 'draken_wastes' },
  abyssal_throne:{ city: 'zao', name: 'zone.abyssal_throne', icon: '😈', worldReq: 'mystian', monsters: ['ushuriel', 'madareth'], goldMult: 17.0, xpMult: 10.6, theme: ['#4a1520', '#1a060a'], boss: 'madareth', requiresBossOf: 'corruption_spire' },
  void_rift:     { city: 'zao', name: 'zone.void_rift', icon: '🔺', worldReq: 'mystian', monsters: ['zamulosh', 'shulgrax', 'tanjis'], goldMult: 18.5, xpMult: 11.5, theme: ['#1a1a3a', '#08081a'], boss: 'tanjis', requiresBossOf: 'abyssal_throne' },
  zao_draken_walls:{ city: 'zao', name: 'zone.zao_draken_walls', icon: '🐲', worldReq: 'mystian', monsters: ['draken_elite', 'draken_spellweaver', 'draptor'], goldMult: 13.0, xpMult: 8.5, theme: ['#5c2f2f', '#241010'], boss: 'draken_elite' },
  ferumbras_citadel:{ city: 'ferumbras', name: 'zone.ferumbras_citadel', icon: '👑', worldReq: 'mystian', monsters: ['ferumbras', 'pale_worm', 'diblis', 'soul_despoiler', 'ferumbras_mortal_shell', 'devovorga'], goldMult: 20.0, xpMult: 13.0, theme: ['#3a1a5c', '#12081f'], boss: 'ferumbras', requiresBossOf: 'void_rift' },
  ...
  fibula_dungeon:  { city: 'thais',     name: 'zone.fibula_dungeon', icon: '🐾',  worldReq: 'auroria', monsters: ['stalker', 'cave_rat', 'rotworm', 'bat'], goldMult: 1.1, xpMult: 1.1, theme: ['#4a4234', '#231f18'], boss: 'stalker' },
  terror_valley:   { city: 'porthope', name: 'zone.terror_valley', icon: '🦤', worldReq: 'spectrum', monsters: ['terror_bird'], goldMult: 2.4, xpMult: 2.1, theme: ['#c9a35c', '#8a6a30'], boss: 'terror_bird' },
  terramite_hive:  { city: 'ankrahmun', name: 'zone.terramite_hive', icon: '🐜', worldReq: 'solarian', monsters: ['terramite', 'ancient_scarab'], goldMult: 4.2, xpMult: 3.7, theme: ['#c98a4a', '#5c3a1a'], boss: 'ancient_scarab' },
  tiquanda_jungle: { city: 'porthope',  name: 'zone.tiquanda_jungle', icon: '🌴', worldReq: 'solarian', monsters: ['sibang', 'kongra', 'merlkin'], goldMult: 3.3, xpMult: 2.9, theme: ['#2e5c2e', '#0f2b0f'], boss: 'kongra' },
  ice_caves:       { city: 'svargrond', name: 'zone.ice_caves', icon: '❄️', worldReq: 'bellum', monsters: ['frost_troll', 'ice_golem'], goldMult: 3.0, xpMult: 2.6, theme: ['#6fa3c9', '#294a63'], boss: 'ice_golem' },
  yeti_peak:       { city: 'svargrond', name: 'zone.yeti_peak', icon: '🦣', worldReq: 'bellum', monsters: ['yeti', 'crystal_wolf', 'frost_giant'], goldMult: 4.0, xpMult: 3.5, theme: ['#8fb8d9', '#3a5a73'], boss: 'yeti' },
  crystal_nest:    { city: 'svargrond', name: 'zone.crystal_nest', icon: '🕸️', worldReq: 'bellum', monsters: ['crystal_spider'], goldMult: 4.6, xpMult: 4.0, theme: ['#a9c9e0', '#4a6b85'], boss: 'crystal_spider' },
  wyrm_cavern:     { city: 'darashia',  name: 'zone.wyrm_cavern', icon: '🐉', worldReq: 'spectrum', monsters: ['wyrm'], goldMult: 4.2, xpMult: 3.8, theme: ['#4a6b6b', '#1c2e2e'], boss: 'wyrm' },
  hero_tower:      { city: 'edron',     name: 'zone.hero_tower', icon: '🦸', worldReq: 'elysian', monsters: ['hero', 'dark_magician', 'dark_apprentice'], goldMult: 5.0, xpMult: 4.2, theme: ['#4a3a5c', '#1a1424'], boss: 'hero' },
  dworc_camp:      { city: 'porthope',  name: 'zone.dworc_camp', icon: '🌀', worldReq: 'auroria', monsters: ['dworc_venomsniper', 'dworc_fighter', 'dworc'], goldMult: 1.85, xpMult: 1.65, theme: ['#5c3a6b', '#241a33'], boss: 'dworc' },
  mutant_ward:     { city: 'yalahar',   name: 'zone.mutant_ward', icon: '🧟', worldReq: 'auroria', monsters: ['mutated_human', 'slime', 'mutated_rat'], goldMult: 1.55, xpMult: 1.45, theme: ['#4a6b3a', '#1f331a'], boss: 'mutated_human' },
  warlock_tower:   { city: 'carlin',    name: 'zone.warlock_tower', icon: '🧙', worldReq: 'solarian', monsters: ['warlock'], goldMult: 4.3, xpMult: 3.9, theme: ['#3a1a5c', '#150a24'], boss: 'warlock' },
  carlin_sewers:   { city: 'carlin',    name: 'zone.carlin_sewers', icon: '🐛', worldReq: 'auroria', monsters: ['bug', 'poison_spider', 'slime'], goldMult: 1.15, xpMult: 1.12, theme: ['#4a4234', '#231f18'], boss: 'slime' },
  ankrahmun_tombs: { city: 'ankrahmun', name: 'zone.ankrahmun_tombs', icon: '🏺', worldReq: 'solarian', monsters: ['fleshcrawler', 'omruc'], goldMult: 5.0, xpMult: 4.3, theme: ['#c9a35c', '#5c3a1a'], boss: 'omruc' },
  porthope_water_dungeon:{ city: 'porthope', name: 'zone.porthope_water_dungeon', icon: '💧', worldReq: 'bellum', monsters: ['crocodile', 'massive_water_elemental'], goldMult: 3.0, xpMult: 2.6, theme: ['#2a5c6b', '#0f2e33'], boss: 'massive_water_elemental' },
  thais_dragon_cave:{ city: 'thais', name: 'zone.thais_dragon_cave', icon: '🐉', worldReq: 'bellum', monsters: ['dragon'], goldMult: 2.5, xpMult: 2.2, theme: ['#8a3020', '#3a1410'], boss: 'dragon' },
  femor_hills:     { city: 'carlin', name: 'zone.femor_hills', icon: '👺', worldReq: 'auroria', monsters: ['goblin', 'cyclops'], goldMult: 1.15, xpMult: 1.1, theme: ['#5c6b3a', '#33401f'], boss: 'cyclops' },
  yalahar_sunken_quarter:{ city: 'yalahar', name: 'zone.yalahar_sunken_quarter', icon: '🦑', worldReq: 'spectrum', monsters: ['quara_pincher', 'quara_hydromancer'], goldMult: 3.3, xpMult: 2.9, theme: ['#1f3a5c', '#0a1826'], boss: 'quara_pincher' },
};
