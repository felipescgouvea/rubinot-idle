...
export const ZONES = {
  ...
  dwarf_mines:   { name: 'Minas dos Dwarfs', icon: '⛏️', minLevel: 6,  worldReq: 'auroria', monsters: ['dwarf', 'orc', 'elf'], goldMult: 1.3, xpMult: 1.25, theme: ['#6b5a44', '#3a2f22'] },
  elf_woods:     { name: 'Acampamento Dworc', icon: '🌀', minLevel: 10, worldReq: 'auroria', monsters: ['dworc'], goldMult: 1.4, xpMult: 1.35, theme: ['#3f7052', '#1e3d2b'] },
  ...
  frost_peak:    { name: 'Pico Congelado', icon: '🧊', minLevel: 35, worldReq: 'bellum',  monsters: ['frost_dragon'], goldMult: 3.5, xpMult: 3.0, theme: ['#6fa3c9', '#294a63'] },
  ...
  lich_lair:     { name: 'Cripta dos Liches', icon: '☠️', minLevel: 48, worldReq: 'elysian', monsters: ['lich', 'grim_reaper', 'undead_dragon', 'warlock'], goldMult: 4.0, xpMult: 3.5, theme: ['#4a3a63', '#1a1424'] },
