...
export const ZONES = {
  ...
  black_knight_hall:{ city: 'svargrond', name: 'Salão dos Cavaleiros Negros', icon: '⚔️', minLevel: 40, worldReq: 'bellum', monsters: ['black_knight'], goldMult: 3.9, xpMult: 3.35, theme: ['#3a4a5c', '#151c26'], boss: 'black_knight', requiresBossOf: 'frost_peak' },
  werewolf_woods:{ city: 'svargrond', name: 'Floresta dos Lobisomens', icon: '🌕', minLevel: 47, worldReq: 'bellum', monsters: ['werewolf', 'werelion'], goldMult: 4.3, xpMult: 3.9, theme: ['#2e3d24', '#141c10'], boss: 'werewolf', requiresBossOf: 'black_knight_hall' },
  ghastly_ruins: { city: 'porthope', name: 'Ruínas Sombrias', icon: '🐉', minLevel: 52, worldReq: 'bellum', monsters: ['ghastly_dragon', 'undead_dragon'], goldMult: 4.8, xpMult: 4.1, theme: ['#5c2b3a', '#26101a'], boss: 'ghastly_dragon', requiresBossOf: 'werewolf_woods' },
  ...
  undead_crypt:  { city: 'edron', name: 'Cripta Profana', icon: '🦴', minLevel: 40, worldReq: 'elysian', monsters: ['bonebeast', 'banshee', 'vampire', 'blightwalker'], goldMult: 3.8, xpMult: 3.3, theme: ['#5a5560', '#211f28'], boss: 'banshee' },
  lich_lair:     { city: 'edron', name: 'Cripta dos Liches', icon: '☠️', minLevel: 48, worldReq: 'elysian', monsters: ['lich', 'grim_reaper', 'undead_dragon'], goldMult: 4.0, xpMult: 3.5, theme: ['#4a3a63', '#1a1424'], boss: 'undead_dragon', requiresBossOf: 'undead_crypt' },
  ...
  war_golem_yard:{ city: 'cormaya', name: 'Pátio dos War Golems', icon: '🤖', minLevel: 65, worldReq: 'elysian', monsters: ['war_golem'], goldMult: 6.8, xpMult: 5.4, theme: ['#5c5c52', '#242420'], boss: 'war_golem', requiresBossOf: 'demon_fortress' },
  falcon_bastion:{ city: 'cormaya', name: 'Bastião Falcão', icon: '🦅', minLevel: 69, worldReq: 'elysian', monsters: ['falcon_knight'], goldMult: 7.6, xpMult: 5.9, theme: ['#4a6b8a', '#1c2e3f'], boss: 'falcon_knight', requiresBossOf: 'war_golem_yard' },
  vexclaw_canyon:{ city: 'yalahar', name: 'Desfiladeiro dos Vexclaw', icon: '🦞', minLevel: 74, worldReq: 'elysian', monsters: ['vexclaw', 'retching_horror'], goldMult: 9.0, xpMult: 6.5, theme: ['#8a4a2f', '#3a1c10'], boss: 'vexclaw', requiresBossOf: 'falcon_bastion' },
  feversleep_marsh:{ city: 'yalahar', name: 'Pântano Feversleep', icon: '💤', minLevel: 78, worldReq: 'elysian', monsters: ['feversleep', 'nightmare'], goldMult: 10.0, xpMult: 7.0, theme: ['#6b7d3a', '#2b3315'], boss: 'feversleep', requiresBossOf: 'vexclaw_canyon' },
  grorlam_grotto:{ city: 'yalahar', name: 'Gruta do Grorlam', icon: '🐖', minLevel: 82, worldReq: 'elysian', monsters: ['grorlam'], goldMult: 11.5, xpMult: 7.8, theme: ['#2f4a4a', '#101f1f'], boss: 'grorlam', requiresBossOf: 'feversleep_marsh' },
  zorvorax_sanctum:{ city: 'yalahar', name: 'Santuário de Zorvorax', icon: '🔮', minLevel: 86, worldReq: 'elysian', monsters: ['zorvorax'], goldMult: 13.0, xpMult: 8.5, theme: ['#6b4a8a', '#251536'], boss: 'zorvorax', requiresBossOf: 'grorlam_grotto' },
  ...
  terror_valley:   { city: 'ankrahmun', name: 'Vale dos Terror Birds', icon: '🦤', minLevel: 24, worldReq: 'spectrum', monsters: ['terror_bird'], goldMult: 2.4, xpMult: 2.1, theme: ['#c9a35c', '#8a6a30'], boss: 'terror_bird' },
  ...
  tiquanda_jungle: { city: 'porthope',  name: 'Selva de Tiquanda', icon: '🌴', minLevel: 33, worldReq: 'solarian', monsters: ['sibang', 'kongra', 'merlkin'], goldMult: 3.3, xpMult: 2.9, theme: ['#2e5c2e', '#0f2b0f'], boss: 'kongra' },
