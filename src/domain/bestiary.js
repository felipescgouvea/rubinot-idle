...
export const ZONES = {
  ...
  dawnport_outpost:      { city: 'dawnport', name: 'zone.dawnport_outpost', icon: '🌅', worldReq: 'auroria', monsters: ['sacred_snake', 'rabbit', 'sheep', 'squirrel', 'deer', 'badger', 'mountain_troll', 'dawn_bat', 'muglex_clan_footman', 'muglex_clan_assassin'], theme: ['#c9a35c', '#8a6a30'], boss: 'muglex_clan_assassin' },
  ...
  hydra_swamp:   { city: 'porthope', name: 'zone.hydra_swamp', icon: '🐍', worldReq: 'solarian', monsters: ['hydra', 'medusa', 'serpent_spawn'], theme: ['#3c6b5e', '#173a30'], boss: 'medusa', requiresBossOf: 'braindeath_bog' },
