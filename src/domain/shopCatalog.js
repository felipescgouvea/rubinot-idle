...
export const SHOP_ITEMS = [
  ...
  { id: 'buy_ultimate_healing_rune',name: 'Ultimate Healing Rune',  icon: '📜', currency: 'gold', price: 216,  type: 'item', itemId: 'ultimate_healing_rune', shop: 'magic' },
  { id: 'buy_explosion_rune',       name: 'Explosion Rune',         icon: '📜', currency: 'gold', price: 72,  type: 'item', itemId: 'explosion_rune', shop: 'magic' },
  { id: 'buy_avalanche_rune',       name: 'Avalanche Rune',         icon: '📜', currency: 'gold', price: 108,  type: 'item', itemId: 'avalanche_rune', shop: 'magic' },
  { id: 'buy_sudden_death_rune',    name: 'Sudden Death Rune',      icon: '📜', currency: 'gold', price: 240,  type: 'item', itemId: 'sudden_death_rune', shop: 'magic' },
  ...
  { id: 'buy_light_magic_missile_rune',  name: 'Light Magic Missile Rune',  icon: '📜', currency: 'gold', price: 8,   type: 'item', itemId: 'light_magic_missile_rune', shop: 'magic' },
  { id: 'buy_heavy_magic_missile_rune',  name: 'Heavy Magic Missile Rune',  icon: '📜', currency: 'gold', price: 24,   type: 'item', itemId: 'heavy_magic_missile_rune', shop: 'magic' },
  ...
  { id: 'buy_poison_bomb_rune',          name: 'Poison Bomb Rune',          icon: '📜', currency: 'gold', price: 168,  type: 'item', itemId: 'poison_bomb_rune', shop: 'magic' },
  ...
  { id: 'buy_energy_bomb_rune',          name: 'Energy Bomb Rune',          icon: '📜', currency: 'gold', price: 420, type: 'item', itemId: 'energy_bomb_rune', shop: 'magic' },
  { id: 'buy_icicle_rune',               name: 'Icicle Rune',               icon: '📜', currency: 'gold', price: 36,  type: 'item', itemId: 'icicle_rune', shop: 'magic' },
  { id: 'buy_stalagmite_rune',           name: 'Stalagmite Rune',           icon: '📜', currency: 'gold', price: 30,  type: 'item', itemId: 'stalagmite_rune', shop: 'magic' },
  { id: 'buy_stone_shower_rune',         name: 'Stone Shower Rune',         icon: '📜', currency: 'gold', price: 72,  type: 'item', itemId: 'stone_shower_rune', shop: 'magic' },
  { id: 'buy_thunderstorm_rune',         name: 'Thunderstorm Rune',         icon: '📜', currency: 'gold', price: 180,  type: 'item', itemId: 'thunderstorm_rune', shop: 'magic' },
  { id: 'buy_soulfire_rune',             name: 'Soulfire Rune',             icon: '📜', currency: 'gold', price: 264,  type: 'item', itemId: 'soulfire_rune', shop: 'magic' },
  ...
  { id: 'buy_convince_creature_rune',    name: 'Convince Creature Rune',    icon: '📜', currency: 'gold', price: 300, type: 'item', itemId: 'convince_creature_rune', shop: 'magic' },
  { id: 'buy_animate_dead_rune',         name: 'Animate Dead Rune',         icon: '📜', currency: 'gold', price: 600, type: 'item', itemId: 'animate_dead_rune', shop: 'magic' },
