...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=183';
import { resolveEquippedItem } from './items.js?v=167';
import { pickWeightedMonster } from './adminConfig.js?v=155';
