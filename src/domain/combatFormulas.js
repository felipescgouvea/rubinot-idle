...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=341';
import { resolveEquippedItem } from './items.js?v=325';
import { pickWeightedMonster } from './adminConfig.js?v=313';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=311';
