...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=255';
import { resolveEquippedItem } from './items.js?v=239';
import { pickWeightedMonster } from './adminConfig.js?v=227';
