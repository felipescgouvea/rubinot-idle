...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=304';
import { resolveEquippedItem } from './items.js?v=288';
import { pickWeightedMonster } from './adminConfig.js?v=276';
