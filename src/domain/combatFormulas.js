...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=209';
import { resolveEquippedItem } from './items.js?v=193';
import { pickWeightedMonster } from './adminConfig.js?v=181';
