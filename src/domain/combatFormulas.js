...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=288';
import { resolveEquippedItem } from './items.js?v=272';
import { pickWeightedMonster } from './adminConfig.js?v=260';
