...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=203';
import { resolveEquippedItem } from './items.js?v=187';
import { pickWeightedMonster } from './adminConfig.js?v=175';
