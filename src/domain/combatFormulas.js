...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=242';
import { resolveEquippedItem } from './items.js?v=226';
import { pickWeightedMonster } from './adminConfig.js?v=214';
