...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=279';
import { resolveEquippedItem } from './items.js?v=263';
import { pickWeightedMonster } from './adminConfig.js?v=251';
