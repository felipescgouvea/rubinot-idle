...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=306';
import { resolveEquippedItem } from './items.js?v=290';
import { pickWeightedMonster } from './adminConfig.js?v=278';
