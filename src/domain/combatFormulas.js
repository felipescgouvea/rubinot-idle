...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=276';
import { resolveEquippedItem } from './items.js?v=260';
import { pickWeightedMonster } from './adminConfig.js?v=248';
