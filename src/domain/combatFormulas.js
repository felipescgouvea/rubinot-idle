...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=194';
import { resolveEquippedItem } from './items.js?v=178';
import { pickWeightedMonster } from './adminConfig.js?v=166';
