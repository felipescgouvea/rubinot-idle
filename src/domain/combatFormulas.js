...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=184';
import { resolveEquippedItem } from './items.js?v=168';
import { pickWeightedMonster } from './adminConfig.js?v=156';
