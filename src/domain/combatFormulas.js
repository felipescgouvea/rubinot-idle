...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=312';
import { resolveEquippedItem } from './items.js?v=296';
import { pickWeightedMonster } from './adminConfig.js?v=284';
