...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=290';
import { resolveEquippedItem } from './items.js?v=274';
import { pickWeightedMonster } from './adminConfig.js?v=262';
