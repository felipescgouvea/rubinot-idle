...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=224';
import { resolveEquippedItem } from './items.js?v=208';
import { pickWeightedMonster } from './adminConfig.js?v=196';
