...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=253';
import { resolveEquippedItem } from './items.js?v=237';
import { pickWeightedMonster } from './adminConfig.js?v=225';
