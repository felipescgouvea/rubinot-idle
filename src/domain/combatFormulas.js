...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=198';
import { resolveEquippedItem } from './items.js?v=182';
import { pickWeightedMonster } from './adminConfig.js?v=170';
