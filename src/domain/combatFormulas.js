...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=199';
import { resolveEquippedItem } from './items.js?v=183';
import { pickWeightedMonster } from './adminConfig.js?v=171';
