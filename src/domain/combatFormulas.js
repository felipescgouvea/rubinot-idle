...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=113';
import { resolveEquippedItem } from './items.js?v=113';
import { pickWeightedMonster } from './adminConfig.js?v=113';
