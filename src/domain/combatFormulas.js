...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=303';
import { resolveEquippedItem } from './items.js?v=287';
import { pickWeightedMonster } from './adminConfig.js?v=275';
