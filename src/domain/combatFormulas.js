...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=162';
import { resolveEquippedItem } from './items.js?v=146';
import { pickWeightedMonster } from './adminConfig.js?v=134';
