...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=234';
import { resolveEquippedItem } from './items.js?v=218';
import { pickWeightedMonster } from './adminConfig.js?v=206';
