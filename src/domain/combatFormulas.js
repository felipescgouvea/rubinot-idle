...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=175';
import { resolveEquippedItem } from './items.js?v=159';
import { pickWeightedMonster } from './adminConfig.js?v=147';
