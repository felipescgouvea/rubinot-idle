...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=239';
import { resolveEquippedItem } from './items.js?v=223';
import { pickWeightedMonster } from './adminConfig.js?v=211';
