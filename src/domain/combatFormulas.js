...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=271';
import { resolveEquippedItem } from './items.js?v=255';
import { pickWeightedMonster } from './adminConfig.js?v=243';
