...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=297';
import { resolveEquippedItem } from './items.js?v=281';
import { pickWeightedMonster } from './adminConfig.js?v=269';
