...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=268';
import { resolveEquippedItem } from './items.js?v=252';
import { pickWeightedMonster } from './adminConfig.js?v=240';
