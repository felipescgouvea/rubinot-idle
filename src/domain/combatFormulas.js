...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=221';
import { resolveEquippedItem } from './items.js?v=205';
import { pickWeightedMonster } from './adminConfig.js?v=193';
