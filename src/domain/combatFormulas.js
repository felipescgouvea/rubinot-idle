...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=197';
import { resolveEquippedItem } from './items.js?v=181';
import { pickWeightedMonster } from './adminConfig.js?v=169';
