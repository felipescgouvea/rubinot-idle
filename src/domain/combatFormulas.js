...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=186';
import { resolveEquippedItem } from './items.js?v=170';
import { pickWeightedMonster } from './adminConfig.js?v=158';
