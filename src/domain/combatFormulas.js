...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=259';
import { resolveEquippedItem } from './items.js?v=243';
import { pickWeightedMonster } from './adminConfig.js?v=231';
