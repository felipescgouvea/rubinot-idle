...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=327';
import { resolveEquippedItem } from './items.js?v=311';
import { pickWeightedMonster } from './adminConfig.js?v=299';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=297';
