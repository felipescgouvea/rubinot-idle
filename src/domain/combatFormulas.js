...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=176';
import { resolveEquippedItem } from './items.js?v=160';
import { pickWeightedMonster } from './adminConfig.js?v=148';
