...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=207';
import { resolveEquippedItem } from './items.js?v=191';
import { pickWeightedMonster } from './adminConfig.js?v=179';
