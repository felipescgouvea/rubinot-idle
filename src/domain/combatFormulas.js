...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=107';
import { resolveEquippedItem } from './items.js?v=107';
import { pickWeightedMonster } from './adminConfig.js?v=107';
