...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=330';
import { resolveEquippedItem } from './items.js?v=314';
import { pickWeightedMonster } from './adminConfig.js?v=302';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=300';
