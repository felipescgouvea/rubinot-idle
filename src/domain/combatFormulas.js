...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=256';
import { resolveEquippedItem } from './items.js?v=240';
import { pickWeightedMonster } from './adminConfig.js?v=228';
