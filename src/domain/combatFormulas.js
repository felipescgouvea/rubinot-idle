...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=216';
import { resolveEquippedItem } from './items.js?v=200';
import { pickWeightedMonster } from './adminConfig.js?v=188';
