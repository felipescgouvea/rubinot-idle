...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=251';
import { resolveEquippedItem } from './items.js?v=235';
import { pickWeightedMonster } from './adminConfig.js?v=223';
