...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=277';
import { resolveEquippedItem } from './items.js?v=261';
import { pickWeightedMonster } from './adminConfig.js?v=249';
