...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=387';
import { resolveEquippedItem } from './items.js?v=371';
import { pickWeightedMonster } from './adminConfig.js?v=359';
import { IMBUEMENTS, isImbuementActive, imbuementPct } from './imbuements.js?v=357';
