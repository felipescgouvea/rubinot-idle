...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=292';
import { resolveEquippedItem } from './items.js?v=276';
import { pickWeightedMonster } from './adminConfig.js?v=264';
