...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=182';
import { resolveEquippedItem } from './items.js?v=166';
import { pickWeightedMonster } from './adminConfig.js?v=154';
