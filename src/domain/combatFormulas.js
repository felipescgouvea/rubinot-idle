...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=301';
import { resolveEquippedItem } from './items.js?v=285';
import { pickWeightedMonster } from './adminConfig.js?v=273';
