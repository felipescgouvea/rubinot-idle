...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=254';
import { resolveEquippedItem } from './items.js?v=238';
import { pickWeightedMonster } from './adminConfig.js?v=226';
