...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=213';
import { resolveEquippedItem } from './items.js?v=197';
import { pickWeightedMonster } from './adminConfig.js?v=185';
