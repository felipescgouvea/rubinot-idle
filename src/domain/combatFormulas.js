...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=263';
import { resolveEquippedItem } from './items.js?v=247';
import { pickWeightedMonster } from './adminConfig.js?v=235';
