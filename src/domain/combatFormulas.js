...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=240';
import { resolveEquippedItem } from './items.js?v=224';
import { pickWeightedMonster } from './adminConfig.js?v=212';
