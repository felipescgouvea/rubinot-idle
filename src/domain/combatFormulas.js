...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=244';
import { resolveEquippedItem } from './items.js?v=228';
import { pickWeightedMonster } from './adminConfig.js?v=216';
