...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=177';
import { resolveEquippedItem } from './items.js?v=161';
import { pickWeightedMonster } from './adminConfig.js?v=149';
