...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=159';
import { resolveEquippedItem } from './items.js?v=143';
import { pickWeightedMonster } from './adminConfig.js?v=131';
