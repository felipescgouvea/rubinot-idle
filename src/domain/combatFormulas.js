...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=287';
import { resolveEquippedItem } from './items.js?v=271';
import { pickWeightedMonster } from './adminConfig.js?v=259';
