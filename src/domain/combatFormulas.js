...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=109';
import { resolveEquippedItem } from './items.js?v=109';
import { pickWeightedMonster } from './adminConfig.js?v=109';
