...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=108';
import { resolveEquippedItem } from './items.js?v=108';
import { pickWeightedMonster } from './adminConfig.js?v=108';
