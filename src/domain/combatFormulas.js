...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=190';
import { resolveEquippedItem } from './items.js?v=174';
import { pickWeightedMonster } from './adminConfig.js?v=162';
