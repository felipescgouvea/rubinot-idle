...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=164';
import { resolveEquippedItem } from './items.js?v=148';
import { pickWeightedMonster } from './adminConfig.js?v=136';
