...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=257';
import { resolveEquippedItem } from './items.js?v=241';
import { pickWeightedMonster } from './adminConfig.js?v=229';
