...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=246';
import { resolveEquippedItem } from './items.js?v=230';
import { pickWeightedMonster } from './adminConfig.js?v=218';
