...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=105';
import { resolveEquippedItem } from './items.js?v=105';
import { pickWeightedMonster } from './adminConfig.js?v=105';
