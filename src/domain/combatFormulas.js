...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=282';
import { resolveEquippedItem } from './items.js?v=266';
import { pickWeightedMonster } from './adminConfig.js?v=254';
