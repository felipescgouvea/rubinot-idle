...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=120';
import { resolveEquippedItem } from './items.js?v=120';
import { pickWeightedMonster } from './adminConfig.js?v=120';
