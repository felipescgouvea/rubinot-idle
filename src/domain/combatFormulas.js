...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=245';
import { resolveEquippedItem } from './items.js?v=229';
import { pickWeightedMonster } from './adminConfig.js?v=217';
