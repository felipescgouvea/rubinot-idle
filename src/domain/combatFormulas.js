...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=112';
import { resolveEquippedItem } from './items.js?v=112';
import { pickWeightedMonster } from './adminConfig.js?v=112';
