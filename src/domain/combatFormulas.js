...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=333';
import { resolveEquippedItem } from './items.js?v=317';
import { pickWeightedMonster } from './adminConfig.js?v=305';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=303';
