...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=298';
import { resolveEquippedItem } from './items.js?v=282';
import { pickWeightedMonster } from './adminConfig.js?v=270';
