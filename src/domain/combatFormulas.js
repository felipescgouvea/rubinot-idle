...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=307';
import { resolveEquippedItem } from './items.js?v=291';
import { pickWeightedMonster } from './adminConfig.js?v=279';
