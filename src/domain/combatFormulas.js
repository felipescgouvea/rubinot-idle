...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=284';
import { resolveEquippedItem } from './items.js?v=268';
import { pickWeightedMonster } from './adminConfig.js?v=256';
