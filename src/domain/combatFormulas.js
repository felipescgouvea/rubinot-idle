...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=342';
import { resolveEquippedItem } from './items.js?v=326';
import { pickWeightedMonster } from './adminConfig.js?v=314';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=312';
