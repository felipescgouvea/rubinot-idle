...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=167';
import { resolveEquippedItem } from './items.js?v=151';
import { pickWeightedMonster } from './adminConfig.js?v=139';
