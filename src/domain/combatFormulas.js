...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=117';
import { resolveEquippedItem } from './items.js?v=117';
import { pickWeightedMonster } from './adminConfig.js?v=117';
