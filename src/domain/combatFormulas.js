...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=291';
import { resolveEquippedItem } from './items.js?v=275';
import { pickWeightedMonster } from './adminConfig.js?v=263';
