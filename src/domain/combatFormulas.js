...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=273';
import { resolveEquippedItem } from './items.js?v=257';
import { pickWeightedMonster } from './adminConfig.js?v=245';
