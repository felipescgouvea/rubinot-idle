...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=193';
import { resolveEquippedItem } from './items.js?v=177';
import { pickWeightedMonster } from './adminConfig.js?v=165';
