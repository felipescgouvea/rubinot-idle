...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=226';
import { resolveEquippedItem } from './items.js?v=210';
import { pickWeightedMonster } from './adminConfig.js?v=198';
