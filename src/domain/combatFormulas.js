...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=248';
import { resolveEquippedItem } from './items.js?v=232';
import { pickWeightedMonster } from './adminConfig.js?v=220';
