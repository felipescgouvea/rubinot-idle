...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=300';
import { resolveEquippedItem } from './items.js?v=284';
import { pickWeightedMonster } from './adminConfig.js?v=272';
