...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=170';
import { resolveEquippedItem } from './items.js?v=154';
import { pickWeightedMonster } from './adminConfig.js?v=142';
