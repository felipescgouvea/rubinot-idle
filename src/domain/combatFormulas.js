...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=233';
import { resolveEquippedItem } from './items.js?v=217';
import { pickWeightedMonster } from './adminConfig.js?v=205';
