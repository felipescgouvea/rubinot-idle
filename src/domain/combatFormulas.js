...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=266';
import { resolveEquippedItem } from './items.js?v=250';
import { pickWeightedMonster } from './adminConfig.js?v=238';
