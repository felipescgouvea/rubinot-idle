...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=275';
import { resolveEquippedItem } from './items.js?v=259';
import { pickWeightedMonster } from './adminConfig.js?v=247';
