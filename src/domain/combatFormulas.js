...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=206';
import { resolveEquippedItem } from './items.js?v=190';
import { pickWeightedMonster } from './adminConfig.js?v=178';
