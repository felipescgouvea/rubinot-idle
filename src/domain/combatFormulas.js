...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=293';
import { resolveEquippedItem } from './items.js?v=277';
import { pickWeightedMonster } from './adminConfig.js?v=265';
