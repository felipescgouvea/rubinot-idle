...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=122';
import { resolveEquippedItem } from './items.js?v=122';
import { pickWeightedMonster } from './adminConfig.js?v=122';
