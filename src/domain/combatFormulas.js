...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=179';
import { resolveEquippedItem } from './items.js?v=163';
import { pickWeightedMonster } from './adminConfig.js?v=151';
