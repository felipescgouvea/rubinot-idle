...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=116';
import { resolveEquippedItem } from './items.js?v=116';
import { pickWeightedMonster } from './adminConfig.js?v=116';
