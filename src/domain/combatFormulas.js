...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=185';
import { resolveEquippedItem } from './items.js?v=169';
import { pickWeightedMonster } from './adminConfig.js?v=157';
