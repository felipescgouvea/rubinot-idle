...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=308';
import { resolveEquippedItem } from './items.js?v=292';
import { pickWeightedMonster } from './adminConfig.js?v=280';
