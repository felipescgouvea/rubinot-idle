...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=252';
import { resolveEquippedItem } from './items.js?v=236';
import { pickWeightedMonster } from './adminConfig.js?v=224';
