...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=181';
import { resolveEquippedItem } from './items.js?v=165';
import { pickWeightedMonster } from './adminConfig.js?v=153';
