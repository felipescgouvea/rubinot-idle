...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=118';
import { resolveEquippedItem } from './items.js?v=118';
import { pickWeightedMonster } from './adminConfig.js?v=118';
