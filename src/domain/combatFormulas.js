...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=189';
import { resolveEquippedItem } from './items.js?v=173';
import { pickWeightedMonster } from './adminConfig.js?v=161';
