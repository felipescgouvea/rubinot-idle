...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=215';
import { resolveEquippedItem } from './items.js?v=199';
import { pickWeightedMonster } from './adminConfig.js?v=187';
