...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=360';
import { resolveEquippedItem } from './items.js?v=344';
import { pickWeightedMonster } from './adminConfig.js?v=332';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=330';
