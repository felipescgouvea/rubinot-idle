...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=328';
import { resolveEquippedItem } from './items.js?v=312';
import { pickWeightedMonster } from './adminConfig.js?v=300';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=298';
