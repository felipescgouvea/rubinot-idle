...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=260';
import { resolveEquippedItem } from './items.js?v=244';
import { pickWeightedMonster } from './adminConfig.js?v=232';
