...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=274';
import { resolveEquippedItem } from './items.js?v=258';
import { pickWeightedMonster } from './adminConfig.js?v=246';
