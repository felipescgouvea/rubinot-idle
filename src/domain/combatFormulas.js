...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=121';
import { resolveEquippedItem } from './items.js?v=121';
import { pickWeightedMonster } from './adminConfig.js?v=121';
