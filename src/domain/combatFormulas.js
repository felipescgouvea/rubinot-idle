...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=119';
import { resolveEquippedItem } from './items.js?v=119';
import { pickWeightedMonster } from './adminConfig.js?v=119';
