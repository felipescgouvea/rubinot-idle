...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=285';
import { resolveEquippedItem } from './items.js?v=269';
import { pickWeightedMonster } from './adminConfig.js?v=257';
