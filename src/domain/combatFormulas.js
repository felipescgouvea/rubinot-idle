...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=223';
import { resolveEquippedItem } from './items.js?v=207';
import { pickWeightedMonster } from './adminConfig.js?v=195';
