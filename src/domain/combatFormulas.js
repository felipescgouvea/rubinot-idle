...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=187';
import { resolveEquippedItem } from './items.js?v=171';
import { pickWeightedMonster } from './adminConfig.js?v=159';
