...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=171';
import { resolveEquippedItem } from './items.js?v=155';
import { pickWeightedMonster } from './adminConfig.js?v=143';
