...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=200';
import { resolveEquippedItem } from './items.js?v=184';
import { pickWeightedMonster } from './adminConfig.js?v=172';
