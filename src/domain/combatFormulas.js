...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=289';
import { resolveEquippedItem } from './items.js?v=273';
import { pickWeightedMonster } from './adminConfig.js?v=261';
