...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=157';
import { resolveEquippedItem } from './items.js?v=141';
import { pickWeightedMonster } from './adminConfig.js?v=129';
