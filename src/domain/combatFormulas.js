...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=236';
import { resolveEquippedItem } from './items.js?v=220';
import { pickWeightedMonster } from './adminConfig.js?v=208';
