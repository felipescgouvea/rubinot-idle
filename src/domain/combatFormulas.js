...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=309';
import { resolveEquippedItem } from './items.js?v=293';
import { pickWeightedMonster } from './adminConfig.js?v=281';
