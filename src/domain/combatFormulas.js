...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=270';
import { resolveEquippedItem } from './items.js?v=254';
import { pickWeightedMonster } from './adminConfig.js?v=242';
