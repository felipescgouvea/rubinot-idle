...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=106';
import { resolveEquippedItem } from './items.js?v=106';
import { pickWeightedMonster } from './adminConfig.js?v=106';
