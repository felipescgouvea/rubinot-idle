...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=229';
import { resolveEquippedItem } from './items.js?v=213';
import { pickWeightedMonster } from './adminConfig.js?v=201';
