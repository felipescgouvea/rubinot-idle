...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=195';
import { resolveEquippedItem } from './items.js?v=179';
import { pickWeightedMonster } from './adminConfig.js?v=167';
