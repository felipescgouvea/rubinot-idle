...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=168';
import { resolveEquippedItem } from './items.js?v=152';
import { pickWeightedMonster } from './adminConfig.js?v=140';
