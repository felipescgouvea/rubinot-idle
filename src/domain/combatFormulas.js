...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=265';
import { resolveEquippedItem } from './items.js?v=249';
import { pickWeightedMonster } from './adminConfig.js?v=237';
