...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=196';
import { resolveEquippedItem } from './items.js?v=180';
import { pickWeightedMonster } from './adminConfig.js?v=168';
