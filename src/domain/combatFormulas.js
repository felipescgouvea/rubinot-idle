...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=174';
import { resolveEquippedItem } from './items.js?v=158';
import { pickWeightedMonster } from './adminConfig.js?v=146';
