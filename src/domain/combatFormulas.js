...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=169';
import { resolveEquippedItem } from './items.js?v=153';
import { pickWeightedMonster } from './adminConfig.js?v=141';
