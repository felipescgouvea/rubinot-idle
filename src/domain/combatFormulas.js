...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=232';
import { resolveEquippedItem } from './items.js?v=216';
import { pickWeightedMonster } from './adminConfig.js?v=204';
