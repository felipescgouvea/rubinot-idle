...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=202';
import { resolveEquippedItem } from './items.js?v=186';
import { pickWeightedMonster } from './adminConfig.js?v=174';
