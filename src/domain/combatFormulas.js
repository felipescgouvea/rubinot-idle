...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=218';
import { resolveEquippedItem } from './items.js?v=202';
import { pickWeightedMonster } from './adminConfig.js?v=190';
