...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=272';
import { resolveEquippedItem } from './items.js?v=256';
import { pickWeightedMonster } from './adminConfig.js?v=244';
