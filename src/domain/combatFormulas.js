...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=283';
import { resolveEquippedItem } from './items.js?v=267';
import { pickWeightedMonster } from './adminConfig.js?v=255';
