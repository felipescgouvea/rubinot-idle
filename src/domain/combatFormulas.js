...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=350';
import { resolveEquippedItem } from './items.js?v=334';
import { pickWeightedMonster } from './adminConfig.js?v=322';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=320';
