...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=338';
import { resolveEquippedItem } from './items.js?v=322';
import { pickWeightedMonster } from './adminConfig.js?v=310';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=308';
