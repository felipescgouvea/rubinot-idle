...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=386';
import { resolveEquippedItem } from './items.js?v=370';
import { pickWeightedMonster } from './adminConfig.js?v=358';
import { IMBUEMENTS, isImbuementActive, imbuementPct } from './imbuements.js?v=356';
