...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=249';
import { resolveEquippedItem } from './items.js?v=233';
import { pickWeightedMonster } from './adminConfig.js?v=221';
