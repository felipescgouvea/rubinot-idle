...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=258';
import { resolveEquippedItem } from './items.js?v=242';
import { pickWeightedMonster } from './adminConfig.js?v=230';
