...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=238';
import { resolveEquippedItem } from './items.js?v=222';
import { pickWeightedMonster } from './adminConfig.js?v=210';
