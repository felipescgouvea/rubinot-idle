...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=160';
import { resolveEquippedItem } from './items.js?v=144';
import { pickWeightedMonster } from './adminConfig.js?v=132';
