...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=230';
import { resolveEquippedItem } from './items.js?v=214';
import { pickWeightedMonster } from './adminConfig.js?v=202';
