...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=241';
import { resolveEquippedItem } from './items.js?v=225';
import { pickWeightedMonster } from './adminConfig.js?v=213';
