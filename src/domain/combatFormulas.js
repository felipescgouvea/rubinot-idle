...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=375';
import { resolveEquippedItem } from './items.js?v=359';
import { pickWeightedMonster } from './adminConfig.js?v=347';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=345';
