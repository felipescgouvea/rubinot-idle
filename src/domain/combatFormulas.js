...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=180';
import { resolveEquippedItem } from './items.js?v=164';
import { pickWeightedMonster } from './adminConfig.js?v=152';
