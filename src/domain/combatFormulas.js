...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=261';
import { resolveEquippedItem } from './items.js?v=245';
import { pickWeightedMonster } from './adminConfig.js?v=233';
