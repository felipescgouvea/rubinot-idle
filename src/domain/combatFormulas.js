...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=336';
import { resolveEquippedItem } from './items.js?v=320';
import { pickWeightedMonster } from './adminConfig.js?v=308';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=306';
