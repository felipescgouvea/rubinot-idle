...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=123';
import { resolveEquippedItem } from './items.js?v=123';
import { pickWeightedMonster } from './adminConfig.js?v=123';
