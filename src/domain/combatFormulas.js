...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=212';
import { resolveEquippedItem } from './items.js?v=196';
import { pickWeightedMonster } from './adminConfig.js?v=184';
