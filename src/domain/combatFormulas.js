...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=111';
import { resolveEquippedItem } from './items.js?v=111';
import { pickWeightedMonster } from './adminConfig.js?v=111';
