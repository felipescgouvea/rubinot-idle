...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=243';
import { resolveEquippedItem } from './items.js?v=227';
import { pickWeightedMonster } from './adminConfig.js?v=215';
