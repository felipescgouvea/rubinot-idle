...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=165';
import { resolveEquippedItem } from './items.js?v=149';
import { pickWeightedMonster } from './adminConfig.js?v=137';
