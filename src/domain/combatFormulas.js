...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=115';
import { resolveEquippedItem } from './items.js?v=115';
import { pickWeightedMonster } from './adminConfig.js?v=115';
