...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=214';
import { resolveEquippedItem } from './items.js?v=198';
import { pickWeightedMonster } from './adminConfig.js?v=186';
