...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=225';
import { resolveEquippedItem } from './items.js?v=209';
import { pickWeightedMonster } from './adminConfig.js?v=197';
