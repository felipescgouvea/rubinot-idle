...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=388';
import { resolveEquippedItem } from './items.js?v=372';
import { pickWeightedMonster } from './adminConfig.js?v=360';
import { IMBUEMENTS, isImbuementActive, imbuementPct } from './imbuements.js?v=358';
