...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=313';
import { resolveEquippedItem } from './items.js?v=297';
import { pickWeightedMonster } from './adminConfig.js?v=285';
