...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=228';
import { resolveEquippedItem } from './items.js?v=212';
import { pickWeightedMonster } from './adminConfig.js?v=200';
