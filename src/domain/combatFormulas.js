...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=204';
import { resolveEquippedItem } from './items.js?v=188';
import { pickWeightedMonster } from './adminConfig.js?v=176';
