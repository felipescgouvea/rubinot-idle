...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=267';
import { resolveEquippedItem } from './items.js?v=251';
import { pickWeightedMonster } from './adminConfig.js?v=239';
