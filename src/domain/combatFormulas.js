...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=205';
import { resolveEquippedItem } from './items.js?v=189';
import { pickWeightedMonster } from './adminConfig.js?v=177';
