...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=262';
import { resolveEquippedItem } from './items.js?v=246';
import { pickWeightedMonster } from './adminConfig.js?v=234';
