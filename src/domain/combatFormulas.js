...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=294';
import { resolveEquippedItem } from './items.js?v=278';
import { pickWeightedMonster } from './adminConfig.js?v=266';
