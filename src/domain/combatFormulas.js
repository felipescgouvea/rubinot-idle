...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=163';
import { resolveEquippedItem } from './items.js?v=147';
import { pickWeightedMonster } from './adminConfig.js?v=135';
