...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=264';
import { resolveEquippedItem } from './items.js?v=248';
import { pickWeightedMonster } from './adminConfig.js?v=236';
