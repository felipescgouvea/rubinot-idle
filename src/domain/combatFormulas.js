...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=191';
import { resolveEquippedItem } from './items.js?v=175';
import { pickWeightedMonster } from './adminConfig.js?v=163';
