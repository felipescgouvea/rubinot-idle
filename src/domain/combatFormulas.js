...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=217';
import { resolveEquippedItem } from './items.js?v=201';
import { pickWeightedMonster } from './adminConfig.js?v=189';
