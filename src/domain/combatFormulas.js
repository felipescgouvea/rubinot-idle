...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=235';
import { resolveEquippedItem } from './items.js?v=219';
import { pickWeightedMonster } from './adminConfig.js?v=207';
