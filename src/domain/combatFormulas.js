...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=280';
import { resolveEquippedItem } from './items.js?v=264';
import { pickWeightedMonster } from './adminConfig.js?v=252';
