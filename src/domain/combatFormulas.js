...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=286';
import { resolveEquippedItem } from './items.js?v=270';
import { pickWeightedMonster } from './adminConfig.js?v=258';
