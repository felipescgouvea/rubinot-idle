...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=269';
import { resolveEquippedItem } from './items.js?v=253';
import { pickWeightedMonster } from './adminConfig.js?v=241';
