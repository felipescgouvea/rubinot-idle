...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=166';
import { resolveEquippedItem } from './items.js?v=150';
import { pickWeightedMonster } from './adminConfig.js?v=138';
