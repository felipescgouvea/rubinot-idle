...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=281';
import { resolveEquippedItem } from './items.js?v=265';
import { pickWeightedMonster } from './adminConfig.js?v=253';
