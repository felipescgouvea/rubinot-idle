...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=227';
import { resolveEquippedItem } from './items.js?v=211';
import { pickWeightedMonster } from './adminConfig.js?v=199';
