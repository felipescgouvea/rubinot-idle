...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=124';
import { resolveEquippedItem } from './items.js?v=124';
import { pickWeightedMonster } from './adminConfig.js?v=124';
