...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=172';
import { resolveEquippedItem } from './items.js?v=156';
import { pickWeightedMonster } from './adminConfig.js?v=144';
