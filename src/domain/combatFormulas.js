...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=161';
import { resolveEquippedItem } from './items.js?v=145';
import { pickWeightedMonster } from './adminConfig.js?v=133';
