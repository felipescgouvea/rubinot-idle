...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=305';
import { resolveEquippedItem } from './items.js?v=289';
import { pickWeightedMonster } from './adminConfig.js?v=277';
