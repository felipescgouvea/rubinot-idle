...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=192';
import { resolveEquippedItem } from './items.js?v=176';
import { pickWeightedMonster } from './adminConfig.js?v=164';
