...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=178';
import { resolveEquippedItem } from './items.js?v=162';
import { pickWeightedMonster } from './adminConfig.js?v=150';
