...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=158';
import { resolveEquippedItem } from './items.js?v=142';
import { pickWeightedMonster } from './adminConfig.js?v=130';
