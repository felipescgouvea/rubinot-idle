...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=317';
import { resolveEquippedItem } from './items.js?v=301';
import { pickWeightedMonster } from './adminConfig.js?v=289';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=287';
