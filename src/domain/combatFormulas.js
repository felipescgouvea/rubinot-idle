...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=201';
import { resolveEquippedItem } from './items.js?v=185';
import { pickWeightedMonster } from './adminConfig.js?v=173';
