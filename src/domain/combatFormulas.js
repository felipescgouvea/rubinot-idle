...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=318';
import { resolveEquippedItem } from './items.js?v=302';
import { pickWeightedMonster } from './adminConfig.js?v=290';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=288';
