...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=247';
import { resolveEquippedItem } from './items.js?v=231';
import { pickWeightedMonster } from './adminConfig.js?v=219';
