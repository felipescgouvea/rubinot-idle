...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=311';
import { resolveEquippedItem } from './items.js?v=295';
import { pickWeightedMonster } from './adminConfig.js?v=283';
