...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=302';
import { resolveEquippedItem } from './items.js?v=286';
import { pickWeightedMonster } from './adminConfig.js?v=274';
