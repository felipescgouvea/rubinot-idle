...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=173';
import { resolveEquippedItem } from './items.js?v=157';
import { pickWeightedMonster } from './adminConfig.js?v=145';
