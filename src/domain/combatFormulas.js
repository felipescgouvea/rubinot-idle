...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=378';
import { resolveEquippedItem } from './items.js?v=362';
import { pickWeightedMonster } from './adminConfig.js?v=350';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=348';
