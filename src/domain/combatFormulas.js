...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=188';
import { resolveEquippedItem } from './items.js?v=172';
import { pickWeightedMonster } from './adminConfig.js?v=160';
