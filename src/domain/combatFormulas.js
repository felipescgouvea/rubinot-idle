...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=278';
import { resolveEquippedItem } from './items.js?v=262';
import { pickWeightedMonster } from './adminConfig.js?v=250';
