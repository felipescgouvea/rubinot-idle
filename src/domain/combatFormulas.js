...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=310';
import { resolveEquippedItem } from './items.js?v=294';
import { pickWeightedMonster } from './adminConfig.js?v=282';
