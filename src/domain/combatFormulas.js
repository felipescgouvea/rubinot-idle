...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=250';
import { resolveEquippedItem } from './items.js?v=234';
import { pickWeightedMonster } from './adminConfig.js?v=222';
