...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=299';
import { resolveEquippedItem } from './items.js?v=283';
import { pickWeightedMonster } from './adminConfig.js?v=271';
