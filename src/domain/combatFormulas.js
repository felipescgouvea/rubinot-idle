...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=337';
import { resolveEquippedItem } from './items.js?v=321';
import { pickWeightedMonster } from './adminConfig.js?v=309';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=307';
