...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=320';
import { resolveEquippedItem } from './items.js?v=304';
import { pickWeightedMonster } from './adminConfig.js?v=292';
import { IMBUEMENTS, isImbuementActive } from './imbuements.js?v=290';
