...
import { VOCATIONS, VOC_TRAINING } from './character.js?v=237';
import { resolveEquippedItem } from './items.js?v=221';
import { pickWeightedMonster } from './adminConfig.js?v=209';
