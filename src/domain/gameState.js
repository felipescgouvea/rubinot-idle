...
import { createDefaultSkills } from './character.js?v=184';
import { createDefaultRtc } from './rtcConfig.js?v=187';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=153';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=156';
