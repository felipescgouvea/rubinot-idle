...
import { createDefaultSkills } from './character.js?v=95';
import { createDefaultRtc } from './rtcConfig.js?v=95';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=95';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=95';
