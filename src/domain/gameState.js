...
import { createDefaultSkills } from './character.js?v=357';
import { createDefaultRtc } from './rtcConfig.js?v=360';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=326';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=329';
