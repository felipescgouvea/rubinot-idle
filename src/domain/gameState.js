...
import { createDefaultSkills } from './character.js?v=300';
import { createDefaultRtc } from './rtcConfig.js?v=303';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=269';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=272';
