...
import { createDefaultSkills } from './character.js?v=294';
import { createDefaultRtc } from './rtcConfig.js?v=297';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=263';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=266';
