...
import { createDefaultSkills } from './character.js?v=361';
import { createDefaultRtc } from './rtcConfig.js?v=364';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=330';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=333';
