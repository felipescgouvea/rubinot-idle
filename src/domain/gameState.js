...
import { createDefaultSkills } from './character.js?v=360';
import { createDefaultRtc } from './rtcConfig.js?v=363';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=329';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=332';
