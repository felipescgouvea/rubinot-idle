...
import { createDefaultSkills } from './character.js?v=341';
import { createDefaultRtc } from './rtcConfig.js?v=344';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=310';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=313';
