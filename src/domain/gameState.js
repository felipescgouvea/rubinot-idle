...
import { createDefaultSkills } from './character.js?v=322';
import { createDefaultRtc } from './rtcConfig.js?v=325';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=291';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=294';
