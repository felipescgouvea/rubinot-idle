...
import { createDefaultSkills } from './character.js?v=326';
import { createDefaultRtc } from './rtcConfig.js?v=329';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=295';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=298';
