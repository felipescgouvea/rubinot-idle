...
import { createDefaultSkills } from './character.js?v=318';
import { createDefaultRtc } from './rtcConfig.js?v=321';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=287';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=290';
