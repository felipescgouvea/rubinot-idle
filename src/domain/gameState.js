...
import { createDefaultSkills } from './character.js?v=311';
import { createDefaultRtc } from './rtcConfig.js?v=314';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=280';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=283';
