...
import { createDefaultSkills } from './character.js?v=317';
import { createDefaultRtc } from './rtcConfig.js?v=320';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=286';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=289';
