...
import { createDefaultSkills } from './character.js?v=293';
import { createDefaultRtc } from './rtcConfig.js?v=296';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=262';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=265';
