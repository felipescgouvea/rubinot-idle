...
import { createDefaultSkills } from './character.js?v=342';
import { createDefaultRtc } from './rtcConfig.js?v=345';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=311';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=314';
