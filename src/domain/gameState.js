...
import { createDefaultSkills } from './character.js?v=168';
import { createDefaultRtc } from './rtcConfig.js?v=171';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=137';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=140';
