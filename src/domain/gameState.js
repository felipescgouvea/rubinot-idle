...
import { createDefaultSkills } from './character.js?v=295';
import { createDefaultRtc } from './rtcConfig.js?v=298';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=264';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=267';
