...
import { createDefaultSkills } from './character.js?v=193';
import { createDefaultRtc } from './rtcConfig.js?v=196';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=162';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=165';
