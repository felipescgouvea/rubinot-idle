...
import { createDefaultSkills } from './character.js?v=327';
import { createDefaultRtc } from './rtcConfig.js?v=330';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=296';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=299';
