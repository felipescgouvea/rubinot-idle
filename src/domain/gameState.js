...
import { createDefaultSkills } from './character.js?v=259';
import { createDefaultRtc } from './rtcConfig.js?v=262';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=228';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=231';
