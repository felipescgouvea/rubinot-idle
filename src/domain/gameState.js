...
import { createDefaultSkills } from './character.js?v=185';
import { createDefaultRtc } from './rtcConfig.js?v=188';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=154';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=157';
