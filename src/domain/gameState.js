...
import { createDefaultSkills } from './character.js?v=314';
import { createDefaultRtc } from './rtcConfig.js?v=317';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=283';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=286';
