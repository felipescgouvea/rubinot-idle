...
import { createDefaultSkills } from './character.js?v=387';
import { createDefaultRtc } from './rtcConfig.js?v=390';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=356';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=359';
