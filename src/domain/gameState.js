...
import { createDefaultSkills } from './character.js?v=349';
import { createDefaultRtc } from './rtcConfig.js?v=352';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=318';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=321';
