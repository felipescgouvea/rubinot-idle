...
import { createDefaultSkills } from './character.js?v=305';
import { createDefaultRtc } from './rtcConfig.js?v=308';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=274';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=277';
