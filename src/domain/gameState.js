...
import { createDefaultSkills } from './character.js?v=222';
import { createDefaultRtc } from './rtcConfig.js?v=225';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=191';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=194';
