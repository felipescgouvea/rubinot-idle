...
import { createDefaultSkills } from './character.js?v=249';
import { createDefaultRtc } from './rtcConfig.js?v=252';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=218';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=221';
