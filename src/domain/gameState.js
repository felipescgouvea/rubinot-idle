...
import { createDefaultSkills } from './character.js?v=332';
import { createDefaultRtc } from './rtcConfig.js?v=335';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=301';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=304';
