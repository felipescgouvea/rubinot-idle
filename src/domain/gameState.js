...
import { createDefaultSkills } from './character.js?v=236';
import { createDefaultRtc } from './rtcConfig.js?v=239';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=205';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=208';
