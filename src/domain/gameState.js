...
import { createDefaultSkills } from './character.js?v=248';
import { createDefaultRtc } from './rtcConfig.js?v=251';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=217';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=220';
