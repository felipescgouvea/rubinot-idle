...
import { createDefaultSkills } from './character.js?v=320';
import { createDefaultRtc } from './rtcConfig.js?v=323';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=289';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=292';
