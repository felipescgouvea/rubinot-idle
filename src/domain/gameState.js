...
import { createDefaultSkills } from './character.js?v=290';
import { createDefaultRtc } from './rtcConfig.js?v=293';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=259';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=262';
