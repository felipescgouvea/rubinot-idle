...
import { createDefaultSkills } from './character.js?v=281';
import { createDefaultRtc } from './rtcConfig.js?v=284';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=250';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=253';
