...
import { createDefaultSkills } from './character.js?v=304';
import { createDefaultRtc } from './rtcConfig.js?v=307';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=273';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=276';
