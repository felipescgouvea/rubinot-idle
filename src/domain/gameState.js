...
import { createDefaultSkills } from './character.js?v=182';
import { createDefaultRtc } from './rtcConfig.js?v=185';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=151';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=154';
