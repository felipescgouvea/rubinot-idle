...
import { createDefaultSkills } from './character.js?v=331';
import { createDefaultRtc } from './rtcConfig.js?v=334';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=300';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=303';
