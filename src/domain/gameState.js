...
import { createDefaultSkills } from './character.js?v=340';
import { createDefaultRtc } from './rtcConfig.js?v=343';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=309';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=312';
