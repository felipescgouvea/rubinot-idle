...
import { createDefaultSkills } from './character.js?v=303';
import { createDefaultRtc } from './rtcConfig.js?v=306';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=272';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=275';
