...
import { createDefaultSkills } from './character.js?v=70';
import { createDefaultRtc } from './rtcConfig.js?v=70';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=70';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=70';
