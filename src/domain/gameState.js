...
import { createDefaultSkills } from './character.js?v=358';
import { createDefaultRtc } from './rtcConfig.js?v=361';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=327';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=330';
