...
import { createDefaultSkills } from './character.js?v=286';
import { createDefaultRtc } from './rtcConfig.js?v=289';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=255';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=258';
