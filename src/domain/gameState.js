...
import { createDefaultSkills } from './character.js?v=335';
import { createDefaultRtc } from './rtcConfig.js?v=338';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=304';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=307';
