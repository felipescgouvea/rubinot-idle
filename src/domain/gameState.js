...
import { createDefaultSkills } from './character.js?v=302';
import { createDefaultRtc } from './rtcConfig.js?v=305';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=271';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=274';
