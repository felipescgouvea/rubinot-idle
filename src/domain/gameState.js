...
import { createDefaultSkills } from './character.js?v=316';
import { createDefaultRtc } from './rtcConfig.js?v=319';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=285';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=288';
