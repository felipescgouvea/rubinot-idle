...
import { createDefaultSkills } from './character.js?v=213';
import { createDefaultRtc } from './rtcConfig.js?v=216';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=182';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=185';
