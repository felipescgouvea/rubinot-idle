...
import { createDefaultSkills } from './character.js?v=338';
import { createDefaultRtc } from './rtcConfig.js?v=341';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=307';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=310';
