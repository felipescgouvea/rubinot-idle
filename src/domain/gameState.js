...
import { createDefaultSkills } from './character.js?v=62';
import { createDefaultRtc } from './rtcConfig.js?v=62';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=62';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=62';
