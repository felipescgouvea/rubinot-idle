...
import { createDefaultSkills } from './character.js?v=359';
import { createDefaultRtc } from './rtcConfig.js?v=362';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=328';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=331';
