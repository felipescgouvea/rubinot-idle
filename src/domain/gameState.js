...
import { createDefaultSkills } from './character.js?v=352';
import { createDefaultRtc } from './rtcConfig.js?v=355';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=321';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=324';
