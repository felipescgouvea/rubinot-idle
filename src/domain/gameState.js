...
import { createDefaultSkills } from './character.js?v=339';
import { createDefaultRtc } from './rtcConfig.js?v=342';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=308';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=311';
