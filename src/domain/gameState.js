...
import { createDefaultSkills } from './character.js?v=296';
import { createDefaultRtc } from './rtcConfig.js?v=299';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=265';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=268';
