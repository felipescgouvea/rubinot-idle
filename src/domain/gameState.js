...
import { createDefaultSkills } from './character.js?v=247';
import { createDefaultRtc } from './rtcConfig.js?v=250';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=216';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=219';
