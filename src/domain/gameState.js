...
import { createDefaultSkills } from './character.js?v=68';
import { createDefaultRtc } from './rtcConfig.js?v=68';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=68';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=68';
