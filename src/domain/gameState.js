...
import { createDefaultSkills } from './character.js?v=321';
import { createDefaultRtc } from './rtcConfig.js?v=324';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=290';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=293';
