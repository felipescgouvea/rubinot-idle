...
import { createDefaultSkills } from './character.js?v=350';
import { createDefaultRtc } from './rtcConfig.js?v=353';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=319';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=322';
