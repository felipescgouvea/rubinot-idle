...
import { createDefaultSkills } from './character.js?v=315';
import { createDefaultRtc } from './rtcConfig.js?v=318';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=284';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=287';
