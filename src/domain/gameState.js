...
import { createDefaultSkills } from './character.js?v=351';
import { createDefaultRtc } from './rtcConfig.js?v=354';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=320';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=323';
