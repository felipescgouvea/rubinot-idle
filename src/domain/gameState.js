...
import { createDefaultSkills } from './character.js?v=291';
import { createDefaultRtc } from './rtcConfig.js?v=294';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=260';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=263';
