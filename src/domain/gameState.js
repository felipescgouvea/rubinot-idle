...
import { createDefaultSkills } from './character.js?v=221';
import { createDefaultRtc } from './rtcConfig.js?v=224';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=190';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=193';
