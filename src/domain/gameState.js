...
import { createDefaultSkills } from './character.js?v=292';
import { createDefaultRtc } from './rtcConfig.js?v=295';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=261';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=264';
