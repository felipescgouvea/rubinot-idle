...
import { createDefaultSkills } from './character.js?v=58';
import { createDefaultRtc } from './rtcConfig.js?v=58';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=58';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=58';
