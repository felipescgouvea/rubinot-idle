...
import { createDefaultSkills } from './character.js?v=280';
import { createDefaultRtc } from './rtcConfig.js?v=283';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=249';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=252';
