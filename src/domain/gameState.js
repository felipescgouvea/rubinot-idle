...
import { createDefaultSkills } from './character.js?v=301';
import { createDefaultRtc } from './rtcConfig.js?v=304';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=270';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=273';
