...
import { createDefaultSkills } from './character.js?v=348';
import { createDefaultRtc } from './rtcConfig.js?v=351';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=317';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=320';
