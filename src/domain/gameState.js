...
import { createDefaultSkills } from './character.js?v=325';
import { createDefaultRtc } from './rtcConfig.js?v=328';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=294';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=297';
