...
import { createDefaultSkills } from './character.js?v=55';
import { createDefaultRtc } from './rtcConfig.js?v=55';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=55';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=55';
