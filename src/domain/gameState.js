...
import { createDefaultSkills } from './character.js?v=313';
import { createDefaultRtc } from './rtcConfig.js?v=316';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=282';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=285';
