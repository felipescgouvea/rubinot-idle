...
import { createDefaultSkills } from './character.js?v=390';
import { createDefaultRtc } from './rtcConfig.js?v=393';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=359';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=362';
