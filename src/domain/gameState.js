...
import { createDefaultSkills } from './character.js?v=275';
import { createDefaultRtc } from './rtcConfig.js?v=278';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=244';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=247';
