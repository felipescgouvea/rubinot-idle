...
import { createDefaultSkills } from './character.js?v=372';
import { createDefaultRtc } from './rtcConfig.js?v=375';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=341';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=344';
