...
import { createDefaultSkills } from './character.js?v=310';
import { createDefaultRtc } from './rtcConfig.js?v=313';
import { DEFAULT_OUTFIT_COLORS } from './outfitColors.js?v=279';
import { DEFAULT_ADMIN_CONFIG } from './adminConfig.js?v=282';
