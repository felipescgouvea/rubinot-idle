...
import { VOCATIONS, XP_TABLE, MAX_LEVEL, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=374';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=344';
import { skillIconImg, itemIconImg } from './shared.js?v=350';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=343';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=343';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=343';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=343';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=344';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=345';
import { formatNum, applyHpState } from './shared.js?v=350';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=364';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=411';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=348';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=343';
import { selectVocation } from '../application/characterUseCases.js?v=348';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=348';
import { t } from '../i18n/i18n.js?v=363';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=184';
