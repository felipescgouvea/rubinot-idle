...
import { VOCATIONS, XP_TABLE, MAX_LEVEL, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=311';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=281';
import { skillIconImg, itemIconImg } from './shared.js?v=287';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=280';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=280';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=280';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=280';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=281';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=282';
import { formatNum, applyHpState } from './shared.js?v=287';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=301';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=348';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=285';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=280';
import { selectVocation } from '../application/characterUseCases.js?v=285';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=285';
import { t } from '../i18n/i18n.js?v=300';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=121';
