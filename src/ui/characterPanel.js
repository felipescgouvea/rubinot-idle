...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=257';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=226';
import { skillIconImg, itemIconImg } from './shared.js?v=232';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=225';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=225';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=225';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=225';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=226';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=227';
import { formatNum, applyHpState } from './shared.js?v=232';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=246';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=293';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=230';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=225';
import { selectVocation } from '../application/characterUseCases.js?v=230';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=229';
import { t } from '../i18n/i18n.js?v=243';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=66';
