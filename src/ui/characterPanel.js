...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=286';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=255';
import { skillIconImg, itemIconImg } from './shared.js?v=261';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=254';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=254';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=254';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=254';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=255';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=256';
import { formatNum, applyHpState } from './shared.js?v=261';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=275';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=322';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=259';
...
import { registerPlayerName } from '../application/highscoresUseCases.js?v=258';
