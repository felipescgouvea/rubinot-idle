...
import { VOCATIONS, XP_TABLE, MAX_LEVEL, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=342';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=312';
import { skillIconImg, itemIconImg } from './shared.js?v=318';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=311';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=311';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=311';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=311';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=312';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=313';
import { formatNum, applyHpState } from './shared.js?v=318';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=332';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=379';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=316';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=311';
import { selectVocation } from '../application/characterUseCases.js?v=316';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=316';
import { t } from '../i18n/i18n.js?v=331';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=152';
