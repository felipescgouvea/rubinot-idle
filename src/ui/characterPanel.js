...
import { VOCATIONS, XP_TABLE, MAX_LEVEL, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=387';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=357';
import { skillIconImg, itemIconImg } from './shared.js?v=363';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=356';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=356';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=356';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=356';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=357';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=358';
import { formatNum, applyHpState } from './shared.js?v=363';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=377';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=424';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=361';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=356';
import { selectVocation } from '../application/characterUseCases.js?v=361';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=361';
import { t } from '../i18n/i18n.js?v=376';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=197';
