...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=288';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=257';
import { skillIconImg, itemIconImg } from './shared.js?v=263';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=256';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=256';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=256';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=256';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=257';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=258';
import { formatNum, applyHpState } from './shared.js?v=263';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=277';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=324';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=261';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=256';
import { selectVocation } from '../application/characterUseCases.js?v=261';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=261';
import { t } from '../i18n/i18n.js?v=276';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=97';
