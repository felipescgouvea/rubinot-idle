...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=299';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=268';
import { skillIconImg, itemIconImg } from './shared.js?v=274';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=267';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=267';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=267';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=267';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=268';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=269';
import { formatNum, applyHpState } from './shared.js?v=274';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=288';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=335';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=272';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=267';
import { selectVocation } from '../application/characterUseCases.js?v=272';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=272';
import { t } from '../i18n/i18n.js?v=287';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=108';
