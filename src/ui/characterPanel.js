...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=166';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=135';
import { skillIconImg } from './shared.js?v=141';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=134';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=134';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=134';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=134';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=135';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=136';
import { formatNum, applyHpState } from './shared.js?v=141';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=155';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=202';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=139';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=134';
import { selectVocation } from '../application/characterUseCases.js?v=139';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=138';
