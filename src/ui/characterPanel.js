...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, triesForNext } from '../domain/character.js?v=79';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=79';
import { skillIconImg } from './shared.js?v=79';
...
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=79';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=79';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=79';
import { on, EVENTS } from '../shared/eventBus.js?v=79';
import { formatNum } from './shared.js?v=79';
import { renderZonePicker } from './huntPanel.js?v=79';
