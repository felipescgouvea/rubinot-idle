...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext, PROMOTION, vocationDisplayName } from '../domain/character.js?v=214';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=183';
import { skillIconImg } from './shared.js?v=189';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=182';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=182';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=182';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=182';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=183';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=184';
import { formatNum, applyHpState } from './shared.js?v=189';
import { renderZonePicker, fmtDuration } from './huntPanel.js?v=203';
import { getCurrentMonster, getHuntStats } from '../application/huntUseCases.js?v=250';
import { isStaminaEnabled } from '../application/adminUseCases.js?v=187';
import { formatStamina, staminaXpMult, staminaTier } from '../domain/stamina.js?v=182';
import { selectVocation } from '../application/characterUseCases.js?v=187';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=186';
import { t } from '../i18n/i18n.js?v=200';
import { stageWalkPhase, isStageWalking } from './stageWalk.js?v=23';
