...
import { VOCATIONS, XP_TABLE, TIBIA_SKILLS, VOC_TRAINING, triesForNext } from '../domain/character.js?v=83';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=83';
import { skillIconImg } from './shared.js?v=83';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=83';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=83';
import { outfitWalkAtlasPath } from '../infrastructure/outfitAssets.js?v=83';
import { buildWalkFrames } from '../infrastructure/outfitWalkRenderer.js?v=83';
import { getAtk, getDef, getSpd, getMagic, getMaxHp, getMaxMana } from '../application/stats.js?v=83';
import { on, EVENTS } from '../shared/eventBus.js?v=83';
import { formatNum } from './shared.js?v=83';
import { renderZonePicker } from './huntPanel.js?v=83';
