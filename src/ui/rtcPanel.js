...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=178';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=191';
import { VOCATIONS } from '../domain/character.js?v=207';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=176';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=210';
import { getMagic } from '../application/stats.js?v=177';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=176';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=176';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=212';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=178';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=183';
