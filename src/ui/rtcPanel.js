...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=40';
import { ITEMS } from '../domain/items.js?v=40';
import { VOCATIONS } from '../domain/character.js?v=40';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=40';
import { isRuneAvailableToVocation } from '../domain/rtcConfig.js?v=40';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=40';
import { on, EVENTS } from '../shared/eventBus.js?v=40';
import { itemIconImg, spellIconImg, vitalIconImg } from './shared.js?v=40';
