...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=195';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=208';
...
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT,
  HEAL_TIER_COUNT, TARGET_PRIORITIES, normalizeHealTiers } from '../domain/rtcConfig.js?v=227';
import { getMagic } from '../application/stats.js?v=194';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=193';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=193';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=229';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=195';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=200';
