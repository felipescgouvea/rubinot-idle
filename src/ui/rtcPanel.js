...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=74';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=74';
...
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=74';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=74';
import { on, EVENTS } from '../shared/eventBus.js?v=74';
import { itemIconImg, spellIconImg, vitalIconImg } from './shared.js?v=74';
