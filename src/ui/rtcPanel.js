...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=150';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=163';
import { VOCATIONS } from '../domain/character.js?v=179';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=148';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=182';
import { getMagic } from '../application/stats.js?v=149';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=148';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=148';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=184';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=150';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=155';
