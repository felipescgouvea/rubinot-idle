...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=188';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=201';
import { VOCATIONS } from '../domain/character.js?v=217';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=186';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=220';
import { getMagic } from '../application/stats.js?v=187';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=186';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=186';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=222';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=188';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=193';
