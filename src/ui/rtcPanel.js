...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=96';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=96';
import { VOCATIONS } from '../domain/character.js?v=96';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=96';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl } from '../domain/rtcConfig.js?v=96';
import { getMagic } from '../application/stats.js?v=96';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=96';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=96';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion } from '../application/rtcUseCases.js?v=96';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=96';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=96';
