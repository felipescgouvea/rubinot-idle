...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=179';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=192';
import { VOCATIONS } from '../domain/character.js?v=208';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=177';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=211';
import { getMagic } from '../application/stats.js?v=178';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=177';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=177';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=213';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=179';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=184';
