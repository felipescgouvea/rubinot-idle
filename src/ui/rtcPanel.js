...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=81';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=81';
...
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=81';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=81';
import { setRtcHealPotion, setRtcManaPotion } from '../application/rtcUseCases.js?v=81';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=81';
import { itemIconImg, spellIconImg, vitalIconImg } from './shared.js?v=81';
