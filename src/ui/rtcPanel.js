...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=169';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=182';
import { VOCATIONS } from '../domain/character.js?v=198';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=167';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=201';
import { getMagic } from '../application/stats.js?v=168';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=167';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=167';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=203';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=169';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=174';
