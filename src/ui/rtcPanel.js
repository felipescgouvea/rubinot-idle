...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=172';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=185';
import { VOCATIONS } from '../domain/character.js?v=201';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=170';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=204';
import { getMagic } from '../application/stats.js?v=171';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=170';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=170';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=206';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=172';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=177';
