...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=166';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=179';
import { VOCATIONS } from '../domain/character.js?v=195';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=164';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=198';
import { getMagic } from '../application/stats.js?v=165';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=164';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=164';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=200';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=166';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=171';
