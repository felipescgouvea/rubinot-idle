...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=165';
...
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=197';
import { getMagic } from '../application/stats.js?v=164';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=163';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=163';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=199';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=165';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=170';
