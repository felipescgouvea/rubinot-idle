...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=151';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=164';
import { VOCATIONS } from '../domain/character.js?v=180';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=149';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=183';
import { getMagic } from '../application/stats.js?v=150';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=149';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=149';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=185';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=151';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=156';
