...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=77';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=77';
...
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=77';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=77';
import { setRtcHealPotion, setRtcManaPotion } from '../application/rtcUseCases.js?v=77';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=77';
import { itemIconImg, spellIconImg, vitalIconImg } from './shared.js?v=77';
