...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=146';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=159';
import { VOCATIONS } from '../domain/character.js?v=175';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=144';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=178';
import { getMagic } from '../application/stats.js?v=145';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=144';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=144';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=180';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=146';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=151';
