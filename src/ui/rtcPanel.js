...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=170';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=183';
import { VOCATIONS } from '../domain/character.js?v=199';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=168';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=202';
import { getMagic } from '../application/stats.js?v=169';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=168';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=168';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=204';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=170';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=175';
