...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=113';
...
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl } from '../domain/rtcConfig.js?v=113';
import { getMagic } from '../application/stats.js?v=113';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=113';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=113';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion } from '../application/rtcUseCases.js?v=113';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=113';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=113';
