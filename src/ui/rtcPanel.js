...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=128';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=141';
import { VOCATIONS } from '../domain/character.js?v=157';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=126';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=160';
import { getMagic } from '../application/stats.js?v=127';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=126';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=126';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=162';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=128';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=133';
