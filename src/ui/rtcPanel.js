...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=164';
...
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=196';
import { getMagic } from '../application/stats.js?v=163';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=162';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=162';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=198';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=164';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=169';
