...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=153';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=166';
import { VOCATIONS } from '../domain/character.js?v=182';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=151';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=185';
import { getMagic } from '../application/stats.js?v=152';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=151';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=151';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=187';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=153';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=158';
