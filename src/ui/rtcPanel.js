...
import { SPELLS, defaultHealSpellId } from '../domain/spells.js?v=103';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=103';
import { VOCATIONS } from '../domain/character.js?v=103';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=103';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl } from '../domain/rtcConfig.js?v=103';
import { getMagic } from '../application/stats.js?v=103';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=103';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=103';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion } from '../application/rtcUseCases.js?v=103';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=103';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=103';
