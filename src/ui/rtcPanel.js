...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=201';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=214';
...
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT,
  HEAL_TIER_COUNT, TARGET_PRIORITIES, normalizeHealTiers } from '../domain/rtcConfig.js?v=233';
import { getMagic } from '../application/stats.js?v=200';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=199';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=199';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=235';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=201';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=206';
