...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=144';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=157';
import { VOCATIONS } from '../domain/character.js?v=173';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=142';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=176';
import { getMagic } from '../application/stats.js?v=143';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=142';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=142';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=178';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=144';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=149';
