...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=171';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=184';
import { VOCATIONS } from '../domain/character.js?v=200';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=169';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=203';
import { getMagic } from '../application/stats.js?v=170';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=169';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=169';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=205';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=171';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=176';
