...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=152';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=165';
import { VOCATIONS } from '../domain/character.js?v=181';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=150';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=184';
import { getMagic } from '../application/stats.js?v=151';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=150';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=150';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=186';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=152';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=157';
