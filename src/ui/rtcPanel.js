...
import { SPELLS, defaultHealSpellId, isSpellAvailable } from '../domain/spells.js?v=184';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=197';
import { VOCATIONS } from '../domain/character.js?v=213';
import { VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=182';
import { isRuneAvailableToVocation, normalizeAttackSpells, runeMinMl, canUseAttackRune, isRuneEntry, runeEntryId, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=216';
import { getMagic } from '../application/stats.js?v=183';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=182';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=182';
import { setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcAttackSpellSlot, clearRtcAttackSpellSlot } from '../application/rtcUseCases.js?v=218';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=184';
import { itemIconImg, spellIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=189';
