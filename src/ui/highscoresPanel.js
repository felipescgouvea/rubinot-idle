...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=322';
import { on, EVENTS } from '../shared/eventBus.js?v=323';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=328';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=326';
