...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=263';
import { on, EVENTS } from '../shared/eventBus.js?v=264';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=269';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=267';
