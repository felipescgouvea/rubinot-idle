...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=268';
import { on, EVENTS } from '../shared/eventBus.js?v=269';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=274';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=272';
