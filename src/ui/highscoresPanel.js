...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=296';
import { on, EVENTS } from '../shared/eventBus.js?v=297';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=302';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=300';
