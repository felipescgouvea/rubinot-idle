...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=242';
import { on, EVENTS } from '../shared/eventBus.js?v=243';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=248';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=245';
