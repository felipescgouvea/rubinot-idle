...
import { escapeHtml, notify } from './shared.js?v=111';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=111';
