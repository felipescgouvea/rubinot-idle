...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=163';
import { on, EVENTS } from '../shared/eventBus.js?v=164';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=169';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=166';
