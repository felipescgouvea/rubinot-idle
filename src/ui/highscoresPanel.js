...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=315';
import { on, EVENTS } from '../shared/eventBus.js?v=316';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=321';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=319';
