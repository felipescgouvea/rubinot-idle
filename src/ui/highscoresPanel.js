...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=181';
import { on, EVENTS } from '../shared/eventBus.js?v=182';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=187';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=184';
