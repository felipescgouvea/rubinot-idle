...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=260';
import { on, EVENTS } from '../shared/eventBus.js?v=261';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=266';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=264';
