...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=140';
import { on, EVENTS } from '../shared/eventBus.js?v=141';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=146';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=143';
