...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=162';
import { on, EVENTS } from '../shared/eventBus.js?v=163';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=168';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=165';
