...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=324';
import { on, EVENTS } from '../shared/eventBus.js?v=325';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=330';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=328';
