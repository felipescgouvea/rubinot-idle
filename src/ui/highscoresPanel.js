...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=280';
import { on, EVENTS } from '../shared/eventBus.js?v=281';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=286';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=284';
