...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=304';
import { on, EVENTS } from '../shared/eventBus.js?v=305';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=310';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=308';
