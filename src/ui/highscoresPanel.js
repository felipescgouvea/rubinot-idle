...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=206';
import { on, EVENTS } from '../shared/eventBus.js?v=207';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=212';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=209';
