...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=193';
import { on, EVENTS } from '../shared/eventBus.js?v=194';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=199';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=196';
