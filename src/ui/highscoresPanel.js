...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=316';
import { on, EVENTS } from '../shared/eventBus.js?v=317';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=322';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=320';
