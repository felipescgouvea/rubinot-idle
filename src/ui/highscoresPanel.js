...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=196';
import { on, EVENTS } from '../shared/eventBus.js?v=197';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=202';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=199';
