...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=338';
import { on, EVENTS } from '../shared/eventBus.js?v=339';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=344';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=342';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=111';
