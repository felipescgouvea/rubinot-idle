...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=256';
import { on, EVENTS } from '../shared/eventBus.js?v=257';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=262';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=260';
