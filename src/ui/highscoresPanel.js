...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=150';
import { on, EVENTS } from '../shared/eventBus.js?v=151';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=156';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=153';
