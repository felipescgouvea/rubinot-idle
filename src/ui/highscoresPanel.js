...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=171';
import { on, EVENTS } from '../shared/eventBus.js?v=172';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=177';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=174';
