...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=186';
import { on, EVENTS } from '../shared/eventBus.js?v=187';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=192';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=189';
