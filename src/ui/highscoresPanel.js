...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=257';
import { on, EVENTS } from '../shared/eventBus.js?v=258';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=263';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=261';
