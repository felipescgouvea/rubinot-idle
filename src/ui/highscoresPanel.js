...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=245';
import { on, EVENTS } from '../shared/eventBus.js?v=246';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=251';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=248';
