...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=279';
import { on, EVENTS } from '../shared/eventBus.js?v=280';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=285';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=283';
