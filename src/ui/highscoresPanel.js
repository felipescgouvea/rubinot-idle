...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=339';
import { on, EVENTS } from '../shared/eventBus.js?v=340';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=345';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=343';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=112';
