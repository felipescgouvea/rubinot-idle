...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=172';
import { on, EVENTS } from '../shared/eventBus.js?v=173';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=178';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=175';
