...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=313';
import { on, EVENTS } from '../shared/eventBus.js?v=314';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=319';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=317';
