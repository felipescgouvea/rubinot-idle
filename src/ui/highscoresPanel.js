...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=183';
import { on, EVENTS } from '../shared/eventBus.js?v=184';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=189';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=186';
