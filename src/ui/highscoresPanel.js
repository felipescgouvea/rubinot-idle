...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=272';
import { on, EVENTS } from '../shared/eventBus.js?v=273';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=278';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=276';
