...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=149';
import { on, EVENTS } from '../shared/eventBus.js?v=150';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=155';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=152';
