...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=317';
import { on, EVENTS } from '../shared/eventBus.js?v=318';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=323';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=321';
