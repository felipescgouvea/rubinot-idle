...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=278';
import { on, EVENTS } from '../shared/eventBus.js?v=279';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=284';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=282';
