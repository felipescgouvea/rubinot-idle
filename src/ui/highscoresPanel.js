...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=320';
import { on, EVENTS } from '../shared/eventBus.js?v=321';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=326';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=324';
