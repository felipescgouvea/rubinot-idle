...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=264';
import { on, EVENTS } from '../shared/eventBus.js?v=265';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=270';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=268';
