...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=148';
import { on, EVENTS } from '../shared/eventBus.js?v=149';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=154';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=151';
