...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=155';
import { on, EVENTS } from '../shared/eventBus.js?v=156';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=161';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=158';
