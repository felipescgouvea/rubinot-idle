...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=197';
import { on, EVENTS } from '../shared/eventBus.js?v=198';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=203';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=200';
