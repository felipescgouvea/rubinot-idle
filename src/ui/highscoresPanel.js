...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=325';
import { on, EVENTS } from '../shared/eventBus.js?v=326';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=331';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=329';
