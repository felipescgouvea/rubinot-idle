...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=337';
import { on, EVENTS } from '../shared/eventBus.js?v=338';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=343';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=341';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=110';
