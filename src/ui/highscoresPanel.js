...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=354';
import { on, EVENTS } from '../shared/eventBus.js?v=355';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=360';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=358';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=127';
