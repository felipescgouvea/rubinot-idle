...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=323';
import { on, EVENTS } from '../shared/eventBus.js?v=324';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=329';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=327';
