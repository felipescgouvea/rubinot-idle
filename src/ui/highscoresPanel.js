...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=307';
import { on, EVENTS } from '../shared/eventBus.js?v=308';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=313';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=311';
