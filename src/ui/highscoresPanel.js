...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=244';
import { on, EVENTS } from '../shared/eventBus.js?v=245';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=250';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=247';
