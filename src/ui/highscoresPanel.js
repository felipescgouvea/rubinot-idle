...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=321';
import { on, EVENTS } from '../shared/eventBus.js?v=322';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=327';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=325';
