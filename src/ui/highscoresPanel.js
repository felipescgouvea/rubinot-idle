...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=284';
import { on, EVENTS } from '../shared/eventBus.js?v=285';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=290';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=288';
