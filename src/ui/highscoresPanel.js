...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=195';
import { on, EVENTS } from '../shared/eventBus.js?v=196';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=201';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=198';
