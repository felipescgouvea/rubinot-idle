...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=128';
import { on, EVENTS } from '../shared/eventBus.js?v=129';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=134';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=131';
