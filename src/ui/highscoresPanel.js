...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=156';
import { on, EVENTS } from '../shared/eventBus.js?v=157';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=162';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=159';
