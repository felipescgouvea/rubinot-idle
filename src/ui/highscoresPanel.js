...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=303';
import { on, EVENTS } from '../shared/eventBus.js?v=304';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=309';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=307';
