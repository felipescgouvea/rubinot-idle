...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=353';
import { on, EVENTS } from '../shared/eventBus.js?v=354';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=359';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=357';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=126';
