...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=243';
import { on, EVENTS } from '../shared/eventBus.js?v=244';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=249';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=246';
