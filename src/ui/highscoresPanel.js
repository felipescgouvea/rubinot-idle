...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=154';
import { on, EVENTS } from '../shared/eventBus.js?v=155';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=160';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=157';
