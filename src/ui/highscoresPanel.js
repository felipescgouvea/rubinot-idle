...
import { escapeHtml, notify } from './shared.js?v=106';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=106';
