...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=275';
import { on, EVENTS } from '../shared/eventBus.js?v=276';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=281';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=279';
