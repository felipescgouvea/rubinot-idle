...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=283';
import { on, EVENTS } from '../shared/eventBus.js?v=284';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=289';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=287';
