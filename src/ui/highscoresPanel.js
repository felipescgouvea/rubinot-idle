...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=226';
import { on, EVENTS } from '../shared/eventBus.js?v=227';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=232';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=229';
