...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=271';
import { on, EVENTS } from '../shared/eventBus.js?v=272';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=277';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=275';
