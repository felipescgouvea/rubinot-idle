...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=224';
import { on, EVENTS } from '../shared/eventBus.js?v=225';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=230';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=227';
