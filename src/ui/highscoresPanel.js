...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=267';
import { on, EVENTS } from '../shared/eventBus.js?v=268';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=273';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=271';
