...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=340';
import { on, EVENTS } from '../shared/eventBus.js?v=341';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=346';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=344';
import { getOnlineSnapshot } from '../application/onlineUseCases.js?v=113';
