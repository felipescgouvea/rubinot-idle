...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=326';
import { on, EVENTS } from '../shared/eventBus.js?v=327';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=332';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=330';
