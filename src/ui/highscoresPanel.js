...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=194';
import { on, EVENTS } from '../shared/eventBus.js?v=195';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=200';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=197';
