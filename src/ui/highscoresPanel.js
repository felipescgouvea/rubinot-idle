...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=182';
import { on, EVENTS } from '../shared/eventBus.js?v=183';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=188';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=185';
