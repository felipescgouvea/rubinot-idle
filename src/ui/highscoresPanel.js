...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=290';
import { on, EVENTS } from '../shared/eventBus.js?v=291';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=296';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=294';
