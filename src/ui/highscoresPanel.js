...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=225';
import { on, EVENTS } from '../shared/eventBus.js?v=226';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=231';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=228';
