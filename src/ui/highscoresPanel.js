...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=302';
import { on, EVENTS } from '../shared/eventBus.js?v=303';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=308';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=306';
