...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=227';
import { on, EVENTS } from '../shared/eventBus.js?v=228';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=233';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=230';
