...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=135';
import { on, EVENTS } from '../shared/eventBus.js?v=136';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=141';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=138';
