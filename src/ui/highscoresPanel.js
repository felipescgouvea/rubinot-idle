...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=295';
import { on, EVENTS } from '../shared/eventBus.js?v=296';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=301';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=299';
