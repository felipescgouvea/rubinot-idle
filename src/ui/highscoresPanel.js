...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=187';
import { on, EVENTS } from '../shared/eventBus.js?v=188';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=193';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=190';
