...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=308';
import { on, EVENTS } from '../shared/eventBus.js?v=309';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=314';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=312';
