...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=151';
import { on, EVENTS } from '../shared/eventBus.js?v=152';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=157';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=154';
