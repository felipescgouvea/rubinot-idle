...
import { HIGHSCORE_CATEGORIES, highscoreCategory } from '../domain/highscoreCategories.js?v=314';
import { on, EVENTS } from '../shared/eventBus.js?v=315';
import { escapeHtml, notify, skillIconImg } from './shared.js?v=320';
import { fetchHighscores, submitScore, invalidateHighscoresCache } from '../application/highscoresUseCases.js?v=318';
