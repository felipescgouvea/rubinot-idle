...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=247';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=259';
import { on, EVENTS } from '../shared/eventBus.js?v=246';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=251';
import { buyShopItem } from '../application/shopUseCases.js?v=252';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=249';
