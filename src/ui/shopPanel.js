...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=55';
import { ITEMS } from '../domain/items.js?v=55';
import { on, EVENTS } from '../shared/eventBus.js?v=55';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg } from './shared.js?v=55';
