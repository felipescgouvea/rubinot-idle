...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=277';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=289';
import { on, EVENTS } from '../shared/eventBus.js?v=276';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=281';
import { buyShopItem } from '../application/shopUseCases.js?v=282';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=279';
