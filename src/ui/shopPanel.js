...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=197';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=209';
import { on, EVENTS } from '../shared/eventBus.js?v=196';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=201';
import { buyShopItem } from '../application/shopUseCases.js?v=202';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=199';
