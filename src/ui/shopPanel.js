...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=171';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=183';
import { on, EVENTS } from '../shared/eventBus.js?v=170';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=175';
import { buyShopItem } from '../application/shopUseCases.js?v=176';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=173';
