...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=174';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=186';
import { on, EVENTS } from '../shared/eventBus.js?v=173';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=178';
import { buyShopItem } from '../application/shopUseCases.js?v=179';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=176';
