...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=186';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=198';
import { on, EVENTS } from '../shared/eventBus.js?v=185';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=190';
import { buyShopItem } from '../application/shopUseCases.js?v=191';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=188';
