...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=315';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=327';
import { on, EVENTS } from '../shared/eventBus.js?v=314';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=319';
import { buyShopItem } from '../application/shopUseCases.js?v=320';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=317';
