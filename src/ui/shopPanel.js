...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=356';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=368';
import { on, EVENTS } from '../shared/eventBus.js?v=355';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=360';
import { buyShopItem } from '../application/shopUseCases.js?v=361';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=358';
