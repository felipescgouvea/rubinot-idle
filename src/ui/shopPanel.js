...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=194';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=206';
import { on, EVENTS } from '../shared/eventBus.js?v=193';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=198';
import { buyShopItem } from '../application/shopUseCases.js?v=199';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=196';
