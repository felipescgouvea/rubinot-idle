...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=276';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=288';
import { on, EVENTS } from '../shared/eventBus.js?v=275';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=280';
import { buyShopItem } from '../application/shopUseCases.js?v=281';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=278';
