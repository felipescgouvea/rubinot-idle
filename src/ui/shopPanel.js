...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=338';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=350';
import { on, EVENTS } from '../shared/eventBus.js?v=337';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=342';
import { buyShopItem } from '../application/shopUseCases.js?v=343';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=340';
