...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=336';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=348';
import { on, EVENTS } from '../shared/eventBus.js?v=335';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=340';
import { buyShopItem } from '../application/shopUseCases.js?v=341';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=338';
