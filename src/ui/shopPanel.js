...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=56';
import { ITEMS } from '../domain/items.js?v=56';
import { on, EVENTS } from '../shared/eventBus.js?v=56';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg } from './shared.js?v=56';
