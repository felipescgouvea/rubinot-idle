...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=236';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=248';
import { on, EVENTS } from '../shared/eventBus.js?v=235';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=240';
import { buyShopItem } from '../application/shopUseCases.js?v=241';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=238';
