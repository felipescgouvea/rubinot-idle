...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=188';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=200';
import { on, EVENTS } from '../shared/eventBus.js?v=187';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=192';
import { buyShopItem } from '../application/shopUseCases.js?v=193';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=190';
