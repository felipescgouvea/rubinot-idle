...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=360';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=372';
import { on, EVENTS } from '../shared/eventBus.js?v=359';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=364';
import { buyShopItem } from '../application/shopUseCases.js?v=365';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=362';
