...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=187';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=199';
import { on, EVENTS } from '../shared/eventBus.js?v=186';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=191';
import { buyShopItem } from '../application/shopUseCases.js?v=192';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=189';
