...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=301';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=313';
import { on, EVENTS } from '../shared/eventBus.js?v=300';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=305';
import { buyShopItem } from '../application/shopUseCases.js?v=306';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=303';
