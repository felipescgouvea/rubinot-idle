...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=178';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=190';
import { on, EVENTS } from '../shared/eventBus.js?v=177';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=182';
import { buyShopItem } from '../application/shopUseCases.js?v=183';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=180';
