...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=180';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=192';
import { on, EVENTS } from '../shared/eventBus.js?v=179';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=184';
import { buyShopItem } from '../application/shopUseCases.js?v=185';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=182';
