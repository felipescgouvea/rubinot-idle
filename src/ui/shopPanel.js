...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=273';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=285';
import { on, EVENTS } from '../shared/eventBus.js?v=272';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=277';
import { buyShopItem } from '../application/shopUseCases.js?v=278';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=275';
