...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=234';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=246';
import { on, EVENTS } from '../shared/eventBus.js?v=233';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=238';
import { buyShopItem } from '../application/shopUseCases.js?v=239';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=236';
