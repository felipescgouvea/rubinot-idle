...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=303';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=315';
import { on, EVENTS } from '../shared/eventBus.js?v=302';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=307';
import { buyShopItem } from '../application/shopUseCases.js?v=308';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=305';
