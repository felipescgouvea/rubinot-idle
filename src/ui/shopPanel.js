...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=297';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=309';
import { on, EVENTS } from '../shared/eventBus.js?v=296';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=301';
import { buyShopItem } from '../application/shopUseCases.js?v=302';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=299';
