...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=181';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=193';
import { on, EVENTS } from '../shared/eventBus.js?v=180';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=185';
import { buyShopItem } from '../application/shopUseCases.js?v=186';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=183';
