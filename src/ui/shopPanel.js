...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=256';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=268';
import { on, EVENTS } from '../shared/eventBus.js?v=255';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=260';
import { buyShopItem } from '../application/shopUseCases.js?v=261';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=258';
