...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=326';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=338';
import { on, EVENTS } from '../shared/eventBus.js?v=325';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=330';
import { buyShopItem } from '../application/shopUseCases.js?v=331';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=328';
