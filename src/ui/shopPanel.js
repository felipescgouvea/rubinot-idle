...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=312';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=324';
import { on, EVENTS } from '../shared/eventBus.js?v=311';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=316';
import { buyShopItem } from '../application/shopUseCases.js?v=317';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=314';
