...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=337';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=349';
import { on, EVENTS } from '../shared/eventBus.js?v=336';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=341';
import { buyShopItem } from '../application/shopUseCases.js?v=342';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=339';
