...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=284';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=296';
import { on, EVENTS } from '../shared/eventBus.js?v=283';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=288';
import { buyShopItem } from '../application/shopUseCases.js?v=289';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=286';
