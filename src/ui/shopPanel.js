...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=206';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=218';
import { on, EVENTS } from '../shared/eventBus.js?v=205';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=210';
import { buyShopItem } from '../application/shopUseCases.js?v=211';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=208';
