...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=231';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=243';
import { on, EVENTS } from '../shared/eventBus.js?v=230';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=235';
import { buyShopItem } from '../application/shopUseCases.js?v=236';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=233';
