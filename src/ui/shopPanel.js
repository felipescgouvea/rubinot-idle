...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=330';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=342';
import { on, EVENTS } from '../shared/eventBus.js?v=329';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=334';
import { buyShopItem } from '../application/shopUseCases.js?v=335';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=332';
