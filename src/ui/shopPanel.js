...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=300';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=312';
import { on, EVENTS } from '../shared/eventBus.js?v=299';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=304';
import { buyShopItem } from '../application/shopUseCases.js?v=305';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=302';
