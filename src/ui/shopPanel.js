...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=226';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=238';
import { on, EVENTS } from '../shared/eventBus.js?v=225';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=230';
import { buyShopItem } from '../application/shopUseCases.js?v=231';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=228';
