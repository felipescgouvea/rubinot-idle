...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=255';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=267';
import { on, EVENTS } from '../shared/eventBus.js?v=254';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=259';
import { buyShopItem } from '../application/shopUseCases.js?v=260';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=257';
