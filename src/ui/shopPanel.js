...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=235';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=247';
import { on, EVENTS } from '../shared/eventBus.js?v=234';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=239';
import { buyShopItem } from '../application/shopUseCases.js?v=240';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=237';
