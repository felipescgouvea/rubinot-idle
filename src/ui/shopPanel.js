...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=248';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=260';
import { on, EVENTS } from '../shared/eventBus.js?v=247';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=252';
import { buyShopItem } from '../application/shopUseCases.js?v=253';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=250';
