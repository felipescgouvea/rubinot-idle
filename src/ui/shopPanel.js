...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=316';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=328';
import { on, EVENTS } from '../shared/eventBus.js?v=315';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=320';
import { buyShopItem } from '../application/shopUseCases.js?v=321';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=318';
