...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=286';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=298';
import { on, EVENTS } from '../shared/eventBus.js?v=285';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=290';
import { buyShopItem } from '../application/shopUseCases.js?v=291';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=288';
