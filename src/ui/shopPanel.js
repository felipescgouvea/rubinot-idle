...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=184';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=196';
import { on, EVENTS } from '../shared/eventBus.js?v=183';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=188';
import { buyShopItem } from '../application/shopUseCases.js?v=189';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=186';
