...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=216';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=228';
import { on, EVENTS } from '../shared/eventBus.js?v=215';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=220';
import { buyShopItem } from '../application/shopUseCases.js?v=221';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=218';
