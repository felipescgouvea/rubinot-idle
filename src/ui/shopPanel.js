...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=341';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=353';
import { on, EVENTS } from '../shared/eventBus.js?v=340';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=345';
import { buyShopItem } from '../application/shopUseCases.js?v=346';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=343';
