...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=179';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=191';
import { on, EVENTS } from '../shared/eventBus.js?v=178';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=183';
import { buyShopItem } from '../application/shopUseCases.js?v=184';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=181';
