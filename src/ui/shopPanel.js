...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=285';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=297';
import { on, EVENTS } from '../shared/eventBus.js?v=284';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=289';
import { buyShopItem } from '../application/shopUseCases.js?v=290';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=287';
