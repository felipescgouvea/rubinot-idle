...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=243';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=255';
import { on, EVENTS } from '../shared/eventBus.js?v=242';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=247';
import { buyShopItem } from '../application/shopUseCases.js?v=248';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=245';
