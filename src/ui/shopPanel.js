...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=292';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=304';
import { on, EVENTS } from '../shared/eventBus.js?v=291';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=296';
import { buyShopItem } from '../application/shopUseCases.js?v=297';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=294';
