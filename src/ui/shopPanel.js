...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=207';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=219';
import { on, EVENTS } from '../shared/eventBus.js?v=206';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=211';
import { buyShopItem } from '../application/shopUseCases.js?v=212';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=209';
