...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=168';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=180';
import { on, EVENTS } from '../shared/eventBus.js?v=167';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=172';
import { buyShopItem } from '../application/shopUseCases.js?v=173';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=171';
