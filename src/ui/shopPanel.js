...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=353';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=365';
import { on, EVENTS } from '../shared/eventBus.js?v=352';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=357';
import { buyShopItem } from '../application/shopUseCases.js?v=358';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=355';
