...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=172';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=184';
import { on, EVENTS } from '../shared/eventBus.js?v=171';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=176';
import { buyShopItem } from '../application/shopUseCases.js?v=177';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=174';
