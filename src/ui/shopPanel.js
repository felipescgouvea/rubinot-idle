...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=290';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=302';
import { on, EVENTS } from '../shared/eventBus.js?v=289';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=294';
import { buyShopItem } from '../application/shopUseCases.js?v=295';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=292';
