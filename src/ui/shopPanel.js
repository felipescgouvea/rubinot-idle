...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=352';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=364';
import { on, EVENTS } from '../shared/eventBus.js?v=351';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=356';
import { buyShopItem } from '../application/shopUseCases.js?v=357';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=354';
