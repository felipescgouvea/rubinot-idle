...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=355';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=367';
import { on, EVENTS } from '../shared/eventBus.js?v=354';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=359';
import { buyShopItem } from '../application/shopUseCases.js?v=360';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=357';
