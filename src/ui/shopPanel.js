...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=311';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=323';
import { on, EVENTS } from '../shared/eventBus.js?v=310';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=315';
import { buyShopItem } from '../application/shopUseCases.js?v=316';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=313';
