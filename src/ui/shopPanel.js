...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=319';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=331';
import { on, EVENTS } from '../shared/eventBus.js?v=318';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=323';
import { buyShopItem } from '../application/shopUseCases.js?v=324';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=321';
