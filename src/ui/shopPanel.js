...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=354';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=366';
import { on, EVENTS } from '../shared/eventBus.js?v=353';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=358';
import { buyShopItem } from '../application/shopUseCases.js?v=359';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=356';
