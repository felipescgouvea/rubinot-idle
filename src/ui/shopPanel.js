...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=357';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=369';
import { on, EVENTS } from '../shared/eventBus.js?v=356';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=361';
import { buyShopItem } from '../application/shopUseCases.js?v=362';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=359';
