...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=229';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=241';
import { on, EVENTS } from '../shared/eventBus.js?v=228';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=233';
import { buyShopItem } from '../application/shopUseCases.js?v=234';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=231';
