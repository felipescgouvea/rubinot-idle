...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=308';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=320';
import { on, EVENTS } from '../shared/eventBus.js?v=307';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=312';
import { buyShopItem } from '../application/shopUseCases.js?v=313';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=310';
