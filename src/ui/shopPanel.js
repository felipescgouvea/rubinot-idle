...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=217';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=229';
import { on, EVENTS } from '../shared/eventBus.js?v=216';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=221';
import { buyShopItem } from '../application/shopUseCases.js?v=222';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=219';
