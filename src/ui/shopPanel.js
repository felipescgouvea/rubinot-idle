...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=271';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=283';
import { on, EVENTS } from '../shared/eventBus.js?v=270';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=275';
import { buyShopItem } from '../application/shopUseCases.js?v=276';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=273';
