...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=200';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=212';
import { on, EVENTS } from '../shared/eventBus.js?v=199';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=204';
import { buyShopItem } from '../application/shopUseCases.js?v=205';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=202';
