...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=333';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=345';
import { on, EVENTS } from '../shared/eventBus.js?v=332';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=337';
import { buyShopItem } from '../application/shopUseCases.js?v=338';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=335';
