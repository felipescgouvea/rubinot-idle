...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=293';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=305';
import { on, EVENTS } from '../shared/eventBus.js?v=292';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=297';
import { buyShopItem } from '../application/shopUseCases.js?v=298';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=295';
