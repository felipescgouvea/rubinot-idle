...
import { SHOP_ITEMS, SHOPS, isBoostActive } from '../domain/shopCatalog.js?v=317';
import { ITEMS, potionReqLabel } from '../domain/items.js?v=329';
import { on, EVENTS } from '../shared/eventBus.js?v=316';
import { formatNum, itemIconImg, goldIconImg, rubiniIconImg, vitalIconImg, openModal, closeModal } from './shared.js?v=321';
import { buyShopItem } from '../application/shopUseCases.js?v=322';
import { spriteImgOrFallback, spriteUrl } from '../infrastructure/tibiaSprites.js?v=319';
