...
import { itemSpriteFile, spriteUrl, skillIconFile, spellIconFile, VITAL_ICON_FILES, RUBINI_COIN_FILE, CHARM_POINTS_ICON_FILE, TRAINING_DUMMY_FILE, TASK_COIN_FILE, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=334';
...
// Chamado pelo Close estático, pelo clique-fora (ver index.html) e pelo Escape
// (handler único em main.js). Se o modal registrou um onClose, ele decide o que
// fazer (fechar ou trocar de modal); senão, fecha normalmente.
