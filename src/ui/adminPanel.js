...
import { ADMIN_RATE_FIELDS, RARITY_TIER_ORDER, rarityChancePercents } from '../domain/adminConfig.js?v=73';
...
import { getAdminConfig } from '../application/adminUseCases.js?v=73';
