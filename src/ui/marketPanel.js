...
import { formatNum, escapeHtml, itemIconImg, goldIconImg } from './shared.js?v=312';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=310';
import { fetchMyMarketWallet, fetchMarketListings, fetchMarketStats } from '../application/marketUseCases.js?v=309';
import { isMarketEnabled } from '../application/adminUseCases.js?v=310';
