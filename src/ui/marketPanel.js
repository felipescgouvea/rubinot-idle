...
import { formatNum, escapeHtml, itemIconImg, goldIconImg } from './shared.js?v=342';
import { registerPlayerName } from '../application/highscoresUseCases.js?v=340';
import { fetchMyMarketWallet, fetchMarketListings, fetchMarketStats } from '../application/marketUseCases.js?v=339';
import { isMarketEnabled } from '../application/adminUseCases.js?v=340';
