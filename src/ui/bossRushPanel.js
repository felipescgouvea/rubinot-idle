...
import { MONSTERS, bossTierMultiplier, bossAuraClass } from '../domain/bestiary.js?v=280';
import { unlockedBossZones, startBossRush, stopBossRush, isBossRushActive } from '../application/bossRushUseCases.js?v=263';
...
import { t, getLocale } from '../i18n/i18n.js?v=278';
