...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=330';
import { graduate } from '../application/characterUseCases.js?v=320';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=317';
