...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=297';
import { graduate } from '../application/characterUseCases.js?v=287';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=284';
