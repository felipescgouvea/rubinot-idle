...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=373';
import { graduate } from '../application/characterUseCases.js?v=363';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=360';
