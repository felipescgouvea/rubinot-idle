...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=313';
import { graduate } from '../application/characterUseCases.js?v=303';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=300';
