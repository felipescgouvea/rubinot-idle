...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=272';
import { graduate } from '../application/characterUseCases.js?v=262';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=259';
