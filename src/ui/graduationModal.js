...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=361';
import { graduate } from '../application/characterUseCases.js?v=351';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=348';
