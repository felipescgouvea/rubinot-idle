...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=342';
import { graduate } from '../application/characterUseCases.js?v=332';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=329';
