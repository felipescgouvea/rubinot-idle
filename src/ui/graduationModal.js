...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=358';
import { graduate } from '../application/characterUseCases.js?v=348';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=345';
