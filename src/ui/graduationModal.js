...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=276';
import { graduate } from '../application/characterUseCases.js?v=266';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=263';
