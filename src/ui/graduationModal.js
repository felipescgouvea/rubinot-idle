...
import { GRADUATE_KITS, GRADUATE_AMMO_QTY, ITEMS } from '../domain/items.js?v=333';
import { graduate } from '../application/characterUseCases.js?v=323';
import { on, EVENTS, emit } from '../shared/eventBus.js?v=320';
