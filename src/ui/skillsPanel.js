...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=268';
import { resolveEquippedItem } from '../domain/items.js?v=252';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=238';
import { skillIconImg } from './shared.js?v=244';
