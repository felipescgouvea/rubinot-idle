...
import { TIBIA_SKILLS, VOC_TRAINING, triesForNext } from '../domain/character.js?v=68';
import { resolveEquippedItem } from '../domain/items.js?v=68';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=68';
