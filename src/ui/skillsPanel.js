...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=324';
import { resolveEquippedItem } from '../domain/items.js?v=308';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=294';
import { skillIconImg } from './shared.js?v=300';
