...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=329';
import { resolveEquippedItem } from '../domain/items.js?v=313';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=299';
import { skillIconImg } from './shared.js?v=305';
