...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=259';
import { resolveEquippedItem } from '../domain/items.js?v=243';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=229';
import { skillIconImg } from './shared.js?v=235';
