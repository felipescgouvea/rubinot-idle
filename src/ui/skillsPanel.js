...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=348';
import { resolveEquippedItem } from '../domain/items.js?v=332';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=318';
import { skillIconImg } from './shared.js?v=324';
