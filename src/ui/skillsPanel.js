...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=351';
import { resolveEquippedItem } from '../domain/items.js?v=335';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=321';
import { skillIconImg } from './shared.js?v=327';
