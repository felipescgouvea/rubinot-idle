...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=247';
import { resolveEquippedItem } from '../domain/items.js?v=231';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=217';
import { skillIconImg } from './shared.js?v=223';
