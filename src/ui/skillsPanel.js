...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=359';
import { resolveEquippedItem } from '../domain/items.js?v=343';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=329';
import { skillIconImg } from './shared.js?v=335';
