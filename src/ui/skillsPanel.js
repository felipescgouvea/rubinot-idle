...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=238';
import { resolveEquippedItem } from '../domain/items.js?v=222';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=208';
import { skillIconImg } from './shared.js?v=214';
