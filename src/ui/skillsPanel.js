...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=284';
import { resolveEquippedItem } from '../domain/items.js?v=268';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=254';
import { skillIconImg } from './shared.js?v=260';
