...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=291';
import { resolveEquippedItem } from '../domain/items.js?v=275';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=261';
import { skillIconImg } from './shared.js?v=267';
