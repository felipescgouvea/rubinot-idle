...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=233';
import { resolveEquippedItem } from '../domain/items.js?v=217';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=203';
import { skillIconImg } from './shared.js?v=209';
