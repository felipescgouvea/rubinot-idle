...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=337';
import { resolveEquippedItem } from '../domain/items.js?v=321';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=307';
import { skillIconImg } from './shared.js?v=313';
