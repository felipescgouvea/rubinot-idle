...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=270';
import { resolveEquippedItem } from '../domain/items.js?v=254';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=240';
import { skillIconImg } from './shared.js?v=246';
