...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=354';
import { resolveEquippedItem } from '../domain/items.js?v=338';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=324';
import { skillIconImg } from './shared.js?v=330';
