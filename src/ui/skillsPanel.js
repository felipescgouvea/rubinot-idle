...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=262';
import { resolveEquippedItem } from '../domain/items.js?v=246';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=232';
import { skillIconImg } from './shared.js?v=238';
