...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=346';
import { resolveEquippedItem } from '../domain/items.js?v=330';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=316';
import { skillIconImg } from './shared.js?v=322';
