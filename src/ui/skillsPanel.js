...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=263';
import { resolveEquippedItem } from '../domain/items.js?v=247';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=233';
import { skillIconImg } from './shared.js?v=239';
