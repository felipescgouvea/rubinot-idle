...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=296';
import { resolveEquippedItem } from '../domain/items.js?v=280';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=266';
import { skillIconImg } from './shared.js?v=272';
