...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=253';
import { resolveEquippedItem } from '../domain/items.js?v=237';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=223';
import { skillIconImg } from './shared.js?v=229';
