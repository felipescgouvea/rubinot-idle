...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=336';
import { resolveEquippedItem } from '../domain/items.js?v=320';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=306';
import { skillIconImg } from './shared.js?v=312';
