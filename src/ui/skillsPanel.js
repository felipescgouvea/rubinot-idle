...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=255';
import { resolveEquippedItem } from '../domain/items.js?v=239';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=225';
import { skillIconImg } from './shared.js?v=231';
