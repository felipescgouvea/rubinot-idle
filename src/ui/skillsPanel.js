...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=332';
import { resolveEquippedItem } from '../domain/items.js?v=316';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=302';
import { skillIconImg } from './shared.js?v=308';
