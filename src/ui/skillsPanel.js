...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=388';
import { resolveEquippedItem } from '../domain/items.js?v=372';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=358';
import { skillIconImg } from './shared.js?v=364';
