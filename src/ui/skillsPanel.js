...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=256';
import { resolveEquippedItem } from '../domain/items.js?v=240';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=226';
import { skillIconImg } from './shared.js?v=232';
