...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=232';
import { resolveEquippedItem } from '../domain/items.js?v=216';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=202';
import { skillIconImg } from './shared.js?v=208';
