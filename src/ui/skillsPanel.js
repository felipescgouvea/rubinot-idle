...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=323';
import { resolveEquippedItem } from '../domain/items.js?v=307';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=293';
import { skillIconImg } from './shared.js?v=299';
