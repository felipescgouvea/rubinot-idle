...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=379';
import { resolveEquippedItem } from '../domain/items.js?v=363';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=349';
import { skillIconImg } from './shared.js?v=355';
