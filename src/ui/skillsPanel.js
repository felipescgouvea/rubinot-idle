...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=326';
import { resolveEquippedItem } from '../domain/items.js?v=310';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=296';
import { skillIconImg } from './shared.js?v=302';
