...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=335';
import { resolveEquippedItem } from '../domain/items.js?v=319';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=305';
import { skillIconImg } from './shared.js?v=311';
