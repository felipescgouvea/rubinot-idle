...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=236';
import { resolveEquippedItem } from '../domain/items.js?v=220';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=206';
import { skillIconImg } from './shared.js?v=212';
