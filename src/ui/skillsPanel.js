...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=341';
import { resolveEquippedItem } from '../domain/items.js?v=325';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=311';
import { skillIconImg } from './shared.js?v=317';
