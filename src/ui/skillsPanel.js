...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=322';
import { resolveEquippedItem } from '../domain/items.js?v=306';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=292';
import { skillIconImg } from './shared.js?v=298';
