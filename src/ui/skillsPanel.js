...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=314';
import { resolveEquippedItem } from '../domain/items.js?v=298';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=284';
import { skillIconImg } from './shared.js?v=290';
