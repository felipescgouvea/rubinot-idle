...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=260';
import { resolveEquippedItem } from '../domain/items.js?v=244';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=230';
import { skillIconImg } from './shared.js?v=236';
