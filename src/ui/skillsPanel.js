...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=301';
import { resolveEquippedItem } from '../domain/items.js?v=285';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=271';
import { skillIconImg } from './shared.js?v=277';
