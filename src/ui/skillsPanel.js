...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=386';
import { resolveEquippedItem } from '../domain/items.js?v=370';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=356';
import { skillIconImg } from './shared.js?v=362';
