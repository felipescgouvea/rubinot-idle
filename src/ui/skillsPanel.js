...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=279';
import { resolveEquippedItem } from '../domain/items.js?v=263';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=249';
import { skillIconImg } from './shared.js?v=255';
