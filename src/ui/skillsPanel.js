...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=349';
import { resolveEquippedItem } from '../domain/items.js?v=333';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=319';
import { skillIconImg } from './shared.js?v=325';
