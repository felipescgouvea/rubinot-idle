...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=382';
import { resolveEquippedItem } from '../domain/items.js?v=366';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=352';
import { skillIconImg } from './shared.js?v=358';
