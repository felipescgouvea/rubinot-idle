...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=294';
import { resolveEquippedItem } from '../domain/items.js?v=278';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=264';
import { skillIconImg } from './shared.js?v=270';
