...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=385';
import { resolveEquippedItem } from '../domain/items.js?v=369';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=355';
import { skillIconImg } from './shared.js?v=361';
