...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=251';
import { resolveEquippedItem } from '../domain/items.js?v=235';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=221';
import { skillIconImg } from './shared.js?v=227';
