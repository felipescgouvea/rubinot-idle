...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=269';
import { resolveEquippedItem } from '../domain/items.js?v=253';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=239';
import { skillIconImg } from './shared.js?v=245';
