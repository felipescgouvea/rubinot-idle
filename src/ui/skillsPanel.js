...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=369';
import { resolveEquippedItem } from '../domain/items.js?v=353';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=339';
import { skillIconImg } from './shared.js?v=345';
