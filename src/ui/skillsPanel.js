...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=254';
import { resolveEquippedItem } from '../domain/items.js?v=238';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=224';
import { skillIconImg } from './shared.js?v=230';
