...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=239';
import { resolveEquippedItem } from '../domain/items.js?v=223';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=209';
import { skillIconImg } from './shared.js?v=215';
