...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=243';
import { resolveEquippedItem } from '../domain/items.js?v=227';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=213';
import { skillIconImg } from './shared.js?v=219';
