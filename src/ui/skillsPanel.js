...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=272';
import { resolveEquippedItem } from '../domain/items.js?v=256';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=242';
import { skillIconImg } from './shared.js?v=248';
