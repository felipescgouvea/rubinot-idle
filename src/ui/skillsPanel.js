...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=309';
import { resolveEquippedItem } from '../domain/items.js?v=293';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=279';
import { skillIconImg } from './shared.js?v=285';
