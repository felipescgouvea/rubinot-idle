...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=235';
import { resolveEquippedItem } from '../domain/items.js?v=219';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=205';
import { skillIconImg } from './shared.js?v=211';
