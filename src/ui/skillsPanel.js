...
import { TIBIA_SKILLS, VOC_TRAINING, triesForNext } from '../domain/character.js?v=75';
import { resolveEquippedItem } from '../domain/items.js?v=75';
import { getEquippedWeaponSkillId } from '../application/stats.js?v=75';
