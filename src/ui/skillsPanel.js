...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=289';
import { resolveEquippedItem } from '../domain/items.js?v=273';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=259';
import { skillIconImg } from './shared.js?v=265';
