...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=242';
import { resolveEquippedItem } from '../domain/items.js?v=226';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=212';
import { skillIconImg } from './shared.js?v=218';
