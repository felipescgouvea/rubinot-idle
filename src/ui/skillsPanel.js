...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=383';
import { resolveEquippedItem } from '../domain/items.js?v=367';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=353';
import { skillIconImg } from './shared.js?v=359';
