...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=387';
import { resolveEquippedItem } from '../domain/items.js?v=371';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=357';
import { skillIconImg } from './shared.js?v=363';
