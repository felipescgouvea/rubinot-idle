...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=245';
import { resolveEquippedItem } from '../domain/items.js?v=229';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=215';
import { skillIconImg } from './shared.js?v=221';
