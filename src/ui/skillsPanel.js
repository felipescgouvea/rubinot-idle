...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=384';
import { resolveEquippedItem } from '../domain/items.js?v=368';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=354';
import { skillIconImg } from './shared.js?v=360';
