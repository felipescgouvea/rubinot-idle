...
import { TIBIA_SKILLS, VOC_TRAINING, MANA_MULTIPLIER, triesForNext } from '../domain/character.js?v=347';
import { resolveEquippedItem } from '../domain/items.js?v=331';
import { getAtk, getDef, getSpd, getMagic, getEquippedWeaponSkillId } from '../application/stats.js?v=317';
import { skillIconImg } from './shared.js?v=323';
