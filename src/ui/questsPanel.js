...
import { QUESTS, QUEST_IDS, questTotalEnemies } from '../domain/quests.js?v=7';
...
import { startQuestRaid } from '../application/huntUseCases.js?v=423';
import { fetchQuestState } from '../infrastructure/authClient.js?v=367';
