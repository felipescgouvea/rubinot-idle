...
import { QUESTS, QUEST_IDS, questTotalEnemies } from '../domain/quests.js?v=8';
...
import { startQuestRaid } from '../application/huntUseCases.js?v=424';
import { fetchQuestState } from '../infrastructure/authClient.js?v=368';
