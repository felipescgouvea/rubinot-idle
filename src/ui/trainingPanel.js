...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=280';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=251';
import { SPELLS } from '../domain/spells.js?v=251';
import { on, EVENTS } from '../shared/eventBus.js?v=251';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=256';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=257';
import { t } from '../i18n/i18n.js?v=267';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=84';
