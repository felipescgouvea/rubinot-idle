...
import { TIBIA_SKILLS } from '../domain/character.js?v=157';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=128';
import { SPELLS } from '../domain/spells.js?v=128';
import { on, EVENTS } from '../shared/eventBus.js?v=128';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=133';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=134';
