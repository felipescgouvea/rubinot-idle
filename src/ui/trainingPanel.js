...
import { TIBIA_SKILLS } from '../domain/character.js?v=213';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=184';
import { SPELLS } from '../domain/spells.js?v=184';
import { on, EVENTS } from '../shared/eventBus.js?v=184';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=189';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=190';
import { t } from '../i18n/i18n.js?v=200';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=17';
