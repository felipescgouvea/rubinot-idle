...
import { TIBIA_SKILLS } from '../domain/character.js?v=222';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=193';
import { SPELLS } from '../domain/spells.js?v=193';
import { on, EVENTS } from '../shared/eventBus.js?v=193';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=198';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=199';
import { t } from '../i18n/i18n.js?v=209';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=26';
