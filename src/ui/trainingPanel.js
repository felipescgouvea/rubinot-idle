...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=317';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=288';
import { SPELLS } from '../domain/spells.js?v=288';
import { on, EVENTS } from '../shared/eventBus.js?v=288';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=293';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=294';
import { t } from '../i18n/i18n.js?v=306';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=121';
