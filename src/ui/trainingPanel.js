...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=278';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=249';
import { SPELLS } from '../domain/spells.js?v=249';
import { on, EVENTS } from '../shared/eventBus.js?v=249';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=254';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=255';
import { t } from '../i18n/i18n.js?v=265';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=82';
