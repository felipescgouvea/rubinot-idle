...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=246';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=217';
import { SPELLS } from '../domain/spells.js?v=217';
import { on, EVENTS } from '../shared/eventBus.js?v=217';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=222';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=223';
import { t } from '../i18n/i18n.js?v=233';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=50';
