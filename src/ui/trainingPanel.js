...
import { TIBIA_SKILLS } from '../domain/character.js?v=177';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=148';
import { SPELLS } from '../domain/spells.js?v=148';
import { on, EVENTS } from '../shared/eventBus.js?v=148';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=153';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=154';
