...
import { TIBIA_SKILLS } from '../domain/character.js?v=218';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=189';
import { SPELLS } from '../domain/spells.js?v=189';
import { on, EVENTS } from '../shared/eventBus.js?v=189';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=194';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=195';
import { t } from '../i18n/i18n.js?v=205';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=22';
