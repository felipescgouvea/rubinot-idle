...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=281';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=252';
import { SPELLS } from '../domain/spells.js?v=252';
import { on, EVENTS } from '../shared/eventBus.js?v=252';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=257';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=258';
import { t } from '../i18n/i18n.js?v=268';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=85';
