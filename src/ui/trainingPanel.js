...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=251';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=222';
import { SPELLS } from '../domain/spells.js?v=222';
import { on, EVENTS } from '../shared/eventBus.js?v=222';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=227';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=228';
import { t } from '../i18n/i18n.js?v=238';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=55';
