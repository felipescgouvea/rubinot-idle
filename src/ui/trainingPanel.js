...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=297';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=268';
import { SPELLS } from '../domain/spells.js?v=268';
import { on, EVENTS } from '../shared/eventBus.js?v=268';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=273';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=274';
import { t } from '../i18n/i18n.js?v=286';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=101';
