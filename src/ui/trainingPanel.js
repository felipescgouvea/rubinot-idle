...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=326';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=297';
import { SPELLS } from '../domain/spells.js?v=297';
import { on, EVENTS } from '../shared/eventBus.js?v=297';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=302';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=303';
import { t } from '../i18n/i18n.js?v=315';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=130';
