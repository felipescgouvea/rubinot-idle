...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=304';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=275';
import { SPELLS } from '../domain/spells.js?v=275';
import { on, EVENTS } from '../shared/eventBus.js?v=275';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=280';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=281';
import { t } from '../i18n/i18n.js?v=293';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=108';
