...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=75';
import { on, EVENTS } from '../shared/eventBus.js?v=75';
import { skillIconImg } from './shared.js?v=75';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=75';
