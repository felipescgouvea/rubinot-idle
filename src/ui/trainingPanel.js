...
import { TIBIA_SKILLS } from '../domain/character.js?v=187';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=158';
import { SPELLS } from '../domain/spells.js?v=158';
import { on, EVENTS } from '../shared/eventBus.js?v=158';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=163';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=164';
