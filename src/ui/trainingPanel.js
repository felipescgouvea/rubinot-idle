...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=361';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=332';
import { SPELLS } from '../domain/spells.js?v=332';
import { on, EVENTS } from '../shared/eventBus.js?v=332';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=337';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=338';
import { t } from '../i18n/i18n.js?v=350';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=165';
