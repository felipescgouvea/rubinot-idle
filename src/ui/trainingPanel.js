...
import { TIBIA_SKILLS } from '../domain/character.js?v=212';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=183';
import { SPELLS } from '../domain/spells.js?v=183';
import { on, EVENTS } from '../shared/eventBus.js?v=183';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=188';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=189';
import { t } from '../i18n/i18n.js?v=199';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=16';
