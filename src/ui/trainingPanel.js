...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=40';
import { on, EVENTS } from '../shared/eventBus.js?v=40';
import { skillIconImg } from './shared.js?v=40';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=40';
