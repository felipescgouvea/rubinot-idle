...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=50';
import { on, EVENTS } from '../shared/eventBus.js?v=50';
import { skillIconImg } from './shared.js?v=50';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=50';
