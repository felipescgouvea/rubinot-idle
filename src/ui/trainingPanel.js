...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=252';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=223';
import { SPELLS } from '../domain/spells.js?v=223';
import { on, EVENTS } from '../shared/eventBus.js?v=223';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=228';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=229';
import { t } from '../i18n/i18n.js?v=239';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=56';
