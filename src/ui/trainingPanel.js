...
import { TIBIA_SKILLS } from '../domain/character.js?v=223';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=194';
import { SPELLS } from '../domain/spells.js?v=194';
import { on, EVENTS } from '../shared/eventBus.js?v=194';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=199';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=200';
import { t } from '../i18n/i18n.js?v=210';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=27';
