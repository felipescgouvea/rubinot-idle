...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=41';
import { on, EVENTS } from '../shared/eventBus.js?v=41';
import { skillIconImg } from './shared.js?v=41';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=41';
