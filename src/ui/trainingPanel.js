...
import { TIBIA_SKILLS } from '../domain/character.js?v=208';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=179';
import { SPELLS } from '../domain/spells.js?v=179';
import { on, EVENTS } from '../shared/eventBus.js?v=179';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=184';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=185';
import { t } from '../i18n/i18n.js?v=195';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=12';
