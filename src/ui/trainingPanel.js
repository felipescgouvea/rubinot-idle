...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=255';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=226';
import { SPELLS } from '../domain/spells.js?v=226';
import { on, EVENTS } from '../shared/eventBus.js?v=226';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=231';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=232';
import { t } from '../i18n/i18n.js?v=242';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=59';
