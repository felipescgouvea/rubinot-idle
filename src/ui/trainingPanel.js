...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=290';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=261';
import { SPELLS } from '../domain/spells.js?v=261';
import { on, EVENTS } from '../shared/eventBus.js?v=261';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=266';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=267';
import { t } from '../i18n/i18n.js?v=279';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=94';
