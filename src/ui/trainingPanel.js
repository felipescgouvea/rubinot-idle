...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=321';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=292';
import { SPELLS } from '../domain/spells.js?v=292';
import { on, EVENTS } from '../shared/eventBus.js?v=292';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=297';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=298';
import { t } from '../i18n/i18n.js?v=310';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=125';
