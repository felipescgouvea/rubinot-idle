...
import { TIBIA_SKILLS } from '../domain/character.js?v=220';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=191';
import { SPELLS } from '../domain/spells.js?v=191';
import { on, EVENTS } from '../shared/eventBus.js?v=191';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=196';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=197';
import { t } from '../i18n/i18n.js?v=207';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=24';
