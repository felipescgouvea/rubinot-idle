...
import { TIBIA_SKILLS } from '../domain/character.js?v=192';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=163';
import { SPELLS } from '../domain/spells.js?v=163';
import { on, EVENTS } from '../shared/eventBus.js?v=163';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=168';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=169';
