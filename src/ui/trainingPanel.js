...
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=141';
import { SPELLS } from '../domain/spells.js?v=141';
import { on, EVENTS } from '../shared/eventBus.js?v=141';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=146';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=147';
