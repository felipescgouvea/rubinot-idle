...
import { TIBIA_SKILLS } from '../domain/character.js?v=211';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=182';
import { SPELLS } from '../domain/spells.js?v=182';
import { on, EVENTS } from '../shared/eventBus.js?v=182';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=187';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=188';
import { t } from '../i18n/i18n.js?v=198';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=15';
