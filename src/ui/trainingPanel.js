...
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=155';
import { SPELLS } from '../domain/spells.js?v=155';
import { on, EVENTS } from '../shared/eventBus.js?v=155';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=160';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=161';
