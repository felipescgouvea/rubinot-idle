...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=45';
import { on, EVENTS } from '../shared/eventBus.js?v=45';
import { skillIconImg } from './shared.js?v=45';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=45';
