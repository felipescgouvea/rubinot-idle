...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=343';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=314';
import { SPELLS } from '../domain/spells.js?v=314';
import { on, EVENTS } from '../shared/eventBus.js?v=314';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=319';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=320';
import { t } from '../i18n/i18n.js?v=332';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=147';
