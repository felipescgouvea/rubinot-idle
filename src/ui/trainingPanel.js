...
import { TIBIA_SKILLS } from '../domain/character.js?v=114';
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=114';
import { on, EVENTS } from '../shared/eventBus.js?v=114';
import { skillIconImg } from './shared.js?v=114';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=114';
