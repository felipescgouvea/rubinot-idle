...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=62';
import { on, EVENTS } from '../shared/eventBus.js?v=62';
import { skillIconImg } from './shared.js?v=62';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=62';
