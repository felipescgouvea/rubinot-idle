...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=353';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=324';
import { SPELLS } from '../domain/spells.js?v=324';
import { on, EVENTS } from '../shared/eventBus.js?v=324';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=329';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=330';
import { t } from '../i18n/i18n.js?v=342';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=157';
