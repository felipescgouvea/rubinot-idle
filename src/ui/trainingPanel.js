...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=340';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=311';
import { SPELLS } from '../domain/spells.js?v=311';
import { on, EVENTS } from '../shared/eventBus.js?v=311';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=316';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=317';
import { t } from '../i18n/i18n.js?v=329';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=144';
