...
import { TIBIA_SKILLS } from '../domain/character.js?v=219';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=190';
import { SPELLS } from '../domain/spells.js?v=190';
import { on, EVENTS } from '../shared/eventBus.js?v=190';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=195';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=196';
import { t } from '../i18n/i18n.js?v=206';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=23';
