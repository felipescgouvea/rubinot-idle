...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=74';
import { on, EVENTS } from '../shared/eventBus.js?v=74';
import { skillIconImg } from './shared.js?v=74';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=74';
