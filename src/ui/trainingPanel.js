...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=33';
import { on, EVENTS } from '../shared/eventBus.js?v=33';
import { skillIconImg } from './shared.js?v=33';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=33';
