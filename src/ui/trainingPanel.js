...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=363';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=334';
import { SPELLS } from '../domain/spells.js?v=334';
import { on, EVENTS } from '../shared/eventBus.js?v=334';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=339';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=340';
import { t } from '../i18n/i18n.js?v=352';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=167';
