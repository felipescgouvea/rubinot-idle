...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=237';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=208';
import { SPELLS } from '../domain/spells.js?v=208';
import { on, EVENTS } from '../shared/eventBus.js?v=208';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=213';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=214';
import { t } from '../i18n/i18n.js?v=224';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=41';
