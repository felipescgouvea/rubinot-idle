...
import { TIBIA_SKILLS } from '../domain/character.js?v=161';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=132';
import { SPELLS } from '../domain/spells.js?v=132';
import { on, EVENTS } from '../shared/eventBus.js?v=132';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=137';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=138';
