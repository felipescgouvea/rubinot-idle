...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=279';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=250';
import { SPELLS } from '../domain/spells.js?v=250';
import { on, EVENTS } from '../shared/eventBus.js?v=250';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=255';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=256';
import { t } from '../i18n/i18n.js?v=266';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=83';
