...
import { TIBIA_SKILLS } from '../domain/character.js?v=180';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=151';
import { SPELLS } from '../domain/spells.js?v=151';
import { on, EVENTS } from '../shared/eventBus.js?v=151';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=156';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=157';
