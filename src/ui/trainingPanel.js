...
import { TIBIA_SKILLS } from '../domain/character.js?v=159';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=130';
import { SPELLS } from '../domain/spells.js?v=130';
import { on, EVENTS } from '../shared/eventBus.js?v=130';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=135';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=136';
