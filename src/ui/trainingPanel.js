...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=276';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=247';
import { SPELLS } from '../domain/spells.js?v=247';
import { on, EVENTS } from '../shared/eventBus.js?v=247';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=252';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=253';
import { t } from '../i18n/i18n.js?v=263';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=80';
