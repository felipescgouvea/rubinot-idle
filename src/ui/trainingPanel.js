...
import { TIBIA_SKILLS } from '../domain/character.js?v=167';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=138';
import { SPELLS } from '../domain/spells.js?v=138';
import { on, EVENTS } from '../shared/eventBus.js?v=138';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=143';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=144';
