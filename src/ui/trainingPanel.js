...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=385';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=356';
import { SPELLS } from '../domain/spells.js?v=356';
import { on, EVENTS } from '../shared/eventBus.js?v=356';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=361';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=362';
import { t } from '../i18n/i18n.js?v=374';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=189';
