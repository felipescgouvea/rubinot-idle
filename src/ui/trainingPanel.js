...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=339';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=310';
import { SPELLS } from '../domain/spells.js?v=310';
import { on, EVENTS } from '../shared/eventBus.js?v=310';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=315';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=316';
import { t } from '../i18n/i18n.js?v=328';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=143';
