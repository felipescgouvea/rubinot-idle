...
import { TIBIA_SKILLS } from '../domain/character.js?v=190';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=161';
import { SPELLS } from '../domain/spells.js?v=161';
import { on, EVENTS } from '../shared/eventBus.js?v=161';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=166';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=167';
