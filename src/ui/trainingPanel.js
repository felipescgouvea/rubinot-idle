...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=295';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=266';
import { SPELLS } from '../domain/spells.js?v=266';
import { on, EVENTS } from '../shared/eventBus.js?v=266';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=271';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=272';
import { t } from '../i18n/i18n.js?v=284';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=99';
