...
import { TIBIA_SKILLS } from '../domain/character.js?v=181';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=152';
import { SPELLS } from '../domain/spells.js?v=152';
import { on, EVENTS } from '../shared/eventBus.js?v=152';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=157';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=158';
