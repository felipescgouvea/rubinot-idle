...
import { TIBIA_SKILLS } from '../domain/character.js?v=77';
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=77';
import { on, EVENTS } from '../shared/eventBus.js?v=77';
import { skillIconImg } from './shared.js?v=77';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=77';
