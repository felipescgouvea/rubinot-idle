...
import { TIBIA_SKILLS } from '../domain/character.js?v=202';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=173';
import { SPELLS } from '../domain/spells.js?v=173';
import { on, EVENTS } from '../shared/eventBus.js?v=173';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=178';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=179';
import { t } from '../i18n/i18n.js?v=189';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=6';
