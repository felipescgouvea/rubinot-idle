...
import { TIBIA_SKILLS } from '../domain/character.js?v=182';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=153';
import { SPELLS } from '../domain/spells.js?v=153';
import { on, EVENTS } from '../shared/eventBus.js?v=153';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=158';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=159';
