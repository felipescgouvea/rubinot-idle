...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=293';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=264';
import { SPELLS } from '../domain/spells.js?v=264';
import { on, EVENTS } from '../shared/eventBus.js?v=264';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=269';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=270';
import { t } from '../i18n/i18n.js?v=282';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=97';
