...
import { TIBIA_SKILLS } from '../domain/character.js?v=201';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=172';
import { SPELLS } from '../domain/spells.js?v=172';
import { on, EVENTS } from '../shared/eventBus.js?v=172';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=177';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=178';
import { t } from '../i18n/i18n.js?v=188';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=5';
