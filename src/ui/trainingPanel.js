...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=248';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=219';
import { SPELLS } from '../domain/spells.js?v=219';
import { on, EVENTS } from '../shared/eventBus.js?v=219';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=224';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=225';
import { t } from '../i18n/i18n.js?v=235';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=52';
