...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=291';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=262';
import { SPELLS } from '../domain/spells.js?v=262';
import { on, EVENTS } from '../shared/eventBus.js?v=262';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=267';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=268';
import { t } from '../i18n/i18n.js?v=280';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=95';
