...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=300';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=271';
import { SPELLS } from '../domain/spells.js?v=271';
import { on, EVENTS } from '../shared/eventBus.js?v=271';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=276';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=277';
import { t } from '../i18n/i18n.js?v=289';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=104';
