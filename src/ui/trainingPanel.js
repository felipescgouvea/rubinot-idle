...
import { TIBIA_SKILLS } from '../domain/character.js?v=178';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=149';
import { SPELLS } from '../domain/spells.js?v=149';
import { on, EVENTS } from '../shared/eventBus.js?v=149';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=154';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=155';
