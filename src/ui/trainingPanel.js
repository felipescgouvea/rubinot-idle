...
import { TRAINABLE_SKILLS, triesPerMinuteFor } from '../domain/training.js?v=69';
import { on, EVENTS } from '../shared/eventBus.js?v=69';
import { skillIconImg } from './shared.js?v=69';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=69';
