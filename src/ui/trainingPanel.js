...
import { TIBIA_SKILLS } from '../domain/character.js?v=217';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=188';
import { SPELLS } from '../domain/spells.js?v=188';
import { on, EVENTS } from '../shared/eventBus.js?v=188';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=193';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=194';
import { t } from '../i18n/i18n.js?v=204';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=21';
