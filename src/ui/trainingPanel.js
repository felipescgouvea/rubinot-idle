...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=301';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=272';
import { SPELLS } from '../domain/spells.js?v=272';
import { on, EVENTS } from '../shared/eventBus.js?v=272';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=277';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=278';
import { t } from '../i18n/i18n.js?v=290';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=105';
