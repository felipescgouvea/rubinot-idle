...
import { TIBIA_SKILLS } from '../domain/character.js?v=205';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=176';
import { SPELLS } from '../domain/spells.js?v=176';
import { on, EVENTS } from '../shared/eventBus.js?v=176';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=181';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=182';
import { t } from '../i18n/i18n.js?v=192';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=9';
