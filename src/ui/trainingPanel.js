...
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=165';
import { SPELLS } from '../domain/spells.js?v=165';
import { on, EVENTS } from '../shared/eventBus.js?v=165';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=170';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=171';
