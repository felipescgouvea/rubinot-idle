...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=277';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=248';
import { SPELLS } from '../domain/spells.js?v=248';
import { on, EVENTS } from '../shared/eventBus.js?v=248';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=253';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=254';
import { t } from '../i18n/i18n.js?v=264';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=81';
