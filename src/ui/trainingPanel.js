...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=262';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=233';
import { SPELLS } from '../domain/spells.js?v=233';
import { on, EVENTS } from '../shared/eventBus.js?v=233';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=238';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=239';
import { t } from '../i18n/i18n.js?v=249';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=66';
