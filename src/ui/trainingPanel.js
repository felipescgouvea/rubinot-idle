...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=282';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=253';
import { SPELLS } from '../domain/spells.js?v=253';
import { on, EVENTS } from '../shared/eventBus.js?v=253';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=258';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=259';
import { t } from '../i18n/i18n.js?v=269';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=86';
