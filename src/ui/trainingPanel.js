...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=349';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=320';
import { SPELLS } from '../domain/spells.js?v=320';
import { on, EVENTS } from '../shared/eventBus.js?v=320';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=325';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=326';
import { t } from '../i18n/i18n.js?v=338';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=153';
