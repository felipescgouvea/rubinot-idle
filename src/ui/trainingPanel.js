...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=259';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=230';
import { SPELLS } from '../domain/spells.js?v=230';
import { on, EVENTS } from '../shared/eventBus.js?v=230';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=235';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=236';
import { t } from '../i18n/i18n.js?v=246';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=63';
