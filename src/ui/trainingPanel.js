...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=240';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=211';
import { SPELLS } from '../domain/spells.js?v=211';
import { on, EVENTS } from '../shared/eventBus.js?v=211';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=216';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=217';
import { t } from '../i18n/i18n.js?v=227';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=44';
