...
import { TIBIA_SKILLS } from '../domain/character.js?v=179';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=150';
import { SPELLS } from '../domain/spells.js?v=150';
import { on, EVENTS } from '../shared/eventBus.js?v=150';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=155';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=156';
