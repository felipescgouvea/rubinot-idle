...
import { TIBIA_SKILLS } from '../domain/character.js?v=160';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=131';
import { SPELLS } from '../domain/spells.js?v=131';
import { on, EVENTS } from '../shared/eventBus.js?v=131';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=136';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=137';
