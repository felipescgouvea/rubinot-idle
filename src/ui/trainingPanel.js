...
import { TIBIA_SKILLS, VOCATIONS, triesForNext } from '../domain/character.js?v=376';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=347';
import { SPELLS } from '../domain/spells.js?v=347';
import { on, EVENTS } from '../shared/eventBus.js?v=347';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=352';
import { startTraining, stopTraining } from '../application/trainingUseCases.js?v=353';
import { t } from '../i18n/i18n.js?v=365';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=180';
