...
import { TIBIA_SKILLS } from '../domain/character.js?v=162';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=133';
import { SPELLS } from '../domain/spells.js?v=133';
import { on, EVENTS } from '../shared/eventBus.js?v=133';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=138';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=139';
