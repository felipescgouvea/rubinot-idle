...
import { TIBIA_SKILLS } from '../domain/character.js?v=200';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=171';
import { SPELLS } from '../domain/spells.js?v=171';
import { on, EVENTS } from '../shared/eventBus.js?v=171';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=176';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=177';
import { t } from '../i18n/i18n.js?v=187';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=4';
