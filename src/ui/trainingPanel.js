...
import { TIBIA_SKILLS, VOCATIONS } from '../domain/character.js?v=247';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor, manaSpentPerMinute } from '../domain/training.js?v=218';
import { SPELLS } from '../domain/spells.js?v=218';
import { on, EVENTS } from '../shared/eventBus.js?v=218';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=223';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=224';
import { t } from '../i18n/i18n.js?v=234';
import { trainingStageHtml, mountTrainingStagePlayer, iniciarPulsoCast, pararPulsoCast } from './trainingStage.js?v=51';
