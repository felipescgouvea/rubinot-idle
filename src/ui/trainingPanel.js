...
import { TIBIA_SKILLS } from '../domain/character.js?v=221';
import { TRAINABLE_SKILLS, ONLINE_RATE_MULTIPLIER, onlineTrainableSkills, triesPerMinuteFor } from '../domain/training.js?v=192';
import { SPELLS } from '../domain/spells.js?v=192';
import { on, EVENTS } from '../shared/eventBus.js?v=192';
import { skillIconImg, spellIconImg, trainingDummyImg } from './shared.js?v=197';
import { startTraining, stopTraining, startOnlineTraining } from '../application/trainingUseCases.js?v=198';
import { t } from '../i18n/i18n.js?v=208';
import { trainingStageHtml, mountTrainingStagePlayer } from './trainingStage.js?v=25';
