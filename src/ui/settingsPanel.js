...
import { currentUser } from '../infrastructure/authClient.js?v=189';
import { getCharacterSlots } from '../application/accountUseCases.js?v=182';
import { VOCATIONS } from '../domain/character.js?v=211';
import { goldIconImg, openModal } from './shared.js?v=187';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=198';
