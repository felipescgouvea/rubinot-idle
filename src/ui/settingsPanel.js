...
import { currentUser } from '../infrastructure/authClient.js?v=270';
import { getCharacterSlots } from '../application/accountUseCases.js?v=260';
import { VOCATIONS } from '../domain/character.js?v=289';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=262';
import { goldIconImg, openModal } from './shared.js?v=265';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=278';
