...
import { currentUser } from '../infrastructure/authClient.js?v=314';
import { getCharacterSlots } from '../application/accountUseCases.js?v=304';
import { VOCATIONS } from '../domain/character.js?v=333';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=306';
import { goldIconImg, openModal } from './shared.js?v=309';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=322';
