...
import { currentUser } from '../infrastructure/authClient.js?v=287';
import { getCharacterSlots } from '../application/accountUseCases.js?v=277';
import { VOCATIONS } from '../domain/character.js?v=306';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=279';
import { goldIconImg, openModal } from './shared.js?v=282';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=295';
