...
import { currentUser } from '../infrastructure/authClient.js?v=301';
import { getCharacterSlots } from '../application/accountUseCases.js?v=291';
import { VOCATIONS } from '../domain/character.js?v=320';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=293';
import { goldIconImg, openModal } from './shared.js?v=296';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=309';
