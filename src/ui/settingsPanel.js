...
import { currentUser } from '../infrastructure/authClient.js?v=216';
import { getCharacterSlots } from '../application/accountUseCases.js?v=209';
import { VOCATIONS } from '../domain/character.js?v=238';
import { goldIconImg, openModal } from './shared.js?v=214';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=225';
