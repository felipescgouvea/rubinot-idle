...
import { currentUser } from '../infrastructure/authClient.js?v=190';
import { getCharacterSlots } from '../application/accountUseCases.js?v=183';
import { VOCATIONS } from '../domain/character.js?v=212';
import { goldIconImg, openModal } from './shared.js?v=188';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=199';
