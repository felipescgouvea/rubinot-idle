...
import { currentUser } from '../infrastructure/authClient.js?v=176';
import { getCharacterSlots } from '../application/accountUseCases.js?v=169';
import { VOCATIONS } from '../domain/character.js?v=198';
import { goldIconImg, openModal } from './shared.js?v=174';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=185';
