...
import { currentUser } from '../infrastructure/authClient.js?v=335';
import { getCharacterSlots } from '../application/accountUseCases.js?v=325';
import { VOCATIONS } from '../domain/character.js?v=354';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=327';
import { goldIconImg, openModal } from './shared.js?v=330';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=343';
