...
import { currentUser } from '../infrastructure/authClient.js?v=143';
import { getCharacterSlots } from '../application/accountUseCases.js?v=136';
import { VOCATIONS } from '../domain/character.js?v=165';
import { goldIconImg, openModal } from './shared.js?v=141';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=152';
