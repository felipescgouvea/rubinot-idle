...
import { currentUser } from '../infrastructure/authClient.js?v=269';
import { getCharacterSlots } from '../application/accountUseCases.js?v=259';
import { VOCATIONS } from '../domain/character.js?v=288';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=261';
import { goldIconImg, openModal } from './shared.js?v=264';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=277';
