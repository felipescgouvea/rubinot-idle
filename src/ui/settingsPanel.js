...
import { currentUser } from '../infrastructure/authClient.js?v=183';
import { getCharacterSlots } from '../application/accountUseCases.js?v=176';
import { VOCATIONS } from '../domain/character.js?v=205';
import { goldIconImg, openModal } from './shared.js?v=181';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=192';
