...
import { currentUser } from '../infrastructure/authClient.js?v=191';
import { getCharacterSlots } from '../application/accountUseCases.js?v=184';
import { VOCATIONS } from '../domain/character.js?v=213';
import { goldIconImg, openModal } from './shared.js?v=189';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=200';
