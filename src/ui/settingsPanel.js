...
import { currentUser } from '../infrastructure/authClient.js?v=263';
...
import { goldIconImg, openModal } from './shared.js?v=261';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=273';
