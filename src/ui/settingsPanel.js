...
import { currentUser } from '../infrastructure/authClient.js?v=194';
import { getCharacterSlots } from '../application/accountUseCases.js?v=187';
import { VOCATIONS } from '../domain/character.js?v=216';
import { goldIconImg, openModal } from './shared.js?v=192';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=203';
