...
import { currentUser } from '../infrastructure/authClient.js?v=227';
import { getCharacterSlots } from '../application/accountUseCases.js?v=220';
import { VOCATIONS } from '../domain/character.js?v=249';
import { goldIconImg, openModal } from './shared.js?v=225';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=236';
