...
import { currentUser } from '../infrastructure/authClient.js?v=172';
import { getCharacterSlots } from '../application/accountUseCases.js?v=165';
import { VOCATIONS } from '../domain/character.js?v=194';
import { goldIconImg, openModal } from './shared.js?v=170';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=181';
