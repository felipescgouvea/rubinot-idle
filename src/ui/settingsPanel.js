...
import { currentUser } from '../infrastructure/authClient.js?v=188';
import { getCharacterSlots } from '../application/accountUseCases.js?v=181';
import { VOCATIONS } from '../domain/character.js?v=210';
import { goldIconImg, openModal } from './shared.js?v=186';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=197';
