...
import { currentUser } from '../infrastructure/authClient.js?v=207';
import { getCharacterSlots } from '../application/accountUseCases.js?v=200';
import { VOCATIONS } from '../domain/character.js?v=229';
import { goldIconImg, openModal } from './shared.js?v=205';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=216';
