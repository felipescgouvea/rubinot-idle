...
import { currentUser } from '../infrastructure/authClient.js?v=161';
import { getCharacterSlots } from '../application/accountUseCases.js?v=154';
import { VOCATIONS } from '../domain/character.js?v=183';
import { goldIconImg, openModal } from './shared.js?v=159';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=170';
