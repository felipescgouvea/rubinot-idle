...
import { currentUser } from '../infrastructure/authClient.js?v=297';
import { getCharacterSlots } from '../application/accountUseCases.js?v=287';
import { VOCATIONS } from '../domain/character.js?v=316';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=289';
import { goldIconImg, openModal } from './shared.js?v=292';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=305';
