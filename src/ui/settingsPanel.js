...
import { currentUser } from '../infrastructure/authClient.js?v=179';
import { getCharacterSlots } from '../application/accountUseCases.js?v=172';
import { VOCATIONS } from '../domain/character.js?v=201';
import { goldIconImg, openModal } from './shared.js?v=177';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=188';
