...
import { currentUser } from '../infrastructure/authClient.js?v=135';
import { getCharacterSlots } from '../application/accountUseCases.js?v=128';
import { VOCATIONS } from '../domain/character.js?v=157';
import { goldIconImg, openModal } from './shared.js?v=133';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=144';
