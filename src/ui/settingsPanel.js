...
import { currentUser } from '../infrastructure/authClient.js?v=171';
import { getCharacterSlots } from '../application/accountUseCases.js?v=164';
import { VOCATIONS } from '../domain/character.js?v=193';
import { goldIconImg, openModal } from './shared.js?v=169';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=180';
