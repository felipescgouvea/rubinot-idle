...
import { currentUser } from '../infrastructure/authClient.js?v=289';
import { getCharacterSlots } from '../application/accountUseCases.js?v=279';
import { VOCATIONS } from '../domain/character.js?v=308';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=281';
import { goldIconImg, openModal } from './shared.js?v=284';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=297';
