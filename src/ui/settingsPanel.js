...
import { currentUser } from '../infrastructure/authClient.js?v=366';
import { getCharacterSlots } from '../application/accountUseCases.js?v=356';
import { VOCATIONS } from '../domain/character.js?v=385';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=358';
import { goldIconImg, openModal } from './shared.js?v=361';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=374';
