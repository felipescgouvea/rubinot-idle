...
import { currentUser } from '../infrastructure/authClient.js?v=184';
import { getCharacterSlots } from '../application/accountUseCases.js?v=177';
import { VOCATIONS } from '../domain/character.js?v=206';
import { goldIconImg, openModal } from './shared.js?v=182';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=193';
