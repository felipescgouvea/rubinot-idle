...
import { currentUser } from '../infrastructure/authClient.js?v=308';
import { getCharacterSlots } from '../application/accountUseCases.js?v=298';
import { VOCATIONS } from '../domain/character.js?v=327';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=300';
import { goldIconImg, openModal } from './shared.js?v=303';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=316';
