...
import { currentUser } from '../infrastructure/authClient.js?v=226';
import { getCharacterSlots } from '../application/accountUseCases.js?v=219';
import { VOCATIONS } from '../domain/character.js?v=248';
import { goldIconImg, openModal } from './shared.js?v=224';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=235';
