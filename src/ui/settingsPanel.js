...
import { currentUser } from '../infrastructure/authClient.js?v=338';
import { getCharacterSlots } from '../application/accountUseCases.js?v=328';
import { VOCATIONS } from '../domain/character.js?v=357';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=330';
import { goldIconImg, openModal } from './shared.js?v=333';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=346';
