...
import { currentUser } from '../infrastructure/authClient.js?v=324';
import { getCharacterSlots } from '../application/accountUseCases.js?v=314';
import { VOCATIONS } from '../domain/character.js?v=343';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=316';
import { goldIconImg, openModal } from './shared.js?v=319';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=332';
