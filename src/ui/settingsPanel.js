...
import { currentUser } from '../infrastructure/authClient.js?v=170';
import { getCharacterSlots } from '../application/accountUseCases.js?v=163';
import { VOCATIONS } from '../domain/character.js?v=192';
import { goldIconImg, openModal } from './shared.js?v=168';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=179';
