...
import { currentUser } from '../infrastructure/authClient.js?v=313';
import { getCharacterSlots } from '../application/accountUseCases.js?v=303';
import { VOCATIONS } from '../domain/character.js?v=332';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=305';
import { goldIconImg, openModal } from './shared.js?v=308';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=321';
