...
import { currentUser } from '../infrastructure/authClient.js?v=157';
import { getCharacterSlots } from '../application/accountUseCases.js?v=150';
import { VOCATIONS } from '../domain/character.js?v=179';
import { goldIconImg, openModal } from './shared.js?v=155';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=166';
