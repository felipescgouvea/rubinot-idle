...
import { currentUser } from '../infrastructure/authClient.js?v=284';
import { getCharacterSlots } from '../application/accountUseCases.js?v=274';
import { VOCATIONS } from '../domain/character.js?v=303';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=276';
import { goldIconImg, openModal } from './shared.js?v=279';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=292';
