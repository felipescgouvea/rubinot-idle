...
import { currentUser } from '../infrastructure/authClient.js?v=174';
import { getCharacterSlots } from '../application/accountUseCases.js?v=167';
import { VOCATIONS } from '../domain/character.js?v=196';
import { goldIconImg, openModal } from './shared.js?v=172';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=183';
