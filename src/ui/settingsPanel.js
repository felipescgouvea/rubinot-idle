...
import { currentUser } from '../infrastructure/authClient.js?v=278';
import { getCharacterSlots } from '../application/accountUseCases.js?v=268';
import { VOCATIONS } from '../domain/character.js?v=297';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=270';
import { goldIconImg, openModal } from './shared.js?v=273';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=286';
