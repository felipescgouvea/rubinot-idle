...
import { currentUser } from '../infrastructure/authClient.js?v=196';
import { getCharacterSlots } from '../application/accountUseCases.js?v=189';
import { VOCATIONS } from '../domain/character.js?v=218';
import { goldIconImg, openModal } from './shared.js?v=194';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=205';
