...
import { currentUser } from '../infrastructure/authClient.js?v=323';
import { getCharacterSlots } from '../application/accountUseCases.js?v=313';
import { VOCATIONS } from '../domain/character.js?v=342';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=315';
import { goldIconImg, openModal } from './shared.js?v=318';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=331';
