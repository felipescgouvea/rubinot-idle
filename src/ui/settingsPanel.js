...
import { currentUser } from '../infrastructure/authClient.js?v=271';
import { getCharacterSlots } from '../application/accountUseCases.js?v=261';
import { VOCATIONS } from '../domain/character.js?v=290';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=263';
import { goldIconImg, openModal } from './shared.js?v=266';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=279';
