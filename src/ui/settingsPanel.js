...
import { currentUser } from '../infrastructure/authClient.js?v=192';
import { getCharacterSlots } from '../application/accountUseCases.js?v=185';
import { VOCATIONS } from '../domain/character.js?v=214';
import { goldIconImg, openModal } from './shared.js?v=190';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=201';
