...
import { currentUser } from '../infrastructure/authClient.js?v=286';
import { getCharacterSlots } from '../application/accountUseCases.js?v=276';
import { VOCATIONS } from '../domain/character.js?v=305';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=278';
import { goldIconImg, openModal } from './shared.js?v=281';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=294';
