...
import { currentUser } from '../infrastructure/authClient.js?v=203';
import { getCharacterSlots } from '../application/accountUseCases.js?v=196';
import { VOCATIONS } from '../domain/character.js?v=225';
import { goldIconImg, openModal } from './shared.js?v=201';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=212';
