...
import { currentUser } from '../infrastructure/authClient.js?v=206';
import { getCharacterSlots } from '../application/accountUseCases.js?v=199';
import { VOCATIONS } from '../domain/character.js?v=228';
import { goldIconImg, openModal } from './shared.js?v=204';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=215';
