...
import { currentUser } from '../infrastructure/authClient.js?v=310';
import { getCharacterSlots } from '../application/accountUseCases.js?v=300';
import { VOCATIONS } from '../domain/character.js?v=329';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=302';
import { goldIconImg, openModal } from './shared.js?v=305';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=318';
