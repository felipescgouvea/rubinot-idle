...
import { currentUser } from '../infrastructure/authClient.js?v=292';
import { getCharacterSlots } from '../application/accountUseCases.js?v=282';
import { VOCATIONS } from '../domain/character.js?v=311';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=284';
import { goldIconImg, openModal } from './shared.js?v=287';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=300';
