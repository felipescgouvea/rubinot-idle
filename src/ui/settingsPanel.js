...
import { currentUser } from '../infrastructure/authClient.js?v=166';
import { getCharacterSlots } from '../application/accountUseCases.js?v=159';
import { VOCATIONS } from '../domain/character.js?v=188';
import { goldIconImg, openModal } from './shared.js?v=164';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=175';
