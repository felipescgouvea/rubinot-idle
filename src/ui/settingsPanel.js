...
import { currentUser } from '../infrastructure/authClient.js?v=228';
import { getCharacterSlots } from '../application/accountUseCases.js?v=221';
import { VOCATIONS } from '../domain/character.js?v=250';
import { goldIconImg, openModal } from './shared.js?v=226';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=237';
