...
import { currentUser } from '../infrastructure/authClient.js?v=268';
import { getCharacterSlots } from '../application/accountUseCases.js?v=258';
import { VOCATIONS } from '../domain/character.js?v=287';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=260';
import { goldIconImg, openModal } from './shared.js?v=263';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=276';
