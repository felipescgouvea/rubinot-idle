...
import { currentUser } from '../infrastructure/authClient.js?v=285';
import { getCharacterSlots } from '../application/accountUseCases.js?v=275';
import { VOCATIONS } from '../domain/character.js?v=304';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=277';
import { goldIconImg, openModal } from './shared.js?v=280';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=293';
