...
import { currentUser } from '../infrastructure/authClient.js?v=139';
import { getCharacterSlots } from '../application/accountUseCases.js?v=132';
import { VOCATIONS } from '../domain/character.js?v=161';
import { goldIconImg, openModal } from './shared.js?v=137';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=148';
