...
import { currentUser } from '../infrastructure/authClient.js?v=351';
import { getCharacterSlots } from '../application/accountUseCases.js?v=341';
import { VOCATIONS } from '../domain/character.js?v=370';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=343';
import { goldIconImg, openModal } from './shared.js?v=346';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=359';
