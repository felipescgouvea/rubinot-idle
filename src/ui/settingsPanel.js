...
import { currentUser } from '../infrastructure/authClient.js?v=163';
import { getCharacterSlots } from '../application/accountUseCases.js?v=156';
import { VOCATIONS } from '../domain/character.js?v=185';
import { goldIconImg, openModal } from './shared.js?v=161';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=172';
