...
import { currentUser } from '../infrastructure/authClient.js?v=370';
import { getCharacterSlots } from '../application/accountUseCases.js?v=360';
import { VOCATIONS } from '../domain/character.js?v=389';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=362';
import { goldIconImg, openModal } from './shared.js?v=365';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=378';
