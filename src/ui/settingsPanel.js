...
import { currentUser } from '../infrastructure/authClient.js?v=195';
import { getCharacterSlots } from '../application/accountUseCases.js?v=188';
import { VOCATIONS } from '../domain/character.js?v=217';
import { goldIconImg, openModal } from './shared.js?v=193';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=204';
