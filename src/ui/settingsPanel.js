...
import { currentUser } from '../infrastructure/authClient.js?v=336';
import { getCharacterSlots } from '../application/accountUseCases.js?v=326';
import { VOCATIONS } from '../domain/character.js?v=355';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=328';
import { goldIconImg, openModal } from './shared.js?v=331';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=344';
