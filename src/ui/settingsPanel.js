...
import { currentUser } from '../infrastructure/authClient.js?v=202';
import { getCharacterSlots } from '../application/accountUseCases.js?v=195';
import { VOCATIONS } from '../domain/character.js?v=224';
import { goldIconImg, openModal } from './shared.js?v=200';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=211';
