...
import { currentUser } from '../infrastructure/authClient.js?v=250';
import { getCharacterSlots } from '../application/accountUseCases.js?v=243';
import { VOCATIONS } from '../domain/character.js?v=272';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=245';
import { goldIconImg, openModal } from './shared.js?v=248';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=259';
