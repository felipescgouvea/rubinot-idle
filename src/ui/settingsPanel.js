...
import { currentUser } from '../infrastructure/authClient.js?v=225';
import { getCharacterSlots } from '../application/accountUseCases.js?v=218';
import { VOCATIONS } from '../domain/character.js?v=247';
import { goldIconImg, openModal } from './shared.js?v=223';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=234';
