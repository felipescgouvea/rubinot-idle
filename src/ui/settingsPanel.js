...
import { currentUser } from '../infrastructure/authClient.js?v=261';
import { getCharacterSlots } from '../application/accountUseCases.js?v=254';
import { VOCATIONS } from '../domain/character.js?v=283';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=256';
import { goldIconImg, openModal } from './shared.js?v=259';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=270';
