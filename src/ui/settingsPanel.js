...
import { currentUser } from '../infrastructure/authClient.js?v=217';
import { getCharacterSlots } from '../application/accountUseCases.js?v=210';
import { VOCATIONS } from '../domain/character.js?v=239';
import { goldIconImg, openModal } from './shared.js?v=215';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=226';
