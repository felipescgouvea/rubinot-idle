...
import { currentUser } from '../infrastructure/authClient.js?v=326';
import { getCharacterSlots } from '../application/accountUseCases.js?v=316';
import { VOCATIONS } from '../domain/character.js?v=345';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=318';
import { goldIconImg, openModal } from './shared.js?v=321';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=334';
