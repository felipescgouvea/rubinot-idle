...
import { currentUser } from '../infrastructure/authClient.js?v=249';
import { getCharacterSlots } from '../application/accountUseCases.js?v=242';
import { VOCATIONS } from '../domain/character.js?v=271';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=244';
import { goldIconImg, openModal } from './shared.js?v=247';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=258';
