...
import { currentUser } from '../infrastructure/authClient.js?v=156';
import { getCharacterSlots } from '../application/accountUseCases.js?v=149';
import { VOCATIONS } from '../domain/character.js?v=178';
import { goldIconImg, openModal } from './shared.js?v=154';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=165';
