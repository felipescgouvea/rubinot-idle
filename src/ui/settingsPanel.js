...
import { currentUser } from '../infrastructure/authClient.js?v=214';
import { getCharacterSlots } from '../application/accountUseCases.js?v=207';
import { VOCATIONS } from '../domain/character.js?v=236';
import { goldIconImg, openModal } from './shared.js?v=212';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=223';
