...
import { currentUser } from '../infrastructure/authClient.js?v=360';
import { getCharacterSlots } from '../application/accountUseCases.js?v=350';
import { VOCATIONS } from '../domain/character.js?v=379';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=352';
import { goldIconImg, openModal } from './shared.js?v=355';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=368';
