...
import { currentUser } from '../infrastructure/authClient.js?v=325';
import { getCharacterSlots } from '../application/accountUseCases.js?v=315';
import { VOCATIONS } from '../domain/character.js?v=344';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=317';
import { goldIconImg, openModal } from './shared.js?v=320';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=333';
