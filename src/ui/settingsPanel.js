...
import { currentUser } from '../infrastructure/authClient.js?v=137';
import { getCharacterSlots } from '../application/accountUseCases.js?v=130';
import { VOCATIONS } from '../domain/character.js?v=159';
import { goldIconImg, openModal } from './shared.js?v=135';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=146';
