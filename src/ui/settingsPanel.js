...
import { currentUser } from '../infrastructure/authClient.js?v=288';
import { getCharacterSlots } from '../application/accountUseCases.js?v=278';
import { VOCATIONS } from '../domain/character.js?v=307';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=280';
import { goldIconImg, openModal } from './shared.js?v=283';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=296';
