...
import { currentUser } from '../infrastructure/authClient.js?v=355';
import { getCharacterSlots } from '../application/accountUseCases.js?v=345';
import { VOCATIONS } from '../domain/character.js?v=374';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=347';
import { goldIconImg, openModal } from './shared.js?v=350';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=363';
