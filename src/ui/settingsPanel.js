...
import { currentUser } from '../infrastructure/authClient.js?v=273';
import { getCharacterSlots } from '../application/accountUseCases.js?v=263';
import { VOCATIONS } from '../domain/character.js?v=292';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=265';
import { goldIconImg, openModal } from './shared.js?v=268';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=281';
