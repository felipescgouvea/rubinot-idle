...
import { currentUser } from '../infrastructure/authClient.js?v=339';
import { getCharacterSlots } from '../application/accountUseCases.js?v=329';
import { VOCATIONS } from '../domain/character.js?v=358';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=331';
import { goldIconImg, openModal } from './shared.js?v=334';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=347';
