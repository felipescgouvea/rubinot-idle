...
import { currentUser } from '../infrastructure/authClient.js?v=315';
import { getCharacterSlots } from '../application/accountUseCases.js?v=305';
import { VOCATIONS } from '../domain/character.js?v=334';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=307';
import { goldIconImg, openModal } from './shared.js?v=310';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=323';
