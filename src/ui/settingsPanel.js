...
import { currentUser } from '../infrastructure/authClient.js?v=356';
import { getCharacterSlots } from '../application/accountUseCases.js?v=346';
import { VOCATIONS } from '../domain/character.js?v=375';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=348';
import { goldIconImg, openModal } from './shared.js?v=351';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=364';
