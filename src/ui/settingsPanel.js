...
import { currentUser } from '../infrastructure/authClient.js?v=357';
import { getCharacterSlots } from '../application/accountUseCases.js?v=347';
import { VOCATIONS } from '../domain/character.js?v=376';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=349';
import { goldIconImg, openModal } from './shared.js?v=352';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=365';
