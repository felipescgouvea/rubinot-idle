...
import { currentUser } from '../infrastructure/authClient.js?v=164';
import { getCharacterSlots } from '../application/accountUseCases.js?v=157';
import { VOCATIONS } from '../domain/character.js?v=186';
import { goldIconImg, openModal } from './shared.js?v=162';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=173';
