...
import { currentUser } from '../infrastructure/authClient.js?v=155';
import { getCharacterSlots } from '../application/accountUseCases.js?v=148';
import { VOCATIONS } from '../domain/character.js?v=177';
import { goldIconImg, openModal } from './shared.js?v=153';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=164';
