...
import { currentUser } from '../infrastructure/authClient.js?v=321';
import { getCharacterSlots } from '../application/accountUseCases.js?v=311';
import { VOCATIONS } from '../domain/character.js?v=340';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=313';
import { goldIconImg, openModal } from './shared.js?v=316';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=329';
