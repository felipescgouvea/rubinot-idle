...
import { currentUser } from '../infrastructure/authClient.js?v=199';
import { getCharacterSlots } from '../application/accountUseCases.js?v=192';
import { VOCATIONS } from '../domain/character.js?v=221';
import { goldIconImg, openModal } from './shared.js?v=197';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=208';
