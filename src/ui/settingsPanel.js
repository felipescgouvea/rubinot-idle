...
import { currentUser } from '../infrastructure/authClient.js?v=334';
import { getCharacterSlots } from '../application/accountUseCases.js?v=324';
import { VOCATIONS } from '../domain/character.js?v=353';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=326';
import { goldIconImg, openModal } from './shared.js?v=329';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=342';
