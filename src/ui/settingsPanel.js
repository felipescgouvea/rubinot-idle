...
import { currentUser } from '../infrastructure/authClient.js?v=358';
import { getCharacterSlots } from '../application/accountUseCases.js?v=348';
import { VOCATIONS } from '../domain/character.js?v=377';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=350';
import { goldIconImg, openModal } from './shared.js?v=353';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=366';
