...
import { currentUser } from '../infrastructure/authClient.js?v=352';
import { getCharacterSlots } from '../application/accountUseCases.js?v=342';
import { VOCATIONS } from '../domain/character.js?v=371';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=344';
import { goldIconImg, openModal } from './shared.js?v=347';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=360';
