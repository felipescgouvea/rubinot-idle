...
import { currentUser } from '../infrastructure/authClient.js?v=177';
import { getCharacterSlots } from '../application/accountUseCases.js?v=170';
import { VOCATIONS } from '../domain/character.js?v=199';
import { goldIconImg, openModal } from './shared.js?v=175';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=186';
