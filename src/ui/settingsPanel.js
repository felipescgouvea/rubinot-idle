...
import { currentUser } from '../infrastructure/authClient.js?v=169';
import { getCharacterSlots } from '../application/accountUseCases.js?v=162';
import { VOCATIONS } from '../domain/character.js?v=191';
import { goldIconImg, openModal } from './shared.js?v=167';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=178';
