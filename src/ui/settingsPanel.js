...
import { currentUser } from '../infrastructure/authClient.js?v=162';
import { getCharacterSlots } from '../application/accountUseCases.js?v=155';
import { VOCATIONS } from '../domain/character.js?v=184';
import { goldIconImg, openModal } from './shared.js?v=160';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=171';
