...
import { currentUser } from '../infrastructure/authClient.js?v=187';
import { getCharacterSlots } from '../application/accountUseCases.js?v=180';
import { VOCATIONS } from '../domain/character.js?v=209';
import { goldIconImg, openModal } from './shared.js?v=185';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=196';
