...
import { currentUser } from '../infrastructure/authClient.js?v=231';
import { getCharacterSlots } from '../application/accountUseCases.js?v=224';
import { VOCATIONS } from '../domain/character.js?v=253';
import { goldIconImg, openModal } from './shared.js?v=229';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=240';
