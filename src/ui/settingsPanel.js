...
import { currentUser } from '../infrastructure/authClient.js?v=348';
import { getCharacterSlots } from '../application/accountUseCases.js?v=338';
import { VOCATIONS } from '../domain/character.js?v=367';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=340';
import { goldIconImg, openModal } from './shared.js?v=343';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=356';
