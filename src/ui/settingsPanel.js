...
import { currentUser } from '../infrastructure/authClient.js?v=367';
import { getCharacterSlots } from '../application/accountUseCases.js?v=357';
import { VOCATIONS } from '../domain/character.js?v=386';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=359';
import { goldIconImg, openModal } from './shared.js?v=362';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=375';
