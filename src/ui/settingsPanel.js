...
import { currentUser } from '../infrastructure/authClient.js?v=178';
import { getCharacterSlots } from '../application/accountUseCases.js?v=171';
import { VOCATIONS } from '../domain/character.js?v=200';
import { goldIconImg, openModal } from './shared.js?v=176';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=187';
