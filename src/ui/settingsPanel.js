...
import { currentUser } from '../infrastructure/authClient.js?v=175';
import { getCharacterSlots } from '../application/accountUseCases.js?v=168';
import { VOCATIONS } from '../domain/character.js?v=197';
import { goldIconImg, openModal } from './shared.js?v=173';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=184';
