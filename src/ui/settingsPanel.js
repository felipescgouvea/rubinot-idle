...
import { currentUser } from '../infrastructure/authClient.js?v=201';
import { getCharacterSlots } from '../application/accountUseCases.js?v=194';
import { VOCATIONS } from '../domain/character.js?v=223';
import { goldIconImg, openModal } from './shared.js?v=199';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=210';
