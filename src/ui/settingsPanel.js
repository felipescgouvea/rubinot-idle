...
import { currentUser } from '../infrastructure/authClient.js?v=193';
import { getCharacterSlots } from '../application/accountUseCases.js?v=186';
import { VOCATIONS } from '../domain/character.js?v=215';
import { goldIconImg, openModal } from './shared.js?v=191';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=202';
