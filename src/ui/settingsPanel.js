...
import { currentUser } from '../infrastructure/authClient.js?v=274';
import { getCharacterSlots } from '../application/accountUseCases.js?v=264';
import { VOCATIONS } from '../domain/character.js?v=293';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=266';
import { goldIconImg, openModal } from './shared.js?v=269';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=282';
