...
import { currentUser } from '../infrastructure/authClient.js?v=347';
import { getCharacterSlots } from '../application/accountUseCases.js?v=337';
import { VOCATIONS } from '../domain/character.js?v=366';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=339';
import { goldIconImg, openModal } from './shared.js?v=342';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=355';
