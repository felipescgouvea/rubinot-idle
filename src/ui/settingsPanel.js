...
import { currentUser } from '../infrastructure/authClient.js?v=200';
import { getCharacterSlots } from '../application/accountUseCases.js?v=193';
import { VOCATIONS } from '../domain/character.js?v=222';
import { goldIconImg, openModal } from './shared.js?v=198';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=209';
