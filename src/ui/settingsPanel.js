...
import { currentUser } from '../infrastructure/authClient.js?v=160';
import { getCharacterSlots } from '../application/accountUseCases.js?v=153';
import { VOCATIONS } from '../domain/character.js?v=182';
import { goldIconImg, openModal } from './shared.js?v=158';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=169';
