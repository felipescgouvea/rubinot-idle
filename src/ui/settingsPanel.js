...
import { currentUser } from '../infrastructure/authClient.js?v=295';
import { getCharacterSlots } from '../application/accountUseCases.js?v=285';
import { VOCATIONS } from '../domain/character.js?v=314';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=287';
import { goldIconImg, openModal } from './shared.js?v=290';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=303';
