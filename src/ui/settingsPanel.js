...
import { currentUser } from '../infrastructure/authClient.js?v=215';
import { getCharacterSlots } from '../application/accountUseCases.js?v=208';
import { VOCATIONS } from '../domain/character.js?v=237';
import { goldIconImg, openModal } from './shared.js?v=213';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=224';
