...
import { currentUser } from '../infrastructure/authClient.js?v=136';
import { getCharacterSlots } from '../application/accountUseCases.js?v=129';
import { VOCATIONS } from '../domain/character.js?v=158';
import { goldIconImg, openModal } from './shared.js?v=134';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=145';
