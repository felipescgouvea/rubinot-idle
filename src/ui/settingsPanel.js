...
import { currentUser } from '../infrastructure/authClient.js?v=275';
import { getCharacterSlots } from '../application/accountUseCases.js?v=265';
import { VOCATIONS } from '../domain/character.js?v=294';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=267';
import { goldIconImg, openModal } from './shared.js?v=270';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=283';
