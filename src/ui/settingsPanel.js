...
import { currentUser } from '../infrastructure/authClient.js?v=224';
import { getCharacterSlots } from '../application/accountUseCases.js?v=217';
import { VOCATIONS } from '../domain/character.js?v=246';
import { goldIconImg, openModal } from './shared.js?v=222';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=233';
