...
import { currentUser } from '../infrastructure/authClient.js?v=312';
import { getCharacterSlots } from '../application/accountUseCases.js?v=302';
import { VOCATIONS } from '../domain/character.js?v=331';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=304';
import { goldIconImg, openModal } from './shared.js?v=307';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=320';
