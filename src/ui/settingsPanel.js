...
import { currentUser } from '../infrastructure/authClient.js?v=159';
import { getCharacterSlots } from '../application/accountUseCases.js?v=152';
import { VOCATIONS } from '../domain/character.js?v=181';
import { goldIconImg, openModal } from './shared.js?v=157';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=168';
