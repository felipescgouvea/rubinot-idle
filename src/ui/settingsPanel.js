...
import { currentUser } from '../infrastructure/authClient.js?v=173';
import { getCharacterSlots } from '../application/accountUseCases.js?v=166';
import { VOCATIONS } from '../domain/character.js?v=195';
import { goldIconImg, openModal } from './shared.js?v=171';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=182';
