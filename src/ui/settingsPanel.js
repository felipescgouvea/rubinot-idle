...
import { currentUser } from '../infrastructure/authClient.js?v=344';
import { getCharacterSlots } from '../application/accountUseCases.js?v=334';
import { VOCATIONS } from '../domain/character.js?v=363';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=336';
import { goldIconImg, openModal } from './shared.js?v=339';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=352';
