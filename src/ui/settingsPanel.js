...
import { currentUser } from '../infrastructure/authClient.js?v=138';
import { getCharacterSlots } from '../application/accountUseCases.js?v=131';
import { VOCATIONS } from '../domain/character.js?v=160';
import { goldIconImg, openModal } from './shared.js?v=136';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=147';
