...
import { currentUser } from '../infrastructure/authClient.js?v=158';
import { getCharacterSlots } from '../application/accountUseCases.js?v=151';
import { VOCATIONS } from '../domain/character.js?v=180';
import { goldIconImg, openModal } from './shared.js?v=156';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=167';
