...
import { currentUser } from '../infrastructure/authClient.js?v=309';
import { getCharacterSlots } from '../application/accountUseCases.js?v=299';
import { VOCATIONS } from '../domain/character.js?v=328';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=301';
import { goldIconImg, openModal } from './shared.js?v=304';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=317';
