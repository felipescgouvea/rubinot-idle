...
import { currentUser } from '../infrastructure/authClient.js?v=165';
import { getCharacterSlots } from '../application/accountUseCases.js?v=158';
import { VOCATIONS } from '../domain/character.js?v=187';
import { goldIconImg, openModal } from './shared.js?v=163';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=174';
