...
import { currentUser } from '../infrastructure/authClient.js?v=272';
import { getCharacterSlots } from '../application/accountUseCases.js?v=262';
import { VOCATIONS } from '../domain/character.js?v=291';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=264';
import { goldIconImg, openModal } from './shared.js?v=267';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=280';
