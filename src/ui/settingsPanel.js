...
import { currentUser } from '../infrastructure/authClient.js?v=316';
import { getCharacterSlots } from '../application/accountUseCases.js?v=306';
import { VOCATIONS } from '../domain/character.js?v=335';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=308';
import { goldIconImg, openModal } from './shared.js?v=311';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=324';
