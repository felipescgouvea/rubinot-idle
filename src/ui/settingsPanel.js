...
import { currentUser } from '../infrastructure/authClient.js?v=140';
import { getCharacterSlots } from '../application/accountUseCases.js?v=133';
import { VOCATIONS } from '../domain/character.js?v=162';
import { goldIconImg, openModal } from './shared.js?v=138';
import { t, getLocale, LOCALE_NAMES } from '../i18n/i18n.js?v=149';
