...
import { G, ACCOUNT } from '../application/gameStore.js?v=217';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=157';
import { ITEMS } from '../domain/items.js?v=228';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=213';
import { maxSoul } from '../domain/soul.js?v=155';
import { conjureSpell } from '../application/spellUseCases.js?v=129';
import { on, EVENTS } from '../shared/eventBus.js?v=215';
import { itemIconImg, spellIconImg } from './shared.js?v=220';
