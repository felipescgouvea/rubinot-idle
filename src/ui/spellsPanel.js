...
import { G, ACCOUNT } from '../application/gameStore.js?v=363';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=303';
import { ITEMS } from '../domain/items.js?v=374';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=359';
import { maxSoul } from '../domain/soul.js?v=301';
import { conjureSpell } from '../application/spellUseCases.js?v=275';
import { on, EVENTS } from '../shared/eventBus.js?v=361';
import { itemIconImg, spellIconImg } from './shared.js?v=366';
