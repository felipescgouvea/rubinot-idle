...
import { G, ACCOUNT } from '../application/gameStore.js?v=205';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=145';
import { ITEMS } from '../domain/items.js?v=216';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=201';
import { maxSoul } from '../domain/soul.js?v=143';
import { conjureSpell } from '../application/spellUseCases.js?v=117';
import { on, EVENTS } from '../shared/eventBus.js?v=203';
import { itemIconImg, spellIconImg } from './shared.js?v=208';
