...
import { G, ACCOUNT } from '../application/gameStore.js?v=347';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=287';
import { ITEMS } from '../domain/items.js?v=358';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=343';
import { maxSoul } from '../domain/soul.js?v=285';
import { conjureSpell } from '../application/spellUseCases.js?v=259';
import { on, EVENTS } from '../shared/eventBus.js?v=345';
import { itemIconImg, spellIconImg } from './shared.js?v=350';
