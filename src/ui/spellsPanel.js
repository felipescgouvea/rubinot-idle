...
import { G, ACCOUNT } from '../application/gameStore.js?v=237';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=177';
import { ITEMS } from '../domain/items.js?v=248';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=233';
import { maxSoul } from '../domain/soul.js?v=175';
import { conjureSpell } from '../application/spellUseCases.js?v=149';
import { on, EVENTS } from '../shared/eventBus.js?v=235';
import { itemIconImg, spellIconImg } from './shared.js?v=240';
