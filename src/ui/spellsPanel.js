...
import { G, ACCOUNT } from '../application/gameStore.js?v=296';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=236';
import { ITEMS } from '../domain/items.js?v=307';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=292';
import { maxSoul } from '../domain/soul.js?v=234';
import { conjureSpell } from '../application/spellUseCases.js?v=208';
import { on, EVENTS } from '../shared/eventBus.js?v=294';
import { itemIconImg, spellIconImg } from './shared.js?v=299';
