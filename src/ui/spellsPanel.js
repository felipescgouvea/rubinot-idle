...
import { G, ACCOUNT } from '../application/gameStore.js?v=229';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=169';
import { ITEMS } from '../domain/items.js?v=240';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=225';
import { maxSoul } from '../domain/soul.js?v=167';
import { conjureSpell } from '../application/spellUseCases.js?v=141';
import { on, EVENTS } from '../shared/eventBus.js?v=227';
import { itemIconImg, spellIconImg } from './shared.js?v=232';
