...
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=296';
import { ITEMS } from '../domain/items.js?v=367';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=352';
import { maxSoul } from '../domain/soul.js?v=294';
import { conjureSpell } from '../application/spellUseCases.js?v=268';
import { on, EVENTS } from '../shared/eventBus.js?v=354';
import { itemIconImg, spellIconImg } from './shared.js?v=359';
