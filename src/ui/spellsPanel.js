...
import { G, ACCOUNT } from '../application/gameStore.js?v=232';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=172';
import { ITEMS } from '../domain/items.js?v=243';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=228';
import { maxSoul } from '../domain/soul.js?v=170';
import { conjureSpell } from '../application/spellUseCases.js?v=144';
import { on, EVENTS } from '../shared/eventBus.js?v=230';
import { itemIconImg, spellIconImg } from './shared.js?v=235';
