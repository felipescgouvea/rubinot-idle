...
import { G, ACCOUNT } from '../application/gameStore.js?v=267';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=207';
import { ITEMS } from '../domain/items.js?v=278';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=263';
import { maxSoul } from '../domain/soul.js?v=205';
import { conjureSpell } from '../application/spellUseCases.js?v=179';
import { on, EVENTS } from '../shared/eventBus.js?v=265';
import { itemIconImg, spellIconImg } from './shared.js?v=270';
