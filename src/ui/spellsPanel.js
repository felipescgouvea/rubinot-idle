...
import { G, ACCOUNT } from '../application/gameStore.js?v=344';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=284';
import { ITEMS } from '../domain/items.js?v=355';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=340';
import { maxSoul } from '../domain/soul.js?v=282';
import { conjureSpell } from '../application/spellUseCases.js?v=256';
import { on, EVENTS } from '../shared/eventBus.js?v=342';
import { itemIconImg, spellIconImg } from './shared.js?v=347';
