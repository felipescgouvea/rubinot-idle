...
import { G, ACCOUNT } from '../application/gameStore.js?v=269';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=209';
import { ITEMS } from '../domain/items.js?v=280';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=265';
import { maxSoul } from '../domain/soul.js?v=207';
import { conjureSpell } from '../application/spellUseCases.js?v=181';
import { on, EVENTS } from '../shared/eventBus.js?v=267';
import { itemIconImg, spellIconImg } from './shared.js?v=272';
