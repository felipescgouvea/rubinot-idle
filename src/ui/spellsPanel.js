...
import { G, ACCOUNT } from '../application/gameStore.js?v=307';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=247';
import { ITEMS } from '../domain/items.js?v=318';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=303';
import { maxSoul } from '../domain/soul.js?v=245';
import { conjureSpell } from '../application/spellUseCases.js?v=219';
import { on, EVENTS } from '../shared/eventBus.js?v=305';
import { itemIconImg, spellIconImg } from './shared.js?v=310';
