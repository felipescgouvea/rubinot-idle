...
import { G, ACCOUNT } from '../application/gameStore.js?v=228';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=168';
import { ITEMS } from '../domain/items.js?v=239';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=224';
import { maxSoul } from '../domain/soul.js?v=166';
import { conjureSpell } from '../application/spellUseCases.js?v=140';
import { on, EVENTS } from '../shared/eventBus.js?v=226';
import { itemIconImg, spellIconImg } from './shared.js?v=231';
