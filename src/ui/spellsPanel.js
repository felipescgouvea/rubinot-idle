...
import { G, ACCOUNT } from '../application/gameStore.js?v=318';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=258';
import { ITEMS } from '../domain/items.js?v=329';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=314';
import { maxSoul } from '../domain/soul.js?v=256';
import { conjureSpell } from '../application/spellUseCases.js?v=230';
import { on, EVENTS } from '../shared/eventBus.js?v=316';
import { itemIconImg, spellIconImg } from './shared.js?v=321';
