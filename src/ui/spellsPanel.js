...
import { G, ACCOUNT } from '../application/gameStore.js?v=246';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=186';
import { ITEMS } from '../domain/items.js?v=257';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=242';
import { maxSoul } from '../domain/soul.js?v=184';
import { conjureSpell } from '../application/spellUseCases.js?v=158';
import { on, EVENTS } from '../shared/eventBus.js?v=244';
import { itemIconImg, spellIconImg } from './shared.js?v=249';
