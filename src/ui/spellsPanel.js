...
import { G, ACCOUNT } from '../application/gameStore.js?v=309';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=249';
import { ITEMS } from '../domain/items.js?v=320';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=305';
import { maxSoul } from '../domain/soul.js?v=247';
import { conjureSpell } from '../application/spellUseCases.js?v=221';
import { on, EVENTS } from '../shared/eventBus.js?v=307';
import { itemIconImg, spellIconImg } from './shared.js?v=312';
