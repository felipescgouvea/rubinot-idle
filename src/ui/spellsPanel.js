...
import { G, ACCOUNT } from '../application/gameStore.js?v=321';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=261';
import { ITEMS } from '../domain/items.js?v=332';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=317';
import { maxSoul } from '../domain/soul.js?v=259';
import { conjureSpell } from '../application/spellUseCases.js?v=233';
import { on, EVENTS } from '../shared/eventBus.js?v=319';
import { itemIconImg, spellIconImg } from './shared.js?v=324';
