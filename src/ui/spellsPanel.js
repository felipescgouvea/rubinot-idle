...
import { G, ACCOUNT } from '../application/gameStore.js?v=291';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=231';
import { ITEMS } from '../domain/items.js?v=302';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=287';
import { maxSoul } from '../domain/soul.js?v=229';
import { conjureSpell } from '../application/spellUseCases.js?v=203';
import { on, EVENTS } from '../shared/eventBus.js?v=289';
import { itemIconImg, spellIconImg } from './shared.js?v=294';
