...
import { G, ACCOUNT } from '../application/gameStore.js?v=230';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=170';
import { ITEMS } from '../domain/items.js?v=241';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=226';
import { maxSoul } from '../domain/soul.js?v=168';
import { conjureSpell } from '../application/spellUseCases.js?v=142';
import { on, EVENTS } from '../shared/eventBus.js?v=228';
import { itemIconImg, spellIconImg } from './shared.js?v=233';
