...
import { G, ACCOUNT } from '../application/gameStore.js?v=243';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=183';
import { ITEMS } from '../domain/items.js?v=254';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=239';
import { maxSoul } from '../domain/soul.js?v=181';
import { conjureSpell } from '../application/spellUseCases.js?v=155';
import { on, EVENTS } from '../shared/eventBus.js?v=241';
import { itemIconImg, spellIconImg } from './shared.js?v=246';
