...
import { G, ACCOUNT } from '../application/gameStore.js?v=242';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=182';
import { ITEMS } from '../domain/items.js?v=253';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=238';
import { maxSoul } from '../domain/soul.js?v=180';
import { conjureSpell } from '../application/spellUseCases.js?v=154';
import { on, EVENTS } from '../shared/eventBus.js?v=240';
import { itemIconImg, spellIconImg } from './shared.js?v=245';
