...
import { G, ACCOUNT } from '../application/gameStore.js?v=335';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=275';
import { ITEMS } from '../domain/items.js?v=346';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=331';
import { maxSoul } from '../domain/soul.js?v=273';
import { conjureSpell } from '../application/spellUseCases.js?v=247';
import { on, EVENTS } from '../shared/eventBus.js?v=333';
import { itemIconImg, spellIconImg } from './shared.js?v=338';
