...
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=295';
import { ITEMS } from '../domain/items.js?v=366';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=351';
import { maxSoul } from '../domain/soul.js?v=293';
import { conjureSpell } from '../application/spellUseCases.js?v=267';
import { on, EVENTS } from '../shared/eventBus.js?v=353';
import { itemIconImg, spellIconImg } from './shared.js?v=358';
