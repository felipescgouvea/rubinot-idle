...
import { G, ACCOUNT } from '../application/gameStore.js?v=275';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=215';
import { ITEMS } from '../domain/items.js?v=286';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=271';
import { maxSoul } from '../domain/soul.js?v=213';
import { conjureSpell } from '../application/spellUseCases.js?v=187';
import { on, EVENTS } from '../shared/eventBus.js?v=273';
import { itemIconImg, spellIconImg } from './shared.js?v=278';
