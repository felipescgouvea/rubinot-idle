...
import { G, ACCOUNT } from '../application/gameStore.js?v=209';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=149';
import { ITEMS } from '../domain/items.js?v=220';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=205';
import { maxSoul } from '../domain/soul.js?v=147';
import { conjureSpell } from '../application/spellUseCases.js?v=121';
import { on, EVENTS } from '../shared/eventBus.js?v=207';
import { itemIconImg, spellIconImg } from './shared.js?v=212';
