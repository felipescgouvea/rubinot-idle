...
import { G, ACCOUNT } from '../application/gameStore.js?v=231';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=171';
import { ITEMS } from '../domain/items.js?v=242';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=227';
import { maxSoul } from '../domain/soul.js?v=169';
import { conjureSpell } from '../application/spellUseCases.js?v=143';
import { on, EVENTS } from '../shared/eventBus.js?v=229';
import { itemIconImg, spellIconImg } from './shared.js?v=234';
