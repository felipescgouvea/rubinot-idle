...
import { G, ACCOUNT } from '../application/gameStore.js?v=306';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=246';
import { ITEMS } from '../domain/items.js?v=317';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=302';
import { maxSoul } from '../domain/soul.js?v=244';
import { conjureSpell } from '../application/spellUseCases.js?v=218';
import { on, EVENTS } from '../shared/eventBus.js?v=304';
import { itemIconImg, spellIconImg } from './shared.js?v=309';
