...
import { G, ACCOUNT } from '../application/gameStore.js?v=268';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=208';
import { ITEMS } from '../domain/items.js?v=279';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=264';
import { maxSoul } from '../domain/soul.js?v=206';
import { conjureSpell } from '../application/spellUseCases.js?v=180';
import { on, EVENTS } from '../shared/eventBus.js?v=266';
import { itemIconImg, spellIconImg } from './shared.js?v=271';
