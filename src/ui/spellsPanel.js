...
import { G, ACCOUNT } from '../application/gameStore.js?v=221';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=161';
import { ITEMS } from '../domain/items.js?v=232';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=217';
import { maxSoul } from '../domain/soul.js?v=159';
import { conjureSpell } from '../application/spellUseCases.js?v=133';
import { on, EVENTS } from '../shared/eventBus.js?v=219';
import { itemIconImg, spellIconImg } from './shared.js?v=224';
