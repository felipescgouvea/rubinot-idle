...
import { G, ACCOUNT } from '../application/gameStore.js?v=222';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=162';
import { ITEMS } from '../domain/items.js?v=233';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=218';
import { maxSoul } from '../domain/soul.js?v=160';
import { conjureSpell } from '../application/spellUseCases.js?v=134';
import { on, EVENTS } from '../shared/eventBus.js?v=220';
import { itemIconImg, spellIconImg } from './shared.js?v=225';
