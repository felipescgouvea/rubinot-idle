...
import { G, ACCOUNT } from '../application/gameStore.js?v=337';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=277';
import { ITEMS } from '../domain/items.js?v=348';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=333';
import { maxSoul } from '../domain/soul.js?v=275';
import { conjureSpell } from '../application/spellUseCases.js?v=249';
import { on, EVENTS } from '../shared/eventBus.js?v=335';
import { itemIconImg, spellIconImg } from './shared.js?v=340';
