...
import { G, ACCOUNT } from '../application/gameStore.js?v=241';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=181';
import { ITEMS } from '../domain/items.js?v=252';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=237';
import { maxSoul } from '../domain/soul.js?v=179';
import { conjureSpell } from '../application/spellUseCases.js?v=153';
import { on, EVENTS } from '../shared/eventBus.js?v=239';
import { itemIconImg, spellIconImg } from './shared.js?v=244';
