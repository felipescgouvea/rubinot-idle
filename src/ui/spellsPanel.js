...
import { G, ACCOUNT } from '../application/gameStore.js?v=265';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=205';
import { ITEMS } from '../domain/items.js?v=276';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=261';
import { maxSoul } from '../domain/soul.js?v=203';
import { conjureSpell } from '../application/spellUseCases.js?v=177';
import { on, EVENTS } from '../shared/eventBus.js?v=263';
import { itemIconImg, spellIconImg } from './shared.js?v=268';
