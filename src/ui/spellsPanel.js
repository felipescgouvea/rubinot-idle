...
import { G, ACCOUNT } from '../application/gameStore.js?v=198';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=138';
import { ITEMS } from '../domain/items.js?v=209';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=194';
import { maxSoul } from '../domain/soul.js?v=136';
import { conjureSpell } from '../application/spellUseCases.js?v=110';
import { on, EVENTS } from '../shared/eventBus.js?v=196';
import { itemIconImg, spellIconImg } from './shared.js?v=201';
