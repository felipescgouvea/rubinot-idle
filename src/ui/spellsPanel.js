...
import { G, ACCOUNT } from '../application/gameStore.js?v=213';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=153';
import { ITEMS } from '../domain/items.js?v=224';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=209';
import { maxSoul } from '../domain/soul.js?v=151';
import { conjureSpell } from '../application/spellUseCases.js?v=125';
import { on, EVENTS } from '../shared/eventBus.js?v=211';
import { itemIconImg, spellIconImg } from './shared.js?v=216';
