...
import { G, ACCOUNT } from '../application/gameStore.js?v=189';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=129';
import { ITEMS } from '../domain/items.js?v=200';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=185';
import { maxSoul } from '../domain/soul.js?v=127';
import { conjureSpell } from '../application/spellUseCases.js?v=101';
import { on, EVENTS } from '../shared/eventBus.js?v=187';
import { itemIconImg, spellIconImg } from './shared.js?v=192';
