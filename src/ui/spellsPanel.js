...
import { G, ACCOUNT } from '../application/gameStore.js?v=289';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=229';
import { ITEMS } from '../domain/items.js?v=300';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=285';
import { maxSoul } from '../domain/soul.js?v=227';
import { conjureSpell } from '../application/spellUseCases.js?v=201';
import { on, EVENTS } from '../shared/eventBus.js?v=287';
import { itemIconImg, spellIconImg } from './shared.js?v=292';
