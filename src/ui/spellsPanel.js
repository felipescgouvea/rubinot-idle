...
import { G, ACCOUNT } from '../application/gameStore.js?v=349';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=289';
import { ITEMS } from '../domain/items.js?v=360';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=345';
import { maxSoul } from '../domain/soul.js?v=287';
import { conjureSpell } from '../application/spellUseCases.js?v=261';
import { on, EVENTS } from '../shared/eventBus.js?v=347';
import { itemIconImg, spellIconImg } from './shared.js?v=352';
