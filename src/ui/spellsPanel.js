...
import { G, ACCOUNT } from '../application/gameStore.js?v=254';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=194';
import { ITEMS } from '../domain/items.js?v=265';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=250';
import { maxSoul } from '../domain/soul.js?v=192';
import { conjureSpell } from '../application/spellUseCases.js?v=166';
import { on, EVENTS } from '../shared/eventBus.js?v=252';
import { itemIconImg, spellIconImg } from './shared.js?v=257';
