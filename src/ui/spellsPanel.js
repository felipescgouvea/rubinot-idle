...
import { G, ACCOUNT } from '../application/gameStore.js?v=257';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=197';
import { ITEMS } from '../domain/items.js?v=268';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=253';
import { maxSoul } from '../domain/soul.js?v=195';
import { conjureSpell } from '../application/spellUseCases.js?v=169';
import { on, EVENTS } from '../shared/eventBus.js?v=255';
import { itemIconImg, spellIconImg } from './shared.js?v=260';
