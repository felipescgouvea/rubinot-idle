...
import { G, ACCOUNT } from '../application/gameStore.js?v=272';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=212';
import { ITEMS } from '../domain/items.js?v=283';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=268';
import { maxSoul } from '../domain/soul.js?v=210';
import { conjureSpell } from '../application/spellUseCases.js?v=184';
import { on, EVENTS } from '../shared/eventBus.js?v=270';
import { itemIconImg, spellIconImg } from './shared.js?v=275';
