...
import { G, ACCOUNT } from '../application/gameStore.js?v=245';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=185';
import { ITEMS } from '../domain/items.js?v=256';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=241';
import { maxSoul } from '../domain/soul.js?v=183';
import { conjureSpell } from '../application/spellUseCases.js?v=157';
import { on, EVENTS } from '../shared/eventBus.js?v=243';
import { itemIconImg, spellIconImg } from './shared.js?v=248';
