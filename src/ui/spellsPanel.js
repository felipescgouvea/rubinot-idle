...
import { G, ACCOUNT } from '../application/gameStore.js?v=305';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=245';
import { ITEMS } from '../domain/items.js?v=316';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=301';
import { maxSoul } from '../domain/soul.js?v=243';
import { conjureSpell } from '../application/spellUseCases.js?v=217';
import { on, EVENTS } from '../shared/eventBus.js?v=303';
import { itemIconImg, spellIconImg } from './shared.js?v=308';
