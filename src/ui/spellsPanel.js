...
import { G, ACCOUNT } from '../application/gameStore.js?v=271';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=211';
import { ITEMS } from '../domain/items.js?v=282';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=267';
import { maxSoul } from '../domain/soul.js?v=209';
import { conjureSpell } from '../application/spellUseCases.js?v=183';
import { on, EVENTS } from '../shared/eventBus.js?v=269';
import { itemIconImg, spellIconImg } from './shared.js?v=274';
