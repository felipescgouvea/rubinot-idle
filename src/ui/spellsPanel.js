...
import { G, ACCOUNT } from '../application/gameStore.js?v=191';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=131';
import { ITEMS } from '../domain/items.js?v=202';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=187';
import { maxSoul } from '../domain/soul.js?v=129';
import { conjureSpell } from '../application/spellUseCases.js?v=103';
import { on, EVENTS } from '../shared/eventBus.js?v=189';
import { itemIconImg, spellIconImg } from './shared.js?v=194';
