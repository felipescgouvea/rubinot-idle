...
import { G, ACCOUNT } from '../application/gameStore.js?v=238';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=178';
import { ITEMS } from '../domain/items.js?v=249';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=234';
import { maxSoul } from '../domain/soul.js?v=176';
import { conjureSpell } from '../application/spellUseCases.js?v=150';
import { on, EVENTS } from '../shared/eventBus.js?v=236';
import { itemIconImg, spellIconImg } from './shared.js?v=241';
