...
import { G, ACCOUNT } from '../application/gameStore.js?v=279';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=219';
import { ITEMS } from '../domain/items.js?v=290';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=275';
import { maxSoul } from '../domain/soul.js?v=217';
import { conjureSpell } from '../application/spellUseCases.js?v=191';
import { on, EVENTS } from '../shared/eventBus.js?v=277';
import { itemIconImg, spellIconImg } from './shared.js?v=282';
