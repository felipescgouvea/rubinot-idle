...
import { G, ACCOUNT } from '../application/gameStore.js?v=194';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=134';
import { ITEMS } from '../domain/items.js?v=205';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=190';
import { maxSoul } from '../domain/soul.js?v=132';
import { conjureSpell } from '../application/spellUseCases.js?v=106';
import { on, EVENTS } from '../shared/eventBus.js?v=192';
import { itemIconImg, spellIconImg } from './shared.js?v=197';
