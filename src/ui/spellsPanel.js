...
import { G, ACCOUNT } from '../application/gameStore.js?v=190';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=130';
import { ITEMS } from '../domain/items.js?v=201';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=186';
import { maxSoul } from '../domain/soul.js?v=128';
import { conjureSpell } from '../application/spellUseCases.js?v=102';
import { on, EVENTS } from '../shared/eventBus.js?v=188';
import { itemIconImg, spellIconImg } from './shared.js?v=193';
