...
import { G, ACCOUNT } from '../application/gameStore.js?v=266';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=206';
import { ITEMS } from '../domain/items.js?v=277';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=262';
import { maxSoul } from '../domain/soul.js?v=204';
import { conjureSpell } from '../application/spellUseCases.js?v=178';
import { on, EVENTS } from '../shared/eventBus.js?v=264';
import { itemIconImg, spellIconImg } from './shared.js?v=269';
