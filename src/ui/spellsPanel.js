...
import { G, ACCOUNT } from '../application/gameStore.js?v=219';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=159';
import { ITEMS } from '../domain/items.js?v=230';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=215';
import { maxSoul } from '../domain/soul.js?v=157';
import { conjureSpell } from '../application/spellUseCases.js?v=131';
import { on, EVENTS } from '../shared/eventBus.js?v=217';
import { itemIconImg, spellIconImg } from './shared.js?v=222';
