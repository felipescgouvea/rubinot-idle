...
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=297';
import { ITEMS } from '../domain/items.js?v=368';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=353';
import { maxSoul } from '../domain/soul.js?v=295';
import { conjureSpell } from '../application/spellUseCases.js?v=269';
import { on, EVENTS } from '../shared/eventBus.js?v=355';
import { itemIconImg, spellIconImg } from './shared.js?v=360';
