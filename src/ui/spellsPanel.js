...
import { G, ACCOUNT } from '../application/gameStore.js?v=270';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=210';
import { ITEMS } from '../domain/items.js?v=281';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=266';
import { maxSoul } from '../domain/soul.js?v=208';
import { conjureSpell } from '../application/spellUseCases.js?v=182';
import { on, EVENTS } from '../shared/eventBus.js?v=268';
import { itemIconImg, spellIconImg } from './shared.js?v=273';
