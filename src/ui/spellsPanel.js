...
import { G, ACCOUNT } from '../application/gameStore.js?v=319';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=259';
import { ITEMS } from '../domain/items.js?v=330';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=315';
import { maxSoul } from '../domain/soul.js?v=257';
import { conjureSpell } from '../application/spellUseCases.js?v=231';
import { on, EVENTS } from '../shared/eventBus.js?v=317';
import { itemIconImg, spellIconImg } from './shared.js?v=322';
