...
import { G, ACCOUNT } from '../application/gameStore.js?v=340';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=280';
import { ITEMS } from '../domain/items.js?v=351';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=336';
import { maxSoul } from '../domain/soul.js?v=278';
import { conjureSpell } from '../application/spellUseCases.js?v=252';
import { on, EVENTS } from '../shared/eventBus.js?v=338';
import { itemIconImg, spellIconImg } from './shared.js?v=343';
