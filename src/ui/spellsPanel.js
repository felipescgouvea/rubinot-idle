...
import { G, ACCOUNT } from '../application/gameStore.js?v=286';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=226';
import { ITEMS } from '../domain/items.js?v=297';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=282';
import { maxSoul } from '../domain/soul.js?v=224';
import { conjureSpell } from '../application/spellUseCases.js?v=198';
import { on, EVENTS } from '../shared/eventBus.js?v=284';
import { itemIconImg, spellIconImg } from './shared.js?v=289';
