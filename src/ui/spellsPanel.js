...
import { G, ACCOUNT } from '../application/gameStore.js?v=244';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=184';
import { ITEMS } from '../domain/items.js?v=255';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=240';
import { maxSoul } from '../domain/soul.js?v=182';
import { conjureSpell } from '../application/spellUseCases.js?v=156';
import { on, EVENTS } from '../shared/eventBus.js?v=242';
import { itemIconImg, spellIconImg } from './shared.js?v=247';
