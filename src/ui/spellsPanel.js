...
import { G, ACCOUNT } from '../application/gameStore.js?v=264';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=204';
import { ITEMS } from '../domain/items.js?v=275';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=260';
import { maxSoul } from '../domain/soul.js?v=202';
import { conjureSpell } from '../application/spellUseCases.js?v=176';
import { on, EVENTS } from '../shared/eventBus.js?v=262';
import { itemIconImg, spellIconImg } from './shared.js?v=267';
