...
import { G, ACCOUNT } from '../application/gameStore.js?v=250';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=190';
import { ITEMS } from '../domain/items.js?v=261';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=246';
import { maxSoul } from '../domain/soul.js?v=188';
import { conjureSpell } from '../application/spellUseCases.js?v=162';
import { on, EVENTS } from '../shared/eventBus.js?v=248';
import { itemIconImg, spellIconImg } from './shared.js?v=253';
