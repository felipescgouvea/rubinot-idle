...
import { G, ACCOUNT } from '../application/gameStore.js?v=331';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=271';
import { ITEMS } from '../domain/items.js?v=342';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=327';
import { maxSoul } from '../domain/soul.js?v=269';
import { conjureSpell } from '../application/spellUseCases.js?v=243';
import { on, EVENTS } from '../shared/eventBus.js?v=329';
import { itemIconImg, spellIconImg } from './shared.js?v=334';
