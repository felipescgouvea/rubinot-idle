...
import { G, ACCOUNT } from '../application/gameStore.js?v=295';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=235';
import { ITEMS } from '../domain/items.js?v=306';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=291';
import { maxSoul } from '../domain/soul.js?v=233';
import { conjureSpell } from '../application/spellUseCases.js?v=207';
import { on, EVENTS } from '../shared/eventBus.js?v=293';
import { itemIconImg, spellIconImg } from './shared.js?v=298';
