...
import { G, ACCOUNT } from '../application/gameStore.js?v=326';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=266';
import { ITEMS } from '../domain/items.js?v=337';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=322';
import { maxSoul } from '../domain/soul.js?v=264';
import { conjureSpell } from '../application/spellUseCases.js?v=238';
import { on, EVENTS } from '../shared/eventBus.js?v=324';
import { itemIconImg, spellIconImg } from './shared.js?v=329';
