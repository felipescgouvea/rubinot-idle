...
import { G, ACCOUNT } from '../application/gameStore.js?v=200';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=140';
import { ITEMS } from '../domain/items.js?v=211';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=196';
import { maxSoul } from '../domain/soul.js?v=138';
import { conjureSpell } from '../application/spellUseCases.js?v=112';
import { on, EVENTS } from '../shared/eventBus.js?v=198';
import { itemIconImg, spellIconImg } from './shared.js?v=203';
