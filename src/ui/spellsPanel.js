...
import { G, ACCOUNT } from '../application/gameStore.js?v=260';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=200';
import { ITEMS } from '../domain/items.js?v=271';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=256';
import { maxSoul } from '../domain/soul.js?v=198';
import { conjureSpell } from '../application/spellUseCases.js?v=172';
import { on, EVENTS } from '../shared/eventBus.js?v=258';
import { itemIconImg, spellIconImg } from './shared.js?v=263';
