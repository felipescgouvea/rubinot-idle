...
import { G, ACCOUNT } from '../application/gameStore.js?v=197';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=137';
import { ITEMS } from '../domain/items.js?v=208';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=193';
import { maxSoul } from '../domain/soul.js?v=135';
import { conjureSpell } from '../application/spellUseCases.js?v=109';
import { on, EVENTS } from '../shared/eventBus.js?v=195';
import { itemIconImg, spellIconImg } from './shared.js?v=200';
