...
import { G, ACCOUNT } from '../application/gameStore.js?v=288';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=228';
import { ITEMS } from '../domain/items.js?v=299';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=284';
import { maxSoul } from '../domain/soul.js?v=226';
import { conjureSpell } from '../application/spellUseCases.js?v=200';
import { on, EVENTS } from '../shared/eventBus.js?v=286';
import { itemIconImg, spellIconImg } from './shared.js?v=291';
