...
import { G, ACCOUNT } from '../application/gameStore.js?v=293';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=233';
import { ITEMS } from '../domain/items.js?v=304';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=289';
import { maxSoul } from '../domain/soul.js?v=231';
import { conjureSpell } from '../application/spellUseCases.js?v=205';
import { on, EVENTS } from '../shared/eventBus.js?v=291';
import { itemIconImg, spellIconImg } from './shared.js?v=296';
