...
import { G, ACCOUNT } from '../application/gameStore.js?v=193';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=133';
import { ITEMS } from '../domain/items.js?v=204';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=189';
import { maxSoul } from '../domain/soul.js?v=131';
import { conjureSpell } from '../application/spellUseCases.js?v=105';
import { on, EVENTS } from '../shared/eventBus.js?v=191';
import { itemIconImg, spellIconImg } from './shared.js?v=196';
