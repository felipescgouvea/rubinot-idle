...
import { G, ACCOUNT } from '../application/gameStore.js?v=210';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=150';
import { ITEMS } from '../domain/items.js?v=221';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=206';
import { maxSoul } from '../domain/soul.js?v=148';
import { conjureSpell } from '../application/spellUseCases.js?v=122';
import { on, EVENTS } from '../shared/eventBus.js?v=208';
import { itemIconImg, spellIconImg } from './shared.js?v=213';
