...
import { G, ACCOUNT } from '../application/gameStore.js?v=287';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=227';
import { ITEMS } from '../domain/items.js?v=298';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=283';
import { maxSoul } from '../domain/soul.js?v=225';
import { conjureSpell } from '../application/spellUseCases.js?v=199';
import { on, EVENTS } from '../shared/eventBus.js?v=285';
import { itemIconImg, spellIconImg } from './shared.js?v=290';
