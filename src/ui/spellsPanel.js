...
import { G, ACCOUNT } from '../application/gameStore.js?v=308';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=248';
import { ITEMS } from '../domain/items.js?v=319';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=304';
import { maxSoul } from '../domain/soul.js?v=246';
import { conjureSpell } from '../application/spellUseCases.js?v=220';
import { on, EVENTS } from '../shared/eventBus.js?v=306';
import { itemIconImg, spellIconImg } from './shared.js?v=311';
