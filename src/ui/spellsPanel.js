...
import { G, ACCOUNT } from '../application/gameStore.js?v=310';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=250';
import { ITEMS } from '../domain/items.js?v=321';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=306';
import { maxSoul } from '../domain/soul.js?v=248';
import { conjureSpell } from '../application/spellUseCases.js?v=222';
import { on, EVENTS } from '../shared/eventBus.js?v=308';
import { itemIconImg, spellIconImg } from './shared.js?v=313';
