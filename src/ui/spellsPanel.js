...
import { G, ACCOUNT } from '../application/gameStore.js?v=328';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=268';
import { ITEMS } from '../domain/items.js?v=339';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=324';
import { maxSoul } from '../domain/soul.js?v=266';
import { conjureSpell } from '../application/spellUseCases.js?v=240';
import { on, EVENTS } from '../shared/eventBus.js?v=326';
import { itemIconImg, spellIconImg } from './shared.js?v=331';
