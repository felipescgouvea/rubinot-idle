...
import { G, ACCOUNT } from '../application/gameStore.js?v=332';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=272';
import { ITEMS } from '../domain/items.js?v=343';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=328';
import { maxSoul } from '../domain/soul.js?v=270';
import { conjureSpell } from '../application/spellUseCases.js?v=244';
import { on, EVENTS } from '../shared/eventBus.js?v=330';
import { itemIconImg, spellIconImg } from './shared.js?v=335';
