...
import { G, ACCOUNT } from '../application/gameStore.js?v=192';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=132';
import { ITEMS } from '../domain/items.js?v=203';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=188';
import { maxSoul } from '../domain/soul.js?v=130';
import { conjureSpell } from '../application/spellUseCases.js?v=104';
import { on, EVENTS } from '../shared/eventBus.js?v=190';
import { itemIconImg, spellIconImg } from './shared.js?v=195';
