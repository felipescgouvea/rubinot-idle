...
import { G, ACCOUNT } from '../application/gameStore.js?v=233';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=173';
import { ITEMS } from '../domain/items.js?v=244';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=229';
import { maxSoul } from '../domain/soul.js?v=171';
import { conjureSpell } from '../application/spellUseCases.js?v=145';
import { on, EVENTS } from '../shared/eventBus.js?v=231';
import { itemIconImg, spellIconImg } from './shared.js?v=236';
