...
import { G, ACCOUNT } from '../application/gameStore.js?v=320';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=260';
import { ITEMS } from '../domain/items.js?v=331';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=316';
import { maxSoul } from '../domain/soul.js?v=258';
import { conjureSpell } from '../application/spellUseCases.js?v=232';
import { on, EVENTS } from '../shared/eventBus.js?v=318';
import { itemIconImg, spellIconImg } from './shared.js?v=323';
