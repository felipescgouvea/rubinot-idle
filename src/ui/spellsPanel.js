...
import { G, ACCOUNT } from '../application/gameStore.js?v=234';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=174';
import { ITEMS } from '../domain/items.js?v=245';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=230';
import { maxSoul } from '../domain/soul.js?v=172';
import { conjureSpell } from '../application/spellUseCases.js?v=146';
import { on, EVENTS } from '../shared/eventBus.js?v=232';
import { itemIconImg, spellIconImg } from './shared.js?v=237';
