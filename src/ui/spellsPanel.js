...
import { G, ACCOUNT } from '../application/gameStore.js?v=216';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=156';
import { ITEMS } from '../domain/items.js?v=227';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=212';
import { maxSoul } from '../domain/soul.js?v=154';
import { conjureSpell } from '../application/spellUseCases.js?v=128';
import { on, EVENTS } from '../shared/eventBus.js?v=214';
import { itemIconImg, spellIconImg } from './shared.js?v=219';
