...
import { G, ACCOUNT } from '../application/gameStore.js?v=327';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=267';
import { ITEMS } from '../domain/items.js?v=338';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=323';
import { maxSoul } from '../domain/soul.js?v=265';
import { conjureSpell } from '../application/spellUseCases.js?v=239';
import { on, EVENTS } from '../shared/eventBus.js?v=325';
import { itemIconImg, spellIconImg } from './shared.js?v=330';
