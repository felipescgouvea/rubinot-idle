...
import { G, ACCOUNT } from '../application/gameStore.js?v=240';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=180';
import { ITEMS } from '../domain/items.js?v=251';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=236';
import { maxSoul } from '../domain/soul.js?v=178';
import { conjureSpell } from '../application/spellUseCases.js?v=152';
import { on, EVENTS } from '../shared/eventBus.js?v=238';
import { itemIconImg, spellIconImg } from './shared.js?v=243';
