...
import { G, ACCOUNT } from '../application/gameStore.js?v=218';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=158';
import { ITEMS } from '../domain/items.js?v=229';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=214';
import { maxSoul } from '../domain/soul.js?v=156';
import { conjureSpell } from '../application/spellUseCases.js?v=130';
import { on, EVENTS } from '../shared/eventBus.js?v=216';
import { itemIconImg, spellIconImg } from './shared.js?v=221';
