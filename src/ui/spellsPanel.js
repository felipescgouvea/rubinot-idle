...
import { G, ACCOUNT } from '../application/gameStore.js?v=202';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=142';
import { ITEMS } from '../domain/items.js?v=213';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=198';
import { maxSoul } from '../domain/soul.js?v=140';
import { conjureSpell } from '../application/spellUseCases.js?v=114';
import { on, EVENTS } from '../shared/eventBus.js?v=200';
import { itemIconImg, spellIconImg } from './shared.js?v=205';
