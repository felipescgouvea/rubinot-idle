...
import { G, ACCOUNT } from '../application/gameStore.js?v=352';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=292';
import { ITEMS } from '../domain/items.js?v=363';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=348';
import { maxSoul } from '../domain/soul.js?v=290';
import { conjureSpell } from '../application/spellUseCases.js?v=264';
import { on, EVENTS } from '../shared/eventBus.js?v=350';
import { itemIconImg, spellIconImg } from './shared.js?v=355';
