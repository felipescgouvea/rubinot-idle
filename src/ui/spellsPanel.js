...
import { G, ACCOUNT } from '../application/gameStore.js?v=208';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=148';
import { ITEMS } from '../domain/items.js?v=219';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=204';
import { maxSoul } from '../domain/soul.js?v=146';
import { conjureSpell } from '../application/spellUseCases.js?v=120';
import { on, EVENTS } from '../shared/eventBus.js?v=206';
import { itemIconImg, spellIconImg } from './shared.js?v=211';
