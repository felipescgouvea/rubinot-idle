...
import { G, ACCOUNT } from '../application/gameStore.js?v=329';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=269';
import { ITEMS } from '../domain/items.js?v=340';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=325';
import { maxSoul } from '../domain/soul.js?v=267';
import { conjureSpell } from '../application/spellUseCases.js?v=241';
import { on, EVENTS } from '../shared/eventBus.js?v=327';
import { itemIconImg, spellIconImg } from './shared.js?v=332';
