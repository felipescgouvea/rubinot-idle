...
import { G, ACCOUNT } from '../application/gameStore.js?v=247';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=187';
import { ITEMS } from '../domain/items.js?v=258';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=243';
import { maxSoul } from '../domain/soul.js?v=185';
import { conjureSpell } from '../application/spellUseCases.js?v=159';
import { on, EVENTS } from '../shared/eventBus.js?v=245';
import { itemIconImg, spellIconImg } from './shared.js?v=250';
