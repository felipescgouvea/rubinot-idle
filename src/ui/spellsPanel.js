...
import { G, ACCOUNT } from '../application/gameStore.js?v=312';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=252';
import { ITEMS } from '../domain/items.js?v=323';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=308';
import { maxSoul } from '../domain/soul.js?v=250';
import { conjureSpell } from '../application/spellUseCases.js?v=224';
import { on, EVENTS } from '../shared/eventBus.js?v=310';
import { itemIconImg, spellIconImg } from './shared.js?v=315';
