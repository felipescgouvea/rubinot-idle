...
import { G, ACCOUNT } from '../application/gameStore.js?v=261';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=201';
import { ITEMS } from '../domain/items.js?v=272';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=257';
import { maxSoul } from '../domain/soul.js?v=199';
import { conjureSpell } from '../application/spellUseCases.js?v=173';
import { on, EVENTS } from '../shared/eventBus.js?v=259';
import { itemIconImg, spellIconImg } from './shared.js?v=264';
