...
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=298';
import { ITEMS } from '../domain/items.js?v=369';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=354';
import { maxSoul } from '../domain/soul.js?v=296';
import { conjureSpell } from '../application/spellUseCases.js?v=270';
import { on, EVENTS } from '../shared/eventBus.js?v=356';
import { itemIconImg, spellIconImg } from './shared.js?v=361';
