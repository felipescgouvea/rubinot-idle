...
import { G, ACCOUNT } from '../application/gameStore.js?v=359';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=299';
import { ITEMS } from '../domain/items.js?v=370';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=355';
import { maxSoul } from '../domain/soul.js?v=297';
import { conjureSpell } from '../application/spellUseCases.js?v=271';
import { on, EVENTS } from '../shared/eventBus.js?v=357';
import { itemIconImg, spellIconImg } from './shared.js?v=362';
