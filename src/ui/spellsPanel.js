...
import { G, ACCOUNT } from '../application/gameStore.js?v=330';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=270';
import { ITEMS } from '../domain/items.js?v=341';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=326';
import { maxSoul } from '../domain/soul.js?v=268';
import { conjureSpell } from '../application/spellUseCases.js?v=242';
import { on, EVENTS } from '../shared/eventBus.js?v=328';
import { itemIconImg, spellIconImg } from './shared.js?v=333';
