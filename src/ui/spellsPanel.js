...
import { G, ACCOUNT } from '../application/gameStore.js?v=345';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=285';
import { ITEMS } from '../domain/items.js?v=356';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=341';
import { maxSoul } from '../domain/soul.js?v=283';
import { conjureSpell } from '../application/spellUseCases.js?v=257';
import { on, EVENTS } from '../shared/eventBus.js?v=343';
import { itemIconImg, spellIconImg } from './shared.js?v=348';
