...
import { G, ACCOUNT } from '../application/gameStore.js?v=236';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=176';
import { ITEMS } from '../domain/items.js?v=247';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=232';
import { maxSoul } from '../domain/soul.js?v=174';
import { conjureSpell } from '../application/spellUseCases.js?v=148';
import { on, EVENTS } from '../shared/eventBus.js?v=234';
import { itemIconImg, spellIconImg } from './shared.js?v=239';
