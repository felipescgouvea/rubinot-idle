...
import { G, ACCOUNT } from '../application/gameStore.js?v=201';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=141';
import { ITEMS } from '../domain/items.js?v=212';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=197';
import { maxSoul } from '../domain/soul.js?v=139';
import { conjureSpell } from '../application/spellUseCases.js?v=113';
import { on, EVENTS } from '../shared/eventBus.js?v=199';
import { itemIconImg, spellIconImg } from './shared.js?v=204';
