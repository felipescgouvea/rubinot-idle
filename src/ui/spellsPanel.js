...
import { G, ACCOUNT } from '../application/gameStore.js?v=350';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=290';
import { ITEMS } from '../domain/items.js?v=361';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=346';
import { maxSoul } from '../domain/soul.js?v=288';
import { conjureSpell } from '../application/spellUseCases.js?v=262';
import { on, EVENTS } from '../shared/eventBus.js?v=348';
import { itemIconImg, spellIconImg } from './shared.js?v=353';
