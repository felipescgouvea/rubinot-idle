...
import { G, ACCOUNT } from '../application/gameStore.js?v=348';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=288';
import { ITEMS } from '../domain/items.js?v=359';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=344';
import { maxSoul } from '../domain/soul.js?v=286';
import { conjureSpell } from '../application/spellUseCases.js?v=260';
import { on, EVENTS } from '../shared/eventBus.js?v=346';
import { itemIconImg, spellIconImg } from './shared.js?v=351';
