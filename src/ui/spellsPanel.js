...
import { G, ACCOUNT } from '../application/gameStore.js?v=299';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=239';
import { ITEMS } from '../domain/items.js?v=310';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=295';
import { maxSoul } from '../domain/soul.js?v=237';
import { conjureSpell } from '../application/spellUseCases.js?v=211';
import { on, EVENTS } from '../shared/eventBus.js?v=297';
import { itemIconImg, spellIconImg } from './shared.js?v=302';
