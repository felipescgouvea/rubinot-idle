...
import { G, ACCOUNT } from '../application/gameStore.js?v=220';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=160';
import { ITEMS } from '../domain/items.js?v=231';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=216';
import { maxSoul } from '../domain/soul.js?v=158';
import { conjureSpell } from '../application/spellUseCases.js?v=132';
import { on, EVENTS } from '../shared/eventBus.js?v=218';
import { itemIconImg, spellIconImg } from './shared.js?v=223';
