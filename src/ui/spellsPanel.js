...
import { G, ACCOUNT } from '../application/gameStore.js?v=351';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=291';
import { ITEMS } from '../domain/items.js?v=362';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=347';
import { maxSoul } from '../domain/soul.js?v=289';
import { conjureSpell } from '../application/spellUseCases.js?v=263';
import { on, EVENTS } from '../shared/eventBus.js?v=349';
import { itemIconImg, spellIconImg } from './shared.js?v=354';
