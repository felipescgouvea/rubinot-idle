...
import { G, ACCOUNT } from '../application/gameStore.js?v=346';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=286';
import { ITEMS } from '../domain/items.js?v=357';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=342';
import { maxSoul } from '../domain/soul.js?v=284';
import { conjureSpell } from '../application/spellUseCases.js?v=258';
import { on, EVENTS } from '../shared/eventBus.js?v=344';
import { itemIconImg, spellIconImg } from './shared.js?v=349';
