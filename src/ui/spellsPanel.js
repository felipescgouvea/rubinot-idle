...
import { G, ACCOUNT } from '../application/gameStore.js?v=239';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=179';
import { ITEMS } from '../domain/items.js?v=250';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=235';
import { maxSoul } from '../domain/soul.js?v=177';
import { conjureSpell } from '../application/spellUseCases.js?v=151';
import { on, EVENTS } from '../shared/eventBus.js?v=237';
import { itemIconImg, spellIconImg } from './shared.js?v=242';
