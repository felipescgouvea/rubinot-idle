...
import { G, ACCOUNT } from '../application/gameStore.js?v=199';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=139';
import { ITEMS } from '../domain/items.js?v=210';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=195';
import { maxSoul } from '../domain/soul.js?v=137';
import { conjureSpell } from '../application/spellUseCases.js?v=111';
import { on, EVENTS } from '../shared/eventBus.js?v=197';
import { itemIconImg, spellIconImg } from './shared.js?v=202';
