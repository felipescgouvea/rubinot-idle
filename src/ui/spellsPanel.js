...
import { G, ACCOUNT } from '../application/gameStore.js?v=278';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=218';
import { ITEMS } from '../domain/items.js?v=289';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=274';
import { maxSoul } from '../domain/soul.js?v=216';
import { conjureSpell } from '../application/spellUseCases.js?v=190';
import { on, EVENTS } from '../shared/eventBus.js?v=276';
import { itemIconImg, spellIconImg } from './shared.js?v=281';
