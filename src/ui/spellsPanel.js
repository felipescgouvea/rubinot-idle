...
import { G, ACCOUNT } from '../application/gameStore.js?v=223';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=163';
import { ITEMS } from '../domain/items.js?v=234';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=219';
import { maxSoul } from '../domain/soul.js?v=161';
import { conjureSpell } from '../application/spellUseCases.js?v=135';
import { on, EVENTS } from '../shared/eventBus.js?v=221';
import { itemIconImg, spellIconImg } from './shared.js?v=226';
