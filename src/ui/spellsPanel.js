...
import { G, ACCOUNT } from '../application/gameStore.js?v=336';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=276';
import { ITEMS } from '../domain/items.js?v=347';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=332';
import { maxSoul } from '../domain/soul.js?v=274';
import { conjureSpell } from '../application/spellUseCases.js?v=248';
import { on, EVENTS } from '../shared/eventBus.js?v=334';
import { itemIconImg, spellIconImg } from './shared.js?v=339';
