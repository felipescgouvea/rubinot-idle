...
import { G, ACCOUNT } from '../application/gameStore.js?v=251';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=191';
import { ITEMS } from '../domain/items.js?v=262';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=247';
import { maxSoul } from '../domain/soul.js?v=189';
import { conjureSpell } from '../application/spellUseCases.js?v=163';
import { on, EVENTS } from '../shared/eventBus.js?v=249';
import { itemIconImg, spellIconImg } from './shared.js?v=254';
