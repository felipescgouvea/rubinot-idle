...
import { G, ACCOUNT } from '../application/gameStore.js?v=290';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=230';
import { ITEMS } from '../domain/items.js?v=301';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=286';
import { maxSoul } from '../domain/soul.js?v=228';
import { conjureSpell } from '../application/spellUseCases.js?v=202';
import { on, EVENTS } from '../shared/eventBus.js?v=288';
import { itemIconImg, spellIconImg } from './shared.js?v=293';
