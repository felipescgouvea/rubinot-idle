...
import { G, ACCOUNT } from '../application/gameStore.js?v=294';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=234';
import { ITEMS } from '../domain/items.js?v=305';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=290';
import { maxSoul } from '../domain/soul.js?v=232';
import { conjureSpell } from '../application/spellUseCases.js?v=206';
import { on, EVENTS } from '../shared/eventBus.js?v=292';
import { itemIconImg, spellIconImg } from './shared.js?v=297';
