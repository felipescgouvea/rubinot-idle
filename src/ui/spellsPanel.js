...
import { G, ACCOUNT } from '../application/gameStore.js?v=311';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=251';
import { ITEMS } from '../domain/items.js?v=322';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=307';
import { maxSoul } from '../domain/soul.js?v=249';
import { conjureSpell } from '../application/spellUseCases.js?v=223';
import { on, EVENTS } from '../shared/eventBus.js?v=309';
import { itemIconImg, spellIconImg } from './shared.js?v=314';
