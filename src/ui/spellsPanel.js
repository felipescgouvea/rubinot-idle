...
import { G, ACCOUNT } from '../application/gameStore.js?v=235';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=175';
import { ITEMS } from '../domain/items.js?v=246';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=231';
import { maxSoul } from '../domain/soul.js?v=173';
import { conjureSpell } from '../application/spellUseCases.js?v=147';
import { on, EVENTS } from '../shared/eventBus.js?v=233';
import { itemIconImg, spellIconImg } from './shared.js?v=238';
