...
import { G, ACCOUNT } from '../application/gameStore.js?v=362';
import { SPELLS, isSpellAvailable } from '../domain/spells.js?v=302';
import { ITEMS } from '../domain/items.js?v=373';
import { areaName, isAreaAttack } from '../domain/attackAreas.js?v=358';
import { maxSoul } from '../domain/soul.js?v=300';
import { conjureSpell } from '../application/spellUseCases.js?v=274';
import { on, EVENTS } from '../shared/eventBus.js?v=360';
import { itemIconImg, spellIconImg } from './shared.js?v=365';
