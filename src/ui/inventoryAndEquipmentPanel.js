...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=255';
import { RARITY_TIERS } from '../domain/rarity.js?v=241';
import { on, EVENTS } from '../shared/eventBus.js?v=242';
import { saveGame } from '../application/saveGameUseCase.js?v=244';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=247';
