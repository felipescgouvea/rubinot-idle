...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=325';
import { RARITY_TIERS } from '../domain/rarity.js?v=311';
import { on, EVENTS } from '../shared/eventBus.js?v=312';
import { saveGame } from '../application/saveGameUseCase.js?v=314';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=317';
