...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=180';
import { RARITY_TIERS } from '../domain/rarity.js?v=166';
import { on, EVENTS } from '../shared/eventBus.js?v=167';
import { saveGame } from '../application/saveGameUseCase.js?v=169';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=172';
