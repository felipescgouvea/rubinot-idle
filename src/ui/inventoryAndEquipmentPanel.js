...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=210';
import { RARITY_TIERS } from '../domain/rarity.js?v=196';
import { on, EVENTS } from '../shared/eventBus.js?v=197';
import { saveGame } from '../application/saveGameUseCase.js?v=199';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=202';
