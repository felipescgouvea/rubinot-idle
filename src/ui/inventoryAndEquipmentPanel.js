...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=225';
import { RARITY_TIERS } from '../domain/rarity.js?v=211';
import { on, EVENTS } from '../shared/eventBus.js?v=212';
import { saveGame } from '../application/saveGameUseCase.js?v=214';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=217';
