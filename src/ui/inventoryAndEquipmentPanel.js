...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=314';
import { RARITY_TIERS } from '../domain/rarity.js?v=300';
import { on, EVENTS } from '../shared/eventBus.js?v=301';
import { saveGame } from '../application/saveGameUseCase.js?v=303';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=306';
