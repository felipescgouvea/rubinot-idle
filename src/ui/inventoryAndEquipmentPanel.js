...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=362';
import { RARITY_TIERS } from '../domain/rarity.js?v=348';
import { on, EVENTS } from '../shared/eventBus.js?v=349';
import { saveGame } from '../application/saveGameUseCase.js?v=351';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=354';
