...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=329';
import { RARITY_TIERS } from '../domain/rarity.js?v=315';
import { on, EVENTS } from '../shared/eventBus.js?v=316';
import { saveGame } from '../application/saveGameUseCase.js?v=318';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=321';
