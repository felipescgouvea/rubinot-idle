...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=179';
import { RARITY_TIERS } from '../domain/rarity.js?v=165';
import { on, EVENTS } from '../shared/eventBus.js?v=166';
import { saveGame } from '../application/saveGameUseCase.js?v=168';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=171';
