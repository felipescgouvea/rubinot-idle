...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=103';
import { RARITY_TIERS } from '../domain/rarity.js?v=103';
import { on, EVENTS } from '../shared/eventBus.js?v=103';
import { saveGame } from '../application/saveGameUseCase.js?v=103';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=103';
