...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=185';
import { RARITY_TIERS } from '../domain/rarity.js?v=171';
import { on, EVENTS } from '../shared/eventBus.js?v=172';
import { saveGame } from '../application/saveGameUseCase.js?v=174';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=177';
