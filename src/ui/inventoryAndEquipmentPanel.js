...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=264';
import { RARITY_TIERS } from '../domain/rarity.js?v=250';
import { on, EVENTS } from '../shared/eventBus.js?v=251';
import { saveGame } from '../application/saveGameUseCase.js?v=253';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=256';
