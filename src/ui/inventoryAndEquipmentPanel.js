...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=249';
import { RARITY_TIERS } from '../domain/rarity.js?v=235';
import { on, EVENTS } from '../shared/eventBus.js?v=236';
import { saveGame } from '../application/saveGameUseCase.js?v=238';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=241';
