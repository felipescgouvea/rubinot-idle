...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=202';
import { RARITY_TIERS } from '../domain/rarity.js?v=188';
import { on, EVENTS } from '../shared/eventBus.js?v=189';
import { saveGame } from '../application/saveGameUseCase.js?v=191';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=194';
