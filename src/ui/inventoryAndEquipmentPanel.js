...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=170';
import { RARITY_TIERS } from '../domain/rarity.js?v=156';
import { on, EVENTS } from '../shared/eventBus.js?v=157';
import { saveGame } from '../application/saveGameUseCase.js?v=159';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=162';
