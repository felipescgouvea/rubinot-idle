...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=254';
import { RARITY_TIERS } from '../domain/rarity.js?v=240';
import { on, EVENTS } from '../shared/eventBus.js?v=241';
import { saveGame } from '../application/saveGameUseCase.js?v=243';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=246';
