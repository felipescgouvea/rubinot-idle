...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=275';
import { RARITY_TIERS } from '../domain/rarity.js?v=261';
import { on, EVENTS } from '../shared/eventBus.js?v=262';
import { saveGame } from '../application/saveGameUseCase.js?v=264';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=267';
