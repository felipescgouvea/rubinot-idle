...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=149';
import { RARITY_TIERS } from '../domain/rarity.js?v=135';
import { on, EVENTS } from '../shared/eventBus.js?v=136';
import { saveGame } from '../application/saveGameUseCase.js?v=138';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=141';
