...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=222';
import { RARITY_TIERS } from '../domain/rarity.js?v=208';
import { on, EVENTS } from '../shared/eventBus.js?v=209';
import { saveGame } from '../application/saveGameUseCase.js?v=211';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=214';
