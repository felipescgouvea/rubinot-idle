...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=220';
import { RARITY_TIERS } from '../domain/rarity.js?v=206';
import { on, EVENTS } from '../shared/eventBus.js?v=207';
import { saveGame } from '../application/saveGameUseCase.js?v=209';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=212';
