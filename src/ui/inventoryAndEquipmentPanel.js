...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=142';
import { RARITY_TIERS } from '../domain/rarity.js?v=128';
import { on, EVENTS } from '../shared/eventBus.js?v=129';
import { saveGame } from '../application/saveGameUseCase.js?v=131';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=134';
