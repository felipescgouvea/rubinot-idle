...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=173';
import { RARITY_TIERS } from '../domain/rarity.js?v=159';
import { on, EVENTS } from '../shared/eventBus.js?v=160';
import { saveGame } from '../application/saveGameUseCase.js?v=162';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=165';
