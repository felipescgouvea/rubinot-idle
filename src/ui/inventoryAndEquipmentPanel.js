...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=361';
import { RARITY_TIERS } from '../domain/rarity.js?v=347';
import { on, EVENTS } from '../shared/eventBus.js?v=348';
import { saveGame } from '../application/saveGameUseCase.js?v=350';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=353';
