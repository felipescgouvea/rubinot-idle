...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=310';
import { RARITY_TIERS } from '../domain/rarity.js?v=296';
import { on, EVENTS } from '../shared/eventBus.js?v=297';
import { saveGame } from '../application/saveGameUseCase.js?v=299';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=302';
