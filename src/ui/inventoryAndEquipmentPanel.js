...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=232';
import { RARITY_TIERS } from '../domain/rarity.js?v=218';
import { on, EVENTS } from '../shared/eventBus.js?v=219';
import { saveGame } from '../application/saveGameUseCase.js?v=221';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=224';
