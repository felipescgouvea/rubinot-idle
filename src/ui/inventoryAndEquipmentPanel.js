...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=355';
import { RARITY_TIERS } from '../domain/rarity.js?v=341';
import { on, EVENTS } from '../shared/eventBus.js?v=342';
import { saveGame } from '../application/saveGameUseCase.js?v=344';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=347';
