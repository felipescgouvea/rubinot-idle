...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=293';
import { RARITY_TIERS } from '../domain/rarity.js?v=279';
import { on, EVENTS } from '../shared/eventBus.js?v=280';
import { saveGame } from '../application/saveGameUseCase.js?v=282';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=285';
