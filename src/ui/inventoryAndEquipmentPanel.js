...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=189';
import { RARITY_TIERS } from '../domain/rarity.js?v=175';
import { on, EVENTS } from '../shared/eventBus.js?v=176';
import { saveGame } from '../application/saveGameUseCase.js?v=178';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=181';
