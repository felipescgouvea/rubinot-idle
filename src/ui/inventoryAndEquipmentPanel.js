...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=85';
import { RARITY_TIERS, primaryStatKeyForItem } from '../domain/rarity.js?v=85';
import { on, EVENTS } from '../shared/eventBus.js?v=85';
import { saveGame } from '../application/saveGameUseCase.js?v=85';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=85';
