...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=305';
import { RARITY_TIERS } from '../domain/rarity.js?v=291';
import { on, EVENTS } from '../shared/eventBus.js?v=292';
import { saveGame } from '../application/saveGameUseCase.js?v=294';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=297';
