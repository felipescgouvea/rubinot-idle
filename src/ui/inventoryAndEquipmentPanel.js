...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=297';
import { RARITY_TIERS } from '../domain/rarity.js?v=283';
import { on, EVENTS } from '../shared/eventBus.js?v=284';
import { saveGame } from '../application/saveGameUseCase.js?v=286';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=289';
