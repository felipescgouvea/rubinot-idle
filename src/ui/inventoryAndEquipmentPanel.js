...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=200';
import { RARITY_TIERS } from '../domain/rarity.js?v=186';
import { on, EVENTS } from '../shared/eventBus.js?v=187';
import { saveGame } from '../application/saveGameUseCase.js?v=189';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=192';
