...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=309';
import { RARITY_TIERS } from '../domain/rarity.js?v=295';
import { on, EVENTS } from '../shared/eventBus.js?v=296';
import { saveGame } from '../application/saveGameUseCase.js?v=298';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=301';
