...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=240';
import { RARITY_TIERS } from '../domain/rarity.js?v=226';
import { on, EVENTS } from '../shared/eventBus.js?v=227';
import { saveGame } from '../application/saveGameUseCase.js?v=229';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=232';
