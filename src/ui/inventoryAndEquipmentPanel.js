...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=298';
import { RARITY_TIERS } from '../domain/rarity.js?v=284';
import { on, EVENTS } from '../shared/eventBus.js?v=285';
import { saveGame } from '../application/saveGameUseCase.js?v=287';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=290';
