...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=157';
...
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=149';
