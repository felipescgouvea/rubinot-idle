...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=122';
import { RARITY_TIERS } from '../domain/rarity.js?v=122';
import { on, EVENTS } from '../shared/eventBus.js?v=122';
import { saveGame } from '../application/saveGameUseCase.js?v=122';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=122';
