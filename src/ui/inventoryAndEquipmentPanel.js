...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=276';
import { RARITY_TIERS } from '../domain/rarity.js?v=262';
import { on, EVENTS } from '../shared/eventBus.js?v=263';
import { saveGame } from '../application/saveGameUseCase.js?v=265';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=268';
