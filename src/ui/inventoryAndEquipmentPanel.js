...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=239';
import { RARITY_TIERS } from '../domain/rarity.js?v=225';
import { on, EVENTS } from '../shared/eventBus.js?v=226';
import { saveGame } from '../application/saveGameUseCase.js?v=228';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=231';
