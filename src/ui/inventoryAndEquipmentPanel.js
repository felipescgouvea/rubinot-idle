...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=267';
import { RARITY_TIERS } from '../domain/rarity.js?v=253';
import { on, EVENTS } from '../shared/eventBus.js?v=254';
import { saveGame } from '../application/saveGameUseCase.js?v=256';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=259';
