...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem, BAG_MAX_SLOTS } from '../domain/items.js?v=174';
import { RARITY_TIERS } from '../domain/rarity.js?v=160';
import { on, EVENTS } from '../shared/eventBus.js?v=161';
import { saveGame } from '../application/saveGameUseCase.js?v=163';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=166';
