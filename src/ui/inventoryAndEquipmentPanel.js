...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=234';
import { RARITY_TIERS } from '../domain/rarity.js?v=220';
import { on, EVENTS } from '../shared/eventBus.js?v=221';
import { saveGame } from '../application/saveGameUseCase.js?v=223';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=226';
