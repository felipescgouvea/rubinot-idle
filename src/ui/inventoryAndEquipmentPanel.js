...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=218';
import { RARITY_TIERS } from '../domain/rarity.js?v=204';
import { on, EVENTS } from '../shared/eventBus.js?v=205';
import { saveGame } from '../application/saveGameUseCase.js?v=207';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=210';
