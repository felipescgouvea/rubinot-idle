...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=61';
import { RARITY_TIERS, primaryStatKeyForItem } from '../domain/rarity.js?v=61';
import { on, EVENTS } from '../shared/eventBus.js?v=61';
import { saveGame } from '../application/saveGameUseCase.js?v=61';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=61';
