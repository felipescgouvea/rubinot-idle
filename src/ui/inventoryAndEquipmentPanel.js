...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=301';
import { RARITY_TIERS } from '../domain/rarity.js?v=287';
import { on, EVENTS } from '../shared/eventBus.js?v=288';
import { saveGame } from '../application/saveGameUseCase.js?v=290';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=293';
