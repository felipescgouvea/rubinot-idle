...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=284';
import { RARITY_TIERS } from '../domain/rarity.js?v=270';
import { on, EVENTS } from '../shared/eventBus.js?v=271';
import { saveGame } from '../application/saveGameUseCase.js?v=273';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=276';
