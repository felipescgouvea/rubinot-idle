...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=261';
import { RARITY_TIERS } from '../domain/rarity.js?v=247';
import { on, EVENTS } from '../shared/eventBus.js?v=248';
import { saveGame } from '../application/saveGameUseCase.js?v=250';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=253';
