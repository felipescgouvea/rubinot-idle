...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=104';
import { RARITY_TIERS } from '../domain/rarity.js?v=104';
import { on, EVENTS } from '../shared/eventBus.js?v=104';
import { saveGame } from '../application/saveGameUseCase.js?v=104';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=104';
