...
import { ITEMS, EQUIPMENT_SLOTS, EQUIPPABLE_TYPES, CONSUMABLE_TYPES, isRelicId, resolveEquippedItem } from '../domain/items.js?v=306';
import { RARITY_TIERS } from '../domain/rarity.js?v=292';
import { on, EVENTS } from '../shared/eventBus.js?v=293';
import { saveGame } from '../application/saveGameUseCase.js?v=295';
import { openModal, closeModal, itemIconImg, goldIconImg } from './shared.js?v=298';
