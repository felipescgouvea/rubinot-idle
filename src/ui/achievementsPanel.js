...
import { ACHIEVEMENTS, isAchievementUnlocked, availableTitles } from '../domain/achievements.js?v=317';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=322';
import { openModal } from './shared.js?v=324';
import { emit, EVENTS } from '../shared/eventBus.js?v=319';
import { saveGame } from '../application/saveGameUseCase.js?v=321';
