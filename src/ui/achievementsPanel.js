...
import { ACHIEVEMENTS, isAchievementUnlocked, availableTitles } from '../domain/achievements.js?v=316';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=321';
import { openModal } from './shared.js?v=323';
import { emit, EVENTS } from '../shared/eventBus.js?v=318';
import { saveGame } from '../application/saveGameUseCase.js?v=320';
