...
import { ACHIEVEMENTS, isAchievementUnlocked, availableTitles } from '../domain/achievements.js?v=309';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=314';
import { openModal } from './shared.js?v=316';
import { emit, EVENTS } from '../shared/eventBus.js?v=311';
import { saveGame } from '../application/saveGameUseCase.js?v=313';
