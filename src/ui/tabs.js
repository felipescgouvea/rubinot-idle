...
import { renderTasksPanel } from './tasksPanel.js?v=346';
import { renderSpellsPanel } from './spellsPanel.js?v=254';
import { renderSkillsPanel } from './skillsPanel.js?v=340';
import { renderArenaPanel } from './arenaPanel.js?v=339';
import { renderWorldsPanel } from './worldsPanel.js?v=338';
import { renderBattlePassPanel } from './battlePassPanel.js?v=338';
import { renderRtcPanel } from './rtcPanel.js?v=373';
import { renderShopPanel } from './shopPanel.js?v=346';
import { renderMarketPanel } from './marketPanel.js?v=342';
import { renderHighscoresPanel } from './highscoresPanel.js?v=343';
import { renderBossRushPanel } from './bossRushPanel.js?v=344';
import { renderBestiaryTab } from './bestiaryPanel.js?v=344';
import { renderTrainingSection } from './trainingPanel.js?v=347';
import { renderImbuePanel } from './imbuementPanel.js?v=338';
import { renderAdminPanel } from './adminPanel.js?v=348';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=342';
