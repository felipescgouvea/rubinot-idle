...
import { renderTasksPanel } from './tasksPanel.js?v=173';
import { renderSkillsPanel } from './skillsPanel.js?v=167';
import { renderArenaPanel } from './arenaPanel.js?v=166';
import { renderWorldsPanel } from './worldsPanel.js?v=165';
import { renderBattlePassPanel } from './battlePassPanel.js?v=165';
import { renderRtcPanel } from './rtcPanel.js?v=200';
import { renderShopPanel } from './shopPanel.js?v=173';
import { renderMarketPanel } from './marketPanel.js?v=169';
import { renderHighscoresPanel } from './highscoresPanel.js?v=170';
import { renderBossRushPanel } from './bossRushPanel.js?v=171';
import { renderBestiaryTab } from './bestiaryPanel.js?v=171';
import { renderTrainingSection } from './trainingPanel.js?v=174';
import { renderAdminPanel } from './adminPanel.js?v=175';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=169';
