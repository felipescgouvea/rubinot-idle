...
import { renderTasksPanel } from './tasksPanel.js?v=287';
import { renderSpellsPanel } from './spellsPanel.js?v=194';
import { renderSkillsPanel } from './skillsPanel.js?v=281';
import { renderArenaPanel } from './arenaPanel.js?v=280';
import { renderWorldsPanel } from './worldsPanel.js?v=279';
import { renderBattlePassPanel } from './battlePassPanel.js?v=279';
import { renderRtcPanel } from './rtcPanel.js?v=314';
import { renderShopPanel } from './shopPanel.js?v=287';
import { renderMarketPanel } from './marketPanel.js?v=283';
import { renderHighscoresPanel } from './highscoresPanel.js?v=284';
import { renderBossRushPanel } from './bossRushPanel.js?v=285';
import { renderBestiaryTab } from './bestiaryPanel.js?v=285';
import { renderTrainingSection } from './trainingPanel.js?v=288';
import { renderAdminPanel } from './adminPanel.js?v=289';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=283';
import { on, EVENTS } from '../shared/eventBus.js?v=280';
