...
import { renderTasksPanel } from './tasksPanel.js?v=144';
import { renderSkillsPanel } from './skillsPanel.js?v=138';
import { renderArenaPanel } from './arenaPanel.js?v=137';
import { renderWorldsPanel } from './worldsPanel.js?v=136';
import { renderBattlePassPanel } from './battlePassPanel.js?v=136';
import { renderRtcPanel } from './rtcPanel.js?v=171';
import { renderShopPanel } from './shopPanel.js?v=144';
import { renderMarketPanel } from './marketPanel.js?v=140';
import { renderHighscoresPanel } from './highscoresPanel.js?v=141';
import { renderBossRushPanel } from './bossRushPanel.js?v=142';
import { renderBestiaryTab } from './bestiaryPanel.js?v=142';
import { renderTrainingSection } from './trainingPanel.js?v=145';
import { renderAdminPanel } from './adminPanel.js?v=146';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=140';
import { on, EVENTS } from '../shared/eventBus.js?v=137';
