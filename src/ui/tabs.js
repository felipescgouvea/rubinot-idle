...
import { renderTasksPanel } from './tasksPanel.js?v=208';
import { renderSpellsPanel } from './spellsPanel.js?v=115';
import { renderSkillsPanel } from './skillsPanel.js?v=202';
import { renderArenaPanel } from './arenaPanel.js?v=201';
import { renderWorldsPanel } from './worldsPanel.js?v=200';
import { renderBattlePassPanel } from './battlePassPanel.js?v=200';
import { renderRtcPanel } from './rtcPanel.js?v=235';
import { renderShopPanel } from './shopPanel.js?v=208';
import { renderMarketPanel } from './marketPanel.js?v=204';
import { renderHighscoresPanel } from './highscoresPanel.js?v=205';
import { renderBossRushPanel } from './bossRushPanel.js?v=206';
import { renderBestiaryTab } from './bestiaryPanel.js?v=206';
import { renderTrainingSection } from './trainingPanel.js?v=209';
import { renderAdminPanel } from './adminPanel.js?v=210';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=204';
