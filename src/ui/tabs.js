...
import { renderTasksPanel } from './tasksPanel.js?v=239';
import { renderSpellsPanel } from './spellsPanel.js?v=146';
import { renderSkillsPanel } from './skillsPanel.js?v=233';
import { renderArenaPanel } from './arenaPanel.js?v=232';
import { renderWorldsPanel } from './worldsPanel.js?v=231';
import { renderBattlePassPanel } from './battlePassPanel.js?v=231';
import { renderRtcPanel } from './rtcPanel.js?v=266';
import { renderShopPanel } from './shopPanel.js?v=239';
import { renderMarketPanel } from './marketPanel.js?v=235';
import { renderHighscoresPanel } from './highscoresPanel.js?v=236';
import { renderBossRushPanel } from './bossRushPanel.js?v=237';
import { renderBestiaryTab } from './bestiaryPanel.js?v=237';
import { renderTrainingSection } from './trainingPanel.js?v=240';
import { renderAdminPanel } from './adminPanel.js?v=241';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=235';
import { on, EVENTS } from '../shared/eventBus.js?v=232';
