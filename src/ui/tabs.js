...
import { renderTasksPanel } from './tasksPanel.js?v=74';
import { renderSkillsPanel } from './skillsPanel.js?v=74';
import { renderArenaPanel } from './arenaPanel.js?v=74';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=74';
import { renderWorldsPanel } from './worldsPanel.js?v=74';
import { renderBattlePassPanel } from './battlePassPanel.js?v=74';
import { renderRtcPanel } from './rtcPanel.js?v=74';
import { renderShopPanel } from './shopPanel.js?v=74';
import { renderMarketPanel } from './marketPanel.js?v=74';
import { renderHighscoresPanel } from './highscoresPanel.js?v=74';
import { renderBossRushPanel } from './bossRushPanel.js?v=74';
import { renderBestiaryTab } from './bestiaryPanel.js?v=74';
import { renderTrainingSection } from './trainingPanel.js?v=74';
import { renderAdminPanel } from './adminPanel.js?v=74';
import { isMarketEnabled } from '../application/adminUseCases.js?v=74';
