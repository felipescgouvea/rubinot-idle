...
import { renderTasksPanel } from './tasksPanel.js?v=37';
import { renderSkillsPanel } from './skillsPanel.js?v=37';
import { renderArenaPanel } from './arenaPanel.js?v=37';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=37';
import { renderWorldsPanel } from './worldsPanel.js?v=37';
import { renderBattlePassPanel } from './battlePassPanel.js?v=37';
import { renderRtcPanel } from './rtcPanel.js?v=37';
import { renderShopPanel } from './shopPanel.js?v=37';
import { renderMarketPanel } from './marketPanel.js?v=37';
import { renderHighscoresPanel } from './highscoresPanel.js?v=37';
import { renderBossRushPanel } from './bossRushPanel.js?v=37';
import { renderBestiaryTab } from './bestiaryPanel.js?v=37';
import { renderTrainingSection } from './trainingPanel.js?v=37';
