...
import { renderTasksPanel } from './tasksPanel.js?v=246';
import { renderSpellsPanel } from './spellsPanel.js?v=153';
import { renderSkillsPanel } from './skillsPanel.js?v=240';
import { renderArenaPanel } from './arenaPanel.js?v=239';
import { renderWorldsPanel } from './worldsPanel.js?v=238';
import { renderBattlePassPanel } from './battlePassPanel.js?v=238';
import { renderRtcPanel } from './rtcPanel.js?v=273';
import { renderShopPanel } from './shopPanel.js?v=246';
import { renderMarketPanel } from './marketPanel.js?v=242';
import { renderHighscoresPanel } from './highscoresPanel.js?v=243';
import { renderBossRushPanel } from './bossRushPanel.js?v=244';
import { renderBestiaryTab } from './bestiaryPanel.js?v=244';
import { renderTrainingSection } from './trainingPanel.js?v=247';
import { renderAdminPanel } from './adminPanel.js?v=248';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=242';
