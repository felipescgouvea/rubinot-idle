...
import { renderTasksPanel } from './tasksPanel.js?v=276';
import { renderSpellsPanel } from './spellsPanel.js?v=183';
import { renderSkillsPanel } from './skillsPanel.js?v=270';
import { renderArenaPanel } from './arenaPanel.js?v=269';
import { renderWorldsPanel } from './worldsPanel.js?v=268';
import { renderBattlePassPanel } from './battlePassPanel.js?v=268';
import { renderRtcPanel } from './rtcPanel.js?v=303';
import { renderShopPanel } from './shopPanel.js?v=276';
import { renderMarketPanel } from './marketPanel.js?v=272';
import { renderHighscoresPanel } from './highscoresPanel.js?v=273';
import { renderBossRushPanel } from './bossRushPanel.js?v=274';
import { renderBestiaryTab } from './bestiaryPanel.js?v=274';
import { renderTrainingSection } from './trainingPanel.js?v=277';
import { renderAdminPanel } from './adminPanel.js?v=278';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=272';
