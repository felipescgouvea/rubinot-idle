...
import { renderTasksPanel } from './tasksPanel.js?v=97';
import { renderSkillsPanel } from './skillsPanel.js?v=97';
import { renderArenaPanel } from './arenaPanel.js?v=97';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=97';
import { renderWorldsPanel } from './worldsPanel.js?v=97';
import { renderBattlePassPanel } from './battlePassPanel.js?v=97';
import { renderRtcPanel } from './rtcPanel.js?v=97';
import { renderShopPanel } from './shopPanel.js?v=97';
import { renderMarketPanel } from './marketPanel.js?v=97';
import { renderHighscoresPanel } from './highscoresPanel.js?v=97';
import { renderBossRushPanel } from './bossRushPanel.js?v=97';
import { renderBestiaryTab } from './bestiaryPanel.js?v=97';
import { renderTrainingSection } from './trainingPanel.js?v=97';
import { renderAdminPanel } from './adminPanel.js?v=97';
import { isMarketEnabled } from '../application/adminUseCases.js?v=97';
