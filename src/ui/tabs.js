...
import { renderTasksPanel } from './tasksPanel.js?v=165';
import { renderSkillsPanel } from './skillsPanel.js?v=159';
import { renderArenaPanel } from './arenaPanel.js?v=158';
import { renderWorldsPanel } from './worldsPanel.js?v=157';
import { renderBattlePassPanel } from './battlePassPanel.js?v=157';
import { renderRtcPanel } from './rtcPanel.js?v=192';
import { renderShopPanel } from './shopPanel.js?v=165';
import { renderMarketPanel } from './marketPanel.js?v=161';
import { renderHighscoresPanel } from './highscoresPanel.js?v=162';
import { renderBossRushPanel } from './bossRushPanel.js?v=163';
import { renderBestiaryTab } from './bestiaryPanel.js?v=163';
import { renderTrainingSection } from './trainingPanel.js?v=166';
import { renderAdminPanel } from './adminPanel.js?v=167';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=161';
import { on, EVENTS } from '../shared/eventBus.js?v=158';
