...
import { renderTasksPanel } from './tasksPanel.js?v=225';
import { renderSpellsPanel } from './spellsPanel.js?v=132';
import { renderSkillsPanel } from './skillsPanel.js?v=219';
import { renderArenaPanel } from './arenaPanel.js?v=218';
import { renderWorldsPanel } from './worldsPanel.js?v=217';
import { renderBattlePassPanel } from './battlePassPanel.js?v=217';
import { renderRtcPanel } from './rtcPanel.js?v=252';
import { renderShopPanel } from './shopPanel.js?v=225';
import { renderMarketPanel } from './marketPanel.js?v=221';
import { renderHighscoresPanel } from './highscoresPanel.js?v=222';
import { renderBossRushPanel } from './bossRushPanel.js?v=223';
import { renderBestiaryTab } from './bestiaryPanel.js?v=223';
import { renderTrainingSection } from './trainingPanel.js?v=226';
import { renderAdminPanel } from './adminPanel.js?v=227';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=221';
import { on, EVENTS } from '../shared/eventBus.js?v=218';
