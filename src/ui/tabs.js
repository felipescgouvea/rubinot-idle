...
import { renderTasksPanel } from './tasksPanel.js?v=158';
import { renderSkillsPanel } from './skillsPanel.js?v=152';
import { renderArenaPanel } from './arenaPanel.js?v=151';
import { renderWorldsPanel } from './worldsPanel.js?v=150';
import { renderBattlePassPanel } from './battlePassPanel.js?v=150';
import { renderRtcPanel } from './rtcPanel.js?v=185';
import { renderShopPanel } from './shopPanel.js?v=158';
import { renderMarketPanel } from './marketPanel.js?v=154';
import { renderHighscoresPanel } from './highscoresPanel.js?v=155';
import { renderBossRushPanel } from './bossRushPanel.js?v=156';
import { renderBestiaryTab } from './bestiaryPanel.js?v=156';
import { renderTrainingSection } from './trainingPanel.js?v=159';
import { renderAdminPanel } from './adminPanel.js?v=160';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=154';
import { on, EVENTS } from '../shared/eventBus.js?v=151';
