...
import { renderTasksPanel } from './tasksPanel.js?v=172';
import { renderSkillsPanel } from './skillsPanel.js?v=166';
import { renderArenaPanel } from './arenaPanel.js?v=165';
import { renderWorldsPanel } from './worldsPanel.js?v=164';
import { renderBattlePassPanel } from './battlePassPanel.js?v=164';
import { renderRtcPanel } from './rtcPanel.js?v=199';
import { renderShopPanel } from './shopPanel.js?v=172';
import { renderMarketPanel } from './marketPanel.js?v=168';
import { renderHighscoresPanel } from './highscoresPanel.js?v=169';
import { renderBossRushPanel } from './bossRushPanel.js?v=170';
import { renderBestiaryTab } from './bestiaryPanel.js?v=170';
import { renderTrainingSection } from './trainingPanel.js?v=173';
import { renderAdminPanel } from './adminPanel.js?v=174';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=168';
