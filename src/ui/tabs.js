...
import { renderTasksPanel } from './tasksPanel.js?v=161';
import { renderSkillsPanel } from './skillsPanel.js?v=155';
import { renderArenaPanel } from './arenaPanel.js?v=154';
import { renderWorldsPanel } from './worldsPanel.js?v=153';
import { renderBattlePassPanel } from './battlePassPanel.js?v=153';
import { renderRtcPanel } from './rtcPanel.js?v=188';
import { renderShopPanel } from './shopPanel.js?v=161';
import { renderMarketPanel } from './marketPanel.js?v=157';
import { renderHighscoresPanel } from './highscoresPanel.js?v=158';
import { renderBossRushPanel } from './bossRushPanel.js?v=159';
import { renderBestiaryTab } from './bestiaryPanel.js?v=159';
import { renderTrainingSection } from './trainingPanel.js?v=162';
import { renderAdminPanel } from './adminPanel.js?v=163';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=157';
