...
import { renderTasksPanel } from './tasksPanel.js?v=101';
import { renderSkillsPanel } from './skillsPanel.js?v=101';
import { renderArenaPanel } from './arenaPanel.js?v=101';
import { renderWorldsPanel } from './worldsPanel.js?v=101';
import { renderBattlePassPanel } from './battlePassPanel.js?v=101';
import { renderRtcPanel } from './rtcPanel.js?v=101';
import { renderShopPanel } from './shopPanel.js?v=101';
import { renderMarketPanel } from './marketPanel.js?v=101';
import { renderHighscoresPanel } from './highscoresPanel.js?v=101';
import { renderBossRushPanel } from './bossRushPanel.js?v=101';
import { renderBestiaryTab } from './bestiaryPanel.js?v=101';
import { renderTrainingSection } from './trainingPanel.js?v=101';
import { renderAdminPanel } from './adminPanel.js?v=101';
import { isMarketEnabled } from '../application/adminUseCases.js?v=101';
