...
import { renderTasksPanel } from './tasksPanel.js?v=361';
import { renderQuestsPanel } from './questsPanel.js?v=4';
import { renderSpellsPanel } from './spellsPanel.js?v=269';
import { renderSkillsPanel } from './skillsPanel.js?v=355';
import { renderArenaPanel } from './arenaPanel.js?v=354';
import { renderWorldsPanel } from './worldsPanel.js?v=353';
import { renderBattlePassPanel } from './battlePassPanel.js?v=353';
import { renderRtcPanel } from './rtcPanel.js?v=388';
import { renderShopPanel } from './shopPanel.js?v=361';
import { renderMarketPanel } from './marketPanel.js?v=357';
import { renderHighscoresPanel } from './highscoresPanel.js?v=358';
import { renderBossRushPanel } from './bossRushPanel.js?v=359';
import { renderBestiaryTab } from './bestiaryPanel.js?v=359';
import { renderTrainingSection } from './trainingPanel.js?v=362';
import { renderImbuePanel } from './imbuementPanel.js?v=353';
import { renderAdminPanel } from './adminPanel.js?v=363';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=357';
import { on, EVENTS } from '../shared/eventBus.js?v=354';
