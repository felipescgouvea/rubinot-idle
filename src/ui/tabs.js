...
import { renderTasksPanel } from './tasksPanel.js?v=212';
import { renderSpellsPanel } from './spellsPanel.js?v=119';
import { renderSkillsPanel } from './skillsPanel.js?v=206';
import { renderArenaPanel } from './arenaPanel.js?v=205';
import { renderWorldsPanel } from './worldsPanel.js?v=204';
import { renderBattlePassPanel } from './battlePassPanel.js?v=204';
import { renderRtcPanel } from './rtcPanel.js?v=239';
import { renderShopPanel } from './shopPanel.js?v=212';
import { renderMarketPanel } from './marketPanel.js?v=208';
import { renderHighscoresPanel } from './highscoresPanel.js?v=209';
import { renderBossRushPanel } from './bossRushPanel.js?v=210';
import { renderBestiaryTab } from './bestiaryPanel.js?v=210';
import { renderTrainingSection } from './trainingPanel.js?v=213';
import { renderAdminPanel } from './adminPanel.js?v=214';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=208';
import { on, EVENTS } from '../shared/eventBus.js?v=205';
