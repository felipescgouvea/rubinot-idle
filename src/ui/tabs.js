...
import { renderTasksPanel } from './tasksPanel.js?v=275';
import { renderSpellsPanel } from './spellsPanel.js?v=182';
import { renderSkillsPanel } from './skillsPanel.js?v=269';
import { renderArenaPanel } from './arenaPanel.js?v=268';
import { renderWorldsPanel } from './worldsPanel.js?v=267';
import { renderBattlePassPanel } from './battlePassPanel.js?v=267';
import { renderRtcPanel } from './rtcPanel.js?v=302';
import { renderShopPanel } from './shopPanel.js?v=275';
import { renderMarketPanel } from './marketPanel.js?v=271';
import { renderHighscoresPanel } from './highscoresPanel.js?v=272';
import { renderBossRushPanel } from './bossRushPanel.js?v=273';
import { renderBestiaryTab } from './bestiaryPanel.js?v=273';
import { renderTrainingSection } from './trainingPanel.js?v=276';
import { renderAdminPanel } from './adminPanel.js?v=277';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=271';
