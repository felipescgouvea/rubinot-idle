...
import { renderTasksPanel } from './tasksPanel.js?v=162';
import { renderSkillsPanel } from './skillsPanel.js?v=156';
import { renderArenaPanel } from './arenaPanel.js?v=155';
import { renderWorldsPanel } from './worldsPanel.js?v=154';
import { renderBattlePassPanel } from './battlePassPanel.js?v=154';
import { renderRtcPanel } from './rtcPanel.js?v=189';
import { renderShopPanel } from './shopPanel.js?v=162';
import { renderMarketPanel } from './marketPanel.js?v=158';
import { renderHighscoresPanel } from './highscoresPanel.js?v=159';
import { renderBossRushPanel } from './bossRushPanel.js?v=160';
import { renderBestiaryTab } from './bestiaryPanel.js?v=160';
import { renderTrainingSection } from './trainingPanel.js?v=163';
import { renderAdminPanel } from './adminPanel.js?v=164';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=158';
import { on, EVENTS } from '../shared/eventBus.js?v=155';
