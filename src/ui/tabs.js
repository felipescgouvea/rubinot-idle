...
import { renderTasksPanel } from './tasksPanel.js?v=241';
import { renderSpellsPanel } from './spellsPanel.js?v=148';
import { renderSkillsPanel } from './skillsPanel.js?v=235';
import { renderArenaPanel } from './arenaPanel.js?v=234';
import { renderWorldsPanel } from './worldsPanel.js?v=233';
import { renderBattlePassPanel } from './battlePassPanel.js?v=233';
import { renderRtcPanel } from './rtcPanel.js?v=268';
import { renderShopPanel } from './shopPanel.js?v=241';
import { renderMarketPanel } from './marketPanel.js?v=237';
import { renderHighscoresPanel } from './highscoresPanel.js?v=238';
import { renderBossRushPanel } from './bossRushPanel.js?v=239';
import { renderBestiaryTab } from './bestiaryPanel.js?v=239';
import { renderTrainingSection } from './trainingPanel.js?v=242';
import { renderAdminPanel } from './adminPanel.js?v=243';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=237';
