...
import { renderTasksPanel } from './tasksPanel.js?v=236';
import { renderSpellsPanel } from './spellsPanel.js?v=143';
import { renderSkillsPanel } from './skillsPanel.js?v=230';
import { renderArenaPanel } from './arenaPanel.js?v=229';
import { renderWorldsPanel } from './worldsPanel.js?v=228';
import { renderBattlePassPanel } from './battlePassPanel.js?v=228';
import { renderRtcPanel } from './rtcPanel.js?v=263';
import { renderShopPanel } from './shopPanel.js?v=236';
import { renderMarketPanel } from './marketPanel.js?v=232';
import { renderHighscoresPanel } from './highscoresPanel.js?v=233';
import { renderBossRushPanel } from './bossRushPanel.js?v=234';
import { renderBestiaryTab } from './bestiaryPanel.js?v=234';
import { renderTrainingSection } from './trainingPanel.js?v=237';
import { renderAdminPanel } from './adminPanel.js?v=238';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=232';
