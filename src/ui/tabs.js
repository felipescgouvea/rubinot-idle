...
import { renderTasksPanel } from './tasksPanel.js?v=270';
import { renderSpellsPanel } from './spellsPanel.js?v=177';
import { renderSkillsPanel } from './skillsPanel.js?v=264';
import { renderArenaPanel } from './arenaPanel.js?v=263';
import { renderWorldsPanel } from './worldsPanel.js?v=262';
import { renderBattlePassPanel } from './battlePassPanel.js?v=262';
import { renderRtcPanel } from './rtcPanel.js?v=297';
import { renderShopPanel } from './shopPanel.js?v=270';
import { renderMarketPanel } from './marketPanel.js?v=266';
import { renderHighscoresPanel } from './highscoresPanel.js?v=267';
import { renderBossRushPanel } from './bossRushPanel.js?v=268';
import { renderBestiaryTab } from './bestiaryPanel.js?v=268';
import { renderTrainingSection } from './trainingPanel.js?v=271';
import { renderAdminPanel } from './adminPanel.js?v=272';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=266';
import { on, EVENTS } from '../shared/eventBus.js?v=263';
