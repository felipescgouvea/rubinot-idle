...
import { renderTasksPanel } from './tasksPanel.js?v=300';
import { renderSpellsPanel } from './spellsPanel.js?v=208';
import { renderSkillsPanel } from './skillsPanel.js?v=294';
import { renderArenaPanel } from './arenaPanel.js?v=293';
import { renderWorldsPanel } from './worldsPanel.js?v=292';
import { renderBattlePassPanel } from './battlePassPanel.js?v=292';
import { renderRtcPanel } from './rtcPanel.js?v=327';
import { renderShopPanel } from './shopPanel.js?v=300';
import { renderMarketPanel } from './marketPanel.js?v=296';
import { renderHighscoresPanel } from './highscoresPanel.js?v=297';
import { renderBossRushPanel } from './bossRushPanel.js?v=298';
import { renderBestiaryTab } from './bestiaryPanel.js?v=298';
import { renderTrainingSection } from './trainingPanel.js?v=301';
import { renderImbuePanel } from './imbuementPanel.js?v=292';
import { renderAdminPanel } from './adminPanel.js?v=302';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=296';
