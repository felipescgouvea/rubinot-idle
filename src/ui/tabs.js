...
import { renderTasksPanel } from './tasksPanel.js?v=135';
import { renderSkillsPanel } from './skillsPanel.js?v=129';
import { renderArenaPanel } from './arenaPanel.js?v=128';
import { renderWorldsPanel } from './worldsPanel.js?v=127';
import { renderBattlePassPanel } from './battlePassPanel.js?v=127';
import { renderRtcPanel } from './rtcPanel.js?v=162';
import { renderShopPanel } from './shopPanel.js?v=135';
import { renderMarketPanel } from './marketPanel.js?v=131';
import { renderHighscoresPanel } from './highscoresPanel.js?v=132';
import { renderBossRushPanel } from './bossRushPanel.js?v=133';
import { renderBestiaryTab } from './bestiaryPanel.js?v=133';
import { renderTrainingSection } from './trainingPanel.js?v=136';
import { renderAdminPanel } from './adminPanel.js?v=137';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=131';
import { on, EVENTS } from '../shared/eventBus.js?v=128';
