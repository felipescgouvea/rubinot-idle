...
import { renderTasksPanel } from './tasksPanel.js?v=94';
import { renderSkillsPanel } from './skillsPanel.js?v=94';
import { renderArenaPanel } from './arenaPanel.js?v=94';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=94';
import { renderWorldsPanel } from './worldsPanel.js?v=94';
import { renderBattlePassPanel } from './battlePassPanel.js?v=94';
import { renderRtcPanel } from './rtcPanel.js?v=94';
import { renderShopPanel } from './shopPanel.js?v=94';
import { renderMarketPanel } from './marketPanel.js?v=94';
import { renderHighscoresPanel } from './highscoresPanel.js?v=94';
import { renderBossRushPanel } from './bossRushPanel.js?v=94';
import { renderBestiaryTab } from './bestiaryPanel.js?v=94';
import { renderTrainingSection } from './trainingPanel.js?v=94';
import { renderAdminPanel } from './adminPanel.js?v=94';
import { isMarketEnabled } from '../application/adminUseCases.js?v=94';
