...
import { renderTasksPanel } from './tasksPanel.js?v=240';
import { renderSpellsPanel } from './spellsPanel.js?v=147';
import { renderSkillsPanel } from './skillsPanel.js?v=234';
import { renderArenaPanel } from './arenaPanel.js?v=233';
import { renderWorldsPanel } from './worldsPanel.js?v=232';
import { renderBattlePassPanel } from './battlePassPanel.js?v=232';
import { renderRtcPanel } from './rtcPanel.js?v=267';
import { renderShopPanel } from './shopPanel.js?v=240';
import { renderMarketPanel } from './marketPanel.js?v=236';
import { renderHighscoresPanel } from './highscoresPanel.js?v=237';
import { renderBossRushPanel } from './bossRushPanel.js?v=238';
import { renderBestiaryTab } from './bestiaryPanel.js?v=238';
import { renderTrainingSection } from './trainingPanel.js?v=241';
import { renderAdminPanel } from './adminPanel.js?v=242';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=236';
import { on, EVENTS } from '../shared/eventBus.js?v=233';
