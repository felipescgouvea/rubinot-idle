...
import { renderShopPanel } from './shopPanel.js?v=128';
...
import { renderAdminPanel } from './adminPanel.js?v=126';
import { isMarketEnabled } from '../application/adminUseCases.js?v=126';
