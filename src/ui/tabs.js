...
import { renderTasksPanel } from './tasksPanel.js?v=280';
import { renderSpellsPanel } from './spellsPanel.js?v=187';
import { renderSkillsPanel } from './skillsPanel.js?v=274';
import { renderArenaPanel } from './arenaPanel.js?v=273';
import { renderWorldsPanel } from './worldsPanel.js?v=272';
import { renderBattlePassPanel } from './battlePassPanel.js?v=272';
import { renderRtcPanel } from './rtcPanel.js?v=307';
import { renderShopPanel } from './shopPanel.js?v=280';
import { renderMarketPanel } from './marketPanel.js?v=276';
import { renderHighscoresPanel } from './highscoresPanel.js?v=277';
import { renderBossRushPanel } from './bossRushPanel.js?v=278';
import { renderBestiaryTab } from './bestiaryPanel.js?v=278';
import { renderTrainingSection } from './trainingPanel.js?v=281';
import { renderAdminPanel } from './adminPanel.js?v=282';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=276';
