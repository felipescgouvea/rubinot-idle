...
import { renderTasksPanel } from './tasksPanel.js?v=73';
import { renderSkillsPanel } from './skillsPanel.js?v=73';
import { renderArenaPanel } from './arenaPanel.js?v=73';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=73';
import { renderWorldsPanel } from './worldsPanel.js?v=73';
import { renderBattlePassPanel } from './battlePassPanel.js?v=73';
import { renderRtcPanel } from './rtcPanel.js?v=73';
import { renderShopPanel } from './shopPanel.js?v=73';
import { renderMarketPanel } from './marketPanel.js?v=73';
import { renderHighscoresPanel } from './highscoresPanel.js?v=73';
import { renderBossRushPanel } from './bossRushPanel.js?v=73';
import { renderBestiaryTab } from './bestiaryPanel.js?v=73';
import { renderTrainingSection } from './trainingPanel.js?v=73';
import { renderAdminPanel } from './adminPanel.js?v=73';
import { isMarketEnabled } from '../application/adminUseCases.js?v=73';
