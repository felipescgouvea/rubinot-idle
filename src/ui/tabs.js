...
import { renderTasksPanel } from './tasksPanel.js?v=262';
import { renderSpellsPanel } from './spellsPanel.js?v=169';
import { renderSkillsPanel } from './skillsPanel.js?v=256';
import { renderArenaPanel } from './arenaPanel.js?v=255';
import { renderWorldsPanel } from './worldsPanel.js?v=254';
import { renderBattlePassPanel } from './battlePassPanel.js?v=254';
import { renderRtcPanel } from './rtcPanel.js?v=289';
import { renderShopPanel } from './shopPanel.js?v=262';
import { renderMarketPanel } from './marketPanel.js?v=258';
import { renderHighscoresPanel } from './highscoresPanel.js?v=259';
import { renderBossRushPanel } from './bossRushPanel.js?v=260';
import { renderBestiaryTab } from './bestiaryPanel.js?v=260';
import { renderTrainingSection } from './trainingPanel.js?v=263';
import { renderAdminPanel } from './adminPanel.js?v=264';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=258';
import { on, EVENTS } from '../shared/eventBus.js?v=255';
