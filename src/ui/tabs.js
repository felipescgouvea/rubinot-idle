...
import { renderTasksPanel } from './tasksPanel.js?v=340';
import { renderSpellsPanel } from './spellsPanel.js?v=248';
import { renderSkillsPanel } from './skillsPanel.js?v=334';
import { renderArenaPanel } from './arenaPanel.js?v=333';
import { renderWorldsPanel } from './worldsPanel.js?v=332';
import { renderBattlePassPanel } from './battlePassPanel.js?v=332';
import { renderRtcPanel } from './rtcPanel.js?v=367';
import { renderShopPanel } from './shopPanel.js?v=340';
import { renderMarketPanel } from './marketPanel.js?v=336';
import { renderHighscoresPanel } from './highscoresPanel.js?v=337';
import { renderBossRushPanel } from './bossRushPanel.js?v=338';
import { renderBestiaryTab } from './bestiaryPanel.js?v=338';
import { renderTrainingSection } from './trainingPanel.js?v=341';
import { renderImbuePanel } from './imbuementPanel.js?v=332';
import { renderAdminPanel } from './adminPanel.js?v=342';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=336';
