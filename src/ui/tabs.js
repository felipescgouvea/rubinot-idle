...
import { renderTasksPanel } from './tasksPanel.js?v=339';
import { renderSpellsPanel } from './spellsPanel.js?v=247';
import { renderSkillsPanel } from './skillsPanel.js?v=333';
import { renderArenaPanel } from './arenaPanel.js?v=332';
import { renderWorldsPanel } from './worldsPanel.js?v=331';
import { renderBattlePassPanel } from './battlePassPanel.js?v=331';
import { renderRtcPanel } from './rtcPanel.js?v=366';
import { renderShopPanel } from './shopPanel.js?v=339';
import { renderMarketPanel } from './marketPanel.js?v=335';
import { renderHighscoresPanel } from './highscoresPanel.js?v=336';
import { renderBossRushPanel } from './bossRushPanel.js?v=337';
import { renderBestiaryTab } from './bestiaryPanel.js?v=337';
import { renderTrainingSection } from './trainingPanel.js?v=340';
import { renderImbuePanel } from './imbuementPanel.js?v=331';
import { renderAdminPanel } from './adminPanel.js?v=341';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=335';
