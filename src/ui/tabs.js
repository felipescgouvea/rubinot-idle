...
import { renderTasksPanel } from './tasksPanel.js?v=159';
import { renderSkillsPanel } from './skillsPanel.js?v=153';
import { renderArenaPanel } from './arenaPanel.js?v=152';
import { renderWorldsPanel } from './worldsPanel.js?v=151';
import { renderBattlePassPanel } from './battlePassPanel.js?v=151';
import { renderRtcPanel } from './rtcPanel.js?v=186';
import { renderShopPanel } from './shopPanel.js?v=159';
import { renderMarketPanel } from './marketPanel.js?v=155';
import { renderHighscoresPanel } from './highscoresPanel.js?v=156';
import { renderBossRushPanel } from './bossRushPanel.js?v=157';
import { renderBestiaryTab } from './bestiaryPanel.js?v=157';
import { renderTrainingSection } from './trainingPanel.js?v=160';
import { renderAdminPanel } from './adminPanel.js?v=161';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=155';
import { on, EVENTS } from '../shared/eventBus.js?v=152';
