...
import { renderTasksPanel } from './tasksPanel.js?v=211';
import { renderSpellsPanel } from './spellsPanel.js?v=118';
import { renderSkillsPanel } from './skillsPanel.js?v=205';
import { renderArenaPanel } from './arenaPanel.js?v=204';
import { renderWorldsPanel } from './worldsPanel.js?v=203';
import { renderBattlePassPanel } from './battlePassPanel.js?v=203';
import { renderRtcPanel } from './rtcPanel.js?v=238';
import { renderShopPanel } from './shopPanel.js?v=211';
import { renderMarketPanel } from './marketPanel.js?v=207';
import { renderHighscoresPanel } from './highscoresPanel.js?v=208';
import { renderBossRushPanel } from './bossRushPanel.js?v=209';
import { renderBestiaryTab } from './bestiaryPanel.js?v=209';
import { renderTrainingSection } from './trainingPanel.js?v=212';
import { renderAdminPanel } from './adminPanel.js?v=213';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=207';
