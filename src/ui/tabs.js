...
import { renderTasksPanel } from './tasksPanel.js?v=44';
import { renderSkillsPanel } from './skillsPanel.js?v=44';
import { renderArenaPanel } from './arenaPanel.js?v=44';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=44';
import { renderWorldsPanel } from './worldsPanel.js?v=44';
import { renderBattlePassPanel } from './battlePassPanel.js?v=44';
import { renderRtcPanel } from './rtcPanel.js?v=44';
import { renderShopPanel } from './shopPanel.js?v=44';
import { renderMarketPanel } from './marketPanel.js?v=44';
import { renderHighscoresPanel } from './highscoresPanel.js?v=44';
import { renderBossRushPanel } from './bossRushPanel.js?v=44';
import { renderBestiaryTab } from './bestiaryPanel.js?v=44';
import { renderTrainingSection } from './trainingPanel.js?v=44';
