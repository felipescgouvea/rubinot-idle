...
import { renderTasksPanel } from './tasksPanel.js?v=108';
import { renderSkillsPanel } from './skillsPanel.js?v=108';
import { renderArenaPanel } from './arenaPanel.js?v=108';
import { renderWorldsPanel } from './worldsPanel.js?v=108';
import { renderBattlePassPanel } from './battlePassPanel.js?v=108';
import { renderRtcPanel } from './rtcPanel.js?v=108';
import { renderShopPanel } from './shopPanel.js?v=108';
import { renderMarketPanel } from './marketPanel.js?v=108';
import { renderHighscoresPanel } from './highscoresPanel.js?v=108';
import { renderBossRushPanel } from './bossRushPanel.js?v=108';
import { renderBestiaryTab } from './bestiaryPanel.js?v=108';
import { renderTrainingSection } from './trainingPanel.js?v=108';
import { renderAdminPanel } from './adminPanel.js?v=108';
import { isMarketEnabled } from '../application/adminUseCases.js?v=108';
