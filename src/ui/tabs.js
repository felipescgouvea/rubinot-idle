...
import { renderTasksPanel } from './tasksPanel.js?v=41';
import { renderSkillsPanel } from './skillsPanel.js?v=41';
import { renderArenaPanel } from './arenaPanel.js?v=41';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=41';
import { renderWorldsPanel } from './worldsPanel.js?v=41';
import { renderBattlePassPanel } from './battlePassPanel.js?v=41';
import { renderRtcPanel } from './rtcPanel.js?v=41';
import { renderShopPanel } from './shopPanel.js?v=41';
import { renderMarketPanel } from './marketPanel.js?v=41';
import { renderHighscoresPanel } from './highscoresPanel.js?v=41';
import { renderBossRushPanel } from './bossRushPanel.js?v=41';
import { renderBestiaryTab } from './bestiaryPanel.js?v=41';
import { renderTrainingSection } from './trainingPanel.js?v=41';
