...
import { renderTasksPanel } from './tasksPanel.js?v=160';
import { renderSkillsPanel } from './skillsPanel.js?v=154';
import { renderArenaPanel } from './arenaPanel.js?v=153';
import { renderWorldsPanel } from './worldsPanel.js?v=152';
import { renderBattlePassPanel } from './battlePassPanel.js?v=152';
import { renderRtcPanel } from './rtcPanel.js?v=187';
import { renderShopPanel } from './shopPanel.js?v=160';
import { renderMarketPanel } from './marketPanel.js?v=156';
import { renderHighscoresPanel } from './highscoresPanel.js?v=157';
import { renderBossRushPanel } from './bossRushPanel.js?v=158';
import { renderBestiaryTab } from './bestiaryPanel.js?v=158';
import { renderTrainingSection } from './trainingPanel.js?v=161';
import { renderAdminPanel } from './adminPanel.js?v=162';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=156';
import { on, EVENTS } from '../shared/eventBus.js?v=153';
