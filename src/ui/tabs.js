...
import { renderTasksPanel } from './tasksPanel.js?v=166';
import { renderSkillsPanel } from './skillsPanel.js?v=160';
import { renderArenaPanel } from './arenaPanel.js?v=159';
import { renderWorldsPanel } from './worldsPanel.js?v=158';
import { renderBattlePassPanel } from './battlePassPanel.js?v=158';
import { renderRtcPanel } from './rtcPanel.js?v=193';
import { renderShopPanel } from './shopPanel.js?v=166';
import { renderMarketPanel } from './marketPanel.js?v=162';
import { renderHighscoresPanel } from './highscoresPanel.js?v=163';
import { renderBossRushPanel } from './bossRushPanel.js?v=164';
import { renderBestiaryTab } from './bestiaryPanel.js?v=164';
import { renderTrainingSection } from './trainingPanel.js?v=167';
import { renderAdminPanel } from './adminPanel.js?v=168';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=162';
import { on, EVENTS } from '../shared/eventBus.js?v=159';
