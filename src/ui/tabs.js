...
import { renderTasksPanel } from './tasksPanel.js?v=123';
import { renderSkillsPanel } from './skillsPanel.js?v=123';
import { renderArenaPanel } from './arenaPanel.js?v=123';
import { renderWorldsPanel } from './worldsPanel.js?v=123';
import { renderBattlePassPanel } from './battlePassPanel.js?v=123';
import { renderRtcPanel } from './rtcPanel.js?v=123';
import { renderShopPanel } from './shopPanel.js?v=123';
import { renderMarketPanel } from './marketPanel.js?v=123';
import { renderHighscoresPanel } from './highscoresPanel.js?v=123';
import { renderBossRushPanel } from './bossRushPanel.js?v=123';
import { renderBestiaryTab } from './bestiaryPanel.js?v=123';
import { renderTrainingSection } from './trainingPanel.js?v=123';
import { renderAdminPanel } from './adminPanel.js?v=123';
import { isMarketEnabled } from '../application/adminUseCases.js?v=123';
