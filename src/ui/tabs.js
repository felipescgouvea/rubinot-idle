...
import { renderTasksPanel } from './tasksPanel.js?v=82';
import { renderSkillsPanel } from './skillsPanel.js?v=82';
import { renderArenaPanel } from './arenaPanel.js?v=82';
import { renderInventory, renderRelics } from './inventoryAndEquipmentPanel.js?v=82';
import { renderWorldsPanel } from './worldsPanel.js?v=82';
import { renderBattlePassPanel } from './battlePassPanel.js?v=82';
import { renderRtcPanel } from './rtcPanel.js?v=82';
import { renderShopPanel } from './shopPanel.js?v=82';
import { renderMarketPanel } from './marketPanel.js?v=82';
import { renderHighscoresPanel } from './highscoresPanel.js?v=82';
import { renderBossRushPanel } from './bossRushPanel.js?v=82';
import { renderBestiaryTab } from './bestiaryPanel.js?v=82';
import { renderTrainingSection } from './trainingPanel.js?v=82';
import { renderAdminPanel } from './adminPanel.js?v=82';
import { isMarketEnabled } from '../application/adminUseCases.js?v=82';
