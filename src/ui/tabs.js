...
import { renderTasksPanel } from './tasksPanel.js?v=245';
import { renderSpellsPanel } from './spellsPanel.js?v=152';
import { renderSkillsPanel } from './skillsPanel.js?v=239';
import { renderArenaPanel } from './arenaPanel.js?v=238';
import { renderWorldsPanel } from './worldsPanel.js?v=237';
import { renderBattlePassPanel } from './battlePassPanel.js?v=237';
import { renderRtcPanel } from './rtcPanel.js?v=272';
import { renderShopPanel } from './shopPanel.js?v=245';
import { renderMarketPanel } from './marketPanel.js?v=241';
import { renderHighscoresPanel } from './highscoresPanel.js?v=242';
import { renderBossRushPanel } from './bossRushPanel.js?v=243';
import { renderBestiaryTab } from './bestiaryPanel.js?v=243';
import { renderTrainingSection } from './trainingPanel.js?v=246';
import { renderAdminPanel } from './adminPanel.js?v=247';
import { isMarketEnabled, isAdminUser } from '../application/adminUseCases.js?v=241';
import { on, EVENTS } from '../shared/eventBus.js?v=238';
