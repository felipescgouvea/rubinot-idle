...
import { renderTasksPanel } from './tasksPanel.js?v=100';
import { renderSkillsPanel } from './skillsPanel.js?v=100';
import { renderArenaPanel } from './arenaPanel.js?v=100';
import { renderWorldsPanel } from './worldsPanel.js?v=100';
import { renderBattlePassPanel } from './battlePassPanel.js?v=100';
import { renderRtcPanel } from './rtcPanel.js?v=100';
import { renderShopPanel } from './shopPanel.js?v=100';
import { renderMarketPanel } from './marketPanel.js?v=100';
import { renderHighscoresPanel } from './highscoresPanel.js?v=100';
import { renderBossRushPanel } from './bossRushPanel.js?v=100';
import { renderBestiaryTab } from './bestiaryPanel.js?v=100';
import { renderTrainingSection } from './trainingPanel.js?v=100';
import { renderAdminPanel } from './adminPanel.js?v=100';
import { isMarketEnabled } from '../application/adminUseCases.js?v=100';
