...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=289';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=289';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=289';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=289';
import { on, EVENTS } from '../shared/eventBus.js?v=291';
import { openModal, rubiniIconImg } from './shared.js?v=296';
