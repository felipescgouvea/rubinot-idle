...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=290';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=290';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=290';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=290';
import { on, EVENTS } from '../shared/eventBus.js?v=292';
import { openModal, rubiniIconImg } from './shared.js?v=297';
