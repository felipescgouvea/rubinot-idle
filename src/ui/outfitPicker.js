...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=345';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=345';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=345';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=345';
import { on, EVENTS } from '../shared/eventBus.js?v=347';
import { openModal, rubiniIconImg } from './shared.js?v=352';
