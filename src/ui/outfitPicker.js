...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=280';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=280';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=280';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=280';
import { on, EVENTS } from '../shared/eventBus.js?v=282';
import { openModal, rubiniIconImg } from './shared.js?v=287';
