...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=140';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=140';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=140';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=140';
import { on, EVENTS } from '../shared/eventBus.js?v=142';
import { openModal, rubiniIconImg } from './shared.js?v=147';
