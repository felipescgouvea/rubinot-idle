...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=174';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=174';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=174';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=174';
import { on, EVENTS } from '../shared/eventBus.js?v=176';
import { openModal, rubiniIconImg } from './shared.js?v=181';
