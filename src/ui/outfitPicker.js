...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=117';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=117';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=117';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=117';
import { on, EVENTS } from '../shared/eventBus.js?v=117';
import { openModal, rubiniIconImg } from './shared.js?v=117';
