...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=146';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=146';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=146';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=146';
import { on, EVENTS } from '../shared/eventBus.js?v=148';
import { openModal, rubiniIconImg } from './shared.js?v=153';
