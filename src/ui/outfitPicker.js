...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=251';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=251';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=251';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=251';
import { on, EVENTS } from '../shared/eventBus.js?v=253';
import { openModal, rubiniIconImg } from './shared.js?v=258';
