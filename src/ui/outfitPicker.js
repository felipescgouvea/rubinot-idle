...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=255';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=255';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=255';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=255';
import { on, EVENTS } from '../shared/eventBus.js?v=257';
import { openModal, rubiniIconImg } from './shared.js?v=262';
