...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=246';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=246';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=246';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=246';
import { on, EVENTS } from '../shared/eventBus.js?v=248';
import { openModal, rubiniIconImg } from './shared.js?v=253';
