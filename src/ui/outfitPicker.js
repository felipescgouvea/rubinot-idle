...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=347';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=347';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=347';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=347';
import { on, EVENTS } from '../shared/eventBus.js?v=349';
import { openModal, rubiniIconImg } from './shared.js?v=354';
