...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=213';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=213';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=213';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=213';
import { on, EVENTS } from '../shared/eventBus.js?v=215';
import { openModal, rubiniIconImg } from './shared.js?v=220';
