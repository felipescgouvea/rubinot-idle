...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=175';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=175';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=175';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=175';
import { on, EVENTS } from '../shared/eventBus.js?v=177';
import { openModal, rubiniIconImg } from './shared.js?v=182';
