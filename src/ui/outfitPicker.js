...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=237';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=237';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=237';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=237';
import { on, EVENTS } from '../shared/eventBus.js?v=239';
import { openModal, rubiniIconImg } from './shared.js?v=244';
