...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=236';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=236';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=236';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=236';
import { on, EVENTS } from '../shared/eventBus.js?v=238';
import { openModal, rubiniIconImg } from './shared.js?v=243';
