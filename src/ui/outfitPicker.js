...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=334';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=334';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=334';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=334';
import { on, EVENTS } from '../shared/eventBus.js?v=336';
import { openModal, rubiniIconImg } from './shared.js?v=341';
