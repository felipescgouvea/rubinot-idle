...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=247';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=247';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=247';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=247';
import { on, EVENTS } from '../shared/eventBus.js?v=249';
import { openModal, rubiniIconImg } from './shared.js?v=254';
