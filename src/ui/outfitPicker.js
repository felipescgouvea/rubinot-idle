...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=259';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=259';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=259';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=259';
import { on, EVENTS } from '../shared/eventBus.js?v=261';
import { openModal, rubiniIconImg } from './shared.js?v=266';
