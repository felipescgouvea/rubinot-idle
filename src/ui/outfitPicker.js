...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=38';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=38';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=38';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=38';
import { on, EVENTS } from '../shared/eventBus.js?v=38';
import { openModal, rubiniIconImg } from './shared.js?v=38';
