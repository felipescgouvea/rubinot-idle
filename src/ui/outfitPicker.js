...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=270';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=270';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=270';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=270';
import { on, EVENTS } from '../shared/eventBus.js?v=272';
import { openModal, rubiniIconImg } from './shared.js?v=277';
