...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=208';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=208';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=208';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=208';
import { on, EVENTS } from '../shared/eventBus.js?v=210';
import { openModal, rubiniIconImg } from './shared.js?v=215';
