...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=154';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=154';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=154';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=154';
import { on, EVENTS } from '../shared/eventBus.js?v=156';
import { openModal, rubiniIconImg } from './shared.js?v=161';
