...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=23';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=23';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=23';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=23';
import { on, EVENTS } from '../shared/eventBus.js?v=23';
import { openModal } from './shared.js?v=23';
