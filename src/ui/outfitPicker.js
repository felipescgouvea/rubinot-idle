...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=188';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=188';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=188';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=188';
import { on, EVENTS } from '../shared/eventBus.js?v=190';
import { openModal, rubiniIconImg } from './shared.js?v=195';
