...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=173';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=173';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=173';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=173';
import { on, EVENTS } from '../shared/eventBus.js?v=175';
import { openModal, rubiniIconImg } from './shared.js?v=180';
