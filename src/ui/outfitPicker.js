...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=338';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=338';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=338';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=338';
import { on, EVENTS } from '../shared/eventBus.js?v=340';
import { openModal, rubiniIconImg } from './shared.js?v=345';
