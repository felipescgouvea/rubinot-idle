...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=153';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=153';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=153';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=153';
import { on, EVENTS } from '../shared/eventBus.js?v=155';
import { openModal, rubiniIconImg } from './shared.js?v=160';
