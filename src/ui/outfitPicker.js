...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=168';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=168';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=168';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=168';
import { on, EVENTS } from '../shared/eventBus.js?v=170';
import { openModal, rubiniIconImg } from './shared.js?v=175';
