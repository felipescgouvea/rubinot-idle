...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=127';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=127';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=127';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=127';
import { on, EVENTS } from '../shared/eventBus.js?v=129';
import { openModal, rubiniIconImg } from './shared.js?v=134';
