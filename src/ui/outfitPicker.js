...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=359';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=359';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=359';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=359';
import { on, EVENTS } from '../shared/eventBus.js?v=361';
import { openModal, rubiniIconImg } from './shared.js?v=366';
