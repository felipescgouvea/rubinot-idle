...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=183';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=183';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=183';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=183';
import { on, EVENTS } from '../shared/eventBus.js?v=185';
import { openModal, rubiniIconImg } from './shared.js?v=190';
