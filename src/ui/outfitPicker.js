...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=134';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=134';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=134';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=134';
import { on, EVENTS } from '../shared/eventBus.js?v=136';
import { openModal, rubiniIconImg } from './shared.js?v=141';
