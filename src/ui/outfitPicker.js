...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=235';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=235';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=235';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=235';
import { on, EVENTS } from '../shared/eventBus.js?v=237';
import { openModal, rubiniIconImg } from './shared.js?v=242';
