...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=269';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=269';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=269';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=269';
import { on, EVENTS } from '../shared/eventBus.js?v=271';
import { openModal, rubiniIconImg } from './shared.js?v=276';
