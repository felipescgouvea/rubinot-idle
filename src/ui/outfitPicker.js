...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=190';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=190';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=190';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=190';
import { on, EVENTS } from '../shared/eventBus.js?v=192';
import { openModal, rubiniIconImg } from './shared.js?v=197';
