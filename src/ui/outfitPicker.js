...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=313';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=313';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=313';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=313';
import { on, EVENTS } from '../shared/eventBus.js?v=315';
import { openModal, rubiniIconImg } from './shared.js?v=320';
