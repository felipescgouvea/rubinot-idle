...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=308';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=308';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=308';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=308';
import { on, EVENTS } from '../shared/eventBus.js?v=310';
import { openModal, rubiniIconImg } from './shared.js?v=315';
