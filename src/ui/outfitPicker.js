...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=138';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=138';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=138';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=138';
import { on, EVENTS } from '../shared/eventBus.js?v=140';
import { openModal, rubiniIconImg } from './shared.js?v=145';
