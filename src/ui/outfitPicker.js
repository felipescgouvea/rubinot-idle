...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=212';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=212';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=212';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=212';
import { on, EVENTS } from '../shared/eventBus.js?v=214';
import { openModal, rubiniIconImg } from './shared.js?v=219';
