...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=316';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=316';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=316';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=316';
import { on, EVENTS } from '../shared/eventBus.js?v=318';
import { openModal, rubiniIconImg } from './shared.js?v=323';
