...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=222';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=222';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=222';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=222';
import { on, EVENTS } from '../shared/eventBus.js?v=224';
import { openModal, rubiniIconImg } from './shared.js?v=229';
