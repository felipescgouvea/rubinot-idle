...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=314';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=314';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=314';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=314';
import { on, EVENTS } from '../shared/eventBus.js?v=316';
import { openModal, rubiniIconImg } from './shared.js?v=321';
