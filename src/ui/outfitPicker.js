...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=319';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=319';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=319';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=319';
import { on, EVENTS } from '../shared/eventBus.js?v=321';
import { openModal, rubiniIconImg } from './shared.js?v=326';
