...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=249';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=249';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=249';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=249';
import { on, EVENTS } from '../shared/eventBus.js?v=251';
import { openModal, rubiniIconImg } from './shared.js?v=256';
