...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=162';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=162';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=162';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=162';
import { on, EVENTS } from '../shared/eventBus.js?v=164';
import { openModal, rubiniIconImg } from './shared.js?v=169';
