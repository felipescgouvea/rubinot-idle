...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=317';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=317';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=317';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=317';
import { on, EVENTS } from '../shared/eventBus.js?v=319';
import { openModal, rubiniIconImg } from './shared.js?v=324';
