...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=76';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=76';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=76';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=76';
import { on, EVENTS } from '../shared/eventBus.js?v=76';
import { openModal, rubiniIconImg } from './shared.js?v=76';
