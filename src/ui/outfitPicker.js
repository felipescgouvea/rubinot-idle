...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=281';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=281';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=281';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=281';
import { on, EVENTS } from '../shared/eventBus.js?v=283';
import { openModal, rubiniIconImg } from './shared.js?v=288';
