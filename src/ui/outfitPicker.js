...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=15';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=15';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=15';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=15';
import { on, EVENTS } from '../shared/eventBus.js?v=15';
import { openModal } from './shared.js?v=15';
