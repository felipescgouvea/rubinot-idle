...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=145';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=145';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=145';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=145';
import { on, EVENTS } from '../shared/eventBus.js?v=147';
import { openModal, rubiniIconImg } from './shared.js?v=152';
