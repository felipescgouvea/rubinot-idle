...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=158';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=158';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=158';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=158';
import { on, EVENTS } from '../shared/eventBus.js?v=160';
import { openModal, rubiniIconImg } from './shared.js?v=165';
