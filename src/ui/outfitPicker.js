...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=99';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=99';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=99';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=99';
import { on, EVENTS } from '../shared/eventBus.js?v=99';
import { openModal, rubiniIconImg } from './shared.js?v=99';
