...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=193';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=193';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=193';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=193';
import { on, EVENTS } from '../shared/eventBus.js?v=195';
import { openModal, rubiniIconImg } from './shared.js?v=200';
