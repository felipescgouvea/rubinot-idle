...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=214';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=214';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=214';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=214';
import { on, EVENTS } from '../shared/eventBus.js?v=216';
import { openModal, rubiniIconImg } from './shared.js?v=221';
