...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=241';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=241';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=241';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=241';
import { on, EVENTS } from '../shared/eventBus.js?v=243';
import { openModal, rubiniIconImg } from './shared.js?v=248';
