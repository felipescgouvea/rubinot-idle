...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=159';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=159';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=159';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=159';
import { on, EVENTS } from '../shared/eventBus.js?v=161';
import { openModal, rubiniIconImg } from './shared.js?v=166';
