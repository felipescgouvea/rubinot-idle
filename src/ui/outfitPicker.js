...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=333';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=333';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=333';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=333';
import { on, EVENTS } from '../shared/eventBus.js?v=335';
import { openModal, rubiniIconImg } from './shared.js?v=340';
