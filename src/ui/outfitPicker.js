...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=303';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=303';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=303';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=303';
import { on, EVENTS } from '../shared/eventBus.js?v=305';
import { openModal, rubiniIconImg } from './shared.js?v=310';
