...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=243';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=243';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=243';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=243';
import { on, EVENTS } from '../shared/eventBus.js?v=245';
import { openModal, rubiniIconImg } from './shared.js?v=250';
