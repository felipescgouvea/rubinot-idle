...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=293';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=293';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=293';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=293';
import { on, EVENTS } from '../shared/eventBus.js?v=295';
import { openModal, rubiniIconImg } from './shared.js?v=300';
