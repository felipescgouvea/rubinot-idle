...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=349';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=349';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=349';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=349';
import { on, EVENTS } from '../shared/eventBus.js?v=351';
import { openModal, rubiniIconImg } from './shared.js?v=356';
