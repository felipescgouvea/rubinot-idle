...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=344';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=344';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=344';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=344';
import { on, EVENTS } from '../shared/eventBus.js?v=346';
import { openModal, rubiniIconImg } from './shared.js?v=351';
