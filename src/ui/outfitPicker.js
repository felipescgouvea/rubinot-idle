...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=171';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=171';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=171';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=171';
import { on, EVENTS } from '../shared/eventBus.js?v=173';
import { openModal, rubiniIconImg } from './shared.js?v=178';
