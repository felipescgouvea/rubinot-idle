...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=339';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=339';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=339';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=339';
import { on, EVENTS } from '../shared/eventBus.js?v=341';
import { openModal, rubiniIconImg } from './shared.js?v=346';
