...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=215';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=215';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=215';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=215';
import { on, EVENTS } from '../shared/eventBus.js?v=217';
import { openModal, rubiniIconImg } from './shared.js?v=222';
