...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=229';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=229';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=229';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=229';
import { on, EVENTS } from '../shared/eventBus.js?v=231';
import { openModal, rubiniIconImg } from './shared.js?v=236';
