...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=274';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=274';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=274';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=274';
import { on, EVENTS } from '../shared/eventBus.js?v=276';
import { openModal, rubiniIconImg } from './shared.js?v=281';
