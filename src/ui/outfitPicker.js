...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=186';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=186';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=186';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=186';
import { on, EVENTS } from '../shared/eventBus.js?v=188';
import { openModal, rubiniIconImg } from './shared.js?v=193';
