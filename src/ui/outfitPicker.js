...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=163';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=163';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=163';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=163';
import { on, EVENTS } from '../shared/eventBus.js?v=165';
import { openModal, rubiniIconImg } from './shared.js?v=170';
