...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=31';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=31';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=31';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=31';
import { on, EVENTS } from '../shared/eventBus.js?v=31';
import { openModal, rubiniIconImg } from './shared.js?v=31';
