...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=139';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=139';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=139';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=139';
import { on, EVENTS } from '../shared/eventBus.js?v=141';
import { openModal, rubiniIconImg } from './shared.js?v=146';
