...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=185';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=185';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=185';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=185';
import { on, EVENTS } from '../shared/eventBus.js?v=187';
import { openModal, rubiniIconImg } from './shared.js?v=192';
