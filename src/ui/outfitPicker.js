...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=26';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=26';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=26';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=26';
import { on, EVENTS } from '../shared/eventBus.js?v=26';
import { openModal } from './shared.js?v=26';
