...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=97';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=97';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=97';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=97';
import { on, EVENTS } from '../shared/eventBus.js?v=97';
import { openModal, rubiniIconImg } from './shared.js?v=97';
