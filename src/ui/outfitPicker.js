...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=221';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=221';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=221';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=221';
import { on, EVENTS } from '../shared/eventBus.js?v=223';
import { openModal, rubiniIconImg } from './shared.js?v=228';
