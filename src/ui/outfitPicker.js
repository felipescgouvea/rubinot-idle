...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=228';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=228';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=228';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=228';
import { on, EVENTS } from '../shared/eventBus.js?v=230';
import { openModal, rubiniIconImg } from './shared.js?v=235';
