...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=291';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=291';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=291';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=291';
import { on, EVENTS } from '../shared/eventBus.js?v=293';
import { openModal, rubiniIconImg } from './shared.js?v=298';
