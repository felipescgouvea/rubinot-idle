...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=71';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=71';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=71';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=71';
import { on, EVENTS } from '../shared/eventBus.js?v=71';
import { openModal, rubiniIconImg } from './shared.js?v=71';
