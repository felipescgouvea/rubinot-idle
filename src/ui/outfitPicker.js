...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=209';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=209';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=209';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=209';
import { on, EVENTS } from '../shared/eventBus.js?v=211';
import { openModal, rubiniIconImg } from './shared.js?v=216';
