...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=201';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=201';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=201';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=201';
import { on, EVENTS } from '../shared/eventBus.js?v=203';
import { openModal, rubiniIconImg } from './shared.js?v=208';
