...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=192';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=192';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=192';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=192';
import { on, EVENTS } from '../shared/eventBus.js?v=194';
import { openModal, rubiniIconImg } from './shared.js?v=199';
