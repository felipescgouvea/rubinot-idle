...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=184';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=184';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=184';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=184';
import { on, EVENTS } from '../shared/eventBus.js?v=186';
import { openModal, rubiniIconImg } from './shared.js?v=191';
