...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=220';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=220';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=220';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=220';
import { on, EVENTS } from '../shared/eventBus.js?v=222';
import { openModal, rubiniIconImg } from './shared.js?v=227';
