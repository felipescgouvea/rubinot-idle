...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=325';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=325';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=325';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=325';
import { on, EVENTS } from '../shared/eventBus.js?v=327';
import { openModal, rubiniIconImg } from './shared.js?v=332';
