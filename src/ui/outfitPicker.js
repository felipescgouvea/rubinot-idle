...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=248';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=248';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=248';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=248';
import { on, EVENTS } from '../shared/eventBus.js?v=250';
import { openModal, rubiniIconImg } from './shared.js?v=255';
