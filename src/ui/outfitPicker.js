...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=312';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=312';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=312';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=312';
import { on, EVENTS } from '../shared/eventBus.js?v=314';
import { openModal, rubiniIconImg } from './shared.js?v=319';
