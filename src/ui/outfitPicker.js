...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=240';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=240';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=240';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=240';
import { on, EVENTS } from '../shared/eventBus.js?v=242';
import { openModal, rubiniIconImg } from './shared.js?v=247';
