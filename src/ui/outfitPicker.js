...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=300';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=300';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=300';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=300';
import { on, EVENTS } from '../shared/eventBus.js?v=302';
import { openModal, rubiniIconImg } from './shared.js?v=307';
