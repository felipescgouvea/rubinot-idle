...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=179';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=179';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=179';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=179';
import { on, EVENTS } from '../shared/eventBus.js?v=181';
import { openModal, rubiniIconImg } from './shared.js?v=186';
