...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=141';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=141';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=141';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=141';
import { on, EVENTS } from '../shared/eventBus.js?v=143';
import { openModal, rubiniIconImg } from './shared.js?v=148';
