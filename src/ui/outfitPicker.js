...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=130';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=130';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=130';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=130';
import { on, EVENTS } from '../shared/eventBus.js?v=132';
import { openModal, rubiniIconImg } from './shared.js?v=137';
