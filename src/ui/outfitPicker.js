...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=283';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=283';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=283';
import { renderOutfitToCanvas } from '../infrastructure/outfitRenderer.js?v=283';
import { on, EVENTS } from '../shared/eventBus.js?v=285';
import { openModal, rubiniIconImg } from './shared.js?v=290';
