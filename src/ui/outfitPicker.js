...
import { OUTFITS, VOCATION_DEFAULT_OUTFIT } from '../domain/outfits.js?v=254';
import { TIBIA_COLOR_PALETTE } from '../domain/outfitColors.js?v=254';
import { outfitAssetPath } from '../infrastructure/outfitAssets.js?v=254';
