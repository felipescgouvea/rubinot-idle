...
import { MONSTERS } from '../domain/bestiary.js?v=139';
import {
...
import { openModal, closeModal, charmPointsIconImg } from './shared.js?v=131';
import { monsterSpriteImg } from './huntPanel.js?v=136';
