...
import { monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=13';
import { on, EVENTS } from '../shared/eventBus.js?v=13';
import { openModal, itemIconImg } from './shared.js?v=13';
import { getCurrentMonster } from '../application/huntUseCases.js?v=13';
