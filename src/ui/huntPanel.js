...
import { ZONES, isZoneUnlocked, boostedZoneForDate } from '../domain/bestiary.js?v=258';
import { MONSTERS } from '../domain/bestiary.js?v=258';
import { XP_TABLE } from '../domain/character.js?v=267';
import { cityName } from '../domain/cities.js?v=243';
import { ITEMS } from '../domain/items.js?v=251';
import { monsterSpriteFile, spriteUrl, effectSpriteFile, missileSpriteFile, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=241';
import { areaMaxTargets } from '../domain/attackAreas.js?v=236';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=238';
import { openModal, itemIconImg, vitalIconImg, goldIconImg, formatNum, applyHpState, hpStateClass } from './shared.js?v=243';
import { uiIcon, huntToggleIcon } from './uiIcons.js?v=241';
import { getCurrentMonster, getCurrentPack, getRecentDead, getHuntStats, isBossOnlyHunt } from '../application/huntUseCases.js?v=304';
import { MAX_BLESSINGS, blessingCost, deathXpLossPct, reviveHpPct } from '../domain/blessings.js?v=236';
import { getProjectileSpeedMs } from '../application/adminUseCases.js?v=241';
import { t } from '../i18n/i18n.js?v=254';
import { setStageWalking } from './stageWalk.js?v=77';
...
export function playAreaEffect({ effect, shape, targetUid } = {}) {
  ...
  if (shape === 'single' || !shape) {
    const alvoEl = (targetUid && cont && cont.querySelector(`[data-uid="${CSS.escape(String(targetUid))}"]`)) || (cont && cont.firstElementChild);
