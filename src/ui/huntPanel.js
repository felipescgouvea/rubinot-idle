...
import { monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=24';
import { on, EVENTS } from '../shared/eventBus.js?v=24';
import { openModal, itemIconImg } from './shared.js?v=24';
import { getCurrentMonster } from '../application/huntUseCases.js?v=24';
