...
import { monsterSpriteFile, spriteUrl, effectSpriteFile, missileSpriteFile, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=295';
import { areaMaxTargets } from '../domain/attackAreas.js?v=290';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=292';
import { openModal, itemIconImg, vitalIconImg, goldIconImg, formatNum, applyHpState, hpStateClass } from './shared.js?v=297';
import { uiIcon, huntToggleIcon } from './uiIcons.js?v=295';
import { getCurrentMonster, getCurrentPack, getRecentDead, getHuntStats, isBossOnlyHunt } from '../application/huntUseCases.js?v=358';
import { MAX_BLESSINGS, blessingCost, deathXpLossPct, reviveHpPct } from '../domain/blessings.js?v=290';
import { getProjectileSpeedMs } from '../application/adminUseCases.js?v=295';
import { t } from '../i18n/i18n.js?v=310';
import { setStageWalking } from './stageWalk.js?v=131';
