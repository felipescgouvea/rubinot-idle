...
import { monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=11';
import { on, EVENTS } from '../shared/eventBus.js?v=11';
import { openModal, itemIconImg } from './shared.js?v=11';
import { getCurrentMonster } from '../application/huntUseCases.js?v=11';
