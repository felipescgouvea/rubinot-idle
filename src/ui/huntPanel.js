...
import { ZONES, isZoneUnlocked, boostedZoneForDate } from '../domain/bestiary.js?v=325';
import { MONSTERS } from '../domain/bestiary.js?v=325';
import { XP_TABLE, MAX_LEVEL } from '../domain/character.js?v=333';
import { cityName } from '../domain/cities.js?v=309';
import { ITEMS } from '../domain/items.js?v=317';
import { monsterSpriteFile, spriteUrl, effectSpriteFile, missileSpriteFile, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=307';
import { areaMaxTargets } from '../domain/attackAreas.js?v=302';
import { on, emit, EVENTS } from '../shared/eventBus.js?v=304';
import { openModal, itemIconImg, vitalIconImg, goldIconImg, formatNum, applyHpState, hpStateClass } from './shared.js?v=309';
import { uiIcon, huntToggleIcon } from './uiIcons.js?v=307';
import { getCurrentMonster, getCurrentPack, getRecentDead, getHuntStats, isBossOnlyHunt } from '../application/huntUseCases.js?v=370';
import { MAX_BLESSINGS, blessingCost, deathXpLossPct, reviveHpPct } from '../domain/blessings.js?v=302';
import { getProjectileSpeedMs } from '../application/adminUseCases.js?v=307';
import { t } from '../i18n/i18n.js?v=322';
import { setStageWalking } from './stageWalk.js?v=143';
...
function updateSceneMode() {
  ...
  if (!stopped) { if (ov) ov.remove(); }
    ...
    ov.innerHTML = `<button class="scene-resume-btn" onclick="toggleHunt()">▶ ${t('hunt.resumeCta')}</button>`;
