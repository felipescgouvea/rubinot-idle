...
import { monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=12';
import { on, EVENTS } from '../shared/eventBus.js?v=12';
import { openModal, itemIconImg } from './shared.js?v=12';
import { getCurrentMonster } from '../application/huntUseCases.js?v=12';
