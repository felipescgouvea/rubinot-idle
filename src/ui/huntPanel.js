...
import { monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=25';
import { on, EVENTS } from '../shared/eventBus.js?v=25';
import { openModal, itemIconImg } from './shared.js?v=25';
import { getCurrentMonster } from '../application/huntUseCases.js?v=25';
