...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=312';
import { on, EVENTS } from '../shared/eventBus.js?v=313';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=318';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=316';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=313';
