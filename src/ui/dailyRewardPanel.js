...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=344';
import { on, EVENTS } from '../shared/eventBus.js?v=345';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=350';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=348';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=345';
import { setTitleFlag } from './notifyTitle.js?v=345';
