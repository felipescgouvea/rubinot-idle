...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=325';
import { on, EVENTS } from '../shared/eventBus.js?v=326';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=331';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=329';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=326';
import { setTitleFlag } from './notifyTitle.js?v=326';
