...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=338';
import { on, EVENTS } from '../shared/eventBus.js?v=339';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=344';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=342';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=339';
import { setTitleFlag } from './notifyTitle.js?v=339';
