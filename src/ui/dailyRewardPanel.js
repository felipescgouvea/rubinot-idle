...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=341';
import { on, EVENTS } from '../shared/eventBus.js?v=342';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=347';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=345';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=342';
import { setTitleFlag } from './notifyTitle.js?v=342';
