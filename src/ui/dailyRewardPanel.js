...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=334';
import { on, EVENTS } from '../shared/eventBus.js?v=335';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=340';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=338';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=335';
import { setTitleFlag } from './notifyTitle.js?v=335';
