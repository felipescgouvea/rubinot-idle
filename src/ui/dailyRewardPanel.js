...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=345';
import { on, EVENTS } from '../shared/eventBus.js?v=346';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=351';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=349';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=346';
import { setTitleFlag } from './notifyTitle.js?v=346';
