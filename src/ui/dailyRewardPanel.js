...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=322';
import { on, EVENTS } from '../shared/eventBus.js?v=323';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=328';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=326';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=323';
import { setTitleFlag } from './notifyTitle.js?v=323';
