...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak, LONG_STREAK_MILESTONE, daysToNextMilestone } from '../domain/dailyReward.js?v=353';
import { on, EVENTS } from '../shared/eventBus.js?v=354';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=359';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=357';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=354';
import { setTitleFlag } from './notifyTitle.js?v=354';
