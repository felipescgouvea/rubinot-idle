...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=316';
import { on, EVENTS } from '../shared/eventBus.js?v=317';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=322';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=320';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=317';
import { setTitleFlag } from './notifyTitle.js?v=317';
