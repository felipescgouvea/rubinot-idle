...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=339';
import { on, EVENTS } from '../shared/eventBus.js?v=340';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=345';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=343';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=340';
import { setTitleFlag } from './notifyTitle.js?v=340';
