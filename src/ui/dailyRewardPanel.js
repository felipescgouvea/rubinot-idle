...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak, LONG_STREAK_MILESTONE, daysToNextMilestone } from '../domain/dailyReward.js?v=355';
import { on, EVENTS } from '../shared/eventBus.js?v=356';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=361';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=359';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=356';
import { setTitleFlag } from './notifyTitle.js?v=356';
