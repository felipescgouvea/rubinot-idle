...
import { DAILY_REWARDS, DAILY_CYCLE, rewardForStreak } from '../domain/dailyReward.js?v=335';
import { on, EVENTS } from '../shared/eventBus.js?v=336';
import { openModal, goldIconImg, rubiniIconImg } from './shared.js?v=341';
import { spriteUrl, spriteImgOrFallback } from '../infrastructure/tibiaSprites.js?v=339';
import { getDailyState, claimDailyReward } from '../application/dailyRewardUseCases.js?v=336';
import { setTitleFlag } from './notifyTitle.js?v=336';
