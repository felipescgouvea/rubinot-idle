...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=252';
import { ITEMS } from '../domain/items.js?v=267';
import { canImbue } from '../application/imbuementUseCases.js?v=252';
import { openModal } from './shared.js?v=259';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=252');
