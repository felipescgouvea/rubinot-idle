...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=233';
import { ITEMS } from '../domain/items.js?v=248';
import { canImbue } from '../application/imbuementUseCases.js?v=233';
import { openModal } from './shared.js?v=240';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=233');
