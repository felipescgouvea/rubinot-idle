...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=170';
import { ITEMS } from '../domain/items.js?v=185';
import { canImbue } from '../application/imbuementUseCases.js?v=170';
import { openModal } from './shared.js?v=177';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=170');
