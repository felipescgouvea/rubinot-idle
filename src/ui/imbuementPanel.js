...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=271';
import { ITEMS } from '../domain/items.js?v=286';
import { canImbue } from '../application/imbuementUseCases.js?v=271';
import { openModal } from './shared.js?v=278';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=271');
