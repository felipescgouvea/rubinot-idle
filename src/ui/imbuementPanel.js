...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=176';
import { ITEMS } from '../domain/items.js?v=191';
import { canImbue } from '../application/imbuementUseCases.js?v=176';
import { openModal } from './shared.js?v=183';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=176');
