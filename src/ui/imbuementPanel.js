...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=330';
import { ITEMS } from '../domain/items.js?v=344';
import { canImbue } from '../application/imbuementUseCases.js?v=329';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=336';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=334';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=329');
