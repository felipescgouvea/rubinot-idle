...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=246';
import { ITEMS } from '../domain/items.js?v=261';
import { canImbue } from '../application/imbuementUseCases.js?v=246';
import { openModal } from './shared.js?v=253';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=246');
