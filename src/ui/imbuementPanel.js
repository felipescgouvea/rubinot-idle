...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=189';
import { ITEMS } from '../domain/items.js?v=204';
import { canImbue } from '../application/imbuementUseCases.js?v=189';
import { openModal } from './shared.js?v=196';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=189');
