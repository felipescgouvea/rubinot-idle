...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=249';
import { ITEMS } from '../domain/items.js?v=264';
import { canImbue } from '../application/imbuementUseCases.js?v=249';
import { openModal } from './shared.js?v=256';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=249');
