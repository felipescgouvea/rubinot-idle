...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=205';
import { ITEMS } from '../domain/items.js?v=220';
import { canImbue } from '../application/imbuementUseCases.js?v=205';
import { openModal } from './shared.js?v=212';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=205');
