...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=149';
import { ITEMS } from '../domain/items.js?v=164';
import { canImbue } from '../application/imbuementUseCases.js?v=149';
import { openModal } from './shared.js?v=156';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=149');
