...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=247';
import { ITEMS } from '../domain/items.js?v=262';
import { canImbue } from '../application/imbuementUseCases.js?v=247';
import { openModal } from './shared.js?v=254';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=247');
