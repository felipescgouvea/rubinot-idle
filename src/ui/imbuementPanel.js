...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=260';
import { ITEMS } from '../domain/items.js?v=275';
import { canImbue } from '../application/imbuementUseCases.js?v=260';
import { openModal } from './shared.js?v=267';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=260');
