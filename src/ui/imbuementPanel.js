...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=192';
import { ITEMS } from '../domain/items.js?v=207';
import { canImbue } from '../application/imbuementUseCases.js?v=192';
import { openModal } from './shared.js?v=199';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=192');
