...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=317';
import { ITEMS } from '../domain/items.js?v=331';
import { canImbue } from '../application/imbuementUseCases.js?v=316';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=323';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=321';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=316');
