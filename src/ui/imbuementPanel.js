...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=298';
import { ITEMS } from '../domain/items.js?v=312';
import { canImbue } from '../application/imbuementUseCases.js?v=297';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=304';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=302';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=297');
