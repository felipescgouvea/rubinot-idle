...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=245';
import { ITEMS } from '../domain/items.js?v=260';
import { canImbue } from '../application/imbuementUseCases.js?v=245';
import { openModal } from './shared.js?v=252';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=245');
