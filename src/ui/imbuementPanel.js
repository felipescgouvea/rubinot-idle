...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=125';
import { ITEMS } from '../domain/items.js?v=140';
import { canImbue } from '../application/imbuementUseCases.js?v=125';
import { openModal } from './shared.js?v=132';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=125');
