...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=255';
import { ITEMS } from '../domain/items.js?v=270';
import { canImbue } from '../application/imbuementUseCases.js?v=255';
import { openModal } from './shared.js?v=262';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=255');
