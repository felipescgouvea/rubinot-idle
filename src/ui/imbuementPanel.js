...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=179';
import { ITEMS } from '../domain/items.js?v=194';
import { canImbue } from '../application/imbuementUseCases.js?v=179';
import { openModal } from './shared.js?v=186';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=179');
