...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=292';
import { ITEMS } from '../domain/items.js?v=306';
import { canImbue } from '../application/imbuementUseCases.js?v=291';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=298';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=296';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=291');
