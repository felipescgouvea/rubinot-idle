...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=210';
import { ITEMS } from '../domain/items.js?v=225';
import { canImbue } from '../application/imbuementUseCases.js?v=210';
import { openModal } from './shared.js?v=217';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=210');
