...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=134';
import { ITEMS } from '../domain/items.js?v=149';
import { canImbue } from '../application/imbuementUseCases.js?v=134';
import { openModal } from './shared.js?v=141';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=134');
