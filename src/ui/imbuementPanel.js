...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=340';
import { ITEMS } from '../domain/items.js?v=354';
import { canImbue } from '../application/imbuementUseCases.js?v=339';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=346';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=344';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=339');
