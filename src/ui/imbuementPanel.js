...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=236';
import { ITEMS } from '../domain/items.js?v=251';
import { canImbue } from '../application/imbuementUseCases.js?v=236';
import { openModal } from './shared.js?v=243';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=236');
