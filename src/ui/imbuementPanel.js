...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=167';
import { ITEMS } from '../domain/items.js?v=182';
import { canImbue } from '../application/imbuementUseCases.js?v=167';
import { openModal } from './shared.js?v=174';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=167');
