...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=279';
import { ITEMS } from '../domain/items.js?v=294';
import { canImbue } from '../application/imbuementUseCases.js?v=279';
import { openModal } from './shared.js?v=286';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=279');
