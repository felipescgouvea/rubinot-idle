...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=206';
import { ITEMS } from '../domain/items.js?v=221';
import { canImbue } from '../application/imbuementUseCases.js?v=206';
import { openModal } from './shared.js?v=213';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=206');
