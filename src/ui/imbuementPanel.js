...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=328';
import { ITEMS } from '../domain/items.js?v=342';
import { canImbue } from '../application/imbuementUseCases.js?v=327';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=334';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=332';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=327');
