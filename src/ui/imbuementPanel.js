...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=235';
import { ITEMS } from '../domain/items.js?v=250';
import { canImbue } from '../application/imbuementUseCases.js?v=235';
import { openModal } from './shared.js?v=242';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=235');
