...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=138';
import { ITEMS } from '../domain/items.js?v=153';
import { canImbue } from '../application/imbuementUseCases.js?v=138';
import { openModal } from './shared.js?v=145';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=138');
