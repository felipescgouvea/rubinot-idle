...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=169';
import { ITEMS } from '../domain/items.js?v=184';
import { canImbue } from '../application/imbuementUseCases.js?v=169';
import { openModal } from './shared.js?v=176';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=169');
