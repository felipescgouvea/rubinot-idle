...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=166';
import { ITEMS } from '../domain/items.js?v=181';
import { canImbue } from '../application/imbuementUseCases.js?v=166';
import { openModal } from './shared.js?v=173';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=166');
