...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=335';
import { ITEMS } from '../domain/items.js?v=349';
import { canImbue } from '../application/imbuementUseCases.js?v=334';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=341';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=339';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=334');
