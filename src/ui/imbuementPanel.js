...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=312';
import { ITEMS } from '../domain/items.js?v=326';
import { canImbue } from '../application/imbuementUseCases.js?v=311';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=318';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=316';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=311');
