...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=244';
import { ITEMS } from '../domain/items.js?v=259';
import { canImbue } from '../application/imbuementUseCases.js?v=244';
import { openModal } from './shared.js?v=251';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=244');
