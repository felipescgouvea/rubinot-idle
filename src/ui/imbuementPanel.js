...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=264';
import { ITEMS } from '../domain/items.js?v=279';
import { canImbue } from '../application/imbuementUseCases.js?v=264';
import { openModal } from './shared.js?v=271';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=264');
