...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=227';
import { ITEMS } from '../domain/items.js?v=242';
import { canImbue } from '../application/imbuementUseCases.js?v=227';
import { openModal } from './shared.js?v=234';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=227');
