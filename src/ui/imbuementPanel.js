...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=294';
import { ITEMS } from '../domain/items.js?v=308';
import { canImbue } from '../application/imbuementUseCases.js?v=293';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=300';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=298';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=293');
