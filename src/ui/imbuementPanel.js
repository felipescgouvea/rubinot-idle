...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=224';
import { ITEMS } from '../domain/items.js?v=239';
import { canImbue } from '../application/imbuementUseCases.js?v=224';
import { openModal } from './shared.js?v=231';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=224');
