...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot, IMBUE_TIERS, IMBUE_TIER_LABEL, imbuementCost, resolveTier } from '../domain/imbuements.js?v=355';
import { ITEMS } from '../domain/items.js?v=369';
import { canImbue } from '../application/imbuementUseCases.js?v=354';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=361';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=359';
...
export async function applyImbuementClick(id, tier) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=354');
