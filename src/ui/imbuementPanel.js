...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot, IMBUE_TIERS, IMBUE_TIER_LABEL, imbuementCost, resolveTier } from '../domain/imbuements.js?v=360';
import { ITEMS } from '../domain/items.js?v=374';
import { canImbue } from '../application/imbuementUseCases.js?v=359';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=366';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=364';
...
export async function applyImbuementClick(id, tier) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=359');
