...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=318';
import { ITEMS } from '../domain/items.js?v=332';
import { canImbue } from '../application/imbuementUseCases.js?v=317';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=324';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=322';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=317');
