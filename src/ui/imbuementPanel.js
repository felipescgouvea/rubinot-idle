...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=313';
import { ITEMS } from '../domain/items.js?v=327';
import { canImbue } from '../application/imbuementUseCases.js?v=312';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=319';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=317';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=312');
