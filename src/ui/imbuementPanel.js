...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=128';
import { ITEMS } from '../domain/items.js?v=143';
import { canImbue } from '../application/imbuementUseCases.js?v=128';
import { openModal } from './shared.js?v=135';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=128');
