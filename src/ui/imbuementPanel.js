...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=342';
import { ITEMS } from '../domain/items.js?v=356';
import { canImbue } from '../application/imbuementUseCases.js?v=341';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=348';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=346';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=341');
