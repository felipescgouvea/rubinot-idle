...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=336';
import { ITEMS } from '../domain/items.js?v=350';
import { canImbue } from '../application/imbuementUseCases.js?v=335';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=342';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=340';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=335');
