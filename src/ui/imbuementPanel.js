...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=175';
import { ITEMS } from '../domain/items.js?v=190';
import { canImbue } from '../application/imbuementUseCases.js?v=175';
import { openModal } from './shared.js?v=182';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=175');
