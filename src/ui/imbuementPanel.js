...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=346';
import { ITEMS } from '../domain/items.js?v=360';
import { canImbue } from '../application/imbuementUseCases.js?v=345';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=352';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=350';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=345');
