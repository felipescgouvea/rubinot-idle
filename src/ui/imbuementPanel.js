...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=187';
import { ITEMS } from '../domain/items.js?v=202';
import { canImbue } from '../application/imbuementUseCases.js?v=187';
import { openModal } from './shared.js?v=194';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=187');
