...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=223';
import { ITEMS } from '../domain/items.js?v=238';
import { canImbue } from '../application/imbuementUseCases.js?v=223';
import { openModal } from './shared.js?v=230';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=223');
