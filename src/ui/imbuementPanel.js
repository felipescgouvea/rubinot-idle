...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=139';
import { ITEMS } from '../domain/items.js?v=154';
import { canImbue } from '../application/imbuementUseCases.js?v=139';
import { openModal } from './shared.js?v=146';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=139');
