...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=199';
import { ITEMS } from '../domain/items.js?v=214';
import { canImbue } from '../application/imbuementUseCases.js?v=199';
import { openModal } from './shared.js?v=206';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=199');
