...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=218';
import { ITEMS } from '../domain/items.js?v=233';
import { canImbue } from '../application/imbuementUseCases.js?v=218';
import { openModal } from './shared.js?v=225';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=218');
