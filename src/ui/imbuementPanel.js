...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=320';
import { ITEMS } from '../domain/items.js?v=334';
import { canImbue } from '../application/imbuementUseCases.js?v=319';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=326';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=324';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=319');
