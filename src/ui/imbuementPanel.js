...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=220';
import { ITEMS } from '../domain/items.js?v=235';
import { canImbue } from '../application/imbuementUseCases.js?v=220';
import { openModal } from './shared.js?v=227';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=220');
