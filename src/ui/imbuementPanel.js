...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=248';
import { ITEMS } from '../domain/items.js?v=263';
import { canImbue } from '../application/imbuementUseCases.js?v=248';
import { openModal } from './shared.js?v=255';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=248');
