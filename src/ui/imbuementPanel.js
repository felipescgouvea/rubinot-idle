...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=155';
import { ITEMS } from '../domain/items.js?v=170';
import { canImbue } from '../application/imbuementUseCases.js?v=155';
import { openModal } from './shared.js?v=162';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=155');
