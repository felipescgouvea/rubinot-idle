...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=326';
import { ITEMS } from '../domain/items.js?v=340';
import { canImbue } from '../application/imbuementUseCases.js?v=325';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=332';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=330';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=325');
