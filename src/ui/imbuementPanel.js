...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=217';
import { ITEMS } from '../domain/items.js?v=232';
import { canImbue } from '../application/imbuementUseCases.js?v=217';
import { openModal } from './shared.js?v=224';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=217');
