...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=277';
import { ITEMS } from '../domain/items.js?v=292';
import { canImbue } from '../application/imbuementUseCases.js?v=277';
import { openModal } from './shared.js?v=284';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=277');
