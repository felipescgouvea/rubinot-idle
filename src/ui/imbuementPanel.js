...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=334';
import { ITEMS } from '../domain/items.js?v=348';
import { canImbue } from '../application/imbuementUseCases.js?v=333';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=340';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=338';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=333');
