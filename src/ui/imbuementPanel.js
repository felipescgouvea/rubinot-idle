...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=270';
import { ITEMS } from '../domain/items.js?v=285';
import { canImbue } from '../application/imbuementUseCases.js?v=270';
import { openModal } from './shared.js?v=277';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=270');
