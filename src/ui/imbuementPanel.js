...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=127';
import { ITEMS } from '../domain/items.js?v=142';
import { canImbue } from '../application/imbuementUseCases.js?v=127';
import { openModal } from './shared.js?v=134';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=127');
