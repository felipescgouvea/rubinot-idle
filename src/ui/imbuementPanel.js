...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot, IMBUE_TIERS, IMBUE_TIER_LABEL, imbuementCost, resolveTier } from '../domain/imbuements.js?v=356';
import { ITEMS } from '../domain/items.js?v=370';
import { canImbue } from '../application/imbuementUseCases.js?v=355';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=362';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=360';
...
export async function applyImbuementClick(id, tier) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=355');
