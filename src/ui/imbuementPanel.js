...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=140';
import { ITEMS } from '../domain/items.js?v=155';
import { canImbue } from '../application/imbuementUseCases.js?v=140';
import { openModal } from './shared.js?v=147';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=140');
