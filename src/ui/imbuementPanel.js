...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=145';
import { ITEMS } from '../domain/items.js?v=160';
import { canImbue } from '../application/imbuementUseCases.js?v=145';
import { openModal } from './shared.js?v=152';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=145');
