...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=310';
import { ITEMS } from '../domain/items.js?v=324';
import { canImbue } from '../application/imbuementUseCases.js?v=309';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=316';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=314';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=309');
