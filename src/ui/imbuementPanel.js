...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=130';
import { ITEMS } from '../domain/items.js?v=145';
import { canImbue } from '../application/imbuementUseCases.js?v=130';
import { openModal } from './shared.js?v=137';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=130');
