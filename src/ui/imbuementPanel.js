...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=212';
import { ITEMS } from '../domain/items.js?v=227';
import { canImbue } from '../application/imbuementUseCases.js?v=212';
import { openModal } from './shared.js?v=219';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=212');
