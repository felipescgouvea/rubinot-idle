...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=314';
import { ITEMS } from '../domain/items.js?v=328';
import { canImbue } from '../application/imbuementUseCases.js?v=313';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=320';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=318';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=313');
