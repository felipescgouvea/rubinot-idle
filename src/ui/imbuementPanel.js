...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=301';
import { ITEMS } from '../domain/items.js?v=315';
import { canImbue } from '../application/imbuementUseCases.js?v=300';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=307';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=305';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=300');
