...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=331';
import { ITEMS } from '../domain/items.js?v=345';
import { canImbue } from '../application/imbuementUseCases.js?v=330';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=337';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=335';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=330');
