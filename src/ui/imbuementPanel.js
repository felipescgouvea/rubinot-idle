...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=126';
import { ITEMS } from '../domain/items.js?v=141';
import { canImbue } from '../application/imbuementUseCases.js?v=126';
import { openModal } from './shared.js?v=133';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=126');
