...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=325';
import { ITEMS } from '../domain/items.js?v=339';
import { canImbue } from '../application/imbuementUseCases.js?v=324';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=331';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=329';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=324');
