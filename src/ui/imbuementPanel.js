...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=216';
import { ITEMS } from '../domain/items.js?v=231';
import { canImbue } from '../application/imbuementUseCases.js?v=216';
import { openModal } from './shared.js?v=223';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=216');
