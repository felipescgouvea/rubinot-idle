...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=152';
import { ITEMS } from '../domain/items.js?v=167';
import { canImbue } from '../application/imbuementUseCases.js?v=152';
import { openModal } from './shared.js?v=159';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=152');
