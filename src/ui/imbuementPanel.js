...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=168';
import { ITEMS } from '../domain/items.js?v=183';
import { canImbue } from '../application/imbuementUseCases.js?v=168';
import { openModal } from './shared.js?v=175';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=168');
