...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=159';
import { ITEMS } from '../domain/items.js?v=174';
import { canImbue } from '../application/imbuementUseCases.js?v=159';
import { openModal } from './shared.js?v=166';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=159');
