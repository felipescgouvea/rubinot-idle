...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=256';
import { ITEMS } from '../domain/items.js?v=271';
import { canImbue } from '../application/imbuementUseCases.js?v=256';
import { openModal } from './shared.js?v=263';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=256');
