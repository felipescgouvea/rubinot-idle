...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=309';
import { ITEMS } from '../domain/items.js?v=323';
import { canImbue } from '../application/imbuementUseCases.js?v=308';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=315';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=313';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=308');
