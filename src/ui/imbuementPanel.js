...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=204';
import { ITEMS } from '../domain/items.js?v=219';
import { canImbue } from '../application/imbuementUseCases.js?v=204';
import { openModal } from './shared.js?v=211';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=204');
