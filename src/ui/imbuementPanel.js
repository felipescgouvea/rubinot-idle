...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot, IMBUE_TIERS, IMBUE_TIER_LABEL, imbuementCost, resolveTier } from '../domain/imbuements.js?v=359';
import { ITEMS } from '../domain/items.js?v=373';
import { canImbue } from '../application/imbuementUseCases.js?v=358';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=365';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=363';
...
export async function applyImbuementClick(id, tier) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=358');
