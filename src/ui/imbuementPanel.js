...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=171';
import { ITEMS } from '../domain/items.js?v=186';
import { canImbue } from '../application/imbuementUseCases.js?v=171';
import { openModal } from './shared.js?v=178';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=171');
