...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=322';
import { ITEMS } from '../domain/items.js?v=336';
import { canImbue } from '../application/imbuementUseCases.js?v=321';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=328';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=326';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=321');
