...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=173';
import { ITEMS } from '../domain/items.js?v=188';
import { canImbue } from '../application/imbuementUseCases.js?v=173';
import { openModal } from './shared.js?v=180';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=173');
