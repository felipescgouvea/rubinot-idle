...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=203';
import { ITEMS } from '../domain/items.js?v=218';
import { canImbue } from '../application/imbuementUseCases.js?v=203';
import { openModal } from './shared.js?v=210';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=203');
