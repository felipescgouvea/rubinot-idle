...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=190';
import { ITEMS } from '../domain/items.js?v=205';
import { canImbue } from '../application/imbuementUseCases.js?v=190';
import { openModal } from './shared.js?v=197';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=190');
