...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=163';
import { ITEMS } from '../domain/items.js?v=178';
import { canImbue } from '../application/imbuementUseCases.js?v=163';
import { openModal } from './shared.js?v=170';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=163');
