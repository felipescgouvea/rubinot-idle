...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=230';
import { ITEMS } from '../domain/items.js?v=245';
import { canImbue } from '../application/imbuementUseCases.js?v=230';
import { openModal } from './shared.js?v=237';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=230');
