...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=345';
import { ITEMS } from '../domain/items.js?v=359';
import { canImbue } from '../application/imbuementUseCases.js?v=344';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=351';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=349';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=344');
