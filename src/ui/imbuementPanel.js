...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=311';
import { ITEMS } from '../domain/items.js?v=325';
import { canImbue } from '../application/imbuementUseCases.js?v=310';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=317';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=315';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=310');
