...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=321';
import { ITEMS } from '../domain/items.js?v=335';
import { canImbue } from '../application/imbuementUseCases.js?v=320';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=327';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=325';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=320');
