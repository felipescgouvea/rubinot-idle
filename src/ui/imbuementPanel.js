...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=327';
import { ITEMS } from '../domain/items.js?v=341';
import { canImbue } from '../application/imbuementUseCases.js?v=326';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=333';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=331';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=326');
