...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=293';
import { ITEMS } from '../domain/items.js?v=307';
import { canImbue } from '../application/imbuementUseCases.js?v=292';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=299';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=297';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=292');
