...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=269';
import { ITEMS } from '../domain/items.js?v=284';
import { canImbue } from '../application/imbuementUseCases.js?v=269';
import { openModal } from './shared.js?v=276';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=269');
