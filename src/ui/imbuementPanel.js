...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=213';
import { ITEMS } from '../domain/items.js?v=228';
import { canImbue } from '../application/imbuementUseCases.js?v=213';
import { openModal } from './shared.js?v=220';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=213');
