...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=133';
import { ITEMS } from '../domain/items.js?v=148';
import { canImbue } from '../application/imbuementUseCases.js?v=133';
import { openModal } from './shared.js?v=140';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=133');
