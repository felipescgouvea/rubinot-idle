...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=188';
import { ITEMS } from '../domain/items.js?v=203';
import { canImbue } from '../application/imbuementUseCases.js?v=188';
import { openModal } from './shared.js?v=195';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=188');
