...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=339';
import { ITEMS } from '../domain/items.js?v=353';
import { canImbue } from '../application/imbuementUseCases.js?v=338';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=345';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=343';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=338');
