...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=231';
import { ITEMS } from '../domain/items.js?v=246';
import { canImbue } from '../application/imbuementUseCases.js?v=231';
import { openModal } from './shared.js?v=238';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=231');
