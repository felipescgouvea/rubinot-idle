...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=228';
import { ITEMS } from '../domain/items.js?v=243';
import { canImbue } from '../application/imbuementUseCases.js?v=228';
import { openModal } from './shared.js?v=235';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=228');
