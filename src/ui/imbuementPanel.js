...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=144';
import { ITEMS } from '../domain/items.js?v=159';
import { canImbue } from '../application/imbuementUseCases.js?v=144';
import { openModal } from './shared.js?v=151';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=144');
