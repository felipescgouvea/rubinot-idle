...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=291';
import { ITEMS } from '../domain/items.js?v=305';
import { canImbue } from '../application/imbuementUseCases.js?v=290';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=297';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=295';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=290');
