...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=226';
import { ITEMS } from '../domain/items.js?v=241';
import { canImbue } from '../application/imbuementUseCases.js?v=226';
import { openModal } from './shared.js?v=233';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=226');
