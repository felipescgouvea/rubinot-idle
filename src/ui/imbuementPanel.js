...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=191';
import { ITEMS } from '../domain/items.js?v=206';
import { canImbue } from '../application/imbuementUseCases.js?v=191';
import { openModal } from './shared.js?v=198';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=191');
