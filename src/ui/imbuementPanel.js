...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=211';
import { ITEMS } from '../domain/items.js?v=226';
import { canImbue } from '../application/imbuementUseCases.js?v=211';
import { openModal } from './shared.js?v=218';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=211');
