...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=308';
import { ITEMS } from '../domain/items.js?v=322';
import { canImbue } from '../application/imbuementUseCases.js?v=307';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=314';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=312';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=307');
