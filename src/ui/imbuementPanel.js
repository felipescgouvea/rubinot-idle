...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=174';
import { ITEMS } from '../domain/items.js?v=189';
import { canImbue } from '../application/imbuementUseCases.js?v=174';
import { openModal } from './shared.js?v=181';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=174');
