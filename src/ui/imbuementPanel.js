...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=135';
import { ITEMS } from '../domain/items.js?v=150';
import { canImbue } from '../application/imbuementUseCases.js?v=135';
import { openModal } from './shared.js?v=142';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=135');
