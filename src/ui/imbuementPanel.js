...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=237';
import { ITEMS } from '../domain/items.js?v=252';
import { canImbue } from '../application/imbuementUseCases.js?v=237';
import { openModal } from './shared.js?v=244';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=237');
