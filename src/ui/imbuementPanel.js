...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=337';
import { ITEMS } from '../domain/items.js?v=351';
import { canImbue } from '../application/imbuementUseCases.js?v=336';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=343';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=341';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=336');
