...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=182';
import { ITEMS } from '../domain/items.js?v=197';
import { canImbue } from '../application/imbuementUseCases.js?v=182';
import { openModal } from './shared.js?v=189';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=182');
