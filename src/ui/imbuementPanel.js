...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=239';
import { ITEMS } from '../domain/items.js?v=254';
import { canImbue } from '../application/imbuementUseCases.js?v=239';
import { openModal } from './shared.js?v=246';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=239');
