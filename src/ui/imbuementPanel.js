...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=158';
import { ITEMS } from '../domain/items.js?v=173';
import { canImbue } from '../application/imbuementUseCases.js?v=158';
import { openModal } from './shared.js?v=165';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=158');
