...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=229';
import { ITEMS } from '../domain/items.js?v=244';
import { canImbue } from '../application/imbuementUseCases.js?v=229';
import { openModal } from './shared.js?v=236';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=229');
