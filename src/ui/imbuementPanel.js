...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=172';
import { ITEMS } from '../domain/items.js?v=187';
import { canImbue } from '../application/imbuementUseCases.js?v=172';
import { openModal } from './shared.js?v=179';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=172');
