...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=258';
import { ITEMS } from '../domain/items.js?v=273';
import { canImbue } from '../application/imbuementUseCases.js?v=258';
import { openModal } from './shared.js?v=265';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=258');
