...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=215';
import { ITEMS } from '../domain/items.js?v=230';
import { canImbue } from '../application/imbuementUseCases.js?v=215';
import { openModal } from './shared.js?v=222';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=215');
