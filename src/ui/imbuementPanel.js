...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=207';
import { ITEMS } from '../domain/items.js?v=222';
import { canImbue } from '../application/imbuementUseCases.js?v=207';
import { openModal } from './shared.js?v=214';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=207');
