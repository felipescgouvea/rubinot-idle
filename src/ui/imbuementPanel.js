...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=153';
import { ITEMS } from '../domain/items.js?v=168';
import { canImbue } from '../application/imbuementUseCases.js?v=153';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=153');
