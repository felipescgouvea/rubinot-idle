...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=186';
import { ITEMS } from '../domain/items.js?v=201';
import { canImbue } from '../application/imbuementUseCases.js?v=186';
import { openModal } from './shared.js?v=193';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=186');
