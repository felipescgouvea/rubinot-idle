...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=165';
import { ITEMS } from '../domain/items.js?v=180';
import { canImbue } from '../application/imbuementUseCases.js?v=165';
import { openModal } from './shared.js?v=172';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=165');
