...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=232';
import { ITEMS } from '../domain/items.js?v=247';
import { canImbue } from '../application/imbuementUseCases.js?v=232';
import { openModal } from './shared.js?v=239';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=232');
