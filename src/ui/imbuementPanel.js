...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=214';
import { ITEMS } from '../domain/items.js?v=229';
import { canImbue } from '../application/imbuementUseCases.js?v=214';
import { openModal } from './shared.js?v=221';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=214');
