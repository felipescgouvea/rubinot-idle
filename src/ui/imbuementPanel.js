...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=319';
import { ITEMS } from '../domain/items.js?v=333';
import { canImbue } from '../application/imbuementUseCases.js?v=318';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=325';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=323';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=318');
