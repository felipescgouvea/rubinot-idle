...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=341';
import { ITEMS } from '../domain/items.js?v=355';
import { canImbue } from '../application/imbuementUseCases.js?v=340';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=347';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=345';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=340');
