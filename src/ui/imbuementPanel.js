...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=177';
import { ITEMS } from '../domain/items.js?v=192';
import { canImbue } from '../application/imbuementUseCases.js?v=177';
import { openModal } from './shared.js?v=184';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=177');
