...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=297';
import { ITEMS } from '../domain/items.js?v=311';
import { canImbue } from '../application/imbuementUseCases.js?v=296';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=303';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=301';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=296');
