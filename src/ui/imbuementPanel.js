...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=162';
import { ITEMS } from '../domain/items.js?v=177';
import { canImbue } from '../application/imbuementUseCases.js?v=162';
import { openModal } from './shared.js?v=169';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=162');
