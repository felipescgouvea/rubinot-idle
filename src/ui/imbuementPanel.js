...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=302';
import { ITEMS } from '../domain/items.js?v=316';
import { canImbue } from '../application/imbuementUseCases.js?v=301';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=308';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=306';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=301');
