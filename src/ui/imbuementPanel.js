...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=280';
import { ITEMS } from '../domain/items.js?v=295';
import { canImbue } from '../application/imbuementUseCases.js?v=280';
import { openModal } from './shared.js?v=287';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=280');
