...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=329';
import { ITEMS } from '../domain/items.js?v=343';
import { canImbue } from '../application/imbuementUseCases.js?v=328';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=335';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=333';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=328');
