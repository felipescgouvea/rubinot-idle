...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=338';
import { ITEMS } from '../domain/items.js?v=352';
import { canImbue } from '../application/imbuementUseCases.js?v=337';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=344';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=342';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=337');
