...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=154';
import { ITEMS } from '../domain/items.js?v=169';
import { canImbue } from '../application/imbuementUseCases.js?v=154';
import { openModal } from './shared.js?v=161';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=154');
