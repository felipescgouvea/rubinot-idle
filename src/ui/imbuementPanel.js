...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=305';
import { ITEMS } from '../domain/items.js?v=319';
import { canImbue } from '../application/imbuementUseCases.js?v=304';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=311';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=309';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=304');
