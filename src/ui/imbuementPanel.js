...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=219';
import { ITEMS } from '../domain/items.js?v=234';
import { canImbue } from '../application/imbuementUseCases.js?v=219';
import { openModal } from './shared.js?v=226';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=219');
