...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=180';
import { ITEMS } from '../domain/items.js?v=195';
import { canImbue } from '../application/imbuementUseCases.js?v=180';
import { openModal } from './shared.js?v=187';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=180');
