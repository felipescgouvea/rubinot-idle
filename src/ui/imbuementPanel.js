...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=181';
import { ITEMS } from '../domain/items.js?v=196';
import { canImbue } from '../application/imbuementUseCases.js?v=181';
import { openModal } from './shared.js?v=188';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=181');
