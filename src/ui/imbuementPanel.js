...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=209';
import { ITEMS } from '../domain/items.js?v=224';
import { canImbue } from '../application/imbuementUseCases.js?v=209';
import { openModal } from './shared.js?v=216';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=209');
