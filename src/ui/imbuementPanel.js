...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=160';
import { ITEMS } from '../domain/items.js?v=175';
import { canImbue } from '../application/imbuementUseCases.js?v=160';
import { openModal } from './shared.js?v=167';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=160');
