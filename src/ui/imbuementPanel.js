...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=225';
import { ITEMS } from '../domain/items.js?v=240';
import { canImbue } from '../application/imbuementUseCases.js?v=225';
import { openModal } from './shared.js?v=232';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=225');
