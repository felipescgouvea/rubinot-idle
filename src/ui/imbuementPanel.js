...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=131';
import { ITEMS } from '../domain/items.js?v=146';
import { canImbue } from '../application/imbuementUseCases.js?v=131';
import { openModal } from './shared.js?v=138';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=131');
