...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=157';
import { ITEMS } from '../domain/items.js?v=172';
import { canImbue } from '../application/imbuementUseCases.js?v=157';
import { openModal } from './shared.js?v=164';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=157');
