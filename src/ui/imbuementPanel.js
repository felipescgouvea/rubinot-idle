...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=161';
import { ITEMS } from '../domain/items.js?v=176';
import { canImbue } from '../application/imbuementUseCases.js?v=161';
import { openModal } from './shared.js?v=168';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=161');
