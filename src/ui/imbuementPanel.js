...
import { IMBUEMENTS, isImbuementActive, activeImbuementFor, IMBUEABLE_SLOTS, imbuementsForSlot } from '../domain/imbuements.js?v=344';
import { ITEMS } from '../domain/items.js?v=358';
import { canImbue } from '../application/imbuementUseCases.js?v=343';
import { openModal, itemIconImg, goldIconImg } from './shared.js?v=350';
import { spriteUrl, spriteImgOrFallback, imbueIconFile } from '../infrastructure/tibiaSprites.js?v=348';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=343');
