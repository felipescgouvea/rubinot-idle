...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=265';
import { ITEMS } from '../domain/items.js?v=280';
import { canImbue } from '../application/imbuementUseCases.js?v=265';
import { openModal } from './shared.js?v=272';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=265');
