...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=202';
import { ITEMS } from '../domain/items.js?v=217';
import { canImbue } from '../application/imbuementUseCases.js?v=202';
import { openModal } from './shared.js?v=209';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=202');
