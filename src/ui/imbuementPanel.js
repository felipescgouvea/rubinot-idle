...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=132';
import { ITEMS } from '../domain/items.js?v=147';
import { canImbue } from '../application/imbuementUseCases.js?v=132';
import { openModal } from './shared.js?v=139';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=132');
