...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=240';
import { ITEMS } from '../domain/items.js?v=255';
import { canImbue } from '../application/imbuementUseCases.js?v=240';
import { openModal } from './shared.js?v=247';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=240');
