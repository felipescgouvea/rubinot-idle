...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=243';
import { ITEMS } from '../domain/items.js?v=258';
import { canImbue } from '../application/imbuementUseCases.js?v=243';
import { openModal } from './shared.js?v=250';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=243');
