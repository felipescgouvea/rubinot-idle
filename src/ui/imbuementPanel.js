...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=266';
import { ITEMS } from '../domain/items.js?v=281';
import { canImbue } from '../application/imbuementUseCases.js?v=266';
import { openModal } from './shared.js?v=273';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=266');
