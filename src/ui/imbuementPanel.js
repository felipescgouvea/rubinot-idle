...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=208';
import { ITEMS } from '../domain/items.js?v=223';
import { canImbue } from '../application/imbuementUseCases.js?v=208';
import { openModal } from './shared.js?v=215';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=208');
