...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=156';
import { ITEMS } from '../domain/items.js?v=171';
import { canImbue } from '../application/imbuementUseCases.js?v=156';
import { openModal } from './shared.js?v=163';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=156');
