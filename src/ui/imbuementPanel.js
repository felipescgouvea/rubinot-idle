...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=129';
import { ITEMS } from '../domain/items.js?v=144';
import { canImbue } from '../application/imbuementUseCases.js?v=129';
import { openModal } from './shared.js?v=136';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=129');
