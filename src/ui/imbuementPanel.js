...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=164';
import { ITEMS } from '../domain/items.js?v=179';
import { canImbue } from '../application/imbuementUseCases.js?v=164';
import { openModal } from './shared.js?v=171';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=164');
