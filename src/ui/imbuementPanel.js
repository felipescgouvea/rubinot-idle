...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=259';
import { ITEMS } from '../domain/items.js?v=274';
import { canImbue } from '../application/imbuementUseCases.js?v=259';
import { openModal } from './shared.js?v=266';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=259');
