...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=278';
import { ITEMS } from '../domain/items.js?v=293';
import { canImbue } from '../application/imbuementUseCases.js?v=278';
import { openModal } from './shared.js?v=285';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=278');
