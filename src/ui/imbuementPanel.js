...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=234';
import { ITEMS } from '../domain/items.js?v=249';
import { canImbue } from '../application/imbuementUseCases.js?v=234';
import { openModal } from './shared.js?v=241';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=234');
