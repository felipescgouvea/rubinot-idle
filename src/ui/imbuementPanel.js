...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=257';
import { ITEMS } from '../domain/items.js?v=272';
import { canImbue } from '../application/imbuementUseCases.js?v=257';
import { openModal } from './shared.js?v=264';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=257');
