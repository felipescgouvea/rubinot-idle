...
import { IMBUEMENTS, isImbuementActive } from '../domain/imbuements.js?v=178';
import { ITEMS } from '../domain/items.js?v=193';
import { canImbue } from '../application/imbuementUseCases.js?v=178';
import { openModal } from './shared.js?v=185';
...
export async function applyImbuementClick(id) {
  const { applyImbuement } = await import('../application/imbuementUseCases.js?v=178');
