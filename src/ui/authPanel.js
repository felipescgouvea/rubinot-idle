...
// e o jogo não inicia.
import { signIn, signUp, signOut, currentUser, resendConfirmation } from '../infrastructure/authClient.js?v=339';
...
export function showLoadingGate() {
  ...
  gate.innerHTML = `
    <div class="auth-card">
      <div class="auth-logo"><img decoding="async" src="logo.webp" alt="RubinOT" class="auth-logo-img" /><span class="auth-logo-sub">IDLE</span></div>
