...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=362';
import { saveState } from '../infrastructure/storage.js?v=358';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=370';
import { emit, EVENTS } from '../shared/eventBus.js?v=360';
import { t } from '../i18n/i18n.js?v=378';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=362';
