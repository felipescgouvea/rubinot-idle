...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=353';
import { saveState } from '../infrastructure/storage.js?v=349';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=361';
import { emit, EVENTS } from '../shared/eventBus.js?v=351';
import { t } from '../i18n/i18n.js?v=369';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=353';
