...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=358';
import { saveState } from '../infrastructure/storage.js?v=354';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=366';
import { emit, EVENTS } from '../shared/eventBus.js?v=356';
import { t } from '../i18n/i18n.js?v=374';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=358';
