...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=311';
import { saveState } from '../infrastructure/storage.js?v=307';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=319';
import { emit, EVENTS } from '../shared/eventBus.js?v=309';
import { t } from '../i18n/i18n.js?v=327';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=311';
