...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=305';
import { saveState } from '../infrastructure/storage.js?v=301';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=313';
import { emit, EVENTS } from '../shared/eventBus.js?v=303';
import { t } from '../i18n/i18n.js?v=321';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=305';
