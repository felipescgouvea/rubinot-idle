...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=312';
import { saveState } from '../infrastructure/storage.js?v=308';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=320';
import { emit, EVENTS } from '../shared/eventBus.js?v=310';
import { t } from '../i18n/i18n.js?v=328';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=312';
