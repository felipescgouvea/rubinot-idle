...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=299';
import { saveState } from '../infrastructure/storage.js?v=295';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=307';
import { emit, EVENTS } from '../shared/eventBus.js?v=297';
import { t } from '../i18n/i18n.js?v=315';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=299';
