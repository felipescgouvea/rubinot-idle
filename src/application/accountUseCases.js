...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=345';
import { saveState } from '../infrastructure/storage.js?v=341';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=353';
import { emit, EVENTS } from '../shared/eventBus.js?v=343';
import { t } from '../i18n/i18n.js?v=361';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=345';
