...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=263';
import { saveState } from '../infrastructure/storage.js?v=259';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=271';
import { emit, EVENTS } from '../shared/eventBus.js?v=261';
import { t } from '../i18n/i18n.js?v=279';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=263';
