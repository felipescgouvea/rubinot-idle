...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=346';
import { saveState } from '../infrastructure/storage.js?v=342';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=354';
import { emit, EVENTS } from '../shared/eventBus.js?v=344';
import { t } from '../i18n/i18n.js?v=362';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=346';
