...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=347';
import { saveState } from '../infrastructure/storage.js?v=343';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=355';
import { emit, EVENTS } from '../shared/eventBus.js?v=345';
import { t } from '../i18n/i18n.js?v=363';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=347';
