...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=304';
import { saveState } from '../infrastructure/storage.js?v=300';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=312';
import { emit, EVENTS } from '../shared/eventBus.js?v=302';
import { t } from '../i18n/i18n.js?v=320';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=304';
