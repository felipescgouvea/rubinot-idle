...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=361';
import { saveState } from '../infrastructure/storage.js?v=357';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=369';
import { emit, EVENTS } from '../shared/eventBus.js?v=359';
import { t } from '../i18n/i18n.js?v=377';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=361';
