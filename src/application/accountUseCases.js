...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=303';
import { saveState } from '../infrastructure/storage.js?v=299';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=311';
import { emit, EVENTS } from '../shared/eventBus.js?v=301';
import { t } from '../i18n/i18n.js?v=319';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=303';
