...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=271';
import { saveState } from '../infrastructure/storage.js?v=267';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=279';
import { emit, EVENTS } from '../shared/eventBus.js?v=269';
import { t } from '../i18n/i18n.js?v=287';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=271';
