...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=313';
import { saveState } from '../infrastructure/storage.js?v=309';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=321';
import { emit, EVENTS } from '../shared/eventBus.js?v=311';
import { t } from '../i18n/i18n.js?v=329';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=313';
