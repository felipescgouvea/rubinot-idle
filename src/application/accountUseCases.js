...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=349';
import { saveState } from '../infrastructure/storage.js?v=345';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=357';
import { emit, EVENTS } from '../shared/eventBus.js?v=347';
import { t } from '../i18n/i18n.js?v=365';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=349';
