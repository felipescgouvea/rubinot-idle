...
import { saveGame, flushCloudSave, stripEconomyFieldsForCloud } from './saveGameUseCase.js?v=355';
import { saveState } from '../infrastructure/storage.js?v=351';
import { saveCloudSave, isLoggedIn } from '../infrastructure/authClient.js?v=363';
import { emit, EVENTS } from '../shared/eventBus.js?v=353';
import { t } from '../i18n/i18n.js?v=371';
import { MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=355';
