...
} from '../domain/combatFormulas.js?v=11';
import { computeRtcMods } from '../domain/shopCatalog.js?v=11';
...
export function getSpd() {
  return computeSpd({ vocation: G.vocation, equipment: G.equipment, rtcSpdMult: computeRtcMods(G.rtc).spdMult });
}
