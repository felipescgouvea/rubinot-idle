...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=295';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=294';
import { gainXp } from './huntUseCases.js?v=360';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=304';
