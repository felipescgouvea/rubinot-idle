...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=286';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=285';
import { gainXp } from './huntUseCases.js?v=351';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=295';
