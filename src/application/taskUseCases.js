...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=289';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=288';
import { gainXp } from './huntUseCases.js?v=354';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=298';
