...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=296';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=295';
import { gainXp } from './huntUseCases.js?v=361';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=305';
