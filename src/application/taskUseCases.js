...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=284';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=283';
import { gainXp } from './huntUseCases.js?v=349';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=293';
