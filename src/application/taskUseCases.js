...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=276';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=275';
import { gainXp } from './huntUseCases.js?v=341';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=285';
