...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=271';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=270';
import { gainXp } from './huntUseCases.js?v=336';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=280';
