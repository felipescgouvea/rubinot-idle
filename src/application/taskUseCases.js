...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=283';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=282';
import { gainXp } from './huntUseCases.js?v=348';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=292';
