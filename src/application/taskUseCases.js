...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=261';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=260';
import { gainXp } from './huntUseCases.js?v=326';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=270';
