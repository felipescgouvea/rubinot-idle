...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=324';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=333';
