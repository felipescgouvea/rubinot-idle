...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=279';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=278';
import { gainXp } from './huntUseCases.js?v=344';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=288';
