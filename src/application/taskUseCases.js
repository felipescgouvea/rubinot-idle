...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=281';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=280';
import { gainXp } from './huntUseCases.js?v=346';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=290';
