...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=270';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=269';
import { gainXp } from './huntUseCases.js?v=335';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=279';
