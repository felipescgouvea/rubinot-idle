...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=265';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=264';
import { gainXp } from './huntUseCases.js?v=330';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=274';
