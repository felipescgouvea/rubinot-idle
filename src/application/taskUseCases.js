...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=259';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=258';
import { gainXp } from './huntUseCases.js?v=324';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=268';
