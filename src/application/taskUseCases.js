...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=264';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=263';
import { gainXp } from './huntUseCases.js?v=329';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=273';
