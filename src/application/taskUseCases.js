...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=280';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=279';
import { gainXp } from './huntUseCases.js?v=345';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=289';
