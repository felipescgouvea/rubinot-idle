...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=269';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=268';
import { gainXp } from './huntUseCases.js?v=334';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=278';
