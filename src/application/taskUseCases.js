...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=282';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=281';
import { gainXp } from './huntUseCases.js?v=347';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=291';
