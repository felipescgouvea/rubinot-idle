...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=288';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=287';
import { gainXp } from './huntUseCases.js?v=353';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=297';
