...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=260';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=259';
import { gainXp } from './huntUseCases.js?v=325';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=269';
