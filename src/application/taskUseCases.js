...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=285';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=284';
import { gainXp } from './huntUseCases.js?v=350';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=294';
