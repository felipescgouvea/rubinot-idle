...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=287';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=286';
import { gainXp } from './huntUseCases.js?v=352';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=296';
