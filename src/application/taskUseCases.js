...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=266';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=265';
import { gainXp } from './huntUseCases.js?v=331';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=275';
