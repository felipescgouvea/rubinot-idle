...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=297';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=296';
import { gainXp } from './huntUseCases.js?v=362';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=306';
