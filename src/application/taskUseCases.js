...
import { TASK_ROOMS, taskKey, isTaskUnlocked, isRoomUnlocked } from '../domain/progression.js?v=294';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=293';
import { gainXp } from './huntUseCases.js?v=359';
...
import { fetchTaskState, completeTaskOnServer } from '../infrastructure/authClient.js?v=303';
