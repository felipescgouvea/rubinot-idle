...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=191';
...
import { stopHunt } from './huntUseCases.js?v=257';
import { saveGame } from './saveGameUseCase.js?v=193';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=200';
