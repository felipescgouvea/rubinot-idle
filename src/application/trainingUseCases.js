...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=170';
...
import { stopHunt } from './huntUseCases.js?v=236';
import { saveGame } from './saveGameUseCase.js?v=172';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=179';
