...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=186';
...
import { stopHunt } from './huntUseCases.js?v=252';
import { saveGame } from './saveGameUseCase.js?v=188';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=195';
