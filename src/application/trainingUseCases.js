...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=127';
...
import { stopHunt } from './huntUseCases.js?v=193';
import { saveGame } from './saveGameUseCase.js?v=129';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=136';
