...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=133';
...
import { stopHunt } from './huntUseCases.js?v=199';
import { saveGame } from './saveGameUseCase.js?v=135';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=142';
