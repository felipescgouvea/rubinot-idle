...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=136';
...
import { stopHunt } from './huntUseCases.js?v=202';
import { saveGame } from './saveGameUseCase.js?v=138';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=145';
