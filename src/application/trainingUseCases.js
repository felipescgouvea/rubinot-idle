...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=160';
...
import { stopHunt } from './huntUseCases.js?v=226';
import { saveGame } from './saveGameUseCase.js?v=162';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=169';
