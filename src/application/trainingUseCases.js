...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=183';
...
import { stopHunt } from './huntUseCases.js?v=249';
import { saveGame } from './saveGameUseCase.js?v=185';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=192';
