...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=173';
...
import { stopHunt } from './huntUseCases.js?v=239';
import { saveGame } from './saveGameUseCase.js?v=175';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=182';
