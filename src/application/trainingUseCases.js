...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=148';
...
import { stopHunt } from './huntUseCases.js?v=214';
import { saveGame } from './saveGameUseCase.js?v=150';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=157';
