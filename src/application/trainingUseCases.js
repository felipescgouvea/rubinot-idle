...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=187';
...
import { stopHunt } from './huntUseCases.js?v=253';
import { saveGame } from './saveGameUseCase.js?v=189';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=196';
