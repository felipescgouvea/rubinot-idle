...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=167';
...
import { stopHunt } from './huntUseCases.js?v=233';
import { saveGame } from './saveGameUseCase.js?v=169';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=176';
