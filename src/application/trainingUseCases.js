...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=172';
...
import { stopHunt } from './huntUseCases.js?v=238';
import { saveGame } from './saveGameUseCase.js?v=174';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=181';
