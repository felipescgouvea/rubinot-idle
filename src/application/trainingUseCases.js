...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=134';
...
import { stopHunt } from './huntUseCases.js?v=200';
import { saveGame } from './saveGameUseCase.js?v=136';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=143';
