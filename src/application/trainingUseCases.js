...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=192';
...
import { stopHunt } from './huntUseCases.js?v=258';
import { saveGame } from './saveGameUseCase.js?v=194';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=201';
