...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=151';
...
import { stopHunt } from './huntUseCases.js?v=217';
import { saveGame } from './saveGameUseCase.js?v=153';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=160';
