...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=137';
...
import { stopHunt } from './huntUseCases.js?v=203';
import { saveGame } from './saveGameUseCase.js?v=139';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=146';
