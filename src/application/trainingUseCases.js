...
import { TRAINABLE_SKILLS, TRAINING_MAX_OFFLINE_SEC, triesForTraining } from '../domain/training.js?v=79';
import { TIBIA_SKILLS } from '../domain/character.js?v=79';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=79';
import { trainSkill } from './skillUseCases.js?v=79';
import { stopHunt } from './huntUseCases.js?v=79';
