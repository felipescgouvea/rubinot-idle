...
import { TRAINABLE_SKILLS, TRAINING_MAX_OFFLINE_SEC, triesForTraining } from '../domain/training.js?v=100';
import { TIBIA_SKILLS } from '../domain/character.js?v=100';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=100';
import { trainSkill } from './skillUseCases.js?v=100';
import { stopHunt } from './huntUseCases.js?v=100';
