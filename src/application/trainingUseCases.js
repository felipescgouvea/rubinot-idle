...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=161';
...
import { stopHunt } from './huntUseCases.js?v=227';
import { saveGame } from './saveGameUseCase.js?v=163';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=170';
