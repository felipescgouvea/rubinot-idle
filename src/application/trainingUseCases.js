...
import { TRAINABLE_SKILLS, TRAINING_MAX_OFFLINE_SEC, triesForTraining } from '../domain/training.js?v=121';
import { TIBIA_SKILLS } from '../domain/character.js?v=121';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=121';
import { trainSkill } from './skillUseCases.js?v=121';
import { stopHunt } from './huntUseCases.js?v=121';
