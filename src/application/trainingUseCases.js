...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=132';
...
import { stopHunt } from './huntUseCases.js?v=198';
import { saveGame } from './saveGameUseCase.js?v=134';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=141';
