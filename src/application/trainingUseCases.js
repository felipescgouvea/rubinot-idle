...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=149';
...
import { stopHunt } from './huntUseCases.js?v=215';
import { saveGame } from './saveGameUseCase.js?v=151';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=158';
