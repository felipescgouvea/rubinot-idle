...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=184';
...
import { stopHunt } from './huntUseCases.js?v=250';
import { saveGame } from './saveGameUseCase.js?v=186';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=193';
