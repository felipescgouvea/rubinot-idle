...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=135';
...
import { stopHunt } from './huntUseCases.js?v=201';
import { saveGame } from './saveGameUseCase.js?v=137';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=144';
