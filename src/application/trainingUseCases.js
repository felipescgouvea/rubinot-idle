...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=176';
...
import { stopHunt } from './huntUseCases.js?v=242';
import { saveGame } from './saveGameUseCase.js?v=178';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=185';
