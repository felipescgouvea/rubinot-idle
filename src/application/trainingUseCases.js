...
import { TRAINABLE_SKILLS, TRAINING_MAX_OFFLINE_SEC, triesForTraining } from '../domain/training.js?v=76';
import { TIBIA_SKILLS } from '../domain/character.js?v=76';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=76';
import { trainSkill } from './skillUseCases.js?v=76';
import { stopHunt } from './huntUseCases.js?v=76';
