...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=145';
...
import { stopHunt } from './huntUseCases.js?v=211';
import { saveGame } from './saveGameUseCase.js?v=147';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=154';
