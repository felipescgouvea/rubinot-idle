...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=185';
...
import { stopHunt } from './huntUseCases.js?v=251';
import { saveGame } from './saveGameUseCase.js?v=187';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=194';
