...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=159';
...
import { stopHunt } from './huntUseCases.js?v=225';
import { saveGame } from './saveGameUseCase.js?v=161';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=168';
