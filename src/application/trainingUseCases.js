...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=175';
...
import { stopHunt } from './huntUseCases.js?v=241';
import { saveGame } from './saveGameUseCase.js?v=177';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=184';
