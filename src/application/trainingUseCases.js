...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=168';
...
import { stopHunt } from './huntUseCases.js?v=234';
import { saveGame } from './saveGameUseCase.js?v=170';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=177';
