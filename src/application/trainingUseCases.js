...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=197';
...
import { stopHunt } from './huntUseCases.js?v=263';
import { saveGame } from './saveGameUseCase.js?v=199';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=206';
