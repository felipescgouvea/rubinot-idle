...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=182';
...
import { stopHunt } from './huntUseCases.js?v=248';
import { saveGame } from './saveGameUseCase.js?v=184';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=191';
