...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=174';
...
import { stopHunt } from './huntUseCases.js?v=240';
import { saveGame } from './saveGameUseCase.js?v=176';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=183';
