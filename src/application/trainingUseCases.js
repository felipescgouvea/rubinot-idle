...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=138';
...
import { stopHunt } from './huntUseCases.js?v=204';
import { saveGame } from './saveGameUseCase.js?v=140';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=147';
