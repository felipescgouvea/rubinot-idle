...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=188';
...
import { stopHunt } from './huntUseCases.js?v=254';
import { saveGame } from './saveGameUseCase.js?v=190';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=197';
