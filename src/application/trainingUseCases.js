...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=131';
...
import { stopHunt } from './huntUseCases.js?v=197';
import { saveGame } from './saveGameUseCase.js?v=133';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=140';
