...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=171';
...
import { stopHunt } from './huntUseCases.js?v=237';
import { saveGame } from './saveGameUseCase.js?v=173';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=180';
