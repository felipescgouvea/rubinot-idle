...
import { TRAINABLE_SKILLS, onlineTrainableSkills } from '../domain/training.js?v=169';
...
import { stopHunt } from './huntUseCases.js?v=235';
import { saveGame } from './saveGameUseCase.js?v=171';
import { trainStartOnServer, trainCreditOnServer, trainStopOnServer, getHuntState } from '../infrastructure/authClient.js?v=178';
