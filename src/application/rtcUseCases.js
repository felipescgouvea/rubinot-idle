...
import { runeEntry, canUseAttackRune, runeMinMl, ATTACK_SLOT_COUNT, HEAL_TIER_COUNT, TARGET_PRIORITIES } from '../domain/rtcConfig.js?v=257';
...
import { updateHuntRtc } from '../infrastructure/authClient.js?v=232';
