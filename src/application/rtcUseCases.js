...
import { runeEntry, canUseAttackRune, runeMinMl, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=180';
...
import { updateHuntRtc } from '../infrastructure/authClient.js?v=155';
