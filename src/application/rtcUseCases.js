...
import { runeEntry, canUseAttackRune, runeMinMl, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=163';
...
import { updateHuntRtc } from '../infrastructure/authClient.js?v=138';
