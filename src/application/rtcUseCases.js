...
import { runeEntry, canUseAttackRune, runeMinMl, ATTACK_SLOT_COUNT } from '../domain/rtcConfig.js?v=216';
...
import { updateHuntRtc } from '../infrastructure/authClient.js?v=191';
