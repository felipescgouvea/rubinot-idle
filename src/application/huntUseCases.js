...
import { G, ACCOUNT } from './gameStore.js?v=286';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=294';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=291';
import { ZONES } from '../domain/bestiary.js?v=304';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=313';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=284';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=316';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=315';
import { elementMod } from '../domain/elements.js?v=282';
import { STAMINA_MAX } from '../domain/stamina.js?v=282';
import { ITEMS } from '../domain/items.js?v=297';
import { MONSTERS } from '../domain/bestiary.js?v=304';
import { RARITY_TIERS } from '../domain/rarity.js?v=283';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=285';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=284';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=283';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=283';
import { saveGame } from './saveGameUseCase.js?v=286';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=287';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=285';
