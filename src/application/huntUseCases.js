...
import { G, ACCOUNT } from './gameStore.js?v=262';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=270';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=267';
import { ZONES } from '../domain/bestiary.js?v=280';
...
import { saveGame } from './saveGameUseCase.js?v=262';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=263';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=261';
