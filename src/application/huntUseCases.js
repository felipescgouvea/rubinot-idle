...
import { G, ACCOUNT } from './gameStore.js?v=331';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=339';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=336';
import { ZONES } from '../domain/bestiary.js?v=350';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=358';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=329';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=361';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=360';
import { elementMod } from '../domain/elements.js?v=327';
import { STAMINA_MAX } from '../domain/stamina.js?v=327';
import { ITEMS } from '../domain/items.js?v=342';
import { MONSTERS } from '../domain/bestiary.js?v=350';
import { RARITY_TIERS } from '../domain/rarity.js?v=328';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=330';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=329';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=328';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=328';
import { saveGame } from './saveGameUseCase.js?v=331';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=332';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=330';
import { t } from '../i18n/i18n.js?v=347';
