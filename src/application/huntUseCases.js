...
import { G, ACCOUNT } from './gameStore.js?v=229';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=234';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=234';
import { ZONES } from '../domain/bestiary.js?v=247';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=256';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=227';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=259';
import { monsterAttack } from '../domain/combatFormulas.js?v=258';
import { elementMod } from '../domain/elements.js?v=225';
import { STAMINA_MAX } from '../domain/stamina.js?v=225';
import { ITEMS } from '../domain/items.js?v=240';
import { MONSTERS } from '../domain/bestiary.js?v=247';
import { RARITY_TIERS } from '../domain/rarity.js?v=226';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=227';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=227';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=226';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=226';
import { saveGame } from './saveGameUseCase.js?v=229';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=230';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=228';
