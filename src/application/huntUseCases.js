...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=335';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=332';
import { ZONES } from '../domain/bestiary.js?v=346';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=354';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=325';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=357';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=356';
import { elementMod } from '../domain/elements.js?v=323';
import { STAMINA_MAX } from '../domain/stamina.js?v=323';
import { ITEMS } from '../domain/items.js?v=338';
import { MONSTERS } from '../domain/bestiary.js?v=346';
import { RARITY_TIERS } from '../domain/rarity.js?v=324';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=326';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=325';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=324';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=324';
import { saveGame } from './saveGameUseCase.js?v=327';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=328';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=326';
