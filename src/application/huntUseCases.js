...
import { G, ACCOUNT } from './gameStore.js?v=277';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=285';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=282';
import { ZONES } from '../domain/bestiary.js?v=295';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=304';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=275';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=307';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=306';
import { elementMod } from '../domain/elements.js?v=273';
import { STAMINA_MAX } from '../domain/stamina.js?v=273';
import { ITEMS } from '../domain/items.js?v=288';
import { MONSTERS } from '../domain/bestiary.js?v=295';
import { RARITY_TIERS } from '../domain/rarity.js?v=274';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=276';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=275';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=274';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=274';
import { saveGame } from './saveGameUseCase.js?v=277';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=278';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=276';
