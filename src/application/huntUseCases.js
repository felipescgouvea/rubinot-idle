...
import { G, ACCOUNT } from './gameStore.js?v=215';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=220';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=220';
import { ZONES } from '../domain/bestiary.js?v=233';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=242';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=213';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=245';
import { monsterAttack } from '../domain/combatFormulas.js?v=244';
import { elementMod } from '../domain/elements.js?v=211';
import { STAMINA_MAX } from '../domain/stamina.js?v=211';
import { ITEMS } from '../domain/items.js?v=226';
import { MONSTERS } from '../domain/bestiary.js?v=233';
import { RARITY_TIERS } from '../domain/rarity.js?v=212';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=213';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=213';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=212';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=212';
import { saveGame } from './saveGameUseCase.js?v=215';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=216';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=214';
