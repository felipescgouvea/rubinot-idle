...
import { ZONES, boostedZoneForDate, BOSS_MONSTER_IDS, bossTierMultiplier, bossAuraClass } from '../domain/bestiary.js?v=71';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=71';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=71';
import { computeBoostMods } from '../domain/shopCatalog.js?v=71';
import { isRuneAvailableToVocation } from '../domain/rtcConfig.js?v=71';
import { worldXpMultiplier, worldGoldMultiplier } from '../domain/progression.js?v=71';
import { calcDamage, spawnMonsterInstance } from '../domain/combatFormulas.js?v=71';
import { ITEMS, EQUIPPABLE_TYPES, canUsePotion } from '../domain/items.js?v=71';
import { MONSTERS } from '../domain/bestiary.js?v=71';
import { RARITY_TIERS, rollRarityTier } from '../domain/rarity.js?v=71';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=71';
import { emit, EVENTS } from '../shared/eventBus.js?v=71';
import { getAtk, getDef, getMaxHp, getMaxMana, getSpd, getEquippedWeaponSkillId } from './stats.js?v=71';
import { trainSkill } from './skillUseCases.js?v=71';
import { addItemToInventory } from './inventoryCore.js?v=71';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=71';
import { getCombatBonuses } from './bonuses.js?v=71';
import { getXpRate, getGoldRate, getLootRate, getRelicDropChance, getRarityWeights, getSpawnDelayRange, getZoneMultiplier } from './adminUseCases.js?v=71';
import { itemSpriteFile, monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=71';
...
export function doHuntTick() {
  ...
  if (G.rtc.attackType === 'rune' && G.rtc.attackRune && isRuneAvailableToVocation(G.rtc.attackRune, G.vocation) && (G.inventory[G.rtc.attackRune] || 0) > 0) {
    ...
    spellElement = rune.element || 'physical';
