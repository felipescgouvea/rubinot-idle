...
import { G, ACCOUNT } from './gameStore.js?v=326';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=334';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=331';
import { ZONES } from '../domain/bestiary.js?v=345';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=353';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=324';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=356';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=355';
import { elementMod } from '../domain/elements.js?v=322';
import { STAMINA_MAX } from '../domain/stamina.js?v=322';
import { ITEMS } from '../domain/items.js?v=337';
import { MONSTERS } from '../domain/bestiary.js?v=345';
import { RARITY_TIERS } from '../domain/rarity.js?v=323';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=325';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=324';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=323';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=323';
import { saveGame } from './saveGameUseCase.js?v=326';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=327';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=325';
import { t } from '../i18n/i18n.js?v=342';
