...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=272';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=269';
import { ZONES } from '../domain/bestiary.js?v=282';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=291';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=262';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=294';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=293';
import { elementMod } from '../domain/elements.js?v=260';
import { STAMINA_MAX } from '../domain/stamina.js?v=260';
import { ITEMS } from '../domain/items.js?v=275';
import { MONSTERS } from '../domain/bestiary.js?v=282';
import { RARITY_TIERS } from '../domain/rarity.js?v=261';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=263';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=262';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=261';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=261';
import { saveGame } from './saveGameUseCase.js?v=264';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=265';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=263';
