...
import { ZONES, boostedZoneForDate, BOSS_MONSTER_IDS, bossTierMultiplier, bossAuraClass } from '../domain/bestiary.js?v=118';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=118';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=118';
import { computeBoostMods } from '../domain/shopCatalog.js?v=118';
import { isRuneAvailableToVocation, canUseAttackRune, normalizeAttackSpells } from '../domain/rtcConfig.js?v=118';
import { worldXpMultiplier, worldGoldMultiplier } from '../domain/progression.js?v=118';
import { calcDamage, spawnMonsterInstance, spellAttackDamage, spellHealAmount, runeDamage, potionRestore, monsterAttack } from '../domain/combatFormulas.js?v=118';
import { elementMod } from '../domain/elements.js?v=118';
import { STAMINA_MAX, staminaXpMult } from '../domain/stamina.js?v=118';
import { deathXpLossPct, reviveHpPct } from '../domain/blessings.js?v=118';
import { ITEMS, EQUIPPABLE_TYPES, canUsePotion, resolveEquippedItem } from '../domain/items.js?v=118';
import { MONSTERS } from '../domain/bestiary.js?v=118';
import { RARITY_TIERS, rollRarityTier } from '../domain/rarity.js?v=118';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=118';
import { spellEffectName, runeEffectName, basicAttackMissile } from '../domain/combatFx.js?v=118';
import { emit, EVENTS } from '../shared/eventBus.js?v=118';
import { getAtk, getDef, getMagic, getMaxHp, getMaxMana, getSpd, getEquippedWeaponSkillId } from './stats.js?v=118';
import { trainSkill } from './skillUseCases.js?v=118';
import { addItemToInventory } from './inventoryCore.js?v=118';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=118';
import { getCombatBonuses } from './bonuses.js?v=118';
import { getXpRate, getGoldRate, getLootRate, getRelicDropChance, getRarityWeights, getSpawnDelayRange, getZoneMultiplier, isStaminaEnabled, isConsumeAmmo, getZoneSpawn } from './adminUseCases.js?v=118';
import { itemSpriteFile, monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=118';
