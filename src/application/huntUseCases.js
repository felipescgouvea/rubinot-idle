...
import { G, ACCOUNT } from './gameStore.js?v=216';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=221';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=221';
import { ZONES } from '../domain/bestiary.js?v=234';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=243';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=214';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=246';
import { monsterAttack } from '../domain/combatFormulas.js?v=245';
import { elementMod } from '../domain/elements.js?v=212';
import { STAMINA_MAX } from '../domain/stamina.js?v=212';
import { ITEMS } from '../domain/items.js?v=227';
import { MONSTERS } from '../domain/bestiary.js?v=234';
import { RARITY_TIERS } from '../domain/rarity.js?v=213';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=214';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=214';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=213';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=213';
import { saveGame } from './saveGameUseCase.js?v=216';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=217';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=215';
