...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=305';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=302';
import { ZONES } from '../domain/bestiary.js?v=316';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=324';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=295';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=327';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=326';
import { elementMod } from '../domain/elements.js?v=293';
import { STAMINA_MAX } from '../domain/stamina.js?v=293';
import { ITEMS } from '../domain/items.js?v=308';
import { MONSTERS } from '../domain/bestiary.js?v=316';
import { RARITY_TIERS } from '../domain/rarity.js?v=294';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=296';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=295';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=294';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=294';
import { saveGame } from './saveGameUseCase.js?v=297';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=298';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=296';
