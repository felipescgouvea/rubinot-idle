...
import { G, ACCOUNT } from './gameStore.js?v=328';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=336';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=333';
import { ZONES } from '../domain/bestiary.js?v=347';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=355';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=326';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=358';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=357';
import { elementMod } from '../domain/elements.js?v=324';
import { STAMINA_MAX } from '../domain/stamina.js?v=324';
import { ITEMS } from '../domain/items.js?v=339';
import { MONSTERS } from '../domain/bestiary.js?v=347';
import { RARITY_TIERS } from '../domain/rarity.js?v=325';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=327';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=326';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=325';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=325';
import { saveGame } from './saveGameUseCase.js?v=328';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=329';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=327';
