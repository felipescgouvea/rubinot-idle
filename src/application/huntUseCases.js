...
import { G, ACCOUNT } from './gameStore.js?v=309';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=317';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=314';
import { ZONES } from '../domain/bestiary.js?v=328';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=336';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=307';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=339';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=338';
import { elementMod } from '../domain/elements.js?v=305';
import { STAMINA_MAX } from '../domain/stamina.js?v=305';
import { ITEMS } from '../domain/items.js?v=320';
import { MONSTERS } from '../domain/bestiary.js?v=328';
import { RARITY_TIERS } from '../domain/rarity.js?v=306';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=308';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=307';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=306';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=306';
import { saveGame } from './saveGameUseCase.js?v=309';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=310';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=308';
