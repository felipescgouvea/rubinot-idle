...
import { G, ACCOUNT } from './gameStore.js?v=308';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=316';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=313';
import { ZONES } from '../domain/bestiary.js?v=327';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=335';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=306';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=338';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=337';
import { elementMod } from '../domain/elements.js?v=304';
import { STAMINA_MAX } from '../domain/stamina.js?v=304';
import { ITEMS } from '../domain/items.js?v=319';
import { MONSTERS } from '../domain/bestiary.js?v=327';
import { RARITY_TIERS } from '../domain/rarity.js?v=305';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=307';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=306';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=305';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=305';
import { saveGame } from './saveGameUseCase.js?v=308';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=309';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=307';
