...
import { G, ACCOUNT } from './gameStore.js?v=210';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=215';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=215';
import { ZONES } from '../domain/bestiary.js?v=228';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=237';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=208';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=240';
import { monsterAttack } from '../domain/combatFormulas.js?v=239';
import { elementMod } from '../domain/elements.js?v=206';
import { STAMINA_MAX } from '../domain/stamina.js?v=206';
import { ITEMS } from '../domain/items.js?v=221';
import { MONSTERS } from '../domain/bestiary.js?v=228';
import { RARITY_TIERS } from '../domain/rarity.js?v=207';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=208';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=208';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=207';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=207';
import { saveGame } from './saveGameUseCase.js?v=210';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=211';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=209';
