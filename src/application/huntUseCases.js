...
import { G, ACCOUNT } from './gameStore.js?v=315';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=323';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=320';
import { ZONES } from '../domain/bestiary.js?v=334';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=342';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=313';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=345';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=344';
import { elementMod } from '../domain/elements.js?v=311';
import { STAMINA_MAX } from '../domain/stamina.js?v=311';
import { ITEMS } from '../domain/items.js?v=326';
import { MONSTERS } from '../domain/bestiary.js?v=334';
import { RARITY_TIERS } from '../domain/rarity.js?v=312';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=314';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=313';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=312';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=312';
import { saveGame } from './saveGameUseCase.js?v=315';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=316';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=314';
import { t } from '../i18n/i18n.js?v=331';
