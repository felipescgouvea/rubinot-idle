...
import { G, ACCOUNT } from './gameStore.js?v=217';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=222';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=222';
import { ZONES } from '../domain/bestiary.js?v=235';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=244';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=215';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=247';
import { monsterAttack } from '../domain/combatFormulas.js?v=246';
import { elementMod } from '../domain/elements.js?v=213';
import { STAMINA_MAX } from '../domain/stamina.js?v=213';
import { ITEMS } from '../domain/items.js?v=228';
import { MONSTERS } from '../domain/bestiary.js?v=235';
import { RARITY_TIERS } from '../domain/rarity.js?v=214';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=215';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=215';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=214';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=214';
import { saveGame } from './saveGameUseCase.js?v=217';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=218';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=216';
