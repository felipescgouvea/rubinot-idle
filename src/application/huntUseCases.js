...
import { G, ACCOUNT } from './gameStore.js?v=207';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=212';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=212';
import { ZONES } from '../domain/bestiary.js?v=225';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=234';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=205';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=237';
import { monsterAttack } from '../domain/combatFormulas.js?v=236';
import { elementMod } from '../domain/elements.js?v=203';
import { STAMINA_MAX } from '../domain/stamina.js?v=203';
import { ITEMS } from '../domain/items.js?v=218';
import { MONSTERS } from '../domain/bestiary.js?v=225';
import { RARITY_TIERS } from '../domain/rarity.js?v=204';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=205';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=205';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=204';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=204';
import { saveGame } from './saveGameUseCase.js?v=207';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=208';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=206';
