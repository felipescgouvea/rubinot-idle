...
import { G, ACCOUNT } from './gameStore.js?v=212';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=217';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=217';
import { ZONES } from '../domain/bestiary.js?v=230';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=239';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=210';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=242';
import { monsterAttack } from '../domain/combatFormulas.js?v=241';
import { elementMod } from '../domain/elements.js?v=208';
import { STAMINA_MAX } from '../domain/stamina.js?v=208';
import { ITEMS } from '../domain/items.js?v=223';
import { MONSTERS } from '../domain/bestiary.js?v=230';
import { RARITY_TIERS } from '../domain/rarity.js?v=209';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=210';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=210';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=209';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=209';
import { saveGame } from './saveGameUseCase.js?v=212';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=213';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=211';
import { t } from '../i18n/i18n.js?v=226';
