...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=230';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=230';
import { ZONES } from '../domain/bestiary.js?v=243';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=252';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=223';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=255';
import { monsterAttack } from '../domain/combatFormulas.js?v=254';
import { elementMod } from '../domain/elements.js?v=221';
import { STAMINA_MAX } from '../domain/stamina.js?v=221';
import { ITEMS } from '../domain/items.js?v=236';
import { MONSTERS } from '../domain/bestiary.js?v=243';
import { RARITY_TIERS } from '../domain/rarity.js?v=222';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=223';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=223';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=222';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=222';
import { saveGame } from './saveGameUseCase.js?v=225';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=226';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=224';
