...
import { G, ACCOUNT } from './gameStore.js?v=203';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=208';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=208';
import { ZONES } from '../domain/bestiary.js?v=221';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=230';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=201';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=233';
import { monsterAttack } from '../domain/combatFormulas.js?v=232';
import { elementMod } from '../domain/elements.js?v=199';
import { STAMINA_MAX } from '../domain/stamina.js?v=199';
import { ITEMS } from '../domain/items.js?v=214';
import { MONSTERS } from '../domain/bestiary.js?v=221';
import { RARITY_TIERS } from '../domain/rarity.js?v=200';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=201';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=201';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=200';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=200';
import { saveGame } from './saveGameUseCase.js?v=203';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=204';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=202';
