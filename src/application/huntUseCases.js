...
import { G, ACCOUNT } from './gameStore.js?v=172';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget } from '../infrastructure/authClient.js?v=177';
import { ZONES } from '../domain/bestiary.js?v=190';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=199';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=170';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=202';
import { monsterAttack } from '../domain/combatFormulas.js?v=201';
import { elementMod } from '../domain/elements.js?v=168';
import { STAMINA_MAX } from '../domain/stamina.js?v=168';
import { ITEMS } from '../domain/items.js?v=183';
import { MONSTERS } from '../domain/bestiary.js?v=190';
import { RARITY_TIERS } from '../domain/rarity.js?v=169';
import { spellEffectName, spellMissileName, runeEffectName, basicAttackMissile } from '../domain/combatFx.js?v=170';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=170';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=169';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=169';
import { saveGame } from './saveGameUseCase.js?v=172';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=173';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=171';
import { t } from '../i18n/i18n.js?v=186';
