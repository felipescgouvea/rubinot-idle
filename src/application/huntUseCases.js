...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=326';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=323';
import { ZONES } from '../domain/bestiary.js?v=337';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=345';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=316';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=348';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=347';
import { elementMod } from '../domain/elements.js?v=314';
import { STAMINA_MAX } from '../domain/stamina.js?v=314';
import { ITEMS } from '../domain/items.js?v=329';
import { MONSTERS } from '../domain/bestiary.js?v=337';
import { RARITY_TIERS } from '../domain/rarity.js?v=315';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=317';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=316';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=315';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=315';
import { saveGame } from './saveGameUseCase.js?v=318';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=319';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=317';
