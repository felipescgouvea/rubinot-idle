...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=245';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=245';
import { ZONES } from '../domain/bestiary.js?v=258';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=267';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=238';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=270';
import { monsterAttack } from '../domain/combatFormulas.js?v=269';
import { elementMod } from '../domain/elements.js?v=236';
import { STAMINA_MAX } from '../domain/stamina.js?v=236';
import { ITEMS } from '../domain/items.js?v=251';
import { MONSTERS } from '../domain/bestiary.js?v=258';
import { RARITY_TIERS } from '../domain/rarity.js?v=237';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=238';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=238';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=237';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=237';
import { saveGame } from './saveGameUseCase.js?v=240';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=241';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=239';
