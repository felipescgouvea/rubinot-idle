...
import { G, ACCOUNT } from './gameStore.js?v=206';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=211';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=211';
import { ZONES } from '../domain/bestiary.js?v=224';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=233';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=204';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=236';
import { monsterAttack } from '../domain/combatFormulas.js?v=235';
import { elementMod } from '../domain/elements.js?v=202';
import { STAMINA_MAX } from '../domain/stamina.js?v=202';
import { ITEMS } from '../domain/items.js?v=217';
import { MONSTERS } from '../domain/bestiary.js?v=224';
import { RARITY_TIERS } from '../domain/rarity.js?v=203';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=204';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=204';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=203';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=203';
import { saveGame } from './saveGameUseCase.js?v=206';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=207';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=205';
