...
import { G, ACCOUNT } from './gameStore.js?v=205';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=210';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=210';
import { ZONES } from '../domain/bestiary.js?v=223';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=232';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=203';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=235';
import { monsterAttack } from '../domain/combatFormulas.js?v=234';
import { elementMod } from '../domain/elements.js?v=201';
import { STAMINA_MAX } from '../domain/stamina.js?v=201';
import { ITEMS } from '../domain/items.js?v=216';
import { MONSTERS } from '../domain/bestiary.js?v=223';
import { RARITY_TIERS } from '../domain/rarity.js?v=202';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=203';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=203';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=202';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=202';
import { saveGame } from './saveGameUseCase.js?v=205';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=206';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=204';
