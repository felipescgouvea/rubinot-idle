...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=307';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=304';
import { ZONES } from '../domain/bestiary.js?v=318';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=326';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=297';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=329';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=328';
import { elementMod } from '../domain/elements.js?v=295';
import { STAMINA_MAX } from '../domain/stamina.js?v=295';
import { ITEMS } from '../domain/items.js?v=310';
import { MONSTERS } from '../domain/bestiary.js?v=318';
import { RARITY_TIERS } from '../domain/rarity.js?v=296';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=298';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=297';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=296';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=296';
import { saveGame } from './saveGameUseCase.js?v=299';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=300';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=298';
