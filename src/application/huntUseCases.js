...
import { G, ACCOUNT } from './gameStore.js?v=329';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=337';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=334';
import { ZONES } from '../domain/bestiary.js?v=348';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=356';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=327';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=359';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=358';
import { elementMod } from '../domain/elements.js?v=325';
import { STAMINA_MAX } from '../domain/stamina.js?v=325';
import { ITEMS } from '../domain/items.js?v=340';
import { MONSTERS } from '../domain/bestiary.js?v=348';
import { RARITY_TIERS } from '../domain/rarity.js?v=326';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=328';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=327';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=326';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=326';
import { saveGame } from './saveGameUseCase.js?v=329';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=330';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=328';
