...
import { G, ACCOUNT } from './gameStore.js?v=317';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=325';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=322';
import { ZONES } from '../domain/bestiary.js?v=336';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=344';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=315';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=347';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=346';
import { elementMod } from '../domain/elements.js?v=313';
import { STAMINA_MAX } from '../domain/stamina.js?v=313';
import { ITEMS } from '../domain/items.js?v=328';
import { MONSTERS } from '../domain/bestiary.js?v=336';
import { RARITY_TIERS } from '../domain/rarity.js?v=314';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=316';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=315';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=314';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=314';
import { saveGame } from './saveGameUseCase.js?v=317';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=318';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=316';
import { t } from '../i18n/i18n.js?v=333';
