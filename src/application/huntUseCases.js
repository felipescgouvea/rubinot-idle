...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=250';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=250';
import { ZONES } from '../domain/bestiary.js?v=263';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=272';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=243';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=275';
import { monsterAttack } from '../domain/combatFormulas.js?v=274';
import { elementMod } from '../domain/elements.js?v=241';
import { STAMINA_MAX } from '../domain/stamina.js?v=241';
import { ITEMS } from '../domain/items.js?v=256';
import { MONSTERS } from '../domain/bestiary.js?v=263';
import { RARITY_TIERS } from '../domain/rarity.js?v=242';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=243';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=243';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=242';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=242';
import { saveGame } from './saveGameUseCase.js?v=245';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=246';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=244';
