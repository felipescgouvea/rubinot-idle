...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=233';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=233';
import { ZONES } from '../domain/bestiary.js?v=246';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=255';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=226';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=258';
import { monsterAttack } from '../domain/combatFormulas.js?v=257';
import { elementMod } from '../domain/elements.js?v=224';
...
import { RARITY_TIERS } from '../domain/rarity.js?v=225';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=226';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=226';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=225';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=225';
import { saveGame } from './saveGameUseCase.js?v=228';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=229';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=227';
