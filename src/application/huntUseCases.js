...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=327';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=324';
import { ZONES } from '../domain/bestiary.js?v=338';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=346';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=317';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=349';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=348';
import { elementMod } from '../domain/elements.js?v=315';
import { STAMINA_MAX } from '../domain/stamina.js?v=315';
import { ITEMS } from '../domain/items.js?v=330';
import { MONSTERS } from '../domain/bestiary.js?v=338';
import { RARITY_TIERS } from '../domain/rarity.js?v=316';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=318';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=317';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=316';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=316';
import { saveGame } from './saveGameUseCase.js?v=319';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=320';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=318';
