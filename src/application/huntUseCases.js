...
import { G, ACCOUNT } from './gameStore.js?v=283';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=291';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=288';
import { ZONES } from '../domain/bestiary.js?v=301';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=310';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=281';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=313';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=312';
import { elementMod } from '../domain/elements.js?v=279';
import { STAMINA_MAX } from '../domain/stamina.js?v=279';
import { ITEMS } from '../domain/items.js?v=294';
import { MONSTERS } from '../domain/bestiary.js?v=301';
import { RARITY_TIERS } from '../domain/rarity.js?v=280';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=282';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=281';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=280';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=280';
import { saveGame } from './saveGameUseCase.js?v=283';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=284';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=282';
