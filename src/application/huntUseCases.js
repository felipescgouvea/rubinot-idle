...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=207';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=207';
import { ZONES } from '../domain/bestiary.js?v=220';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=229';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=200';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=232';
import { monsterAttack } from '../domain/combatFormulas.js?v=231';
import { elementMod } from '../domain/elements.js?v=198';
import { STAMINA_MAX } from '../domain/stamina.js?v=198';
import { ITEMS } from '../domain/items.js?v=213';
import { MONSTERS } from '../domain/bestiary.js?v=220';
import { RARITY_TIERS } from '../domain/rarity.js?v=199';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=200';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=200';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=199';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=199';
import { saveGame } from './saveGameUseCase.js?v=202';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=203';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=201';
