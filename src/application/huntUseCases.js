...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=360';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=357';
import { ZONES } from '../domain/bestiary.js?v=371';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=379';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=350';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=382';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=381';
import { elementMod } from '../domain/elements.js?v=348';
import { STAMINA_MAX } from '../domain/stamina.js?v=348';
import { ITEMS } from '../domain/items.js?v=363';
import { ITEM_BUY_PRICE } from '../domain/shopCatalog.js?v=351';
import { MONSTERS } from '../domain/bestiary.js?v=371';
import { RARITY_TIERS } from '../domain/rarity.js?v=349';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=351';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=350';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=349';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=349';
import { saveGame } from './saveGameUseCase.js?v=352';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=353';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=351';
