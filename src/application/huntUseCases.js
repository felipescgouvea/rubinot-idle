...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=246';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=246';
import { ZONES } from '../domain/bestiary.js?v=259';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=268';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=239';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=271';
import { monsterAttack } from '../domain/combatFormulas.js?v=270';
import { elementMod } from '../domain/elements.js?v=237';
import { STAMINA_MAX } from '../domain/stamina.js?v=237';
import { ITEMS } from '../domain/items.js?v=252';
import { MONSTERS } from '../domain/bestiary.js?v=259';
import { RARITY_TIERS } from '../domain/rarity.js?v=238';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=239';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=239';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=238';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=238';
import { saveGame } from './saveGameUseCase.js?v=241';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=242';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=240';
