...
import { G, ACCOUNT } from './gameStore.js?v=239';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=244';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=244';
import { ZONES } from '../domain/bestiary.js?v=257';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, PROMOTION } from '../domain/character.js?v=266';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=237';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=269';
import { monsterAttack } from '../domain/combatFormulas.js?v=268';
import { elementMod } from '../domain/elements.js?v=235';
import { STAMINA_MAX } from '../domain/stamina.js?v=235';
import { ITEMS } from '../domain/items.js?v=250';
import { MONSTERS } from '../domain/bestiary.js?v=257';
import { RARITY_TIERS } from '../domain/rarity.js?v=236';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=237';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=237';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=236';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=236';
import { saveGame } from './saveGameUseCase.js?v=239';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=240';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=238';
