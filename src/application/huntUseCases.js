...
import { G, ACCOUNT } from './gameStore.js?v=330';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=338';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=335';
import { ZONES } from '../domain/bestiary.js?v=349';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=357';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=328';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=360';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=359';
import { elementMod } from '../domain/elements.js?v=326';
import { STAMINA_MAX } from '../domain/stamina.js?v=326';
import { ITEMS } from '../domain/items.js?v=341';
import { MONSTERS } from '../domain/bestiary.js?v=349';
import { RARITY_TIERS } from '../domain/rarity.js?v=327';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=329';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=328';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=327';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=327';
import { saveGame } from './saveGameUseCase.js?v=330';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=331';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=329';
