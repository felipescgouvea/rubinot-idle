...
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=354';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=351';
import { ZONES } from '../domain/bestiary.js?v=365';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=373';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=344';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=376';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=375';
import { elementMod } from '../domain/elements.js?v=342';
import { STAMINA_MAX } from '../domain/stamina.js?v=342';
import { ITEMS } from '../domain/items.js?v=357';
import { ITEM_BUY_PRICE } from '../domain/shopCatalog.js?v=345';
import { MONSTERS } from '../domain/bestiary.js?v=365';
import { RARITY_TIERS } from '../domain/rarity.js?v=343';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=345';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=344';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=343';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=343';
import { saveGame } from './saveGameUseCase.js?v=346';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=347';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=345';
