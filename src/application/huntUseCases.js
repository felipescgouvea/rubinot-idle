...
import { G, ACCOUNT } from './gameStore.js?v=337';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=345';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=342';
import { ZONES } from '../domain/bestiary.js?v=356';
import { VOCATIONS, VOC_TRAINING, XP_TABLE, MAX_LEVEL, PROMOTION } from '../domain/character.js?v=364';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=335';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=367';
import { monsterAttack, equippedWeaponSkillId } from '../domain/combatFormulas.js?v=366';
import { elementMod } from '../domain/elements.js?v=333';
import { STAMINA_MAX } from '../domain/stamina.js?v=333';
import { ITEMS } from '../domain/items.js?v=348';
import { ITEM_BUY_PRICE } from '../domain/shopCatalog.js?v=336';
import { MONSTERS } from '../domain/bestiary.js?v=356';
import { RARITY_TIERS } from '../domain/rarity.js?v=334';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile, meleeSwingName } from '../domain/combatFx.js?v=336';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=335';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=334';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=334';
import { saveGame } from './saveGameUseCase.js?v=337';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=338';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=336';
import { t } from '../i18n/i18n.js?v=353';
