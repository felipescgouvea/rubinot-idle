...
import { ZONES, boostedZoneForDate, BOSS_MONSTER_IDS, bossTierMultiplier, bossAuraClass } from '../domain/bestiary.js?v=117';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=117';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=117';
import { computeBoostMods } from '../domain/shopCatalog.js?v=117';
import { isRuneAvailableToVocation, canUseAttackRune, normalizeAttackSpells } from '../domain/rtcConfig.js?v=117';
import { worldXpMultiplier, worldGoldMultiplier } from '../domain/progression.js?v=117';
import { calcDamage, spawnMonsterInstance, spellAttackDamage, spellHealAmount, runeDamage, potionRestore, monsterAttack } from '../domain/combatFormulas.js?v=117';
import { elementMod } from '../domain/elements.js?v=117';
import { STAMINA_MAX, staminaXpMult } from '../domain/stamina.js?v=117';
import { deathXpLossPct, reviveHpPct } from '../domain/blessings.js?v=117';
import { ITEMS, EQUIPPABLE_TYPES, canUsePotion, resolveEquippedItem } from '../domain/items.js?v=117';
import { MONSTERS } from '../domain/bestiary.js?v=117';
import { RARITY_TIERS, rollRarityTier } from '../domain/rarity.js?v=117';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=117';
import { spellEffectName, runeEffectName, basicAttackMissile } from '../domain/combatFx.js?v=117';
import { emit, EVENTS } from '../shared/eventBus.js?v=117';
import { getAtk, getDef, getMagic, getMaxHp, getMaxMana, getSpd, getEquippedWeaponSkillId } from './stats.js?v=117';
import { trainSkill } from './skillUseCases.js?v=117';
import { addItemToInventory } from './inventoryCore.js?v=117';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=117';
import { getCombatBonuses } from './bonuses.js?v=117';
import { getXpRate, getGoldRate, getLootRate, getRelicDropChance, getRarityWeights, getSpawnDelayRange, getZoneMultiplier, isStaminaEnabled, isConsumeAmmo, getZoneSpawn } from './adminUseCases.js?v=117';
import { itemSpriteFile, monsterSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=117';
