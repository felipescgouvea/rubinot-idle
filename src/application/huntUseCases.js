...
import { G, ACCOUNT } from './gameStore.js?v=171';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget } from '../infrastructure/authClient.js?v=176';
import { ZONES } from '../domain/bestiary.js?v=189';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=198';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=169';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=201';
import { monsterAttack } from '../domain/combatFormulas.js?v=200';
import { elementMod } from '../domain/elements.js?v=167';
import { STAMINA_MAX } from '../domain/stamina.js?v=167';
import { ITEMS } from '../domain/items.js?v=182';
import { MONSTERS } from '../domain/bestiary.js?v=189';
import { RARITY_TIERS } from '../domain/rarity.js?v=168';
import { spellEffectName, spellMissileName, runeEffectName, basicAttackMissile } from '../domain/combatFx.js?v=169';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=169';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=168';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=168';
import { saveGame } from './saveGameUseCase.js?v=171';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=172';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=170';
