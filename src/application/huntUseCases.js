...
import { G, ACCOUNT } from './gameStore.js?v=211';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=216';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=216';
import { ZONES } from '../domain/bestiary.js?v=229';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=238';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=209';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=241';
import { monsterAttack } from '../domain/combatFormulas.js?v=240';
import { elementMod } from '../domain/elements.js?v=207';
import { STAMINA_MAX } from '../domain/stamina.js?v=207';
import { ITEMS } from '../domain/items.js?v=222';
import { MONSTERS } from '../domain/bestiary.js?v=229';
import { RARITY_TIERS } from '../domain/rarity.js?v=208';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=209';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=209';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=208';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=208';
import { saveGame } from './saveGameUseCase.js?v=211';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=212';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=210';
