...
import { G, ACCOUNT } from './gameStore.js?v=141';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget } from '../infrastructure/authClient.js?v=146';
import { ZONES } from '../domain/bestiary.js?v=159';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=168';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=139';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=171';
import { monsterAttack } from '../domain/combatFormulas.js?v=170';
import { elementMod } from '../domain/elements.js?v=137';
import { STAMINA_MAX } from '../domain/stamina.js?v=137';
import { ITEMS } from '../domain/items.js?v=152';
import { MONSTERS } from '../domain/bestiary.js?v=159';
import { RARITY_TIERS } from '../domain/rarity.js?v=138';
import { spellEffectName, spellMissileName, runeEffectName, basicAttackMissile } from '../domain/combatFx.js?v=139';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=139';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=138';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=138';
import { saveGame } from './saveGameUseCase.js?v=141';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=142';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=140';
