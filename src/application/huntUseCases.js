...
import { G, ACCOUNT } from './gameStore.js?v=204';
import { startHuntSession, stopHuntSession, getHuntState, idleHealOnServer, setHuntTarget, updateHuntRtc, getAccessToken } from '../infrastructure/authClient.js?v=209';
import { conectarRealtime, desconectarRealtime, realtimeAtivo } from '../infrastructure/realtimeClient.js?v=209';
import { ZONES } from '../domain/bestiary.js?v=222';
import { VOCATIONS, VOC_TRAINING, XP_TABLE } from '../domain/character.js?v=231';
import { SPELLS, isSpellAvailable, defaultHealSpellId } from '../domain/spells.js?v=202';
import { canUseAttackRune, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=234';
import { monsterAttack } from '../domain/combatFormulas.js?v=233';
import { elementMod } from '../domain/elements.js?v=200';
import { STAMINA_MAX } from '../domain/stamina.js?v=200';
import { ITEMS } from '../domain/items.js?v=215';
import { MONSTERS } from '../domain/bestiary.js?v=222';
import { RARITY_TIERS } from '../domain/rarity.js?v=201';
import { spellEffectName, spellMissileName, runeEffectName, runeMissileName, basicAttackMissile } from '../domain/combatFx.js?v=202';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=202';
import { getDef, getMagic, getMaxHp, getMaxMana, getSpd } from './stats.js?v=201';
import { checkBpTier, bumpMissionProgress } from './battlePassUseCases.js?v=201';
import { saveGame } from './saveGameUseCase.js?v=204';
import { isStaminaEnabled, isConsumeAmmo, getProjectileSpeedMs } from './adminUseCases.js?v=205';
import { itemLogIcon, monsterLogIcon } from './logIcons.js?v=203';
import { t } from '../i18n/i18n.js?v=218';
