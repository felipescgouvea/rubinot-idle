...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=202';
import { emit, EVENTS } from '../shared/eventBus.js?v=189';
import { addItemToInventory } from './inventoryCore.js?v=189';
import { startRegen } from './huntUseCases.js?v=255';
import { saveGame } from './saveGameUseCase.js?v=191';
import { grantStarterKit } from '../infrastructure/authClient.js?v=196';
