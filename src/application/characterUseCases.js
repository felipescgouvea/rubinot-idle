...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=192';
import { emit, EVENTS } from '../shared/eventBus.js?v=179';
import { addItemToInventory } from './inventoryCore.js?v=179';
import { startRegen } from './huntUseCases.js?v=245';
import { saveGame } from './saveGameUseCase.js?v=181';
import { grantStarterKit } from '../infrastructure/authClient.js?v=186';
