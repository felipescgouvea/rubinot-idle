...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=153';
import { emit, EVENTS } from '../shared/eventBus.js?v=140';
import { addItemToInventory } from './inventoryCore.js?v=140';
import { startRegen } from './huntUseCases.js?v=206';
import { saveGame } from './saveGameUseCase.js?v=142';
import { grantStarterKit } from '../infrastructure/authClient.js?v=147';
