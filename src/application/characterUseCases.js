...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=142';
import { emit, EVENTS } from '../shared/eventBus.js?v=129';
import { addItemToInventory } from './inventoryCore.js?v=129';
import { startRegen } from './huntUseCases.js?v=195';
import { saveGame } from './saveGameUseCase.js?v=131';
import { grantStarterKit } from '../infrastructure/authClient.js?v=136';
