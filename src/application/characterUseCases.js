...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=171';
import { emit, EVENTS } from '../shared/eventBus.js?v=158';
import { addItemToInventory } from './inventoryCore.js?v=158';
import { startRegen } from './huntUseCases.js?v=224';
import { saveGame } from './saveGameUseCase.js?v=160';
import { grantStarterKit } from '../infrastructure/authClient.js?v=165';
