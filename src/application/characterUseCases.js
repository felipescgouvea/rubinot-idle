...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=144';
import { emit, EVENTS } from '../shared/eventBus.js?v=131';
import { addItemToInventory } from './inventoryCore.js?v=131';
import { startRegen } from './huntUseCases.js?v=197';
import { saveGame } from './saveGameUseCase.js?v=133';
import { grantStarterKit } from '../infrastructure/authClient.js?v=138';
