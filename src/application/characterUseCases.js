...
import { STARTER_KITS, STARTER_SUPPLIES } from '../domain/items.js?v=141';
import { emit, EVENTS } from '../shared/eventBus.js?v=128';
import { addItemToInventory } from './inventoryCore.js?v=128';
import { startRegen } from './huntUseCases.js?v=194';
import { saveGame } from './saveGameUseCase.js?v=130';
import { grantStarterKit } from '../infrastructure/authClient.js?v=135';
