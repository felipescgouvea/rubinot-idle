...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=165';
import { emit, EVENTS } from '../shared/eventBus.js?v=152';
import { addItemToInventory } from './inventoryCore.js?v=152';
import { startRegen } from './huntUseCases.js?v=218';
import { saveGame } from './saveGameUseCase.js?v=154';
import { grantStarterKit } from '../infrastructure/authClient.js?v=159';
