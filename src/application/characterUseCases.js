...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=200';
import { emit, EVENTS } from '../shared/eventBus.js?v=187';
import { addItemToInventory } from './inventoryCore.js?v=187';
import { startRegen } from './huntUseCases.js?v=253';
import { saveGame } from './saveGameUseCase.js?v=189';
import { grantStarterKit } from '../infrastructure/authClient.js?v=194';
