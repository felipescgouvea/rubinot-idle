...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=190';
import { emit, EVENTS } from '../shared/eventBus.js?v=177';
import { addItemToInventory } from './inventoryCore.js?v=177';
import { startRegen } from './huntUseCases.js?v=243';
import { saveGame } from './saveGameUseCase.js?v=179';
import { grantStarterKit } from '../infrastructure/authClient.js?v=184';
