...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=160';
import { emit, EVENTS } from '../shared/eventBus.js?v=147';
import { addItemToInventory } from './inventoryCore.js?v=147';
import { startRegen } from './huntUseCases.js?v=213';
import { saveGame } from './saveGameUseCase.js?v=149';
import { grantStarterKit } from '../infrastructure/authClient.js?v=154';
