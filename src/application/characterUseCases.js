...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=369';
import { canGraduate } from '../domain/cities.js?v=369';
import { getMaxHp, getMaxMana } from './stats.js?v=369';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=356';
import { addItemToInventory } from './inventoryCore.js?v=356';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=422';
import { saveGame } from './saveGameUseCase.js?v=358';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=366';
import { pruneRtcForVocation } from './rtcUseCases.js?v=384';
