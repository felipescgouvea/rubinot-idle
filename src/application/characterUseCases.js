...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=156';
import { emit, EVENTS } from '../shared/eventBus.js?v=143';
import { addItemToInventory } from './inventoryCore.js?v=143';
import { startRegen } from './huntUseCases.js?v=209';
import { saveGame } from './saveGameUseCase.js?v=145';
import { grantStarterKit } from '../infrastructure/authClient.js?v=150';
