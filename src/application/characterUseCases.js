...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=201';
import { emit, EVENTS } from '../shared/eventBus.js?v=188';
import { addItemToInventory } from './inventoryCore.js?v=188';
import { startRegen } from './huntUseCases.js?v=254';
import { saveGame } from './saveGameUseCase.js?v=190';
import { grantStarterKit } from '../infrastructure/authClient.js?v=195';
