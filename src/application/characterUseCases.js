...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=147';
import { emit, EVENTS } from '../shared/eventBus.js?v=134';
import { addItemToInventory } from './inventoryCore.js?v=134';
import { startRegen } from './huntUseCases.js?v=200';
import { saveGame } from './saveGameUseCase.js?v=136';
import { grantStarterKit } from '../infrastructure/authClient.js?v=141';
