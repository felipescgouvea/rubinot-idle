...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=185';
import { emit, EVENTS } from '../shared/eventBus.js?v=172';
import { addItemToInventory } from './inventoryCore.js?v=172';
import { startRegen } from './huntUseCases.js?v=238';
import { saveGame } from './saveGameUseCase.js?v=174';
import { grantStarterKit } from '../infrastructure/authClient.js?v=179';
