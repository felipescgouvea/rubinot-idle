...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=162';
import { emit, EVENTS } from '../shared/eventBus.js?v=149';
import { addItemToInventory } from './inventoryCore.js?v=149';
import { startRegen } from './huntUseCases.js?v=215';
import { saveGame } from './saveGameUseCase.js?v=151';
import { grantStarterKit } from '../infrastructure/authClient.js?v=156';
