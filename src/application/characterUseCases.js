...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=230';
import { canGraduate } from '../domain/cities.js?v=230';
...
import { startRegen } from './huntUseCases.js?v=283';
import { saveGame } from './saveGameUseCase.js?v=219';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=224';
