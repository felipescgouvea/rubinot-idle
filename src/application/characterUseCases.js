...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=199';
import { emit, EVENTS } from '../shared/eventBus.js?v=186';
import { addItemToInventory } from './inventoryCore.js?v=186';
import { startRegen } from './huntUseCases.js?v=252';
import { saveGame } from './saveGameUseCase.js?v=188';
import { grantStarterKit } from '../infrastructure/authClient.js?v=193';
