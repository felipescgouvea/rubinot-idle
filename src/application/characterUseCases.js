...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=143';
import { emit, EVENTS } from '../shared/eventBus.js?v=130';
import { addItemToInventory } from './inventoryCore.js?v=130';
import { startRegen } from './huntUseCases.js?v=196';
import { saveGame } from './saveGameUseCase.js?v=132';
import { grantStarterKit } from '../infrastructure/authClient.js?v=137';
