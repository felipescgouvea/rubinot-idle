...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=151';
import { emit, EVENTS } from '../shared/eventBus.js?v=138';
import { addItemToInventory } from './inventoryCore.js?v=138';
import { startRegen } from './huntUseCases.js?v=204';
import { saveGame } from './saveGameUseCase.js?v=140';
import { grantStarterKit } from '../infrastructure/authClient.js?v=145';
