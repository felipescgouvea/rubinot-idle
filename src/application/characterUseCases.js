...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=208';
import { emit, EVENTS } from '../shared/eventBus.js?v=195';
import { addItemToInventory } from './inventoryCore.js?v=195';
import { startRegen } from './huntUseCases.js?v=261';
import { saveGame } from './saveGameUseCase.js?v=197';
import { grantStarterKit } from '../infrastructure/authClient.js?v=202';
