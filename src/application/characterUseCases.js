...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=203';
import { emit, EVENTS } from '../shared/eventBus.js?v=190';
import { addItemToInventory } from './inventoryCore.js?v=190';
import { startRegen } from './huntUseCases.js?v=256';
import { saveGame } from './saveGameUseCase.js?v=192';
import { grantStarterKit } from '../infrastructure/authClient.js?v=197';
