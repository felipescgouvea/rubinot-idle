...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=148';
import { emit, EVENTS } from '../shared/eventBus.js?v=135';
import { addItemToInventory } from './inventoryCore.js?v=135';
import { startRegen } from './huntUseCases.js?v=201';
import { saveGame } from './saveGameUseCase.js?v=137';
import { grantStarterKit } from '../infrastructure/authClient.js?v=142';
