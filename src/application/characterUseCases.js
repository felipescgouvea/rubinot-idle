...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=188';
import { emit, EVENTS } from '../shared/eventBus.js?v=175';
import { addItemToInventory } from './inventoryCore.js?v=175';
import { startRegen } from './huntUseCases.js?v=241';
import { saveGame } from './saveGameUseCase.js?v=177';
import { grantStarterKit } from '../infrastructure/authClient.js?v=182';
