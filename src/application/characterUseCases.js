...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=170';
import { emit, EVENTS } from '../shared/eventBus.js?v=157';
import { addItemToInventory } from './inventoryCore.js?v=157';
import { startRegen } from './huntUseCases.js?v=223';
import { saveGame } from './saveGameUseCase.js?v=159';
import { grantStarterKit } from '../infrastructure/authClient.js?v=164';
