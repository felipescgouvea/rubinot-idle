...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=173';
import { emit, EVENTS } from '../shared/eventBus.js?v=160';
import { addItemToInventory } from './inventoryCore.js?v=160';
import { startRegen } from './huntUseCases.js?v=226';
import { saveGame } from './saveGameUseCase.js?v=162';
import { grantStarterKit } from '../infrastructure/authClient.js?v=167';
