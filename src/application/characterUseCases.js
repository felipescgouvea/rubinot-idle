...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=216';
import { emit, EVENTS } from '../shared/eventBus.js?v=203';
import { addItemToInventory } from './inventoryCore.js?v=203';
import { startRegen } from './huntUseCases.js?v=269';
import { saveGame } from './saveGameUseCase.js?v=205';
import { grantStarterKit } from '../infrastructure/authClient.js?v=210';
