...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=215';
import { emit, EVENTS } from '../shared/eventBus.js?v=202';
import { addItemToInventory } from './inventoryCore.js?v=202';
import { startRegen } from './huntUseCases.js?v=268';
import { saveGame } from './saveGameUseCase.js?v=204';
import { grantStarterKit } from '../infrastructure/authClient.js?v=209';
