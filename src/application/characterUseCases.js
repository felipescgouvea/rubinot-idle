...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=195';
import { emit, EVENTS } from '../shared/eventBus.js?v=182';
import { addItemToInventory } from './inventoryCore.js?v=182';
import { startRegen } from './huntUseCases.js?v=248';
import { saveGame } from './saveGameUseCase.js?v=184';
import { grantStarterKit } from '../infrastructure/authClient.js?v=189';
