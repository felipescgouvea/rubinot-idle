...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=146';
import { emit, EVENTS } from '../shared/eventBus.js?v=133';
import { addItemToInventory } from './inventoryCore.js?v=133';
import { startRegen } from './huntUseCases.js?v=199';
import { saveGame } from './saveGameUseCase.js?v=135';
import { grantStarterKit } from '../infrastructure/authClient.js?v=140';
