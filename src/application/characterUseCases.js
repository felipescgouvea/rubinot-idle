...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=167';
import { emit, EVENTS } from '../shared/eventBus.js?v=154';
import { addItemToInventory } from './inventoryCore.js?v=154';
import { startRegen } from './huntUseCases.js?v=220';
import { saveGame } from './saveGameUseCase.js?v=156';
import { grantStarterKit } from '../infrastructure/authClient.js?v=161';
