...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=368';
import { canGraduate } from '../domain/cities.js?v=368';
import { getMaxHp, getMaxMana } from './stats.js?v=368';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=355';
import { addItemToInventory } from './inventoryCore.js?v=355';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=421';
import { saveGame } from './saveGameUseCase.js?v=357';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=365';
import { pruneRtcForVocation } from './rtcUseCases.js?v=383';
