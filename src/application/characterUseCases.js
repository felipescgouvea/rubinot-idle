...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=364';
import { canGraduate } from '../domain/cities.js?v=364';
import { getMaxHp, getMaxMana } from './stats.js?v=364';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=351';
import { addItemToInventory } from './inventoryCore.js?v=351';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=417';
import { saveGame } from './saveGameUseCase.js?v=353';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=361';
import { pruneRtcForVocation } from './rtcUseCases.js?v=379';
