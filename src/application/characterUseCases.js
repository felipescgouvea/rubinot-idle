...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=217';
import { emit, EVENTS } from '../shared/eventBus.js?v=204';
import { addItemToInventory } from './inventoryCore.js?v=204';
import { startRegen } from './huntUseCases.js?v=270';
import { saveGame } from './saveGameUseCase.js?v=206';
import { grantStarterKit } from '../infrastructure/authClient.js?v=211';
