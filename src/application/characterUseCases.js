...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=370';
import { canGraduate } from '../domain/cities.js?v=370';
import { getMaxHp, getMaxMana } from './stats.js?v=370';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=357';
import { addItemToInventory } from './inventoryCore.js?v=357';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=423';
import { saveGame } from './saveGameUseCase.js?v=359';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=367';
import { pruneRtcForVocation } from './rtcUseCases.js?v=385';
