...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=154';
import { emit, EVENTS } from '../shared/eventBus.js?v=141';
import { addItemToInventory } from './inventoryCore.js?v=141';
import { startRegen } from './huntUseCases.js?v=207';
import { saveGame } from './saveGameUseCase.js?v=143';
import { grantStarterKit } from '../infrastructure/authClient.js?v=148';
