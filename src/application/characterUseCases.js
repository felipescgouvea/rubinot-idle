...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=193';
import { emit, EVENTS } from '../shared/eventBus.js?v=180';
import { addItemToInventory } from './inventoryCore.js?v=180';
import { startRegen } from './huntUseCases.js?v=246';
import { saveGame } from './saveGameUseCase.js?v=182';
import { grantStarterKit } from '../infrastructure/authClient.js?v=187';
