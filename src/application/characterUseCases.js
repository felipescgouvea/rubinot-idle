...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=164';
import { emit, EVENTS } from '../shared/eventBus.js?v=151';
import { addItemToInventory } from './inventoryCore.js?v=151';
import { startRegen } from './huntUseCases.js?v=217';
import { saveGame } from './saveGameUseCase.js?v=153';
import { grantStarterKit } from '../infrastructure/authClient.js?v=158';
