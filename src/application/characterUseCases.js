...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=204';
import { emit, EVENTS } from '../shared/eventBus.js?v=191';
import { addItemToInventory } from './inventoryCore.js?v=191';
import { startRegen } from './huntUseCases.js?v=257';
import { saveGame } from './saveGameUseCase.js?v=193';
import { grantStarterKit } from '../infrastructure/authClient.js?v=198';
