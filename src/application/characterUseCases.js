...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=159';
import { emit, EVENTS } from '../shared/eventBus.js?v=146';
import { addItemToInventory } from './inventoryCore.js?v=146';
import { startRegen } from './huntUseCases.js?v=212';
import { saveGame } from './saveGameUseCase.js?v=148';
import { grantStarterKit } from '../infrastructure/authClient.js?v=153';
