...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=218';
import { emit, EVENTS } from '../shared/eventBus.js?v=205';
import { addItemToInventory } from './inventoryCore.js?v=205';
import { startRegen } from './huntUseCases.js?v=271';
import { saveGame } from './saveGameUseCase.js?v=207';
import { grantStarterKit } from '../infrastructure/authClient.js?v=212';
