...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=194';
import { emit, EVENTS } from '../shared/eventBus.js?v=181';
import { addItemToInventory } from './inventoryCore.js?v=181';
import { startRegen } from './huntUseCases.js?v=247';
import { saveGame } from './saveGameUseCase.js?v=183';
import { grantStarterKit } from '../infrastructure/authClient.js?v=188';
