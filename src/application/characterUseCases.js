...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=149';
import { emit, EVENTS } from '../shared/eventBus.js?v=136';
import { addItemToInventory } from './inventoryCore.js?v=136';
import { startRegen } from './huntUseCases.js?v=202';
import { saveGame } from './saveGameUseCase.js?v=138';
import { grantStarterKit } from '../infrastructure/authClient.js?v=143';
