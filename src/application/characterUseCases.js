...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=371';
import { canGraduate } from '../domain/cities.js?v=371';
import { getMaxHp, getMaxMana } from './stats.js?v=371';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=358';
import { addItemToInventory } from './inventoryCore.js?v=358';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=424';
import { saveGame } from './saveGameUseCase.js?v=360';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=368';
import { pruneRtcForVocation } from './rtcUseCases.js?v=386';
