...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=150';
import { emit, EVENTS } from '../shared/eventBus.js?v=137';
import { addItemToInventory } from './inventoryCore.js?v=137';
import { startRegen } from './huntUseCases.js?v=203';
import { saveGame } from './saveGameUseCase.js?v=139';
import { grantStarterKit } from '../infrastructure/authClient.js?v=144';
