...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=163';
import { emit, EVENTS } from '../shared/eventBus.js?v=150';
import { addItemToInventory } from './inventoryCore.js?v=150';
import { startRegen } from './huntUseCases.js?v=216';
import { saveGame } from './saveGameUseCase.js?v=152';
import { grantStarterKit } from '../infrastructure/authClient.js?v=157';
