...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=161';
import { emit, EVENTS } from '../shared/eventBus.js?v=148';
import { addItemToInventory } from './inventoryCore.js?v=148';
import { startRegen } from './huntUseCases.js?v=214';
import { saveGame } from './saveGameUseCase.js?v=150';
import { grantStarterKit } from '../infrastructure/authClient.js?v=155';
