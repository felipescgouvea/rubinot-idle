...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=196';
import { emit, EVENTS } from '../shared/eventBus.js?v=183';
import { addItemToInventory } from './inventoryCore.js?v=183';
import { startRegen } from './huntUseCases.js?v=249';
import { saveGame } from './saveGameUseCase.js?v=185';
import { grantStarterKit } from '../infrastructure/authClient.js?v=190';
