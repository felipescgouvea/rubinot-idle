...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=166';
import { emit, EVENTS } from '../shared/eventBus.js?v=153';
import { addItemToInventory } from './inventoryCore.js?v=153';
import { startRegen } from './huntUseCases.js?v=219';
import { saveGame } from './saveGameUseCase.js?v=155';
import { grantStarterKit } from '../infrastructure/authClient.js?v=160';
