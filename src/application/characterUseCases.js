...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=172';
import { emit, EVENTS } from '../shared/eventBus.js?v=159';
import { addItemToInventory } from './inventoryCore.js?v=159';
import { startRegen } from './huntUseCases.js?v=225';
import { saveGame } from './saveGameUseCase.js?v=161';
import { grantStarterKit } from '../infrastructure/authClient.js?v=166';
