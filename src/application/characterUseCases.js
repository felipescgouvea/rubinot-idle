...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=155';
import { emit, EVENTS } from '../shared/eventBus.js?v=142';
import { addItemToInventory } from './inventoryCore.js?v=142';
import { startRegen } from './huntUseCases.js?v=208';
import { saveGame } from './saveGameUseCase.js?v=144';
import { grantStarterKit } from '../infrastructure/authClient.js?v=149';
