...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=191';
import { emit, EVENTS } from '../shared/eventBus.js?v=178';
import { addItemToInventory } from './inventoryCore.js?v=178';
import { startRegen } from './huntUseCases.js?v=244';
import { saveGame } from './saveGameUseCase.js?v=180';
import { grantStarterKit } from '../infrastructure/authClient.js?v=185';
