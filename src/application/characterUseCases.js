...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=145';
import { emit, EVENTS } from '../shared/eventBus.js?v=132';
import { addItemToInventory } from './inventoryCore.js?v=132';
import { startRegen } from './huntUseCases.js?v=198';
import { saveGame } from './saveGameUseCase.js?v=134';
import { grantStarterKit } from '../infrastructure/authClient.js?v=139';
