...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=184';
import { emit, EVENTS } from '../shared/eventBus.js?v=171';
import { addItemToInventory } from './inventoryCore.js?v=171';
import { startRegen } from './huntUseCases.js?v=237';
import { saveGame } from './saveGameUseCase.js?v=173';
import { grantStarterKit } from '../infrastructure/authClient.js?v=178';
