...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=207';
import { emit, EVENTS } from '../shared/eventBus.js?v=194';
import { addItemToInventory } from './inventoryCore.js?v=194';
import { startRegen } from './huntUseCases.js?v=260';
import { saveGame } from './saveGameUseCase.js?v=196';
import { grantStarterKit } from '../infrastructure/authClient.js?v=201';
