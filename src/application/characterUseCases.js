...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=367';
import { canGraduate } from '../domain/cities.js?v=367';
import { getMaxHp, getMaxMana } from './stats.js?v=367';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=354';
import { addItemToInventory } from './inventoryCore.js?v=354';
import { startRegen, resyncHuntSession } from './huntUseCases.js?v=420';
import { saveGame } from './saveGameUseCase.js?v=356';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=364';
import { pruneRtcForVocation } from './rtcUseCases.js?v=382';
