...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=189';
import { emit, EVENTS } from '../shared/eventBus.js?v=176';
import { addItemToInventory } from './inventoryCore.js?v=176';
import { startRegen } from './huntUseCases.js?v=242';
import { saveGame } from './saveGameUseCase.js?v=178';
import { grantStarterKit } from '../infrastructure/authClient.js?v=183';
