...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY, GRADUATE_KITS, GRADUATE_AMMO_QTY } from '../domain/items.js?v=239';
import { canGraduate } from '../domain/cities.js?v=239';
...
import { startRegen } from './huntUseCases.js?v=292';
import { saveGame } from './saveGameUseCase.js?v=228';
import { grantStarterKit, grantGraduateKit } from '../infrastructure/authClient.js?v=233';
