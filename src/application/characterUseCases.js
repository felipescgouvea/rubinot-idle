...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=183';
import { emit, EVENTS } from '../shared/eventBus.js?v=170';
import { addItemToInventory } from './inventoryCore.js?v=170';
import { startRegen } from './huntUseCases.js?v=236';
import { saveGame } from './saveGameUseCase.js?v=172';
import { grantStarterKit } from '../infrastructure/authClient.js?v=177';
