...
import { STARTER_KITS, STARTER_SUPPLIES, STARTER_AMMO_QTY } from '../domain/items.js?v=152';
import { emit, EVENTS } from '../shared/eventBus.js?v=139';
import { addItemToInventory } from './inventoryCore.js?v=139';
import { startRegen } from './huntUseCases.js?v=205';
import { saveGame } from './saveGameUseCase.js?v=141';
import { grantStarterKit } from '../infrastructure/authClient.js?v=146';
