...
import { G, replaceState, replaceAccount } from './gameStore.js?v=175';
import { createDefaultState } from '../domain/gameState.js?v=175';
import { createDefaultSkills } from '../domain/character.js?v=202';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=205';
import { isSpellAvailable } from '../domain/spells.js?v=173';
import { findOutfit } from '../domain/outfits.js?v=171';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=171';
import { ZONES } from '../domain/bestiary.js?v=193';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=186';
import { addItemToInventory } from './inventoryCore.js?v=173';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=172';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=174';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=171';
import { t } from '../i18n/i18n.js?v=189';
import { getMaxHp, getMaxMana } from './stats.js?v=172';
