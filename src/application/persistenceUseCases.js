...
import { G, replaceState, replaceAccount } from './gameStore.js?v=216';
import { createDefaultState } from '../domain/gameState.js?v=216';
import { createDefaultSkills } from '../domain/character.js?v=243';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=246';
import { isSpellAvailable } from '../domain/spells.js?v=214';
import { findOutfit } from '../domain/outfits.js?v=212';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=212';
import { ZONES } from '../domain/bestiary.js?v=234';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=227';
import { addItemToInventory } from './inventoryCore.js?v=214';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=213';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=215';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=212';
import { t } from '../i18n/i18n.js?v=230';
import { getMaxHp, getMaxMana } from './stats.js?v=213';
