...
import { G, replaceState, replaceAccount } from './gameStore.js?v=226';
import { createDefaultState } from '../domain/gameState.js?v=226';
import { createDefaultSkills } from '../domain/character.js?v=253';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=256';
import { isSpellAvailable } from '../domain/spells.js?v=224';
import { findOutfit } from '../domain/outfits.js?v=222';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=222';
import { ZONES } from '../domain/bestiary.js?v=244';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=237';
import { addItemToInventory } from './inventoryCore.js?v=224';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=223';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=225';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=222';
import { t } from '../i18n/i18n.js?v=240';
import { getMaxHp, getMaxMana } from './stats.js?v=223';
