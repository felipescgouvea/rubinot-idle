...
import { G, replaceState, replaceAccount } from './gameStore.js?v=319';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=319';
import { createDefaultSkills } from '../domain/character.js?v=346';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=349';
import { isSpellAvailable } from '../domain/spells.js?v=317';
import { findOutfit } from '../domain/outfits.js?v=315';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=315';
import { ZONES } from '../domain/bestiary.js?v=338';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=330';
import { addItemToInventory } from './inventoryCore.js?v=317';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=316';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=318';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=315';
import { t } from '../i18n/i18n.js?v=335';
import { getMaxHp, getMaxMana } from './stats.js?v=316';
