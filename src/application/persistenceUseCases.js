...
import { G, replaceState, replaceAccount } from './gameStore.js?v=342';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=342';
import { createDefaultSkills } from '../domain/character.js?v=369';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=372';
import { isSpellAvailable } from '../domain/spells.js?v=340';
import { findOutfit } from '../domain/outfits.js?v=338';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=338';
import { ZONES } from '../domain/bestiary.js?v=361';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=353';
import { addItemToInventory } from './inventoryCore.js?v=340';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=339';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=341';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=338';
