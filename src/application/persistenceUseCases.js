...
import { G, replaceState, replaceAccount } from './gameStore.js?v=189';
import { createDefaultState } from '../domain/gameState.js?v=189';
import { createDefaultSkills } from '../domain/character.js?v=216';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=219';
import { isSpellAvailable } from '../domain/spells.js?v=187';
import { findOutfit } from '../domain/outfits.js?v=185';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=185';
import { ZONES } from '../domain/bestiary.js?v=207';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=200';
import { addItemToInventory } from './inventoryCore.js?v=187';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=186';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=188';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=185';
import { t } from '../i18n/i18n.js?v=203';
import { getMaxHp, getMaxMana } from './stats.js?v=186';
