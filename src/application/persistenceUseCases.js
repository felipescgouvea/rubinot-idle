...
import { G, replaceState, replaceAccount } from './gameStore.js?v=149';
import { createDefaultState } from '../domain/gameState.js?v=149';
import { createDefaultSkills } from '../domain/character.js?v=176';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=179';
import { isSpellAvailable } from '../domain/spells.js?v=147';
import { findOutfit } from '../domain/outfits.js?v=145';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=145';
import { ZONES } from '../domain/bestiary.js?v=167';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=160';
import { addItemToInventory } from './inventoryCore.js?v=147';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=146';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=148';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=145';
import { t } from '../i18n/i18n.js?v=163';
import { getMaxHp, getMaxMana } from './stats.js?v=146';
