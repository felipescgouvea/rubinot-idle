...
import { G, replaceState, replaceAccount } from './gameStore.js?v=287';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=287';
import { createDefaultSkills } from '../domain/character.js?v=314';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=317';
import { isSpellAvailable } from '../domain/spells.js?v=285';
import { findOutfit } from '../domain/outfits.js?v=283';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=283';
import { ZONES } from '../domain/bestiary.js?v=305';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=298';
import { addItemToInventory } from './inventoryCore.js?v=285';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=284';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=286';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=283';
import { t } from '../i18n/i18n.js?v=303';
import { getMaxHp, getMaxMana } from './stats.js?v=284';
