...
import { G, replaceState, replaceAccount } from './gameStore.js?v=211';
import { createDefaultState } from '../domain/gameState.js?v=211';
import { createDefaultSkills } from '../domain/character.js?v=238';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=241';
import { isSpellAvailable } from '../domain/spells.js?v=209';
import { findOutfit } from '../domain/outfits.js?v=207';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=207';
import { ZONES } from '../domain/bestiary.js?v=229';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=222';
import { addItemToInventory } from './inventoryCore.js?v=209';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=208';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=210';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=207';
import { t } from '../i18n/i18n.js?v=225';
import { getMaxHp, getMaxMana } from './stats.js?v=208';
