...
import { G, replaceState, replaceAccount } from './gameStore.js?v=303';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=303';
import { createDefaultSkills } from '../domain/character.js?v=330';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=333';
import { isSpellAvailable } from '../domain/spells.js?v=301';
import { findOutfit } from '../domain/outfits.js?v=299';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=299';
import { ZONES } from '../domain/bestiary.js?v=322';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=314';
import { addItemToInventory } from './inventoryCore.js?v=301';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=300';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=302';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=299';
import { t } from '../i18n/i18n.js?v=319';
import { getMaxHp, getMaxMana } from './stats.js?v=300';
