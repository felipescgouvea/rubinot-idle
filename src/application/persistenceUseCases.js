...
import { G, replaceState, replaceAccount } from './gameStore.js?v=194';
import { createDefaultState } from '../domain/gameState.js?v=194';
import { createDefaultSkills } from '../domain/character.js?v=221';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=224';
import { isSpellAvailable } from '../domain/spells.js?v=192';
import { findOutfit } from '../domain/outfits.js?v=190';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=190';
import { ZONES } from '../domain/bestiary.js?v=212';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=205';
import { addItemToInventory } from './inventoryCore.js?v=192';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=191';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=193';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=190';
import { t } from '../i18n/i18n.js?v=208';
import { getMaxHp, getMaxMana } from './stats.js?v=191';
