...
import { G, replaceState, replaceAccount } from './gameStore.js?v=241';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=241';
import { createDefaultSkills } from '../domain/character.js?v=268';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=271';
import { isSpellAvailable } from '../domain/spells.js?v=239';
import { findOutfit } from '../domain/outfits.js?v=237';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=237';
import { ZONES } from '../domain/bestiary.js?v=259';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=252';
import { addItemToInventory } from './inventoryCore.js?v=239';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=238';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=240';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=237';
import { t } from '../i18n/i18n.js?v=255';
import { getMaxHp, getMaxMana } from './stats.js?v=238';
