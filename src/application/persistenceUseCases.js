...
import { G, replaceState, replaceAccount } from './gameStore.js?v=185';
import { createDefaultState } from '../domain/gameState.js?v=185';
import { createDefaultSkills } from '../domain/character.js?v=212';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=215';
import { isSpellAvailable } from '../domain/spells.js?v=183';
import { findOutfit } from '../domain/outfits.js?v=181';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=181';
import { ZONES } from '../domain/bestiary.js?v=203';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=196';
import { addItemToInventory } from './inventoryCore.js?v=183';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=182';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=184';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=181';
import { t } from '../i18n/i18n.js?v=199';
import { getMaxHp, getMaxMana } from './stats.js?v=182';
