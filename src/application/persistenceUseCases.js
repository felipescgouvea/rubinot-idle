...
import { G, replaceState, replaceAccount } from './gameStore.js?v=181';
import { createDefaultState } from '../domain/gameState.js?v=181';
import { createDefaultSkills } from '../domain/character.js?v=208';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=211';
import { isSpellAvailable } from '../domain/spells.js?v=179';
import { findOutfit } from '../domain/outfits.js?v=177';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=177';
import { ZONES } from '../domain/bestiary.js?v=199';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=192';
import { addItemToInventory } from './inventoryCore.js?v=179';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=178';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=180';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=177';
import { t } from '../i18n/i18n.js?v=195';
import { getMaxHp, getMaxMana } from './stats.js?v=178';
