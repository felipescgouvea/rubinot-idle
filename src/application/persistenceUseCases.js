...
import { G, replaceState } from './gameStore.js?v=85';
import { createDefaultState } from '../domain/gameState.js?v=85';
import { createDefaultSkills } from '../domain/character.js?v=85';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells } from '../domain/rtcConfig.js?v=85';
import { isSpellAvailable } from '../domain/spells.js?v=85';
import { findOutfit } from '../domain/outfits.js?v=85';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=85';
import { ZONES, MONSTERS } from '../domain/bestiary.js?v=85';
import { isRelicId } from '../domain/items.js?v=85';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=85';
import { worldXpMultiplier, worldGoldMultiplier } from '../domain/progression.js?v=85';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=85';
import { emit, EVENTS } from '../shared/eventBus.js?v=85';
import { getMaxHp, getMaxMana } from './stats.js?v=85';
import { gainXp } from './huntUseCases.js?v=85';
import { checkBpTier } from './battlePassUseCases.js?v=85';
import { getXpRate, getGoldRate, getZoneMultiplier, isStaminaEnabled } from './adminUseCases.js?v=85';
