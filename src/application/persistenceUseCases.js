...
import { G, replaceState, replaceAccount } from './gameStore.js?v=174';
import { createDefaultState } from '../domain/gameState.js?v=174';
import { createDefaultSkills } from '../domain/character.js?v=201';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=204';
import { isSpellAvailable } from '../domain/spells.js?v=172';
import { findOutfit } from '../domain/outfits.js?v=170';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=170';
import { ZONES } from '../domain/bestiary.js?v=192';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=185';
import { addItemToInventory } from './inventoryCore.js?v=172';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=171';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=173';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=170';
import { t } from '../i18n/i18n.js?v=188';
import { getMaxHp, getMaxMana } from './stats.js?v=171';
