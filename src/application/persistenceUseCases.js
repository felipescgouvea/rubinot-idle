...
import { G, replaceState, replaceAccount } from './gameStore.js?v=347';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=347';
import { createDefaultSkills } from '../domain/character.js?v=374';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=377';
import { isSpellAvailable } from '../domain/spells.js?v=345';
import { findOutfit } from '../domain/outfits.js?v=343';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=343';
import { ZONES } from '../domain/bestiary.js?v=366';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=358';
import { addItemToInventory } from './inventoryCore.js?v=345';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=344';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=346';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=343';
import { t } from '../i18n/i18n.js?v=363';
import { getMaxHp, getMaxMana } from './stats.js?v=344';
