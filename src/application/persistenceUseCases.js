...
import { G, replaceState, replaceAccount } from './gameStore.js?v=321';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=321';
import { createDefaultSkills } from '../domain/character.js?v=348';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=351';
import { isSpellAvailable } from '../domain/spells.js?v=319';
import { findOutfit } from '../domain/outfits.js?v=317';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=317';
import { ZONES } from '../domain/bestiary.js?v=340';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=332';
import { addItemToInventory } from './inventoryCore.js?v=319';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=318';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=320';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=317';
import { t } from '../i18n/i18n.js?v=337';
import { getMaxHp, getMaxMana } from './stats.js?v=318';
