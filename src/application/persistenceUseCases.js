...
import { G, replaceState, replaceAccount } from './gameStore.js?v=344';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=344';
import { createDefaultSkills } from '../domain/character.js?v=371';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=374';
import { isSpellAvailable } from '../domain/spells.js?v=342';
import { findOutfit } from '../domain/outfits.js?v=340';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=340';
import { ZONES } from '../domain/bestiary.js?v=363';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=355';
import { addItemToInventory } from './inventoryCore.js?v=342';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=341';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=343';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=340';
import { t } from '../i18n/i18n.js?v=360';
import { getMaxHp, getMaxMana } from './stats.js?v=341';
