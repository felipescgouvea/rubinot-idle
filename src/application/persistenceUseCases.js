...
import { G, replaceState, replaceAccount } from './gameStore.js?v=198';
import { createDefaultState } from '../domain/gameState.js?v=198';
import { createDefaultSkills } from '../domain/character.js?v=225';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=228';
import { isSpellAvailable } from '../domain/spells.js?v=196';
import { findOutfit } from '../domain/outfits.js?v=194';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=194';
import { ZONES } from '../domain/bestiary.js?v=216';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=209';
import { addItemToInventory } from './inventoryCore.js?v=196';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=195';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=197';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=194';
import { t } from '../i18n/i18n.js?v=212';
import { getMaxHp, getMaxMana } from './stats.js?v=195';
