...
import { G, replaceState, replaceAccount } from './gameStore.js?v=314';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=314';
import { createDefaultSkills } from '../domain/character.js?v=341';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=344';
import { isSpellAvailable } from '../domain/spells.js?v=312';
import { findOutfit } from '../domain/outfits.js?v=310';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=310';
import { ZONES } from '../domain/bestiary.js?v=333';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=325';
import { addItemToInventory } from './inventoryCore.js?v=312';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=311';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=313';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=310';
import { t } from '../i18n/i18n.js?v=330';
import { getMaxHp, getMaxMana } from './stats.js?v=311';
