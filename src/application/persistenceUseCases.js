...
import { G, replaceState, replaceAccount } from './gameStore.js?v=363';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=363';
import { createDefaultSkills } from '../domain/character.js?v=390';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=393';
import { isSpellAvailable } from '../domain/spells.js?v=361';
import { findOutfit } from '../domain/outfits.js?v=359';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=359';
import { ZONES } from '../domain/bestiary.js?v=382';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=374';
import { addItemToInventory } from './inventoryCore.js?v=361';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=360';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=362';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=359';
import { t } from '../i18n/i18n.js?v=379';
import { getMaxHp, getMaxMana } from './stats.js?v=360';
