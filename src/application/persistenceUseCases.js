...
import { G, replaceState, replaceAccount } from './gameStore.js?v=320';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=320';
import { createDefaultSkills } from '../domain/character.js?v=347';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=350';
import { isSpellAvailable } from '../domain/spells.js?v=318';
import { findOutfit } from '../domain/outfits.js?v=316';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=316';
import { ZONES } from '../domain/bestiary.js?v=339';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=331';
import { addItemToInventory } from './inventoryCore.js?v=318';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=317';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=319';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=316';
import { t } from '../i18n/i18n.js?v=336';
import { getMaxHp, getMaxMana } from './stats.js?v=317';
