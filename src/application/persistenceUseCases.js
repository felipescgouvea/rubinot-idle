...
import { G, replaceState, replaceAccount } from './gameStore.js?v=169';
import { createDefaultState } from '../domain/gameState.js?v=169';
import { createDefaultSkills } from '../domain/character.js?v=196';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=199';
import { isSpellAvailable } from '../domain/spells.js?v=167';
import { findOutfit } from '../domain/outfits.js?v=165';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=165';
import { ZONES } from '../domain/bestiary.js?v=187';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=180';
import { addItemToInventory } from './inventoryCore.js?v=167';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=166';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=168';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=165';
import { t } from '../i18n/i18n.js?v=183';
import { getMaxHp, getMaxMana } from './stats.js?v=166';
