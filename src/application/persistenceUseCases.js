...
import { G, replaceState, replaceAccount } from './gameStore.js?v=236';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=236';
import { createDefaultSkills } from '../domain/character.js?v=263';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=266';
import { isSpellAvailable } from '../domain/spells.js?v=234';
import { findOutfit } from '../domain/outfits.js?v=232';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=232';
import { ZONES } from '../domain/bestiary.js?v=254';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=247';
import { addItemToInventory } from './inventoryCore.js?v=234';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=233';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=235';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=232';
import { t } from '../i18n/i18n.js?v=250';
import { getMaxHp, getMaxMana } from './stats.js?v=233';
