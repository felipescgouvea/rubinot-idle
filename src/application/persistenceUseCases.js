...
import { G, replaceState, replaceAccount } from './gameStore.js?v=274';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=274';
import { createDefaultSkills } from '../domain/character.js?v=301';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=304';
import { isSpellAvailable } from '../domain/spells.js?v=272';
import { findOutfit } from '../domain/outfits.js?v=270';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=270';
import { ZONES } from '../domain/bestiary.js?v=292';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=285';
import { addItemToInventory } from './inventoryCore.js?v=272';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=271';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=273';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=270';
import { t } from '../i18n/i18n.js?v=290';
import { getMaxHp, getMaxMana } from './stats.js?v=271';
