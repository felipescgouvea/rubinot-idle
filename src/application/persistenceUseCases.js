...
import { G, replaceState, replaceAccount } from './gameStore.js?v=262';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=262';
import { createDefaultSkills } from '../domain/character.js?v=289';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=292';
import { isSpellAvailable } from '../domain/spells.js?v=260';
import { findOutfit } from '../domain/outfits.js?v=258';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=258';
import { ZONES } from '../domain/bestiary.js?v=280';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=273';
import { addItemToInventory } from './inventoryCore.js?v=260';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=259';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=261';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=258';
import { t } from '../i18n/i18n.js?v=278';
import { getMaxHp, getMaxMana } from './stats.js?v=259';
