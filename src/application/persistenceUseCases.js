...
import { G, replaceState, replaceAccount } from './gameStore.js?v=238';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=238';
import { createDefaultSkills } from '../domain/character.js?v=265';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=268';
import { isSpellAvailable } from '../domain/spells.js?v=236';
import { findOutfit } from '../domain/outfits.js?v=234';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=234';
import { ZONES } from '../domain/bestiary.js?v=256';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=249';
import { addItemToInventory } from './inventoryCore.js?v=236';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=235';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=237';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=234';
