...
import { G, replaceState, replaceAccount } from './gameStore.js?v=180';
import { createDefaultState } from '../domain/gameState.js?v=180';
import { createDefaultSkills } from '../domain/character.js?v=207';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=210';
import { isSpellAvailable } from '../domain/spells.js?v=178';
import { findOutfit } from '../domain/outfits.js?v=176';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=176';
import { ZONES } from '../domain/bestiary.js?v=198';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=191';
import { addItemToInventory } from './inventoryCore.js?v=178';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=177';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=179';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=176';
import { t } from '../i18n/i18n.js?v=194';
import { getMaxHp, getMaxMana } from './stats.js?v=177';
