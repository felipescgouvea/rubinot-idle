...
import { G, replaceState, replaceAccount } from './gameStore.js?v=218';
import { createDefaultState } from '../domain/gameState.js?v=218';
import { createDefaultSkills } from '../domain/character.js?v=245';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=248';
import { isSpellAvailable } from '../domain/spells.js?v=216';
import { findOutfit } from '../domain/outfits.js?v=214';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=214';
import { ZONES } from '../domain/bestiary.js?v=236';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=229';
import { addItemToInventory } from './inventoryCore.js?v=216';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=215';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=217';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=214';
import { t } from '../i18n/i18n.js?v=232';
import { getMaxHp, getMaxMana } from './stats.js?v=215';
