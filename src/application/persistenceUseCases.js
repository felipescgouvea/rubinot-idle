...
import { G, replaceState, replaceAccount } from './gameStore.js?v=178';
import { createDefaultState } from '../domain/gameState.js?v=178';
import { createDefaultSkills } from '../domain/character.js?v=205';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=208';
import { isSpellAvailable } from '../domain/spells.js?v=176';
import { findOutfit } from '../domain/outfits.js?v=174';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=174';
import { ZONES } from '../domain/bestiary.js?v=196';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=189';
import { addItemToInventory } from './inventoryCore.js?v=176';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=175';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=177';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=174';
import { t } from '../i18n/i18n.js?v=192';
import { getMaxHp, getMaxMana } from './stats.js?v=175';
