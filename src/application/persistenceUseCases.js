...
import { G, replaceState, replaceAccount } from './gameStore.js?v=328';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=328';
import { createDefaultSkills } from '../domain/character.js?v=355';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=358';
import { isSpellAvailable } from '../domain/spells.js?v=326';
import { findOutfit } from '../domain/outfits.js?v=324';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=324';
import { ZONES } from '../domain/bestiary.js?v=347';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=339';
import { addItemToInventory } from './inventoryCore.js?v=326';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=325';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=327';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=324';
import { t } from '../i18n/i18n.js?v=344';
import { getMaxHp, getMaxMana } from './stats.js?v=325';
