...
import { G, replaceState, replaceAccount } from './gameStore.js?v=159';
import { createDefaultState } from '../domain/gameState.js?v=159';
import { createDefaultSkills } from '../domain/character.js?v=186';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=189';
import { isSpellAvailable } from '../domain/spells.js?v=157';
import { findOutfit } from '../domain/outfits.js?v=155';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=155';
import { ZONES } from '../domain/bestiary.js?v=177';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=170';
import { addItemToInventory } from './inventoryCore.js?v=157';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=156';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=158';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=155';
import { t } from '../i18n/i18n.js?v=173';
import { getMaxHp, getMaxMana } from './stats.js?v=156';
