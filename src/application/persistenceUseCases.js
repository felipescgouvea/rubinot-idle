...
import { G, replaceState, replaceAccount } from './gameStore.js?v=188';
import { createDefaultState } from '../domain/gameState.js?v=188';
import { createDefaultSkills } from '../domain/character.js?v=215';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=218';
import { isSpellAvailable } from '../domain/spells.js?v=186';
import { findOutfit } from '../domain/outfits.js?v=184';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=184';
import { ZONES } from '../domain/bestiary.js?v=206';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=199';
import { addItemToInventory } from './inventoryCore.js?v=186';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=185';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=187';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=184';
import { t } from '../i18n/i18n.js?v=202';
import { getMaxHp, getMaxMana } from './stats.js?v=185';
