...
import { G, replaceState, replaceAccount } from './gameStore.js?v=269';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=269';
import { createDefaultSkills } from '../domain/character.js?v=296';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=299';
import { isSpellAvailable } from '../domain/spells.js?v=267';
import { findOutfit } from '../domain/outfits.js?v=265';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=265';
import { ZONES } from '../domain/bestiary.js?v=287';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=280';
import { addItemToInventory } from './inventoryCore.js?v=267';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=266';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=268';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=265';
import { t } from '../i18n/i18n.js?v=285';
import { getMaxHp, getMaxMana } from './stats.js?v=266';
