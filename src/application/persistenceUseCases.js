...
import { G, replaceState, replaceAccount } from './gameStore.js?v=350';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=350';
import { createDefaultSkills } from '../domain/character.js?v=377';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=380';
import { isSpellAvailable } from '../domain/spells.js?v=348';
import { findOutfit } from '../domain/outfits.js?v=346';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=346';
import { ZONES } from '../domain/bestiary.js?v=369';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=361';
import { addItemToInventory } from './inventoryCore.js?v=348';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=347';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=349';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=346';
import { t } from '../i18n/i18n.js?v=366';
import { getMaxHp, getMaxMana } from './stats.js?v=347';
