...
import { G, replaceState, replaceAccount } from './gameStore.js?v=193';
import { createDefaultState } from '../domain/gameState.js?v=193';
import { createDefaultSkills } from '../domain/character.js?v=220';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=223';
import { isSpellAvailable } from '../domain/spells.js?v=191';
import { findOutfit } from '../domain/outfits.js?v=189';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=189';
import { ZONES } from '../domain/bestiary.js?v=211';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=204';
import { addItemToInventory } from './inventoryCore.js?v=191';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=190';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=192';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=189';
import { t } from '../i18n/i18n.js?v=207';
import { getMaxHp, getMaxMana } from './stats.js?v=190';
