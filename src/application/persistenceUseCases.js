...
import { G, replaceState, replaceAccount } from './gameStore.js?v=249';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=249';
import { createDefaultSkills } from '../domain/character.js?v=276';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=279';
import { isSpellAvailable } from '../domain/spells.js?v=247';
import { findOutfit } from '../domain/outfits.js?v=245';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=245';
import { ZONES } from '../domain/bestiary.js?v=267';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=260';
import { addItemToInventory } from './inventoryCore.js?v=247';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=246';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=248';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=245';
import { t } from '../i18n/i18n.js?v=263';
import { getMaxHp, getMaxMana } from './stats.js?v=246';
