...
import { G, replaceState, replaceAccount } from './gameStore.js?v=235';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=235';
import { createDefaultSkills } from '../domain/character.js?v=262';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=265';
import { isSpellAvailable } from '../domain/spells.js?v=233';
import { findOutfit } from '../domain/outfits.js?v=231';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=231';
import { ZONES } from '../domain/bestiary.js?v=253';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=246';
import { addItemToInventory } from './inventoryCore.js?v=233';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=232';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=234';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=231';
import { t } from '../i18n/i18n.js?v=249';
import { getMaxHp, getMaxMana } from './stats.js?v=232';
