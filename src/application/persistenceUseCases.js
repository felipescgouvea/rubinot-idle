...
import { G, replaceState, replaceAccount } from './gameStore.js?v=291';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=291';
import { createDefaultSkills } from '../domain/character.js?v=318';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=321';
import { isSpellAvailable } from '../domain/spells.js?v=289';
import { findOutfit } from '../domain/outfits.js?v=287';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=287';
import { ZONES } from '../domain/bestiary.js?v=309';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=302';
import { addItemToInventory } from './inventoryCore.js?v=289';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=288';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=290';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=287';
import { t } from '../i18n/i18n.js?v=307';
import { getMaxHp, getMaxMana } from './stats.js?v=288';
