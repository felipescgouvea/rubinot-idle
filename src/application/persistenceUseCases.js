...
import { G, replaceState, replaceAccount } from './gameStore.js?v=246';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=246';
import { createDefaultSkills } from '../domain/character.js?v=273';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=276';
import { isSpellAvailable } from '../domain/spells.js?v=244';
import { findOutfit } from '../domain/outfits.js?v=242';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=242';
import { ZONES } from '../domain/bestiary.js?v=264';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=257';
import { addItemToInventory } from './inventoryCore.js?v=244';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=243';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=245';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=242';
