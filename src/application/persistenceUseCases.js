...
import { G, replaceState, replaceAccount } from './gameStore.js?v=245';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=245';
import { createDefaultSkills } from '../domain/character.js?v=272';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=275';
import { isSpellAvailable } from '../domain/spells.js?v=243';
import { findOutfit } from '../domain/outfits.js?v=241';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=241';
import { ZONES } from '../domain/bestiary.js?v=263';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=256';
import { addItemToInventory } from './inventoryCore.js?v=243';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=242';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=244';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=241';
