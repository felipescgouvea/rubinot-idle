...
import { G, replaceState, replaceAccount } from './gameStore.js?v=154';
import { createDefaultState } from '../domain/gameState.js?v=154';
import { createDefaultSkills } from '../domain/character.js?v=181';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=184';
import { isSpellAvailable } from '../domain/spells.js?v=152';
import { findOutfit } from '../domain/outfits.js?v=150';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=150';
import { ZONES } from '../domain/bestiary.js?v=172';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=165';
import { addItemToInventory } from './inventoryCore.js?v=152';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=151';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=153';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=150';
import { t } from '../i18n/i18n.js?v=168';
import { getMaxHp, getMaxMana } from './stats.js?v=151';
