...
import { G, replaceState, replaceAccount } from './gameStore.js?v=190';
import { createDefaultState } from '../domain/gameState.js?v=190';
import { createDefaultSkills } from '../domain/character.js?v=217';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=220';
import { isSpellAvailable } from '../domain/spells.js?v=188';
import { findOutfit } from '../domain/outfits.js?v=186';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=186';
import { ZONES } from '../domain/bestiary.js?v=208';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=201';
import { addItemToInventory } from './inventoryCore.js?v=188';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=187';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=189';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=186';
import { t } from '../i18n/i18n.js?v=204';
import { getMaxHp, getMaxMana } from './stats.js?v=187';
