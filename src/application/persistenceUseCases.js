...
import { G, replaceState, replaceAccount } from './gameStore.js?v=179';
import { createDefaultState } from '../domain/gameState.js?v=179';
import { createDefaultSkills } from '../domain/character.js?v=206';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=209';
import { isSpellAvailable } from '../domain/spells.js?v=177';
import { findOutfit } from '../domain/outfits.js?v=175';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=175';
import { ZONES } from '../domain/bestiary.js?v=197';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=190';
import { addItemToInventory } from './inventoryCore.js?v=177';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=176';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=178';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=175';
import { t } from '../i18n/i18n.js?v=193';
import { getMaxHp, getMaxMana } from './stats.js?v=176';
