...
import { G, replaceState, replaceAccount } from './gameStore.js?v=131';
import { createDefaultState } from '../domain/gameState.js?v=131';
import { createDefaultSkills } from '../domain/character.js?v=158';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=161';
import { isSpellAvailable } from '../domain/spells.js?v=129';
import { findOutfit } from '../domain/outfits.js?v=127';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=127';
import { ZONES } from '../domain/bestiary.js?v=149';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=142';
import { addItemToInventory } from './inventoryCore.js?v=129';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=128';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=130';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=127';
import { t } from '../i18n/i18n.js?v=145';
import { getMaxHp, getMaxMana } from './stats.js?v=128';
