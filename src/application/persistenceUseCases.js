...
import { G, replaceState, replaceAccount } from './gameStore.js?v=355';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=355';
import { createDefaultSkills } from '../domain/character.js?v=382';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=385';
import { isSpellAvailable } from '../domain/spells.js?v=353';
import { findOutfit } from '../domain/outfits.js?v=351';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=351';
import { ZONES } from '../domain/bestiary.js?v=374';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=366';
import { addItemToInventory } from './inventoryCore.js?v=353';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=352';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=354';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=351';
import { t } from '../i18n/i18n.js?v=371';
import { getMaxHp, getMaxMana } from './stats.js?v=352';
