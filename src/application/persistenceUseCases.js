...
import { G, replaceState, replaceAccount } from './gameStore.js?v=295';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=295';
import { createDefaultSkills } from '../domain/character.js?v=322';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=325';
import { isSpellAvailable } from '../domain/spells.js?v=293';
import { findOutfit } from '../domain/outfits.js?v=291';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=291';
import { ZONES } from '../domain/bestiary.js?v=314';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=306';
import { addItemToInventory } from './inventoryCore.js?v=293';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=292';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=294';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=291';
import { t } from '../i18n/i18n.js?v=311';
import { getMaxHp, getMaxMana } from './stats.js?v=292';
