...
import { G, replaceState, replaceAccount } from './gameStore.js?v=161';
import { createDefaultState } from '../domain/gameState.js?v=161';
import { createDefaultSkills } from '../domain/character.js?v=188';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=191';
import { isSpellAvailable } from '../domain/spells.js?v=159';
import { findOutfit } from '../domain/outfits.js?v=157';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=157';
import { ZONES } from '../domain/bestiary.js?v=179';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=172';
import { addItemToInventory } from './inventoryCore.js?v=159';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=158';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=160';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=157';
import { t } from '../i18n/i18n.js?v=175';
import { getMaxHp, getMaxMana } from './stats.js?v=158';
