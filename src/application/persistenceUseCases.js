...
import { G, replaceState, replaceAccount } from './gameStore.js?v=164';
import { createDefaultState } from '../domain/gameState.js?v=164';
import { createDefaultSkills } from '../domain/character.js?v=191';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=194';
import { isSpellAvailable } from '../domain/spells.js?v=162';
import { findOutfit } from '../domain/outfits.js?v=160';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=160';
import { ZONES } from '../domain/bestiary.js?v=182';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=175';
import { addItemToInventory } from './inventoryCore.js?v=162';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=161';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=163';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=160';
import { t } from '../i18n/i18n.js?v=178';
import { getMaxHp, getMaxMana } from './stats.js?v=161';
