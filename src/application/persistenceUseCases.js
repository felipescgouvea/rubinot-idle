...
import { G, replaceState, replaceAccount } from './gameStore.js?v=273';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=273';
import { createDefaultSkills } from '../domain/character.js?v=300';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=303';
import { isSpellAvailable } from '../domain/spells.js?v=271';
import { findOutfit } from '../domain/outfits.js?v=269';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=269';
import { ZONES } from '../domain/bestiary.js?v=291';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=284';
import { addItemToInventory } from './inventoryCore.js?v=271';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=270';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=272';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=269';
import { t } from '../i18n/i18n.js?v=289';
import { getMaxHp, getMaxMana } from './stats.js?v=270';
