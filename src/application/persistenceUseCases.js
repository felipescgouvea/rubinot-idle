...
import { G, replaceState, replaceAccount } from './gameStore.js?v=265';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=265';
import { createDefaultSkills } from '../domain/character.js?v=292';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=295';
import { isSpellAvailable } from '../domain/spells.js?v=263';
import { findOutfit } from '../domain/outfits.js?v=261';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=261';
import { ZONES } from '../domain/bestiary.js?v=283';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=276';
import { addItemToInventory } from './inventoryCore.js?v=263';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=262';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=264';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=261';
import { t } from '../i18n/i18n.js?v=281';
import { getMaxHp, getMaxMana } from './stats.js?v=262';
