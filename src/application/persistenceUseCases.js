...
import { G, replaceState, replaceAccount } from './gameStore.js?v=331';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=331';
import { createDefaultSkills } from '../domain/character.js?v=358';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=361';
import { isSpellAvailable } from '../domain/spells.js?v=329';
import { findOutfit } from '../domain/outfits.js?v=327';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=327';
import { ZONES } from '../domain/bestiary.js?v=350';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=342';
import { addItemToInventory } from './inventoryCore.js?v=329';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=328';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=330';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=327';
import { t } from '../i18n/i18n.js?v=347';
import { getMaxHp, getMaxMana } from './stats.js?v=328';
