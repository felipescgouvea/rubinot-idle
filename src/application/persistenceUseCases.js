...
import { G, replaceState, replaceAccount } from './gameStore.js?v=165';
import { createDefaultState } from '../domain/gameState.js?v=165';
import { createDefaultSkills } from '../domain/character.js?v=192';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=195';
import { isSpellAvailable } from '../domain/spells.js?v=163';
import { findOutfit } from '../domain/outfits.js?v=161';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=161';
import { ZONES } from '../domain/bestiary.js?v=183';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=176';
import { addItemToInventory } from './inventoryCore.js?v=163';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=162';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=164';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=161';
import { t } from '../i18n/i18n.js?v=179';
import { getMaxHp, getMaxMana } from './stats.js?v=162';
