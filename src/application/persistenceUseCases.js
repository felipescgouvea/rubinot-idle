...
import { G, replaceState, replaceAccount } from './gameStore.js?v=234';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=234';
import { createDefaultSkills } from '../domain/character.js?v=261';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=264';
import { isSpellAvailable } from '../domain/spells.js?v=232';
import { findOutfit } from '../domain/outfits.js?v=230';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=230';
import { ZONES } from '../domain/bestiary.js?v=252';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=245';
import { addItemToInventory } from './inventoryCore.js?v=232';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=231';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=233';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=230';
import { t } from '../i18n/i18n.js?v=248';
import { getMaxHp, getMaxMana } from './stats.js?v=231';
