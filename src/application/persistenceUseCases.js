...
import { G, replaceState, replaceAccount } from './gameStore.js?v=199';
import { createDefaultState } from '../domain/gameState.js?v=199';
import { createDefaultSkills } from '../domain/character.js?v=226';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=229';
import { isSpellAvailable } from '../domain/spells.js?v=197';
import { findOutfit } from '../domain/outfits.js?v=195';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=195';
import { ZONES } from '../domain/bestiary.js?v=217';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=210';
import { addItemToInventory } from './inventoryCore.js?v=197';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=196';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=198';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=195';
import { t } from '../i18n/i18n.js?v=213';
import { getMaxHp, getMaxMana } from './stats.js?v=196';
