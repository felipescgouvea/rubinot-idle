...
import { G, replaceState, replaceAccount } from './gameStore.js?v=230';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=230';
import { createDefaultSkills } from '../domain/character.js?v=257';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=260';
import { isSpellAvailable } from '../domain/spells.js?v=228';
import { findOutfit } from '../domain/outfits.js?v=226';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=226';
import { ZONES } from '../domain/bestiary.js?v=248';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=241';
import { addItemToInventory } from './inventoryCore.js?v=228';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=227';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=229';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=226';
import { t } from '../i18n/i18n.js?v=244';
import { getMaxHp, getMaxMana } from './stats.js?v=227';
