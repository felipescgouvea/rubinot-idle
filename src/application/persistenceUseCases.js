...
import { G, replaceState, replaceAccount } from './gameStore.js?v=148';
import { createDefaultState } from '../domain/gameState.js?v=148';
import { createDefaultSkills } from '../domain/character.js?v=175';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=178';
import { isSpellAvailable } from '../domain/spells.js?v=146';
import { findOutfit } from '../domain/outfits.js?v=144';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=144';
import { ZONES } from '../domain/bestiary.js?v=166';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=159';
import { addItemToInventory } from './inventoryCore.js?v=146';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=145';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=147';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=144';
import { t } from '../i18n/i18n.js?v=162';
import { getMaxHp, getMaxMana } from './stats.js?v=145';
