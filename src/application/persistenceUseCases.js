...
import { G, replaceState, replaceAccount } from './gameStore.js?v=288';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=288';
import { createDefaultSkills } from '../domain/character.js?v=315';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=318';
import { isSpellAvailable } from '../domain/spells.js?v=286';
import { findOutfit } from '../domain/outfits.js?v=284';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=284';
import { ZONES } from '../domain/bestiary.js?v=306';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=299';
import { addItemToInventory } from './inventoryCore.js?v=286';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=285';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=287';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=284';
import { t } from '../i18n/i18n.js?v=304';
import { getMaxHp, getMaxMana } from './stats.js?v=285';
