...
import { G, replaceState, replaceAccount } from './gameStore.js?v=158';
import { createDefaultState } from '../domain/gameState.js?v=158';
import { createDefaultSkills } from '../domain/character.js?v=185';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=188';
import { isSpellAvailable } from '../domain/spells.js?v=156';
import { findOutfit } from '../domain/outfits.js?v=154';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=154';
import { ZONES } from '../domain/bestiary.js?v=176';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=169';
import { addItemToInventory } from './inventoryCore.js?v=156';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=155';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=157';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=154';
import { t } from '../i18n/i18n.js?v=172';
import { getMaxHp, getMaxMana } from './stats.js?v=155';
