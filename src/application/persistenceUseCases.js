...
import { G, replaceState, replaceAccount } from './gameStore.js?v=330';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=330';
import { createDefaultSkills } from '../domain/character.js?v=357';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=360';
import { isSpellAvailable } from '../domain/spells.js?v=328';
import { findOutfit } from '../domain/outfits.js?v=326';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=326';
import { ZONES } from '../domain/bestiary.js?v=349';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=341';
import { addItemToInventory } from './inventoryCore.js?v=328';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=327';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=329';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=326';
import { t } from '../i18n/i18n.js?v=346';
import { getMaxHp, getMaxMana } from './stats.js?v=327';
