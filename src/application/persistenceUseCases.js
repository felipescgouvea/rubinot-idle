...
import { G, replaceState, replaceAccount } from './gameStore.js?v=281';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=281';
import { createDefaultSkills } from '../domain/character.js?v=308';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=311';
import { isSpellAvailable } from '../domain/spells.js?v=279';
import { findOutfit } from '../domain/outfits.js?v=277';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=277';
import { ZONES } from '../domain/bestiary.js?v=299';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=292';
import { addItemToInventory } from './inventoryCore.js?v=279';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=278';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=280';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=277';
import { t } from '../i18n/i18n.js?v=297';
import { getMaxHp, getMaxMana } from './stats.js?v=278';
