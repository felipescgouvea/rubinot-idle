...
import { G, replaceState, replaceAccount } from './gameStore.js?v=167';
import { createDefaultState } from '../domain/gameState.js?v=167';
import { createDefaultSkills } from '../domain/character.js?v=194';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=197';
import { isSpellAvailable } from '../domain/spells.js?v=165';
import { findOutfit } from '../domain/outfits.js?v=163';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=163';
import { ZONES } from '../domain/bestiary.js?v=185';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=178';
import { addItemToInventory } from './inventoryCore.js?v=165';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=164';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=166';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=163';
import { t } from '../i18n/i18n.js?v=181';
import { getMaxHp, getMaxMana } from './stats.js?v=164';
