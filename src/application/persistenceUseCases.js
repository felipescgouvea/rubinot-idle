...
import { G, replaceState, replaceAccount } from './gameStore.js?v=168';
import { createDefaultState } from '../domain/gameState.js?v=168';
import { createDefaultSkills } from '../domain/character.js?v=195';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=198';
import { isSpellAvailable } from '../domain/spells.js?v=166';
import { findOutfit } from '../domain/outfits.js?v=164';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=164';
import { ZONES } from '../domain/bestiary.js?v=186';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=179';
import { addItemToInventory } from './inventoryCore.js?v=166';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=165';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=167';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=164';
import { t } from '../i18n/i18n.js?v=182';
import { getMaxHp, getMaxMana } from './stats.js?v=165';
