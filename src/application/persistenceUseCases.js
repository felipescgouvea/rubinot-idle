...
import { G, replaceState, replaceAccount } from './gameStore.js?v=239';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=239';
import { createDefaultSkills } from '../domain/character.js?v=266';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=269';
import { isSpellAvailable } from '../domain/spells.js?v=237';
import { findOutfit } from '../domain/outfits.js?v=235';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=235';
import { ZONES } from '../domain/bestiary.js?v=257';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=250';
import { addItemToInventory } from './inventoryCore.js?v=237';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=236';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=238';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=235';
import { t } from '../i18n/i18n.js?v=253';
import { getMaxHp, getMaxMana } from './stats.js?v=236';
