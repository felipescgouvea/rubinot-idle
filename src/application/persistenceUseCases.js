...
import { G, replaceState, replaceAccount } from './gameStore.js?v=339';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=339';
import { createDefaultSkills } from '../domain/character.js?v=366';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=369';
import { isSpellAvailable } from '../domain/spells.js?v=337';
import { findOutfit } from '../domain/outfits.js?v=335';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=335';
import { ZONES } from '../domain/bestiary.js?v=358';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=350';
import { addItemToInventory } from './inventoryCore.js?v=337';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=336';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=338';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=335';
import { t } from '../i18n/i18n.js?v=355';
import { getMaxHp, getMaxMana } from './stats.js?v=336';
