...
import { G, replaceState, replaceAccount } from './gameStore.js?v=150';
import { createDefaultState } from '../domain/gameState.js?v=150';
import { createDefaultSkills } from '../domain/character.js?v=177';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=180';
import { isSpellAvailable } from '../domain/spells.js?v=148';
import { findOutfit } from '../domain/outfits.js?v=146';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=146';
import { ZONES } from '../domain/bestiary.js?v=168';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=161';
import { addItemToInventory } from './inventoryCore.js?v=148';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=147';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=149';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=146';
import { t } from '../i18n/i18n.js?v=164';
import { getMaxHp, getMaxMana } from './stats.js?v=147';
