...
import { G, replaceState, replaceAccount } from './gameStore.js?v=153';
import { createDefaultState } from '../domain/gameState.js?v=153';
import { createDefaultSkills } from '../domain/character.js?v=180';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=183';
import { isSpellAvailable } from '../domain/spells.js?v=151';
import { findOutfit } from '../domain/outfits.js?v=149';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=149';
import { ZONES } from '../domain/bestiary.js?v=171';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=164';
import { addItemToInventory } from './inventoryCore.js?v=151';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=150';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=152';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=149';
import { t } from '../i18n/i18n.js?v=167';
import { getMaxHp, getMaxMana } from './stats.js?v=150';
