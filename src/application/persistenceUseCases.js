...
import { G, replaceState, replaceAccount } from './gameStore.js?v=222';
import { createDefaultState } from '../domain/gameState.js?v=222';
import { createDefaultSkills } from '../domain/character.js?v=249';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=252';
import { isSpellAvailable } from '../domain/spells.js?v=220';
import { findOutfit } from '../domain/outfits.js?v=218';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=218';
import { ZONES } from '../domain/bestiary.js?v=240';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=233';
import { addItemToInventory } from './inventoryCore.js?v=220';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=219';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=221';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=218';
import { t } from '../i18n/i18n.js?v=236';
import { getMaxHp, getMaxMana } from './stats.js?v=219';
