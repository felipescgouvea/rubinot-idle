...
import { G, replaceState, replaceAccount } from './gameStore.js?v=323';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=323';
import { createDefaultSkills } from '../domain/character.js?v=350';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=353';
import { isSpellAvailable } from '../domain/spells.js?v=321';
import { findOutfit } from '../domain/outfits.js?v=319';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=319';
import { ZONES } from '../domain/bestiary.js?v=342';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=334';
import { addItemToInventory } from './inventoryCore.js?v=321';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=320';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=322';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=319';
import { t } from '../i18n/i18n.js?v=339';
import { getMaxHp, getMaxMana } from './stats.js?v=320';
