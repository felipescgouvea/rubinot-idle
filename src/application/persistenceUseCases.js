...
import { G, replaceState, replaceAccount } from './gameStore.js?v=244';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=244';
import { createDefaultSkills } from '../domain/character.js?v=271';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=274';
import { isSpellAvailable } from '../domain/spells.js?v=242';
import { findOutfit } from '../domain/outfits.js?v=240';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=240';
import { ZONES } from '../domain/bestiary.js?v=262';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=255';
import { addItemToInventory } from './inventoryCore.js?v=242';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=241';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=243';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=240';
import { t } from '../i18n/i18n.js?v=258';
import { getMaxHp, getMaxMana } from './stats.js?v=241';
