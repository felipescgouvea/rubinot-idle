...
import { G, replaceState, replaceAccount } from './gameStore.js?v=160';
import { createDefaultState } from '../domain/gameState.js?v=160';
import { createDefaultSkills } from '../domain/character.js?v=187';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=190';
import { isSpellAvailable } from '../domain/spells.js?v=158';
import { findOutfit } from '../domain/outfits.js?v=156';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=156';
import { ZONES } from '../domain/bestiary.js?v=178';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=171';
import { addItemToInventory } from './inventoryCore.js?v=158';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=157';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=159';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=156';
import { t } from '../i18n/i18n.js?v=174';
import { getMaxHp, getMaxMana } from './stats.js?v=157';
