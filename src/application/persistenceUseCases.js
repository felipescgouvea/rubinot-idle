...
import { G, replaceState, replaceAccount } from './gameStore.js?v=170';
import { createDefaultState } from '../domain/gameState.js?v=170';
import { createDefaultSkills } from '../domain/character.js?v=197';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=200';
import { isSpellAvailable } from '../domain/spells.js?v=168';
import { findOutfit } from '../domain/outfits.js?v=166';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=166';
import { ZONES } from '../domain/bestiary.js?v=188';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=181';
import { addItemToInventory } from './inventoryCore.js?v=168';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=167';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=169';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=166';
import { t } from '../i18n/i18n.js?v=184';
import { getMaxHp, getMaxMana } from './stats.js?v=167';
