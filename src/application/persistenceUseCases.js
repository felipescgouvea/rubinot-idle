...
import { G, replaceState, replaceAccount } from './gameStore.js?v=334';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=334';
import { createDefaultSkills } from '../domain/character.js?v=361';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=364';
import { isSpellAvailable } from '../domain/spells.js?v=332';
import { findOutfit } from '../domain/outfits.js?v=330';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=330';
import { ZONES } from '../domain/bestiary.js?v=353';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=345';
import { addItemToInventory } from './inventoryCore.js?v=332';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=331';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=333';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=330';
import { t } from '../i18n/i18n.js?v=350';
import { getMaxHp, getMaxMana } from './stats.js?v=331';
