...
import { G, replaceState, replaceAccount } from './gameStore.js?v=343';
import { createDefaultState, MAX_CHARACTER_SLOTS } from '../domain/gameState.js?v=343';
import { createDefaultSkills } from '../domain/character.js?v=370';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=373';
import { isSpellAvailable } from '../domain/spells.js?v=341';
import { findOutfit } from '../domain/outfits.js?v=339';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=339';
import { ZONES } from '../domain/bestiary.js?v=362';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=354';
import { addItemToInventory } from './inventoryCore.js?v=341';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=340';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=342';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=339';
import { t } from '../i18n/i18n.js?v=359';
import { getMaxHp, getMaxMana } from './stats.js?v=340';
