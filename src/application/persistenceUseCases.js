...
import { G, replaceState, replaceAccount } from './gameStore.js?v=141';
import { createDefaultState } from '../domain/gameState.js?v=141';
import { createDefaultSkills } from '../domain/character.js?v=168';
import { createDefaultRtc, isRuneAvailableToVocation, normalizeAttackSpells, isRuneEntry, runeEntryId } from '../domain/rtcConfig.js?v=171';
import { isSpellAvailable } from '../domain/spells.js?v=139';
import { findOutfit } from '../domain/outfits.js?v=137';
import { DEFAULT_OUTFIT_COLORS } from '../domain/outfitColors.js?v=137';
import { ZONES } from '../domain/bestiary.js?v=159';
import { isRelicId, STARTER_KITS } from '../domain/items.js?v=152';
import { addItemToInventory } from './inventoryCore.js?v=139';
import { LEGACY_RARITY_MAP } from '../domain/rarity.js?v=138';
import { LEGACY_ARENA_DIVISION_MAP, TASK_ROOMS } from '../domain/progression.js?v=140';
import { loadRawState, clearState, saveState } from '../infrastructure/storage.js?v=137';
import { t } from '../i18n/i18n.js?v=155';
import { getMaxHp, getMaxMana } from './stats.js?v=138';
