...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=362';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=365';
import { RARITY_TIERS } from '../domain/rarity.js?v=351';
import { emit, EVENTS } from '../shared/eventBus.js?v=352';
import { getMagic } from './stats.js?v=351';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=384';
import { getCurrentMonster } from './huntUseCases.js?v=418';
import { areaName } from '../domain/attackAreas.js?v=350';
import { saveGame } from './saveGameUseCase.js?v=354';
import { itemLogIcon } from './logIcons.js?v=353';
import { t } from '../i18n/i18n.js?v=370';

export { addItemToInventory } from './inventoryCore.js?v=352';
