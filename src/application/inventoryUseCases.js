...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=308';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=311';
import { RARITY_TIERS } from '../domain/rarity.js?v=297';
import { emit, EVENTS } from '../shared/eventBus.js?v=298';
import { getMagic } from './stats.js?v=297';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=330';
import { getCurrentMonster } from './huntUseCases.js?v=364';
import { areaName } from '../domain/attackAreas.js?v=296';
import { saveGame } from './saveGameUseCase.js?v=300';
import { itemLogIcon } from './logIcons.js?v=299';
import { t } from '../i18n/i18n.js?v=316';

export { addItemToInventory } from './inventoryCore.js?v=298';
