...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=367';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=370';
import { RARITY_TIERS } from '../domain/rarity.js?v=356';
import { emit, EVENTS } from '../shared/eventBus.js?v=357';
import { getMagic } from './stats.js?v=356';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=389';
import { getCurrentMonster } from './huntUseCases.js?v=423';
import { areaName } from '../domain/attackAreas.js?v=355';
import { saveGame } from './saveGameUseCase.js?v=359';
import { itemLogIcon } from './logIcons.js?v=358';
import { t } from '../i18n/i18n.js?v=375';

export { addItemToInventory } from './inventoryCore.js?v=357';
