...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=294';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=297';
import { RARITY_TIERS } from '../domain/rarity.js?v=283';
import { emit, EVENTS } from '../shared/eventBus.js?v=284';
import { getMagic } from './stats.js?v=283';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=316';
import { getCurrentMonster } from './huntUseCases.js?v=350';
import { areaName } from '../domain/attackAreas.js?v=282';
import { saveGame } from './saveGameUseCase.js?v=286';
import { itemLogIcon } from './logIcons.js?v=285';
import { t } from '../i18n/i18n.js?v=302';

export { addItemToInventory } from './inventoryCore.js?v=284';
