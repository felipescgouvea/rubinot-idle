...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=158';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=164';
import { RARITY_TIERS } from '../domain/rarity.js?v=150';
import { emit, EVENTS } from '../shared/eventBus.js?v=151';
import { getMagic } from './stats.js?v=150';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=183';
import { getCurrentMonster } from './huntUseCases.js?v=217';
import { areaName } from '../domain/attackAreas.js?v=149';
import { saveGame } from './saveGameUseCase.js?v=153';
import { itemLogIcon } from './logIcons.js?v=152';
import { t } from '../i18n/i18n.js?v=167';

export { addItemToInventory } from './inventoryCore.js?v=151';
