...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=283';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=286';
import { RARITY_TIERS } from '../domain/rarity.js?v=272';
import { emit, EVENTS } from '../shared/eventBus.js?v=273';
import { getMagic } from './stats.js?v=272';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=305';
import { getCurrentMonster } from './huntUseCases.js?v=339';
import { areaName } from '../domain/attackAreas.js?v=271';
import { saveGame } from './saveGameUseCase.js?v=275';
import { itemLogIcon } from './logIcons.js?v=274';
import { t } from '../i18n/i18n.js?v=291';

export { addItemToInventory } from './inventoryCore.js?v=273';
