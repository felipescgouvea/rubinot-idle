...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=90';
import { ZONES } from '../domain/bestiary.js?v=90';
import { RARITY_TIERS } from '../domain/rarity.js?v=90';
import { emit, EVENTS } from '../shared/eventBus.js?v=90';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=90';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=90';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=90';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=90';
import { saveGame } from './saveGameUseCase.js?v=90';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=90';
...
export { addItemToInventory } from './inventoryCore.js?v=90';
