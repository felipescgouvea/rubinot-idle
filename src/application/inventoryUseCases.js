...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=234';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=240';
import { RARITY_TIERS } from '../domain/rarity.js?v=226';
import { emit, EVENTS } from '../shared/eventBus.js?v=227';
import { getMagic } from './stats.js?v=226';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=259';
import { getCurrentMonster } from './huntUseCases.js?v=293';
import { areaName } from '../domain/attackAreas.js?v=225';
import { saveGame } from './saveGameUseCase.js?v=229';
import { itemLogIcon } from './logIcons.js?v=228';
import { t } from '../i18n/i18n.js?v=243';

export { addItemToInventory } from './inventoryCore.js?v=227';
