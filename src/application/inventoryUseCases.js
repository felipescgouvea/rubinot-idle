...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=348';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=351';
import { RARITY_TIERS } from '../domain/rarity.js?v=337';
import { emit, EVENTS } from '../shared/eventBus.js?v=338';
import { getMagic } from './stats.js?v=337';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=370';
import { getCurrentMonster } from './huntUseCases.js?v=404';
import { areaName } from '../domain/attackAreas.js?v=336';
import { saveGame } from './saveGameUseCase.js?v=340';
import { itemLogIcon } from './logIcons.js?v=339';
import { t } from '../i18n/i18n.js?v=356';

export { addItemToInventory } from './inventoryCore.js?v=338';
