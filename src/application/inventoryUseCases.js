...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=315';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=318';
import { RARITY_TIERS } from '../domain/rarity.js?v=304';
import { emit, EVENTS } from '../shared/eventBus.js?v=305';
import { getMagic } from './stats.js?v=304';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=337';
import { getCurrentMonster } from './huntUseCases.js?v=371';
import { areaName } from '../domain/attackAreas.js?v=303';
import { saveGame } from './saveGameUseCase.js?v=307';
import { itemLogIcon } from './logIcons.js?v=306';
import { t } from '../i18n/i18n.js?v=323';

export { addItemToInventory } from './inventoryCore.js?v=305';
