...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=222';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=228';
import { RARITY_TIERS } from '../domain/rarity.js?v=214';
import { emit, EVENTS } from '../shared/eventBus.js?v=215';
import { getMagic } from './stats.js?v=214';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=247';
import { getCurrentMonster } from './huntUseCases.js?v=281';
import { areaName } from '../domain/attackAreas.js?v=213';
import { saveGame } from './saveGameUseCase.js?v=217';
import { itemLogIcon } from './logIcons.js?v=216';
import { t } from '../i18n/i18n.js?v=231';

export { addItemToInventory } from './inventoryCore.js?v=215';
