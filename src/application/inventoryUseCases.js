...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=164';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=170';
import { RARITY_TIERS } from '../domain/rarity.js?v=156';
import { emit, EVENTS } from '../shared/eventBus.js?v=157';
import { getMagic } from './stats.js?v=156';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=189';
import { getCurrentMonster } from './huntUseCases.js?v=223';
import { areaName } from '../domain/attackAreas.js?v=155';
import { saveGame } from './saveGameUseCase.js?v=159';
import { itemLogIcon } from './logIcons.js?v=158';
import { t } from '../i18n/i18n.js?v=173';

export { addItemToInventory } from './inventoryCore.js?v=157';
