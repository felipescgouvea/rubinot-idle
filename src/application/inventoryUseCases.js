...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=361';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=364';
import { RARITY_TIERS } from '../domain/rarity.js?v=350';
import { emit, EVENTS } from '../shared/eventBus.js?v=351';
import { getMagic } from './stats.js?v=350';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=383';
import { getCurrentMonster } from './huntUseCases.js?v=417';
import { areaName } from '../domain/attackAreas.js?v=349';
import { saveGame } from './saveGameUseCase.js?v=353';
import { itemLogIcon } from './logIcons.js?v=352';
import { t } from '../i18n/i18n.js?v=369';

export { addItemToInventory } from './inventoryCore.js?v=351';
