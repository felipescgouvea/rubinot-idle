...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=349';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=352';
import { RARITY_TIERS } from '../domain/rarity.js?v=338';
import { emit, EVENTS } from '../shared/eventBus.js?v=339';
import { getMagic } from './stats.js?v=338';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=371';
import { getCurrentMonster } from './huntUseCases.js?v=405';
import { areaName } from '../domain/attackAreas.js?v=337';
import { saveGame } from './saveGameUseCase.js?v=341';
import { itemLogIcon } from './logIcons.js?v=340';
import { t } from '../i18n/i18n.js?v=357';

export { addItemToInventory } from './inventoryCore.js?v=339';
