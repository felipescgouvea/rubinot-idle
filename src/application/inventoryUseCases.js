...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=347';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=350';
import { RARITY_TIERS } from '../domain/rarity.js?v=336';
import { emit, EVENTS } from '../shared/eventBus.js?v=337';
import { getMagic } from './stats.js?v=336';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=369';
import { getCurrentMonster } from './huntUseCases.js?v=403';
import { areaName } from '../domain/attackAreas.js?v=335';
import { saveGame } from './saveGameUseCase.js?v=339';
import { itemLogIcon } from './logIcons.js?v=338';
import { t } from '../i18n/i18n.js?v=355';

export { addItemToInventory } from './inventoryCore.js?v=337';
