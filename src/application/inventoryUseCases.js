...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=317';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=320';
import { RARITY_TIERS } from '../domain/rarity.js?v=306';
import { emit, EVENTS } from '../shared/eventBus.js?v=307';
import { getMagic } from './stats.js?v=306';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=339';
import { getCurrentMonster } from './huntUseCases.js?v=373';
import { areaName } from '../domain/attackAreas.js?v=305';
import { saveGame } from './saveGameUseCase.js?v=309';
import { itemLogIcon } from './logIcons.js?v=308';
import { t } from '../i18n/i18n.js?v=325';

export { addItemToInventory } from './inventoryCore.js?v=307';
