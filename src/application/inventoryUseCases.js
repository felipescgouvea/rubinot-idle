...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=179';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=185';
...
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=204';
import { getCurrentMonster } from './huntUseCases.js?v=238';
import { areaName } from '../domain/attackAreas.js?v=170';
import { saveGame } from './saveGameUseCase.js?v=174';
import { itemLogIcon } from './logIcons.js?v=173';
import { t } from '../i18n/i18n.js?v=188';

export { addItemToInventory } from './inventoryCore.js?v=172';
