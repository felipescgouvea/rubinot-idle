...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=185';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=191';
import { RARITY_TIERS } from '../domain/rarity.js?v=177';
import { emit, EVENTS } from '../shared/eventBus.js?v=178';
import { getMagic } from './stats.js?v=177';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=210';
import { getCurrentMonster } from './huntUseCases.js?v=244';
import { areaName } from '../domain/attackAreas.js?v=176';
import { saveGame } from './saveGameUseCase.js?v=180';
import { itemLogIcon } from './logIcons.js?v=179';
import { t } from '../i18n/i18n.js?v=194';

export { addItemToInventory } from './inventoryCore.js?v=178';
