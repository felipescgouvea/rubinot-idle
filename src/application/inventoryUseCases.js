...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=190';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=196';
import { RARITY_TIERS } from '../domain/rarity.js?v=182';
import { emit, EVENTS } from '../shared/eventBus.js?v=183';
import { getMagic } from './stats.js?v=182';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=215';
import { getCurrentMonster } from './huntUseCases.js?v=249';
import { areaName } from '../domain/attackAreas.js?v=181';
import { saveGame } from './saveGameUseCase.js?v=185';
import { itemLogIcon } from './logIcons.js?v=184';
import { t } from '../i18n/i18n.js?v=199';

export { addItemToInventory } from './inventoryCore.js?v=183';
