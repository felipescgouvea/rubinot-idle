...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=273';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=276';
import { RARITY_TIERS } from '../domain/rarity.js?v=262';
import { emit, EVENTS } from '../shared/eventBus.js?v=263';
import { getMagic } from './stats.js?v=262';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=295';
import { getCurrentMonster } from './huntUseCases.js?v=329';
import { areaName } from '../domain/attackAreas.js?v=261';
import { saveGame } from './saveGameUseCase.js?v=265';
import { itemLogIcon } from './logIcons.js?v=264';
import { t } from '../i18n/i18n.js?v=281';

export { addItemToInventory } from './inventoryCore.js?v=263';
