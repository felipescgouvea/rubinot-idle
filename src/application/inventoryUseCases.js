...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=147';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=153';
import { RARITY_TIERS } from '../domain/rarity.js?v=139';
import { emit, EVENTS } from '../shared/eventBus.js?v=140';
import { getMagic } from './stats.js?v=139';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=172';
import { getCurrentMonster } from './huntUseCases.js?v=206';
import { areaName } from '../domain/attackAreas.js?v=138';
import { saveGame } from './saveGameUseCase.js?v=142';
import { itemLogIcon } from './logIcons.js?v=141';
import { t } from '../i18n/i18n.js?v=156';

export { addItemToInventory } from './inventoryCore.js?v=140';
