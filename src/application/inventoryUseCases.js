...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=316';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=319';
import { RARITY_TIERS } from '../domain/rarity.js?v=305';
import { emit, EVENTS } from '../shared/eventBus.js?v=306';
import { getMagic } from './stats.js?v=305';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=338';
import { getCurrentMonster } from './huntUseCases.js?v=372';
import { areaName } from '../domain/attackAreas.js?v=304';
import { saveGame } from './saveGameUseCase.js?v=308';
import { itemLogIcon } from './logIcons.js?v=307';
import { t } from '../i18n/i18n.js?v=324';

export { addItemToInventory } from './inventoryCore.js?v=306';
