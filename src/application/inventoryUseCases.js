...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=53';
...
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=53';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=53';
import { saveGame } from './saveGameUseCase.js?v=53';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=53';
...
export { addItemToInventory } from './inventoryCore.js?v=53';
