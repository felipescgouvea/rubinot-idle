...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=281';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=284';
import { RARITY_TIERS } from '../domain/rarity.js?v=270';
import { emit, EVENTS } from '../shared/eventBus.js?v=271';
import { getMagic } from './stats.js?v=270';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=303';
import { getCurrentMonster } from './huntUseCases.js?v=337';
import { areaName } from '../domain/attackAreas.js?v=269';
import { saveGame } from './saveGameUseCase.js?v=273';
import { itemLogIcon } from './logIcons.js?v=272';
import { t } from '../i18n/i18n.js?v=289';

export { addItemToInventory } from './inventoryCore.js?v=271';
