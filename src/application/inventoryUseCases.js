...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=371';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=374';
import { RARITY_TIERS } from '../domain/rarity.js?v=360';
import { emit, EVENTS } from '../shared/eventBus.js?v=361';
import { getMagic } from './stats.js?v=360';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=393';
import { getCurrentMonster } from './huntUseCases.js?v=427';
import { areaName } from '../domain/attackAreas.js?v=359';
import { saveGame } from './saveGameUseCase.js?v=363';
import { itemLogIcon } from './logIcons.js?v=362';
import { t } from '../i18n/i18n.js?v=379';

export { addItemToInventory } from './inventoryCore.js?v=361';
