...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=352';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=355';
import { RARITY_TIERS } from '../domain/rarity.js?v=341';
import { emit, EVENTS } from '../shared/eventBus.js?v=342';
import { getMagic } from './stats.js?v=341';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=374';
import { getCurrentMonster } from './huntUseCases.js?v=408';
import { areaName } from '../domain/attackAreas.js?v=340';
import { saveGame } from './saveGameUseCase.js?v=344';
import { itemLogIcon } from './logIcons.js?v=343';
import { t } from '../i18n/i18n.js?v=360';

export { addItemToInventory } from './inventoryCore.js?v=342';
