...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=155';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=161';
import { RARITY_TIERS } from '../domain/rarity.js?v=147';
import { emit, EVENTS } from '../shared/eventBus.js?v=148';
import { getMagic } from './stats.js?v=147';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=180';
import { getCurrentMonster } from './huntUseCases.js?v=214';
import { areaName } from '../domain/attackAreas.js?v=146';
import { saveGame } from './saveGameUseCase.js?v=150';
import { itemLogIcon } from './logIcons.js?v=149';
import { t } from '../i18n/i18n.js?v=164';

export { addItemToInventory } from './inventoryCore.js?v=148';
