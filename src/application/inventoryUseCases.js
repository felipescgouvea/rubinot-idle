...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=242';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=248';
import { RARITY_TIERS } from '../domain/rarity.js?v=234';
import { emit, EVENTS } from '../shared/eventBus.js?v=235';
import { getMagic } from './stats.js?v=234';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=267';
import { getCurrentMonster } from './huntUseCases.js?v=301';
import { areaName } from '../domain/attackAreas.js?v=233';
import { saveGame } from './saveGameUseCase.js?v=237';
import { itemLogIcon } from './logIcons.js?v=236';
import { t } from '../i18n/i18n.js?v=251';

export { addItemToInventory } from './inventoryCore.js?v=235';
