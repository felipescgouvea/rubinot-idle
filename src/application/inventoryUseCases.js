...
import { ITEMS, resolveEquippedItem, potionUseBlockReason } from '../domain/items.js?v=70';
import { ZONES } from '../domain/bestiary.js?v=70';
import { RARITY_TIERS } from '../domain/rarity.js?v=70';
import { emit, EVENTS } from '../shared/eventBus.js?v=70';
import { getMaxHp, getMaxMana } from './stats.js?v=70';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=70';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=70';
import { saveGame } from './saveGameUseCase.js?v=70';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=70';
...
export { addItemToInventory } from './inventoryCore.js?v=70';
