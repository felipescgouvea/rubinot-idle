...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=274';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=277';
import { RARITY_TIERS } from '../domain/rarity.js?v=263';
import { emit, EVENTS } from '../shared/eventBus.js?v=264';
import { getMagic } from './stats.js?v=263';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=296';
import { getCurrentMonster } from './huntUseCases.js?v=330';
import { areaName } from '../domain/attackAreas.js?v=262';
import { saveGame } from './saveGameUseCase.js?v=266';
import { itemLogIcon } from './logIcons.js?v=265';
import { t } from '../i18n/i18n.js?v=282';

export { addItemToInventory } from './inventoryCore.js?v=264';
