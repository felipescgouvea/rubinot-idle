...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=264';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=269';
import { RARITY_TIERS } from '../domain/rarity.js?v=255';
import { emit, EVENTS } from '../shared/eventBus.js?v=256';
import { getMagic } from './stats.js?v=255';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=288';
import { getCurrentMonster } from './huntUseCases.js?v=322';
import { areaName } from '../domain/attackAreas.js?v=254';
import { saveGame } from './saveGameUseCase.js?v=258';
import { itemLogIcon } from './logIcons.js?v=257';
import { t } from '../i18n/i18n.js?v=274';

export { addItemToInventory } from './inventoryCore.js?v=256';
