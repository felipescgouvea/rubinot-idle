...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=173';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=179';
import { RARITY_TIERS } from '../domain/rarity.js?v=165';
import { emit, EVENTS } from '../shared/eventBus.js?v=166';
import { getMagic } from './stats.js?v=165';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=198';
import { getCurrentMonster } from './huntUseCases.js?v=232';
import { areaName } from '../domain/attackAreas.js?v=164';
import { saveGame } from './saveGameUseCase.js?v=168';
import { itemLogIcon } from './logIcons.js?v=167';
import { t } from '../i18n/i18n.js?v=182';

export { addItemToInventory } from './inventoryCore.js?v=166';
