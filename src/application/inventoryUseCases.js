...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=146';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=152';
import { RARITY_TIERS } from '../domain/rarity.js?v=138';
import { emit, EVENTS } from '../shared/eventBus.js?v=139';
import { getMagic } from './stats.js?v=138';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=171';
import { getCurrentMonster } from './huntUseCases.js?v=205';
import { areaName } from '../domain/attackAreas.js?v=137';
import { saveGame } from './saveGameUseCase.js?v=141';
import { itemLogIcon } from './logIcons.js?v=140';
import { t } from '../i18n/i18n.js?v=155';

export { addItemToInventory } from './inventoryCore.js?v=139';
