...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=291';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=294';
import { RARITY_TIERS } from '../domain/rarity.js?v=280';
import { emit, EVENTS } from '../shared/eventBus.js?v=281';
import { getMagic } from './stats.js?v=280';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=313';
import { getCurrentMonster } from './huntUseCases.js?v=347';
import { areaName } from '../domain/attackAreas.js?v=279';
import { saveGame } from './saveGameUseCase.js?v=283';
import { itemLogIcon } from './logIcons.js?v=282';
import { t } from '../i18n/i18n.js?v=299';

export { addItemToInventory } from './inventoryCore.js?v=281';
