...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=113';
import { ZONES } from '../domain/bestiary.js?v=113';
import { RARITY_TIERS } from '../domain/rarity.js?v=113';
import { emit, EVENTS } from '../shared/eventBus.js?v=113';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=113';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=113';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=113';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=113';
import { runeDamage } from '../domain/combatFormulas.js?v=113';
import { elementMod } from '../domain/elements.js?v=113';
import { saveGame } from './saveGameUseCase.js?v=113';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=113';
...
export { addItemToInventory } from './inventoryCore.js?v=113';
