...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=310';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=313';
import { RARITY_TIERS } from '../domain/rarity.js?v=299';
import { emit, EVENTS } from '../shared/eventBus.js?v=300';
import { getMagic } from './stats.js?v=299';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=332';
import { getCurrentMonster } from './huntUseCases.js?v=366';
import { areaName } from '../domain/attackAreas.js?v=298';
import { saveGame } from './saveGameUseCase.js?v=302';
import { itemLogIcon } from './logIcons.js?v=301';
import { t } from '../i18n/i18n.js?v=318';

export { addItemToInventory } from './inventoryCore.js?v=300';
