...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=328';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=331';
import { RARITY_TIERS } from '../domain/rarity.js?v=317';
import { emit, EVENTS } from '../shared/eventBus.js?v=318';
import { getMagic } from './stats.js?v=317';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=350';
import { getCurrentMonster } from './huntUseCases.js?v=384';
import { areaName } from '../domain/attackAreas.js?v=316';
import { saveGame } from './saveGameUseCase.js?v=320';
import { itemLogIcon } from './logIcons.js?v=319';
import { t } from '../i18n/i18n.js?v=336';

export { addItemToInventory } from './inventoryCore.js?v=318';
