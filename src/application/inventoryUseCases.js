...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=251';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=257';
import { RARITY_TIERS } from '../domain/rarity.js?v=243';
import { emit, EVENTS } from '../shared/eventBus.js?v=244';
import { getMagic } from './stats.js?v=243';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=276';
import { getCurrentMonster } from './huntUseCases.js?v=310';
import { areaName } from '../domain/attackAreas.js?v=242';
import { saveGame } from './saveGameUseCase.js?v=246';
import { itemLogIcon } from './logIcons.js?v=245';
import { t } from '../i18n/i18n.js?v=260';

export { addItemToInventory } from './inventoryCore.js?v=244';
