...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=165';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=171';
import { RARITY_TIERS } from '../domain/rarity.js?v=157';
import { emit, EVENTS } from '../shared/eventBus.js?v=158';
import { getMagic } from './stats.js?v=157';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=190';
import { getCurrentMonster } from './huntUseCases.js?v=224';
import { areaName } from '../domain/attackAreas.js?v=156';
import { saveGame } from './saveGameUseCase.js?v=160';
import { itemLogIcon } from './logIcons.js?v=159';
import { t } from '../i18n/i18n.js?v=174';

export { addItemToInventory } from './inventoryCore.js?v=158';
