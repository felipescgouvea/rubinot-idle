...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=145';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=151';
import { RARITY_TIERS } from '../domain/rarity.js?v=137';
import { emit, EVENTS } from '../shared/eventBus.js?v=138';
import { getMagic } from './stats.js?v=137';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=170';
import { getCurrentMonster } from './huntUseCases.js?v=204';
import { areaName } from '../domain/attackAreas.js?v=136';
import { saveGame } from './saveGameUseCase.js?v=140';
import { itemLogIcon } from './logIcons.js?v=139';
import { t } from '../i18n/i18n.js?v=154';

export { addItemToInventory } from './inventoryCore.js?v=138';
