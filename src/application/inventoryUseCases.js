...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=262';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=268';
import { RARITY_TIERS } from '../domain/rarity.js?v=254';
import { emit, EVENTS } from '../shared/eventBus.js?v=255';
import { getMagic } from './stats.js?v=254';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=287';
import { getCurrentMonster } from './huntUseCases.js?v=321';
import { areaName } from '../domain/attackAreas.js?v=253';
import { saveGame } from './saveGameUseCase.js?v=257';
import { itemLogIcon } from './logIcons.js?v=256';
import { t } from '../i18n/i18n.js?v=271';

export { addItemToInventory } from './inventoryCore.js?v=255';
