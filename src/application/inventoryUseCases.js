...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=297';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=300';
import { RARITY_TIERS } from '../domain/rarity.js?v=286';
import { emit, EVENTS } from '../shared/eventBus.js?v=287';
import { getMagic } from './stats.js?v=286';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=319';
import { getCurrentMonster } from './huntUseCases.js?v=353';
import { areaName } from '../domain/attackAreas.js?v=285';
import { saveGame } from './saveGameUseCase.js?v=289';
import { itemLogIcon } from './logIcons.js?v=288';
import { t } from '../i18n/i18n.js?v=305';

export { addItemToInventory } from './inventoryCore.js?v=287';
