...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=152';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=158';
import { RARITY_TIERS } from '../domain/rarity.js?v=144';
import { emit, EVENTS } from '../shared/eventBus.js?v=145';
import { getMagic } from './stats.js?v=144';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=177';
import { getCurrentMonster } from './huntUseCases.js?v=211';
import { areaName } from '../domain/attackAreas.js?v=143';
import { saveGame } from './saveGameUseCase.js?v=147';
import { itemLogIcon } from './logIcons.js?v=146';
import { t } from '../i18n/i18n.js?v=161';

export { addItemToInventory } from './inventoryCore.js?v=145';
