...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=201';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=207';
import { RARITY_TIERS } from '../domain/rarity.js?v=193';
import { emit, EVENTS } from '../shared/eventBus.js?v=194';
import { getMagic } from './stats.js?v=193';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=226';
import { getCurrentMonster } from './huntUseCases.js?v=260';
import { areaName } from '../domain/attackAreas.js?v=192';
import { saveGame } from './saveGameUseCase.js?v=196';
import { itemLogIcon } from './logIcons.js?v=195';
import { t } from '../i18n/i18n.js?v=210';

export { addItemToInventory } from './inventoryCore.js?v=194';
