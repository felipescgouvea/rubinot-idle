...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=335';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=338';
import { RARITY_TIERS } from '../domain/rarity.js?v=324';
import { emit, EVENTS } from '../shared/eventBus.js?v=325';
import { getMagic } from './stats.js?v=324';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=357';
import { getCurrentMonster } from './huntUseCases.js?v=391';
import { areaName } from '../domain/attackAreas.js?v=323';
import { saveGame } from './saveGameUseCase.js?v=327';
import { itemLogIcon } from './logIcons.js?v=326';
import { t } from '../i18n/i18n.js?v=343';

export { addItemToInventory } from './inventoryCore.js?v=325';
