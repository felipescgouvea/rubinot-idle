...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=119';
import { ZONES } from '../domain/bestiary.js?v=119';
import { RARITY_TIERS } from '../domain/rarity.js?v=119';
import { emit, EVENTS } from '../shared/eventBus.js?v=119';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=119';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=119';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=119';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=119';
import { runeDamage } from '../domain/combatFormulas.js?v=119';
import { elementMod } from '../domain/elements.js?v=119';
import { saveGame } from './saveGameUseCase.js?v=119';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=119';
...
export { addItemToInventory } from './inventoryCore.js?v=119';
