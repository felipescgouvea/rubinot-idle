...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=172';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=178';
import { RARITY_TIERS } from '../domain/rarity.js?v=164';
import { emit, EVENTS } from '../shared/eventBus.js?v=165';
import { getMagic } from './stats.js?v=164';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=197';
import { getCurrentMonster } from './huntUseCases.js?v=231';
import { areaName } from '../domain/attackAreas.js?v=163';
import { saveGame } from './saveGameUseCase.js?v=167';
import { itemLogIcon } from './logIcons.js?v=166';
import { t } from '../i18n/i18n.js?v=181';

export { addItemToInventory } from './inventoryCore.js?v=165';
