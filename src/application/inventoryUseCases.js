...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=142';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=148';
import { RARITY_TIERS } from '../domain/rarity.js?v=134';
import { emit, EVENTS } from '../shared/eventBus.js?v=135';
import { getMagic } from './stats.js?v=134';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=167';
import { getCurrentMonster } from './huntUseCases.js?v=201';
import { areaName } from '../domain/attackAreas.js?v=133';
import { saveGame } from './saveGameUseCase.js?v=137';
import { itemLogIcon } from './logIcons.js?v=136';
import { t } from '../i18n/i18n.js?v=151';

export { addItemToInventory } from './inventoryCore.js?v=135';
