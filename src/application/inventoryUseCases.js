...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=258';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=264';
...
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=283';
import { getCurrentMonster } from './huntUseCases.js?v=317';
import { areaName } from '../domain/attackAreas.js?v=249';
import { saveGame } from './saveGameUseCase.js?v=253';
import { itemLogIcon } from './logIcons.js?v=252';
import { t } from '../i18n/i18n.js?v=267';

export { addItemToInventory } from './inventoryCore.js?v=251';
