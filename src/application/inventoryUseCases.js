...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=323';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=326';
import { RARITY_TIERS } from '../domain/rarity.js?v=312';
import { emit, EVENTS } from '../shared/eventBus.js?v=313';
import { getMagic } from './stats.js?v=312';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=345';
import { getCurrentMonster } from './huntUseCases.js?v=379';
import { areaName } from '../domain/attackAreas.js?v=311';
import { saveGame } from './saveGameUseCase.js?v=315';
import { itemLogIcon } from './logIcons.js?v=314';
import { t } from '../i18n/i18n.js?v=331';

export { addItemToInventory } from './inventoryCore.js?v=313';
