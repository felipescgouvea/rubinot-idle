...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=221';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=227';
import { RARITY_TIERS } from '../domain/rarity.js?v=213';
import { emit, EVENTS } from '../shared/eventBus.js?v=214';
import { getMagic } from './stats.js?v=213';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=246';
import { getCurrentMonster } from './huntUseCases.js?v=280';
import { areaName } from '../domain/attackAreas.js?v=212';
import { saveGame } from './saveGameUseCase.js?v=216';
import { itemLogIcon } from './logIcons.js?v=215';
import { t } from '../i18n/i18n.js?v=230';

export { addItemToInventory } from './inventoryCore.js?v=214';
