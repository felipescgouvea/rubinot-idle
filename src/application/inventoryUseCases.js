...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=144';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=150';
import { RARITY_TIERS } from '../domain/rarity.js?v=136';
import { emit, EVENTS } from '../shared/eventBus.js?v=137';
import { getMagic } from './stats.js?v=136';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=169';
import { getCurrentMonster } from './huntUseCases.js?v=203';
import { areaName } from '../domain/attackAreas.js?v=135';
import { saveGame } from './saveGameUseCase.js?v=139';
import { itemLogIcon } from './logIcons.js?v=138';
import { t } from '../i18n/i18n.js?v=153';

export { addItemToInventory } from './inventoryCore.js?v=137';
