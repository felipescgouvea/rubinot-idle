...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=334';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=337';
import { RARITY_TIERS } from '../domain/rarity.js?v=323';
import { emit, EVENTS } from '../shared/eventBus.js?v=324';
import { getMagic } from './stats.js?v=323';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=356';
import { getCurrentMonster } from './huntUseCases.js?v=390';
import { areaName } from '../domain/attackAreas.js?v=322';
import { saveGame } from './saveGameUseCase.js?v=326';
import { itemLogIcon } from './logIcons.js?v=325';
import { t } from '../i18n/i18n.js?v=342';

export { addItemToInventory } from './inventoryCore.js?v=324';
