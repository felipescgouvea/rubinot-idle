...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=332';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=335';
import { RARITY_TIERS } from '../domain/rarity.js?v=321';
import { emit, EVENTS } from '../shared/eventBus.js?v=322';
import { getMagic } from './stats.js?v=321';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=354';
import { getCurrentMonster } from './huntUseCases.js?v=388';
import { areaName } from '../domain/attackAreas.js?v=320';
import { saveGame } from './saveGameUseCase.js?v=324';
import { itemLogIcon } from './logIcons.js?v=323';
import { t } from '../i18n/i18n.js?v=340';

export { addItemToInventory } from './inventoryCore.js?v=322';
