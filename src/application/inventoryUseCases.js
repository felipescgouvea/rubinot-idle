...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=143';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=149';
import { RARITY_TIERS } from '../domain/rarity.js?v=135';
import { emit, EVENTS } from '../shared/eventBus.js?v=136';
import { getMagic } from './stats.js?v=135';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=168';
import { getCurrentMonster } from './huntUseCases.js?v=202';
import { areaName } from '../domain/attackAreas.js?v=134';
import { saveGame } from './saveGameUseCase.js?v=138';
import { itemLogIcon } from './logIcons.js?v=137';
import { t } from '../i18n/i18n.js?v=152';

export { addItemToInventory } from './inventoryCore.js?v=136';
