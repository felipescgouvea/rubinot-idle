...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=118';
import { ZONES } from '../domain/bestiary.js?v=118';
import { RARITY_TIERS } from '../domain/rarity.js?v=118';
import { emit, EVENTS } from '../shared/eventBus.js?v=118';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=118';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=118';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=118';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=118';
import { runeDamage } from '../domain/combatFormulas.js?v=118';
import { elementMod } from '../domain/elements.js?v=118';
import { saveGame } from './saveGameUseCase.js?v=118';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=118';
...
export { addItemToInventory } from './inventoryCore.js?v=118';
