...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=351';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=354';
import { RARITY_TIERS } from '../domain/rarity.js?v=340';
import { emit, EVENTS } from '../shared/eventBus.js?v=341';
import { getMagic } from './stats.js?v=340';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=373';
import { getCurrentMonster } from './huntUseCases.js?v=407';
import { areaName } from '../domain/attackAreas.js?v=339';
import { saveGame } from './saveGameUseCase.js?v=343';
import { itemLogIcon } from './logIcons.js?v=342';
import { t } from '../i18n/i18n.js?v=359';

export { addItemToInventory } from './inventoryCore.js?v=341';
