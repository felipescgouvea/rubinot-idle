...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=223';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=229';
import { RARITY_TIERS } from '../domain/rarity.js?v=215';
import { emit, EVENTS } from '../shared/eventBus.js?v=216';
import { getMagic } from './stats.js?v=215';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=248';
import { getCurrentMonster } from './huntUseCases.js?v=282';
import { areaName } from '../domain/attackAreas.js?v=214';
import { saveGame } from './saveGameUseCase.js?v=218';
import { itemLogIcon } from './logIcons.js?v=217';
import { t } from '../i18n/i18n.js?v=232';

export { addItemToInventory } from './inventoryCore.js?v=216';
