...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=350';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=353';
import { RARITY_TIERS } from '../domain/rarity.js?v=339';
import { emit, EVENTS } from '../shared/eventBus.js?v=340';
import { getMagic } from './stats.js?v=339';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=372';
import { getCurrentMonster } from './huntUseCases.js?v=406';
import { areaName } from '../domain/attackAreas.js?v=338';
import { saveGame } from './saveGameUseCase.js?v=342';
import { itemLogIcon } from './logIcons.js?v=341';
import { t } from '../i18n/i18n.js?v=358';

export { addItemToInventory } from './inventoryCore.js?v=340';
