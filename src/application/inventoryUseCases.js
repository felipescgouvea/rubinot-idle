...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=186';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=192';
import { RARITY_TIERS } from '../domain/rarity.js?v=178';
import { emit, EVENTS } from '../shared/eventBus.js?v=179';
import { getMagic } from './stats.js?v=178';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=211';
import { getCurrentMonster } from './huntUseCases.js?v=245';
import { areaName } from '../domain/attackAreas.js?v=177';
import { saveGame } from './saveGameUseCase.js?v=181';
import { itemLogIcon } from './logIcons.js?v=180';
import { t } from '../i18n/i18n.js?v=195';

export { addItemToInventory } from './inventoryCore.js?v=179';
