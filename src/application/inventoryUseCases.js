...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=194';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=200';
import { RARITY_TIERS } from '../domain/rarity.js?v=186';
import { emit, EVENTS } from '../shared/eventBus.js?v=187';
import { getMagic } from './stats.js?v=186';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=219';
import { getCurrentMonster } from './huntUseCases.js?v=253';
import { areaName } from '../domain/attackAreas.js?v=185';
import { saveGame } from './saveGameUseCase.js?v=189';
import { itemLogIcon } from './logIcons.js?v=188';
import { t } from '../i18n/i18n.js?v=203';

export { addItemToInventory } from './inventoryCore.js?v=187';
