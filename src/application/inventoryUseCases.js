...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=188';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=194';
import { RARITY_TIERS } from '../domain/rarity.js?v=180';
import { emit, EVENTS } from '../shared/eventBus.js?v=181';
import { getMagic } from './stats.js?v=180';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=213';
import { getCurrentMonster } from './huntUseCases.js?v=247';
import { areaName } from '../domain/attackAreas.js?v=179';
import { saveGame } from './saveGameUseCase.js?v=183';
import { itemLogIcon } from './logIcons.js?v=182';
import { t } from '../i18n/i18n.js?v=197';

export { addItemToInventory } from './inventoryCore.js?v=181';
