...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=255';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=261';
import { RARITY_TIERS } from '../domain/rarity.js?v=247';
import { emit, EVENTS } from '../shared/eventBus.js?v=248';
import { getMagic } from './stats.js?v=247';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=280';
import { getCurrentMonster } from './huntUseCases.js?v=314';
import { areaName } from '../domain/attackAreas.js?v=246';
import { saveGame } from './saveGameUseCase.js?v=250';
import { itemLogIcon } from './logIcons.js?v=249';
import { t } from '../i18n/i18n.js?v=264';

export { addItemToInventory } from './inventoryCore.js?v=248';
