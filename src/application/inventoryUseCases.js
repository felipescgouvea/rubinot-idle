...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=366';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=369';
import { RARITY_TIERS } from '../domain/rarity.js?v=355';
import { emit, EVENTS } from '../shared/eventBus.js?v=356';
import { getMagic } from './stats.js?v=355';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=388';
import { getCurrentMonster } from './huntUseCases.js?v=422';
import { areaName } from '../domain/attackAreas.js?v=354';
import { saveGame } from './saveGameUseCase.js?v=358';
import { itemLogIcon } from './logIcons.js?v=357';
import { t } from '../i18n/i18n.js?v=374';

export { addItemToInventory } from './inventoryCore.js?v=356';
