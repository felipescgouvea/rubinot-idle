...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=35';
import { ZONES } from '../domain/bestiary.js?v=35';
import { RARITY_TIERS } from '../domain/rarity.js?v=35';
import { emit, EVENTS } from '../shared/eventBus.js?v=35';
import { getMaxHp, getMaxMana } from './stats.js?v=35';
import { getCurrentMonster, resolveMonsterKill } from './huntUseCases.js?v=35';
import { saveGame } from './saveGameUseCase.js?v=35';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=35';
...
export { addItemToInventory } from './inventoryCore.js?v=35';
