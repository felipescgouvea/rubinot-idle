...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=156';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=162';
import { RARITY_TIERS } from '../domain/rarity.js?v=148';
import { emit, EVENTS } from '../shared/eventBus.js?v=149';
import { getMagic } from './stats.js?v=148';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=181';
import { getCurrentMonster } from './huntUseCases.js?v=215';
import { areaName } from '../domain/attackAreas.js?v=147';
import { saveGame } from './saveGameUseCase.js?v=151';
import { itemLogIcon } from './logIcons.js?v=150';
import { t } from '../i18n/i18n.js?v=165';

export { addItemToInventory } from './inventoryCore.js?v=149';
