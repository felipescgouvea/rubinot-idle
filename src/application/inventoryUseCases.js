...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=329';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=332';
import { RARITY_TIERS } from '../domain/rarity.js?v=318';
import { emit, EVENTS } from '../shared/eventBus.js?v=319';
import { getMagic } from './stats.js?v=318';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=351';
import { getCurrentMonster } from './huntUseCases.js?v=385';
import { areaName } from '../domain/attackAreas.js?v=317';
import { saveGame } from './saveGameUseCase.js?v=321';
import { itemLogIcon } from './logIcons.js?v=320';
import { t } from '../i18n/i18n.js?v=337';

export { addItemToInventory } from './inventoryCore.js?v=319';
