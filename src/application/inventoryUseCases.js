...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=309';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=312';
import { RARITY_TIERS } from '../domain/rarity.js?v=298';
import { emit, EVENTS } from '../shared/eventBus.js?v=299';
import { getMagic } from './stats.js?v=298';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=331';
import { getCurrentMonster } from './huntUseCases.js?v=365';
import { areaName } from '../domain/attackAreas.js?v=297';
import { saveGame } from './saveGameUseCase.js?v=301';
import { itemLogIcon } from './logIcons.js?v=300';
import { t } from '../i18n/i18n.js?v=317';

export { addItemToInventory } from './inventoryCore.js?v=299';
