...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=330';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=333';
import { RARITY_TIERS } from '../domain/rarity.js?v=319';
import { emit, EVENTS } from '../shared/eventBus.js?v=320';
import { getMagic } from './stats.js?v=319';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=352';
import { getCurrentMonster } from './huntUseCases.js?v=386';
import { areaName } from '../domain/attackAreas.js?v=318';
import { saveGame } from './saveGameUseCase.js?v=322';
import { itemLogIcon } from './logIcons.js?v=321';
import { t } from '../i18n/i18n.js?v=338';

export { addItemToInventory } from './inventoryCore.js?v=320';
