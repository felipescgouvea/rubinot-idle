...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=112';
import { ZONES } from '../domain/bestiary.js?v=112';
import { RARITY_TIERS } from '../domain/rarity.js?v=112';
import { emit, EVENTS } from '../shared/eventBus.js?v=112';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=112';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=112';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=112';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=112';
import { runeDamage } from '../domain/combatFormulas.js?v=112';
import { elementMod } from '../domain/elements.js?v=112';
import { saveGame } from './saveGameUseCase.js?v=112';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=112';
...
export { addItemToInventory } from './inventoryCore.js?v=112';
