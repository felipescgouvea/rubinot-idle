...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=293';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=296';
import { RARITY_TIERS } from '../domain/rarity.js?v=282';
import { emit, EVENTS } from '../shared/eventBus.js?v=283';
import { getMagic } from './stats.js?v=282';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=315';
import { getCurrentMonster } from './huntUseCases.js?v=349';
import { areaName } from '../domain/attackAreas.js?v=281';
import { saveGame } from './saveGameUseCase.js?v=285';
import { itemLogIcon } from './logIcons.js?v=284';
import { t } from '../i18n/i18n.js?v=301';

export { addItemToInventory } from './inventoryCore.js?v=283';
