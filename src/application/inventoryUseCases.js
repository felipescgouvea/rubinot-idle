...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=195';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=201';
import { RARITY_TIERS } from '../domain/rarity.js?v=187';
import { emit, EVENTS } from '../shared/eventBus.js?v=188';
import { getMagic } from './stats.js?v=187';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=220';
import { getCurrentMonster } from './huntUseCases.js?v=254';
import { areaName } from '../domain/attackAreas.js?v=186';
import { saveGame } from './saveGameUseCase.js?v=190';
import { itemLogIcon } from './logIcons.js?v=189';
import { t } from '../i18n/i18n.js?v=204';

export { addItemToInventory } from './inventoryCore.js?v=188';
