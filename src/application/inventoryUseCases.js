...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=282';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=285';
import { RARITY_TIERS } from '../domain/rarity.js?v=271';
import { emit, EVENTS } from '../shared/eventBus.js?v=272';
import { getMagic } from './stats.js?v=271';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=304';
import { getCurrentMonster } from './huntUseCases.js?v=338';
import { areaName } from '../domain/attackAreas.js?v=270';
import { saveGame } from './saveGameUseCase.js?v=274';
import { itemLogIcon } from './logIcons.js?v=273';
import { t } from '../i18n/i18n.js?v=290';

export { addItemToInventory } from './inventoryCore.js?v=272';
