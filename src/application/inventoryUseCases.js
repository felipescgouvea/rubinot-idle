...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=211';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=217';
import { RARITY_TIERS } from '../domain/rarity.js?v=203';
import { emit, EVENTS } from '../shared/eventBus.js?v=204';
import { getMagic } from './stats.js?v=203';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=236';
import { getCurrentMonster } from './huntUseCases.js?v=270';
import { areaName } from '../domain/attackAreas.js?v=202';
import { saveGame } from './saveGameUseCase.js?v=206';
import { itemLogIcon } from './logIcons.js?v=205';
import { t } from '../i18n/i18n.js?v=220';

export { addItemToInventory } from './inventoryCore.js?v=204';
