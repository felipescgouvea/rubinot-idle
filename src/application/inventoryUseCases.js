...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=187';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=193';
import { RARITY_TIERS } from '../domain/rarity.js?v=179';
import { emit, EVENTS } from '../shared/eventBus.js?v=180';
import { getMagic } from './stats.js?v=179';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=212';
import { getCurrentMonster } from './huntUseCases.js?v=246';
import { areaName } from '../domain/attackAreas.js?v=178';
import { saveGame } from './saveGameUseCase.js?v=182';
import { itemLogIcon } from './logIcons.js?v=181';
import { t } from '../i18n/i18n.js?v=196';

export { addItemToInventory } from './inventoryCore.js?v=180';
