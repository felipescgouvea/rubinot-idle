...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=135';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=141';
import { RARITY_TIERS } from '../domain/rarity.js?v=127';
import { emit, EVENTS } from '../shared/eventBus.js?v=128';
import { getMagic } from './stats.js?v=127';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=160';
import { getCurrentMonster } from './huntUseCases.js?v=194';
import { areaName } from '../domain/attackAreas.js?v=126';
import { saveGame } from './saveGameUseCase.js?v=130';
import { itemLogIcon } from './logIcons.js?v=129';
import { t } from '../i18n/i18n.js?v=144';

export { addItemToInventory } from './inventoryCore.js?v=128';
