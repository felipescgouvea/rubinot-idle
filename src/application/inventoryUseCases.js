...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=243';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=249';
import { RARITY_TIERS } from '../domain/rarity.js?v=235';
import { emit, EVENTS } from '../shared/eventBus.js?v=236';
import { getMagic } from './stats.js?v=235';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=268';
import { getCurrentMonster } from './huntUseCases.js?v=302';
import { areaName } from '../domain/attackAreas.js?v=234';
import { saveGame } from './saveGameUseCase.js?v=238';
import { itemLogIcon } from './logIcons.js?v=237';
import { t } from '../i18n/i18n.js?v=252';

export { addItemToInventory } from './inventoryCore.js?v=236';
