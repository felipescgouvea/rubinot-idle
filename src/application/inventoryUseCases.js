...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=167';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=173';
...
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=192';
import { getCurrentMonster } from './huntUseCases.js?v=226';
import { areaName } from '../domain/attackAreas.js?v=158';
import { saveGame } from './saveGameUseCase.js?v=162';
import { itemLogIcon } from './logIcons.js?v=161';
import { t } from '../i18n/i18n.js?v=176';

export { addItemToInventory } from './inventoryCore.js?v=160';
