...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=336';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=339';
import { RARITY_TIERS } from '../domain/rarity.js?v=325';
import { emit, EVENTS } from '../shared/eventBus.js?v=326';
import { getMagic } from './stats.js?v=325';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=358';
import { getCurrentMonster } from './huntUseCases.js?v=392';
import { areaName } from '../domain/attackAreas.js?v=324';
import { saveGame } from './saveGameUseCase.js?v=328';
import { itemLogIcon } from './logIcons.js?v=327';
import { t } from '../i18n/i18n.js?v=344';

export { addItemToInventory } from './inventoryCore.js?v=326';
