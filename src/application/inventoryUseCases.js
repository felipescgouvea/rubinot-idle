...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=275';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=278';
import { RARITY_TIERS } from '../domain/rarity.js?v=264';
import { emit, EVENTS } from '../shared/eventBus.js?v=265';
import { getMagic } from './stats.js?v=264';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=297';
import { getCurrentMonster } from './huntUseCases.js?v=331';
import { areaName } from '../domain/attackAreas.js?v=263';
import { saveGame } from './saveGameUseCase.js?v=267';
import { itemLogIcon } from './logIcons.js?v=266';
import { t } from '../i18n/i18n.js?v=283';

export { addItemToInventory } from './inventoryCore.js?v=265';
