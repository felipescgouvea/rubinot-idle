...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=184';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=190';
...
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=209';
import { getCurrentMonster } from './huntUseCases.js?v=243';
import { areaName } from '../domain/attackAreas.js?v=175';
import { saveGame } from './saveGameUseCase.js?v=179';
import { itemLogIcon } from './logIcons.js?v=178';
import { t } from '../i18n/i18n.js?v=193';

export { addItemToInventory } from './inventoryCore.js?v=177';
