...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=168';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=174';
import { RARITY_TIERS } from '../domain/rarity.js?v=160';
import { emit, EVENTS } from '../shared/eventBus.js?v=161';
import { getMagic } from './stats.js?v=160';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=193';
import { getCurrentMonster } from './huntUseCases.js?v=227';
import { areaName } from '../domain/attackAreas.js?v=159';
import { saveGame } from './saveGameUseCase.js?v=163';
import { itemLogIcon } from './logIcons.js?v=162';
import { t } from '../i18n/i18n.js?v=177';

export { addItemToInventory } from './inventoryCore.js?v=161';
