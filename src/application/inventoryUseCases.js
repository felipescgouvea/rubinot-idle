...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=353';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=356';
import { RARITY_TIERS } from '../domain/rarity.js?v=342';
import { emit, EVENTS } from '../shared/eventBus.js?v=343';
import { getMagic } from './stats.js?v=342';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=375';
import { getCurrentMonster } from './huntUseCases.js?v=409';
import { areaName } from '../domain/attackAreas.js?v=341';
import { saveGame } from './saveGameUseCase.js?v=345';
import { itemLogIcon } from './logIcons.js?v=344';
import { t } from '../i18n/i18n.js?v=361';

export { addItemToInventory } from './inventoryCore.js?v=343';
