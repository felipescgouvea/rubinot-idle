...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=313';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=316';
import { RARITY_TIERS } from '../domain/rarity.js?v=302';
import { emit, EVENTS } from '../shared/eventBus.js?v=303';
import { getMagic } from './stats.js?v=302';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=335';
import { getCurrentMonster } from './huntUseCases.js?v=369';
import { areaName } from '../domain/attackAreas.js?v=301';
import { saveGame } from './saveGameUseCase.js?v=305';
import { itemLogIcon } from './logIcons.js?v=304';
import { t } from '../i18n/i18n.js?v=321';

export { addItemToInventory } from './inventoryCore.js?v=303';
