...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=280';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=283';
import { RARITY_TIERS } from '../domain/rarity.js?v=269';
import { emit, EVENTS } from '../shared/eventBus.js?v=270';
import { getMagic } from './stats.js?v=269';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=302';
import { getCurrentMonster } from './huntUseCases.js?v=336';
import { areaName } from '../domain/attackAreas.js?v=268';
import { saveGame } from './saveGameUseCase.js?v=272';
import { itemLogIcon } from './logIcons.js?v=271';
import { t } from '../i18n/i18n.js?v=288';

export { addItemToInventory } from './inventoryCore.js?v=270';
