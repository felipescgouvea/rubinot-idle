...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=322';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=325';
import { RARITY_TIERS } from '../domain/rarity.js?v=311';
import { emit, EVENTS } from '../shared/eventBus.js?v=312';
import { getMagic } from './stats.js?v=311';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=344';
import { getCurrentMonster } from './huntUseCases.js?v=378';
import { areaName } from '../domain/attackAreas.js?v=310';
import { saveGame } from './saveGameUseCase.js?v=314';
import { itemLogIcon } from './logIcons.js?v=313';
import { t } from '../i18n/i18n.js?v=330';

export { addItemToInventory } from './inventoryCore.js?v=312';
