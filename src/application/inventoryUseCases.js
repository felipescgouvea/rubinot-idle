...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=292';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=295';
import { RARITY_TIERS } from '../domain/rarity.js?v=281';
import { emit, EVENTS } from '../shared/eventBus.js?v=282';
import { getMagic } from './stats.js?v=281';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=314';
import { getCurrentMonster } from './huntUseCases.js?v=348';
import { areaName } from '../domain/attackAreas.js?v=280';
import { saveGame } from './saveGameUseCase.js?v=284';
import { itemLogIcon } from './logIcons.js?v=283';
import { t } from '../i18n/i18n.js?v=300';

export { addItemToInventory } from './inventoryCore.js?v=282';
