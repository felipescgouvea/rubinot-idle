...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=61';
import { ZONES } from '../domain/bestiary.js?v=61';
import { RARITY_TIERS } from '../domain/rarity.js?v=61';
import { emit, EVENTS } from '../shared/eventBus.js?v=61';
import { getMaxHp, getMaxMana } from './stats.js?v=61';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=61';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=61';
import { saveGame } from './saveGameUseCase.js?v=61';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=61';
...
export { addItemToInventory } from './inventoryCore.js?v=61';
