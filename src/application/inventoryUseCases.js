...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=89';
import { ZONES } from '../domain/bestiary.js?v=89';
import { RARITY_TIERS } from '../domain/rarity.js?v=89';
import { emit, EVENTS } from '../shared/eventBus.js?v=89';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=89';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=89';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=89';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=89';
import { saveGame } from './saveGameUseCase.js?v=89';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=89';
...
export { addItemToInventory } from './inventoryCore.js?v=89';
