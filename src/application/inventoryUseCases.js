...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=157';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=163';
import { RARITY_TIERS } from '../domain/rarity.js?v=149';
import { emit, EVENTS } from '../shared/eventBus.js?v=150';
import { getMagic } from './stats.js?v=149';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=182';
import { getCurrentMonster } from './huntUseCases.js?v=216';
import { areaName } from '../domain/attackAreas.js?v=148';
import { saveGame } from './saveGameUseCase.js?v=152';
import { itemLogIcon } from './logIcons.js?v=151';
import { t } from '../i18n/i18n.js?v=166';

export { addItemToInventory } from './inventoryCore.js?v=150';
