...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=320';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=323';
import { RARITY_TIERS } from '../domain/rarity.js?v=309';
import { emit, EVENTS } from '../shared/eventBus.js?v=310';
import { getMagic } from './stats.js?v=309';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=342';
import { getCurrentMonster } from './huntUseCases.js?v=376';
import { areaName } from '../domain/attackAreas.js?v=308';
import { saveGame } from './saveGameUseCase.js?v=312';
import { itemLogIcon } from './logIcons.js?v=311';
import { t } from '../i18n/i18n.js?v=328';

export { addItemToInventory } from './inventoryCore.js?v=310';
