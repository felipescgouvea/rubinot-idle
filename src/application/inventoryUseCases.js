...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=230';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=236';
import { RARITY_TIERS } from '../domain/rarity.js?v=222';
import { emit, EVENTS } from '../shared/eventBus.js?v=223';
import { getMagic } from './stats.js?v=222';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=255';
import { getCurrentMonster } from './huntUseCases.js?v=289';
import { areaName } from '../domain/attackAreas.js?v=221';
import { saveGame } from './saveGameUseCase.js?v=225';
import { itemLogIcon } from './logIcons.js?v=224';
import { t } from '../i18n/i18n.js?v=239';

export { addItemToInventory } from './inventoryCore.js?v=223';
