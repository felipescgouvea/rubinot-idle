...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=176';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=182';
import { RARITY_TIERS } from '../domain/rarity.js?v=168';
import { emit, EVENTS } from '../shared/eventBus.js?v=169';
import { getMagic } from './stats.js?v=168';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=201';
import { getCurrentMonster } from './huntUseCases.js?v=235';
import { areaName } from '../domain/attackAreas.js?v=167';
import { saveGame } from './saveGameUseCase.js?v=171';
import { itemLogIcon } from './logIcons.js?v=170';
import { t } from '../i18n/i18n.js?v=185';

export { addItemToInventory } from './inventoryCore.js?v=169';
