...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=62';
import { ZONES } from '../domain/bestiary.js?v=62';
import { RARITY_TIERS } from '../domain/rarity.js?v=62';
import { emit, EVENTS } from '../shared/eventBus.js?v=62';
import { getMaxHp, getMaxMana } from './stats.js?v=62';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=62';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=62';
import { saveGame } from './saveGameUseCase.js?v=62';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=62';
...
export { addItemToInventory } from './inventoryCore.js?v=62';
