...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=290';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=293';
import { RARITY_TIERS } from '../domain/rarity.js?v=279';
import { emit, EVENTS } from '../shared/eventBus.js?v=280';
import { getMagic } from './stats.js?v=279';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=312';
import { getCurrentMonster } from './huntUseCases.js?v=346';
import { areaName } from '../domain/attackAreas.js?v=278';
import { saveGame } from './saveGameUseCase.js?v=282';
import { itemLogIcon } from './logIcons.js?v=281';
import { t } from '../i18n/i18n.js?v=298';

export { addItemToInventory } from './inventoryCore.js?v=280';
