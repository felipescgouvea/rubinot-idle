...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=321';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=324';
import { RARITY_TIERS } from '../domain/rarity.js?v=310';
import { emit, EVENTS } from '../shared/eventBus.js?v=311';
import { getMagic } from './stats.js?v=310';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=343';
import { getCurrentMonster } from './huntUseCases.js?v=377';
import { areaName } from '../domain/attackAreas.js?v=309';
import { saveGame } from './saveGameUseCase.js?v=313';
import { itemLogIcon } from './logIcons.js?v=312';
import { t } from '../i18n/i18n.js?v=329';

export { addItemToInventory } from './inventoryCore.js?v=311';
