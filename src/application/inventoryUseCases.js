...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=149';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=155';
import { RARITY_TIERS } from '../domain/rarity.js?v=141';
import { emit, EVENTS } from '../shared/eventBus.js?v=142';
import { getMagic } from './stats.js?v=141';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=174';
import { getCurrentMonster } from './huntUseCases.js?v=208';
import { areaName } from '../domain/attackAreas.js?v=140';
import { saveGame } from './saveGameUseCase.js?v=144';
import { itemLogIcon } from './logIcons.js?v=143';
import { t } from '../i18n/i18n.js?v=158';

export { addItemToInventory } from './inventoryCore.js?v=142';
