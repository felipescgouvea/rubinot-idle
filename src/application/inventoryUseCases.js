...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=312';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=315';
import { RARITY_TIERS } from '../domain/rarity.js?v=301';
import { emit, EVENTS } from '../shared/eventBus.js?v=302';
import { getMagic } from './stats.js?v=301';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=334';
import { getCurrentMonster } from './huntUseCases.js?v=368';
import { areaName } from '../domain/attackAreas.js?v=300';
import { saveGame } from './saveGameUseCase.js?v=304';
import { itemLogIcon } from './logIcons.js?v=303';
import { t } from '../i18n/i18n.js?v=320';

export { addItemToInventory } from './inventoryCore.js?v=302';
