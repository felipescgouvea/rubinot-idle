...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=107';
import { ZONES } from '../domain/bestiary.js?v=107';
import { RARITY_TIERS } from '../domain/rarity.js?v=107';
import { emit, EVENTS } from '../shared/eventBus.js?v=107';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=107';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=107';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=107';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=107';
import { runeDamage } from '../domain/combatFormulas.js?v=107';
import { elementMod } from '../domain/elements.js?v=107';
import { saveGame } from './saveGameUseCase.js?v=107';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=107';
...
export { addItemToInventory } from './inventoryCore.js?v=107';
