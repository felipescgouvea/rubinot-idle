...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=296';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=299';
import { RARITY_TIERS } from '../domain/rarity.js?v=285';
import { emit, EVENTS } from '../shared/eventBus.js?v=286';
import { getMagic } from './stats.js?v=285';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=318';
import { getCurrentMonster } from './huntUseCases.js?v=352';
import { areaName } from '../domain/attackAreas.js?v=284';
import { saveGame } from './saveGameUseCase.js?v=288';
import { itemLogIcon } from './logIcons.js?v=287';
import { t } from '../i18n/i18n.js?v=304';

export { addItemToInventory } from './inventoryCore.js?v=286';
