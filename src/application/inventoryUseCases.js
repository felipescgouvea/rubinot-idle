...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=268';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=271';
import { RARITY_TIERS } from '../domain/rarity.js?v=257';
import { emit, EVENTS } from '../shared/eventBus.js?v=258';
import { getMagic } from './stats.js?v=257';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=290';
import { getCurrentMonster } from './huntUseCases.js?v=324';
import { areaName } from '../domain/attackAreas.js?v=256';
import { saveGame } from './saveGameUseCase.js?v=260';
import { itemLogIcon } from './logIcons.js?v=259';
import { t } from '../i18n/i18n.js?v=276';

export { addItemToInventory } from './inventoryCore.js?v=258';
