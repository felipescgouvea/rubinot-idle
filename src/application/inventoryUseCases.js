...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=196';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=202';
import { RARITY_TIERS } from '../domain/rarity.js?v=188';
import { emit, EVENTS } from '../shared/eventBus.js?v=189';
import { getMagic } from './stats.js?v=188';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=221';
import { getCurrentMonster } from './huntUseCases.js?v=255';
import { areaName } from '../domain/attackAreas.js?v=187';
import { saveGame } from './saveGameUseCase.js?v=191';
import { itemLogIcon } from './logIcons.js?v=190';
import { t } from '../i18n/i18n.js?v=205';

export { addItemToInventory } from './inventoryCore.js?v=189';
