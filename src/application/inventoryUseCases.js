...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=60';
import { ZONES } from '../domain/bestiary.js?v=60';
import { RARITY_TIERS } from '../domain/rarity.js?v=60';
import { emit, EVENTS } from '../shared/eventBus.js?v=60';
import { getMaxHp, getMaxMana } from './stats.js?v=60';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=60';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=60';
import { saveGame } from './saveGameUseCase.js?v=60';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=60';
...
export { addItemToInventory } from './inventoryCore.js?v=60';
