...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=217';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=223';
import { RARITY_TIERS } from '../domain/rarity.js?v=209';
import { emit, EVENTS } from '../shared/eventBus.js?v=210';
import { getMagic } from './stats.js?v=209';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=242';
import { getCurrentMonster } from './huntUseCases.js?v=276';
import { areaName } from '../domain/attackAreas.js?v=208';
import { saveGame } from './saveGameUseCase.js?v=212';
import { itemLogIcon } from './logIcons.js?v=211';
import { t } from '../i18n/i18n.js?v=226';

export { addItemToInventory } from './inventoryCore.js?v=210';
