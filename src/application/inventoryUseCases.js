...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=295';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=298';
import { RARITY_TIERS } from '../domain/rarity.js?v=284';
import { emit, EVENTS } from '../shared/eventBus.js?v=285';
import { getMagic } from './stats.js?v=284';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=317';
import { getCurrentMonster } from './huntUseCases.js?v=351';
import { areaName } from '../domain/attackAreas.js?v=283';
import { saveGame } from './saveGameUseCase.js?v=287';
import { itemLogIcon } from './logIcons.js?v=286';
import { t } from '../i18n/i18n.js?v=303';

export { addItemToInventory } from './inventoryCore.js?v=285';
