...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=169';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=175';
import { RARITY_TIERS } from '../domain/rarity.js?v=161';
import { emit, EVENTS } from '../shared/eventBus.js?v=162';
import { getMagic } from './stats.js?v=161';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=194';
import { getCurrentMonster } from './huntUseCases.js?v=228';
import { areaName } from '../domain/attackAreas.js?v=160';
import { saveGame } from './saveGameUseCase.js?v=164';
import { itemLogIcon } from './logIcons.js?v=163';
import { t } from '../i18n/i18n.js?v=178';

export { addItemToInventory } from './inventoryCore.js?v=162';
