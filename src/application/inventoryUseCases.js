...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=150';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=156';
import { RARITY_TIERS } from '../domain/rarity.js?v=142';
import { emit, EVENTS } from '../shared/eventBus.js?v=143';
import { getMagic } from './stats.js?v=142';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=175';
import { getCurrentMonster } from './huntUseCases.js?v=209';
import { areaName } from '../domain/attackAreas.js?v=141';
import { saveGame } from './saveGameUseCase.js?v=145';
import { itemLogIcon } from './logIcons.js?v=144';
import { t } from '../i18n/i18n.js?v=159';

export { addItemToInventory } from './inventoryCore.js?v=143';
