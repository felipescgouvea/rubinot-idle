...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=314';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=317';
import { RARITY_TIERS } from '../domain/rarity.js?v=303';
import { emit, EVENTS } from '../shared/eventBus.js?v=304';
import { getMagic } from './stats.js?v=303';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=336';
import { getCurrentMonster } from './huntUseCases.js?v=370';
import { areaName } from '../domain/attackAreas.js?v=302';
import { saveGame } from './saveGameUseCase.js?v=306';
import { itemLogIcon } from './logIcons.js?v=305';
import { t } from '../i18n/i18n.js?v=322';

export { addItemToInventory } from './inventoryCore.js?v=304';
