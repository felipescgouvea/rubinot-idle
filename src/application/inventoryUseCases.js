...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=233';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=239';
import { RARITY_TIERS } from '../domain/rarity.js?v=225';
import { emit, EVENTS } from '../shared/eventBus.js?v=226';
import { getMagic } from './stats.js?v=225';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=258';
import { getCurrentMonster } from './huntUseCases.js?v=292';
import { areaName } from '../domain/attackAreas.js?v=224';
import { saveGame } from './saveGameUseCase.js?v=228';
import { itemLogIcon } from './logIcons.js?v=227';
import { t } from '../i18n/i18n.js?v=242';

export { addItemToInventory } from './inventoryCore.js?v=226';
