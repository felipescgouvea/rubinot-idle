...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=136';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=142';
import { RARITY_TIERS } from '../domain/rarity.js?v=128';
import { emit, EVENTS } from '../shared/eventBus.js?v=129';
import { getMagic } from './stats.js?v=128';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=161';
import { getCurrentMonster } from './huntUseCases.js?v=195';
import { areaName } from '../domain/attackAreas.js?v=127';
import { saveGame } from './saveGameUseCase.js?v=131';
import { itemLogIcon } from './logIcons.js?v=130';
import { t } from '../i18n/i18n.js?v=145';

export { addItemToInventory } from './inventoryCore.js?v=129';
