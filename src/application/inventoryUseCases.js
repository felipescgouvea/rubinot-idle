...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=326';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=329';
import { RARITY_TIERS } from '../domain/rarity.js?v=315';
import { emit, EVENTS } from '../shared/eventBus.js?v=316';
import { getMagic } from './stats.js?v=315';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=348';
import { getCurrentMonster } from './huntUseCases.js?v=382';
import { areaName } from '../domain/attackAreas.js?v=314';
import { saveGame } from './saveGameUseCase.js?v=318';
import { itemLogIcon } from './logIcons.js?v=317';
import { t } from '../i18n/i18n.js?v=334';

export { addItemToInventory } from './inventoryCore.js?v=316';
