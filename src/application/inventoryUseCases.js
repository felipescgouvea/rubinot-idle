...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=307';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=310';
import { RARITY_TIERS } from '../domain/rarity.js?v=296';
import { emit, EVENTS } from '../shared/eventBus.js?v=297';
import { getMagic } from './stats.js?v=296';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=329';
import { getCurrentMonster } from './huntUseCases.js?v=363';
import { areaName } from '../domain/attackAreas.js?v=295';
import { saveGame } from './saveGameUseCase.js?v=299';
import { itemLogIcon } from './logIcons.js?v=298';
import { t } from '../i18n/i18n.js?v=315';

export { addItemToInventory } from './inventoryCore.js?v=297';
