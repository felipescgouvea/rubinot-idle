...
import { ITEMS, resolveEquippedItem } from '../domain/items.js?v=55';
import { ZONES } from '../domain/bestiary.js?v=55';
import { RARITY_TIERS } from '../domain/rarity.js?v=55';
import { emit, EVENTS } from '../shared/eventBus.js?v=55';
import { getMaxHp, getMaxMana } from './stats.js?v=55';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=55';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=55';
import { saveGame } from './saveGameUseCase.js?v=55';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=55';
...
export { addItemToInventory } from './inventoryCore.js?v=55';
