...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=311';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=314';
import { RARITY_TIERS } from '../domain/rarity.js?v=300';
import { emit, EVENTS } from '../shared/eventBus.js?v=301';
import { getMagic } from './stats.js?v=300';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=333';
import { getCurrentMonster } from './huntUseCases.js?v=367';
import { areaName } from '../domain/attackAreas.js?v=299';
import { saveGame } from './saveGameUseCase.js?v=303';
import { itemLogIcon } from './logIcons.js?v=302';
import { t } from '../i18n/i18n.js?v=319';

export { addItemToInventory } from './inventoryCore.js?v=301';
