...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=166';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=172';
import { RARITY_TIERS } from '../domain/rarity.js?v=158';
import { emit, EVENTS } from '../shared/eventBus.js?v=159';
import { getMagic } from './stats.js?v=158';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=191';
import { getCurrentMonster } from './huntUseCases.js?v=225';
import { areaName } from '../domain/attackAreas.js?v=157';
import { saveGame } from './saveGameUseCase.js?v=161';
import { itemLogIcon } from './logIcons.js?v=160';
import { t } from '../i18n/i18n.js?v=175';

export { addItemToInventory } from './inventoryCore.js?v=159';
