...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=214';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=220';
import { RARITY_TIERS } from '../domain/rarity.js?v=206';
import { emit, EVENTS } from '../shared/eventBus.js?v=207';
import { getMagic } from './stats.js?v=206';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=239';
import { getCurrentMonster } from './huntUseCases.js?v=273';
import { areaName } from '../domain/attackAreas.js?v=205';
import { saveGame } from './saveGameUseCase.js?v=209';
import { itemLogIcon } from './logIcons.js?v=208';
import { t } from '../i18n/i18n.js?v=223';

export { addItemToInventory } from './inventoryCore.js?v=207';
