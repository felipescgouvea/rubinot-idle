...
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=88';
import { ZONES } from '../domain/bestiary.js?v=88';
import { RARITY_TIERS } from '../domain/rarity.js?v=88';
import { emit, EVENTS } from '../shared/eventBus.js?v=88';
import { getMaxHp, getMaxMana, getMagic } from './stats.js?v=88';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=88';
import { getCurrentMonster, getCurrentPack, resolveMonsterKill } from './huntUseCases.js?v=88';
import { areaMaxTargets, areaName, isAreaAttack } from '../domain/attackAreas.js?v=88';
import { saveGame } from './saveGameUseCase.js?v=88';
import { itemSpriteFile, spriteUrl } from '../infrastructure/tibiaSprites.js?v=88';
...
export { addItemToInventory } from './inventoryCore.js?v=88';
