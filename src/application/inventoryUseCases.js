...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=191';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=197';
import { RARITY_TIERS } from '../domain/rarity.js?v=183';
import { emit, EVENTS } from '../shared/eventBus.js?v=184';
import { getMagic } from './stats.js?v=183';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=216';
import { getCurrentMonster } from './huntUseCases.js?v=250';
import { areaName } from '../domain/attackAreas.js?v=182';
import { saveGame } from './saveGameUseCase.js?v=186';
import { itemLogIcon } from './logIcons.js?v=185';
import { t } from '../i18n/i18n.js?v=200';

export { addItemToInventory } from './inventoryCore.js?v=184';
