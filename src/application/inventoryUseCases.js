...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer } from '../infrastructure/authClient.js?v=148';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=154';
import { RARITY_TIERS } from '../domain/rarity.js?v=140';
import { emit, EVENTS } from '../shared/eventBus.js?v=141';
import { getMagic } from './stats.js?v=140';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=173';
import { getCurrentMonster } from './huntUseCases.js?v=207';
import { areaName } from '../domain/attackAreas.js?v=139';
import { saveGame } from './saveGameUseCase.js?v=143';
import { itemLogIcon } from './logIcons.js?v=142';
import { t } from '../i18n/i18n.js?v=157';

export { addItemToInventory } from './inventoryCore.js?v=141';
