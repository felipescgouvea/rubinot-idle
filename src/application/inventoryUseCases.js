...
import { syncEquipment, useItemOnServer, sellItemOnServer, sellRelicOnServer, updateHuntRtc } from '../infrastructure/authClient.js?v=331';
import { ITEMS, resolveEquippedItem, potionUseBlockReason, equipBlockReason } from '../domain/items.js?v=334';
import { RARITY_TIERS } from '../domain/rarity.js?v=320';
import { emit, EVENTS } from '../shared/eventBus.js?v=321';
import { getMagic } from './stats.js?v=320';
import { canUseAttackRune, runeMinMl } from '../domain/rtcConfig.js?v=353';
import { getCurrentMonster } from './huntUseCases.js?v=387';
import { areaName } from '../domain/attackAreas.js?v=319';
import { saveGame } from './saveGameUseCase.js?v=323';
import { itemLogIcon } from './logIcons.js?v=322';
import { t } from '../i18n/i18n.js?v=339';

export { addItemToInventory } from './inventoryCore.js?v=321';
