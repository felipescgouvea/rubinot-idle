...
import { getMagic, getMaxHp } from './stats.js?v=341';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=373';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=341';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=343';
import { grantReward } from './rewardGrants.js?v=181';
import { grantCharmBonus } from './bestiaryUseCases.js?v=342';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=352';
import { bumpMissionProgress } from './battlePassUseCases.js?v=341';
