...
import { getMagic, getMaxHp } from './stats.js?v=333';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=365';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=333';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=335';
import { grantReward } from './rewardGrants.js?v=173';
import { grantCharmBonus } from './bestiaryUseCases.js?v=334';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=344';
import { bumpMissionProgress } from './battlePassUseCases.js?v=333';
