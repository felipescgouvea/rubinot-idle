...
import { getMagic, getMaxHp } from './stats.js?v=315';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=347';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=315';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=317';
import { grantReward } from './rewardGrants.js?v=155';
import { grantCharmBonus } from './bestiaryUseCases.js?v=316';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=326';
import { bumpMissionProgress } from './battlePassUseCases.js?v=315';
