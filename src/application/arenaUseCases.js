...
import { getMagic, getMaxHp } from './stats.js?v=354';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=386';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=354';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=356';
import { grantReward } from './rewardGrants.js?v=194';
import { grantCharmBonus } from './bestiaryUseCases.js?v=355';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=365';
import { bumpMissionProgress } from './battlePassUseCases.js?v=354';
