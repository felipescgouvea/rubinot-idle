...
import { getMagic, getMaxHp } from './stats.js?v=196';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=228';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=196';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=198';
import { grantReward } from './rewardGrants.js?v=36';
import { bumpMissionProgress } from './battlePassUseCases.js?v=196';
