...
import { G } from './gameStore.js?v=217';
import { emit, EVENTS } from '../shared/eventBus.js?v=215';
import { getMagic, getMaxHp } from './stats.js?v=214';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=246';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=214';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=216';
import { grantReward } from './rewardGrants.js?v=54';
import { bumpMissionProgress } from './battlePassUseCases.js?v=214';
