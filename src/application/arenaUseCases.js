...
import { getMagic, getMaxHp } from './stats.js?v=197';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=229';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=197';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=199';
import { grantReward } from './rewardGrants.js?v=37';
import { bumpMissionProgress } from './battlePassUseCases.js?v=197';
