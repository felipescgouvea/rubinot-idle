...
import { getMagic, getMaxHp } from './stats.js?v=355';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=387';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=355';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=357';
import { grantReward } from './rewardGrants.js?v=195';
import { grantCharmBonus } from './bestiaryUseCases.js?v=356';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=366';
import { bumpMissionProgress } from './battlePassUseCases.js?v=355';
