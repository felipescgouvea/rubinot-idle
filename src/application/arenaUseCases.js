...
import { G } from './gameStore.js?v=238';
import { emit, EVENTS } from '../shared/eventBus.js?v=236';
import { getMagic, getMaxHp } from './stats.js?v=235';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=267';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=235';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=237';
import { grantReward } from './rewardGrants.js?v=75';
import { bumpMissionProgress } from './battlePassUseCases.js?v=235';
