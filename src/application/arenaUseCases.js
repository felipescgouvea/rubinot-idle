...
import { G } from './gameStore.js?v=266';
import { emit, EVENTS } from '../shared/eventBus.js?v=264';
import { getMagic, getMaxHp } from './stats.js?v=263';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=295';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=263';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=265';
import { grantReward } from './rewardGrants.js?v=103';
import { bumpMissionProgress } from './battlePassUseCases.js?v=263';
