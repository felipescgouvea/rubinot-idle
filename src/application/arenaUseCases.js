...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=33';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=33';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=33';
import { bumpMissionProgress } from './battlePassUseCases.js?v=33';
import { addItemToInventory } from './inventoryCore.js?v=33';
import { ITEMS } from '../domain/items.js?v=33';
