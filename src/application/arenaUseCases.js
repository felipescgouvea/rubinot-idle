...
import { G } from './gameStore.js?v=227';
import { emit, EVENTS } from '../shared/eventBus.js?v=225';
import { getMagic, getMaxHp } from './stats.js?v=224';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=256';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=224';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=226';
import { grantReward } from './rewardGrants.js?v=64';
import { bumpMissionProgress } from './battlePassUseCases.js?v=224';
