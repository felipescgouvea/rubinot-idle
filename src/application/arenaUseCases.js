...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=57';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=57';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=57';
import { bumpMissionProgress } from './battlePassUseCases.js?v=57';
import { addItemToInventory } from './inventoryCore.js?v=57';
import { ITEMS } from '../domain/items.js?v=57';
