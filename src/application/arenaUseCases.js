...
import { G } from './gameStore.js?v=239';
import { emit, EVENTS } from '../shared/eventBus.js?v=237';
import { getMagic, getMaxHp } from './stats.js?v=236';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=268';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=236';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=238';
import { grantReward } from './rewardGrants.js?v=76';
import { bumpMissionProgress } from './battlePassUseCases.js?v=236';
