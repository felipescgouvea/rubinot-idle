...
import { getMagic, getMaxHp } from './stats.js?v=221';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=253';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=221';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=223';
import { grantReward } from './rewardGrants.js?v=61';
