...
import { getMagic, getMaxHp } from './stats.js?v=336';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=368';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=336';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=338';
import { grantReward } from './rewardGrants.js?v=176';
import { grantCharmBonus } from './bestiaryUseCases.js?v=337';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=347';
import { bumpMissionProgress } from './battlePassUseCases.js?v=336';
