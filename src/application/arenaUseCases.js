...
import { getMagic, getMaxHp } from './stats.js?v=148';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=180';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=148';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=150';
import { bumpMissionProgress } from './battlePassUseCases.js?v=148';
