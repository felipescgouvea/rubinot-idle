...
import { G } from './gameStore.js?v=156';
import { emit, EVENTS } from '../shared/eventBus.js?v=154';
import { getMagic, getMaxHp } from './stats.js?v=153';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=185';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=153';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=155';
import { bumpMissionProgress } from './battlePassUseCases.js?v=153';
