...
import { getMagic, getMaxHp } from './stats.js?v=144';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=176';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=144';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=146';
import { bumpMissionProgress } from './battlePassUseCases.js?v=144';
