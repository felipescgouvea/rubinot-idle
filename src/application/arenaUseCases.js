...
import { G } from './gameStore.js?v=287';
import { emit, EVENTS } from '../shared/eventBus.js?v=285';
import { getMagic, getMaxHp } from './stats.js?v=284';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=316';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=284';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=286';
import { grantReward } from './rewardGrants.js?v=124';
import { bumpMissionProgress } from './battlePassUseCases.js?v=284';
