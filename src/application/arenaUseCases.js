...
import { getMagic, getMaxHp } from './stats.js?v=304';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=336';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=304';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=306';
import { grantReward } from './rewardGrants.js?v=144';
import { grantCharmBonus } from './bestiaryUseCases.js?v=305';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=315';
import { bumpMissionProgress } from './battlePassUseCases.js?v=304';
