...
import { getMagic, getMaxHp } from './stats.js?v=252';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=284';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=252';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=254';
import { grantReward } from './rewardGrants.js?v=92';
import { bumpMissionProgress } from './battlePassUseCases.js?v=252';
