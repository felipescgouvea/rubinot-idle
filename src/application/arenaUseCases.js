...
import { getMagic, getMaxHp } from './stats.js?v=326';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=358';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=326';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=328';
import { grantReward } from './rewardGrants.js?v=166';
import { grantCharmBonus } from './bestiaryUseCases.js?v=327';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=337';
import { bumpMissionProgress } from './battlePassUseCases.js?v=326';
