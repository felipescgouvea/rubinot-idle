...
import { G } from './gameStore.js?v=208';
import { emit, EVENTS } from '../shared/eventBus.js?v=206';
import { getMagic, getMaxHp } from './stats.js?v=205';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=237';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=205';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=207';
import { grantReward } from './rewardGrants.js?v=45';
import { bumpMissionProgress } from './battlePassUseCases.js?v=205';
