...
import { G } from './gameStore.js?v=211';
import { emit, EVENTS } from '../shared/eventBus.js?v=209';
import { getMagic, getMaxHp } from './stats.js?v=208';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=240';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=208';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=210';
import { grantReward } from './rewardGrants.js?v=48';
import { bumpMissionProgress } from './battlePassUseCases.js?v=208';
