...
import { G } from './gameStore.js?v=183';
import { emit, EVENTS } from '../shared/eventBus.js?v=181';
import { getMagic, getMaxHp } from './stats.js?v=180';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=212';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=180';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=182';
import { grantReward } from './rewardGrants.js?v=20';
import { bumpMissionProgress } from './battlePassUseCases.js?v=180';
