...
import { G } from './gameStore.js?v=249';
import { emit, EVENTS } from '../shared/eventBus.js?v=247';
import { getMagic, getMaxHp } from './stats.js?v=246';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=278';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=246';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=248';
import { grantReward } from './rewardGrants.js?v=86';
import { bumpMissionProgress } from './battlePassUseCases.js?v=246';
