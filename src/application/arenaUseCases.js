...
import { G } from './gameStore.js?v=295';
import { emit, EVENTS } from '../shared/eventBus.js?v=293';
import { getMagic, getMaxHp } from './stats.js?v=292';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=324';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=292';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=294';
import { grantReward } from './rewardGrants.js?v=132';
import { bumpMissionProgress } from './battlePassUseCases.js?v=292';
