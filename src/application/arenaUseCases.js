...
import { G } from './gameStore.js?v=193';
import { emit, EVENTS } from '../shared/eventBus.js?v=191';
import { getMagic, getMaxHp } from './stats.js?v=190';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=222';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=190';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=192';
import { grantReward } from './rewardGrants.js?v=30';
import { bumpMissionProgress } from './battlePassUseCases.js?v=190';
