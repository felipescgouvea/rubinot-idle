...
import { getMagic, getMaxHp } from './stats.js?v=328';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=360';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=328';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=330';
import { grantReward } from './rewardGrants.js?v=168';
import { grantCharmBonus } from './bestiaryUseCases.js?v=329';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=339';
import { bumpMissionProgress } from './battlePassUseCases.js?v=328';
