...
import { G } from './gameStore.js?v=197';
import { emit, EVENTS } from '../shared/eventBus.js?v=195';
import { getMagic, getMaxHp } from './stats.js?v=194';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=226';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=194';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=196';
import { grantReward } from './rewardGrants.js?v=34';
import { bumpMissionProgress } from './battlePassUseCases.js?v=194';
