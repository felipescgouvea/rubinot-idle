...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=49';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=49';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=49';
import { bumpMissionProgress } from './battlePassUseCases.js?v=49';
import { addItemToInventory } from './inventoryCore.js?v=49';
import { ITEMS } from '../domain/items.js?v=49';
import { saveGame } from './saveGameUseCase.js?v=49';
