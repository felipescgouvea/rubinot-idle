...
import { G } from './gameStore.js?v=181';
import { emit, EVENTS } from '../shared/eventBus.js?v=179';
import { getMagic, getMaxHp } from './stats.js?v=178';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=210';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=178';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=180';
import { grantReward } from './rewardGrants.js?v=18';
import { bumpMissionProgress } from './battlePassUseCases.js?v=178';
