...
import { getMagic, getMaxHp } from './stats.js?v=299';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=331';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=299';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=301';
import { grantReward } from './rewardGrants.js?v=139';
import { grantCharmBonus } from './bestiaryUseCases.js?v=300';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=310';
import { bumpMissionProgress } from './battlePassUseCases.js?v=299';
