...
import { G } from './gameStore.js?v=247';
import { emit, EVENTS } from '../shared/eventBus.js?v=245';
import { getMagic, getMaxHp } from './stats.js?v=244';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=276';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=244';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=246';
import { grantReward } from './rewardGrants.js?v=84';
import { bumpMissionProgress } from './battlePassUseCases.js?v=244';
