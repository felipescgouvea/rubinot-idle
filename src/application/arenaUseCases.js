...
import { getMagic, getMaxHp } from './stats.js?v=301';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=333';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=301';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=303';
import { grantReward } from './rewardGrants.js?v=141';
import { grantCharmBonus } from './bestiaryUseCases.js?v=302';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=312';
import { bumpMissionProgress } from './battlePassUseCases.js?v=301';
