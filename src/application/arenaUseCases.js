...
import { getMagic, getMaxHp } from './stats.js?v=300';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=332';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=300';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=302';
import { grantReward } from './rewardGrants.js?v=140';
import { grantCharmBonus } from './bestiaryUseCases.js?v=301';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=311';
import { bumpMissionProgress } from './battlePassUseCases.js?v=300';
