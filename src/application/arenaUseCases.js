...
import { getMagic, getMaxHp } from './stats.js?v=348';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=380';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=348';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=350';
import { grantReward } from './rewardGrants.js?v=188';
import { grantCharmBonus } from './bestiaryUseCases.js?v=349';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=359';
import { bumpMissionProgress } from './battlePassUseCases.js?v=348';
