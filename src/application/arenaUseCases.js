...
import { G } from './gameStore.js?v=179';
import { emit, EVENTS } from '../shared/eventBus.js?v=177';
import { getMagic, getMaxHp } from './stats.js?v=176';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=208';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=176';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=178';
import { grantReward } from './rewardGrants.js?v=16';
import { bumpMissionProgress } from './battlePassUseCases.js?v=176';
