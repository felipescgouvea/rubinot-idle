...
import { getMagic, getMaxHp } from './stats.js?v=311';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=343';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=311';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=313';
import { grantReward } from './rewardGrants.js?v=151';
import { grantCharmBonus } from './bestiaryUseCases.js?v=312';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=322';
import { bumpMissionProgress } from './battlePassUseCases.js?v=311';
