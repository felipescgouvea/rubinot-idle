...
import { getMagic, getMaxHp } from './stats.js?v=228';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=260';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=228';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=230';
import { grantReward } from './rewardGrants.js?v=68';
import { bumpMissionProgress } from './battlePassUseCases.js?v=228';
