...
import { getMagic, getMaxHp } from './stats.js?v=309';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=341';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=309';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=311';
import { grantReward } from './rewardGrants.js?v=149';
import { grantCharmBonus } from './bestiaryUseCases.js?v=310';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=320';
import { bumpMissionProgress } from './battlePassUseCases.js?v=309';
