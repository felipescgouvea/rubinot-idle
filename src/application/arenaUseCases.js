...
import { getMagic, getMaxHp } from './stats.js?v=302';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=334';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=302';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=304';
import { grantReward } from './rewardGrants.js?v=142';
import { grantCharmBonus } from './bestiaryUseCases.js?v=303';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=313';
import { bumpMissionProgress } from './battlePassUseCases.js?v=302';
