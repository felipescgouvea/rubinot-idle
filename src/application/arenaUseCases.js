...
import { getMagic, getMaxHp } from './stats.js?v=339';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=371';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=339';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=341';
import { grantReward } from './rewardGrants.js?v=179';
import { grantCharmBonus } from './bestiaryUseCases.js?v=340';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=350';
