...
import { G } from './gameStore.js?v=277';
import { emit, EVENTS } from '../shared/eventBus.js?v=275';
import { getMagic, getMaxHp } from './stats.js?v=274';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=306';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=274';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=276';
import { grantReward } from './rewardGrants.js?v=114';
import { bumpMissionProgress } from './battlePassUseCases.js?v=274';
