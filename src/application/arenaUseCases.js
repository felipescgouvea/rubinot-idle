...
import { G } from './gameStore.js?v=214';
import { emit, EVENTS } from '../shared/eventBus.js?v=212';
import { getMagic, getMaxHp } from './stats.js?v=211';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=243';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=211';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=213';
import { grantReward } from './rewardGrants.js?v=51';
import { bumpMissionProgress } from './battlePassUseCases.js?v=211';
