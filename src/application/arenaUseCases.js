...
import { G } from './gameStore.js?v=185';
import { emit, EVENTS } from '../shared/eventBus.js?v=183';
import { getMagic, getMaxHp } from './stats.js?v=182';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=214';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=182';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=184';
import { grantReward } from './rewardGrants.js?v=22';
import { bumpMissionProgress } from './battlePassUseCases.js?v=182';
