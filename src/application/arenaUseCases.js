...
import { getMagic, getMaxHp } from './stats.js?v=202';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=234';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=202';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=204';
import { grantReward } from './rewardGrants.js?v=42';
import { bumpMissionProgress } from './battlePassUseCases.js?v=202';
