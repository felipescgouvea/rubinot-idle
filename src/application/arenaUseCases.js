...
import { G } from './gameStore.js?v=163';
import { emit, EVENTS } from '../shared/eventBus.js?v=161';
import { getMagic, getMaxHp } from './stats.js?v=160';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=192';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=160';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=162';
import { bumpMissionProgress } from './battlePassUseCases.js?v=160';
