...
import { getMagic, getMaxHp } from './stats.js?v=216';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=248';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=216';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=218';
import { grantReward } from './rewardGrants.js?v=56';
import { bumpMissionProgress } from './battlePassUseCases.js?v=216';
