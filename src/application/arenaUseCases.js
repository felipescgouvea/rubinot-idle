...
import { getMagic, getMaxHp } from './stats.js?v=324';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=356';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=324';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=326';
import { grantReward } from './rewardGrants.js?v=164';
import { grantCharmBonus } from './bestiaryUseCases.js?v=325';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=335';
import { bumpMissionProgress } from './battlePassUseCases.js?v=324';
