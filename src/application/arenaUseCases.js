...
import { getMagic, getMaxHp } from './stats.js?v=327';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=359';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=327';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=329';
import { grantReward } from './rewardGrants.js?v=167';
import { grantCharmBonus } from './bestiaryUseCases.js?v=328';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=338';
import { bumpMissionProgress } from './battlePassUseCases.js?v=327';
