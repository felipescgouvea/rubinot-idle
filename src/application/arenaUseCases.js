...
import { getMagic, getMaxHp } from './stats.js?v=332';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=364';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=332';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=334';
import { grantReward } from './rewardGrants.js?v=172';
import { grantCharmBonus } from './bestiaryUseCases.js?v=333';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=343';
import { bumpMissionProgress } from './battlePassUseCases.js?v=332';
