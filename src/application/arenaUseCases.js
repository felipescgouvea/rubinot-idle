...
import { getMagic, getMaxHp } from './stats.js?v=303';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=335';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=303';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=305';
import { grantReward } from './rewardGrants.js?v=143';
import { grantCharmBonus } from './bestiaryUseCases.js?v=304';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=314';
import { bumpMissionProgress } from './battlePassUseCases.js?v=303';
