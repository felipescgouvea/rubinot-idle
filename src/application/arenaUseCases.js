...
import { G } from './gameStore.js?v=265';
import { emit, EVENTS } from '../shared/eventBus.js?v=263';
import { getMagic, getMaxHp } from './stats.js?v=262';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=294';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=262';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=264';
import { grantReward } from './rewardGrants.js?v=102';
import { bumpMissionProgress } from './battlePassUseCases.js?v=262';
