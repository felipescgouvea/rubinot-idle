...
import { getMagic, getMaxHp } from './stats.js?v=316';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=348';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=316';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=318';
import { grantReward } from './rewardGrants.js?v=156';
import { grantCharmBonus } from './bestiaryUseCases.js?v=317';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=327';
import { bumpMissionProgress } from './battlePassUseCases.js?v=316';
