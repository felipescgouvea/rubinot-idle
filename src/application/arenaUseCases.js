...
import { getMagic, getMaxHp } from './stats.js?v=360';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=392';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=360';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=362';
import { grantReward } from './rewardGrants.js?v=200';
import { grantCharmBonus } from './bestiaryUseCases.js?v=361';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=371';
import { bumpMissionProgress } from './battlePassUseCases.js?v=360';
