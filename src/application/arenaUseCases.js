...
import { getMagic, getMaxHp } from './stats.js?v=310';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=342';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=310';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=312';
import { grantReward } from './rewardGrants.js?v=150';
import { grantCharmBonus } from './bestiaryUseCases.js?v=311';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=321';
import { bumpMissionProgress } from './battlePassUseCases.js?v=310';
