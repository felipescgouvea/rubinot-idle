...
import { getMagic, getMaxHp } from './stats.js?v=347';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=379';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=347';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=349';
import { grantReward } from './rewardGrants.js?v=187';
import { grantCharmBonus } from './bestiaryUseCases.js?v=348';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=358';
import { bumpMissionProgress } from './battlePassUseCases.js?v=347';
