...
import { getMagic, getMaxHp } from './stats.js?v=159';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=191';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=159';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=161';
import { bumpMissionProgress } from './battlePassUseCases.js?v=159';
