...
import { G } from './gameStore.js?v=170';
import { emit, EVENTS } from '../shared/eventBus.js?v=168';
import { getMagic, getMaxHp } from './stats.js?v=167';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=199';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=167';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=169';
import { grantReward } from './rewardGrants.js?v=7';
import { bumpMissionProgress } from './battlePassUseCases.js?v=167';
