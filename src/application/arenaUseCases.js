...
import { getMagic, getMaxHp } from './stats.js?v=359';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=391';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=359';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=361';
import { grantReward } from './rewardGrants.js?v=199';
import { grantCharmBonus } from './bestiaryUseCases.js?v=360';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=370';
import { bumpMissionProgress } from './battlePassUseCases.js?v=359';
