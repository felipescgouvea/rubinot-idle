...
import { getMagic, getMaxHp } from './stats.js?v=175';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=207';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=175';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=177';
import { grantReward } from './rewardGrants.js?v=15';
import { bumpMissionProgress } from './battlePassUseCases.js?v=175';
