...
import { getMagic, getMaxHp } from './stats.js?v=338';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=370';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=338';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=340';
import { grantReward } from './rewardGrants.js?v=178';
import { grantCharmBonus } from './bestiaryUseCases.js?v=339';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=349';
