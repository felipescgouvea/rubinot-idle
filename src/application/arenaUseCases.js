...
import { G } from './gameStore.js?v=267';
import { emit, EVENTS } from '../shared/eventBus.js?v=265';
import { getMagic, getMaxHp } from './stats.js?v=264';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=296';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=264';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=266';
import { grantReward } from './rewardGrants.js?v=104';
import { bumpMissionProgress } from './battlePassUseCases.js?v=264';
