...
import { G } from './gameStore.js?v=194';
import { emit, EVENTS } from '../shared/eventBus.js?v=192';
import { getMagic, getMaxHp } from './stats.js?v=191';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=223';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=191';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=193';
import { grantReward } from './rewardGrants.js?v=31';
import { bumpMissionProgress } from './battlePassUseCases.js?v=191';
