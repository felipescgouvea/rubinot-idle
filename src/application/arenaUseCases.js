...
import { G } from './gameStore.js?v=184';
import { emit, EVENTS } from '../shared/eventBus.js?v=182';
import { getMagic, getMaxHp } from './stats.js?v=181';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=213';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=181';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=183';
import { grantReward } from './rewardGrants.js?v=21';
import { bumpMissionProgress } from './battlePassUseCases.js?v=181';
