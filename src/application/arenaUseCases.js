...
import { G } from './gameStore.js?v=286';
import { emit, EVENTS } from '../shared/eventBus.js?v=284';
import { getMagic, getMaxHp } from './stats.js?v=283';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=315';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=283';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=285';
import { grantReward } from './rewardGrants.js?v=123';
import { bumpMissionProgress } from './battlePassUseCases.js?v=283';
