...
import { getMagic, getMaxHp } from './stats.js?v=323';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=355';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=323';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=325';
import { grantReward } from './rewardGrants.js?v=163';
import { grantCharmBonus } from './bestiaryUseCases.js?v=324';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=334';
import { bumpMissionProgress } from './battlePassUseCases.js?v=323';
