...
import { getMagic, getMaxHp } from './stats.js?v=343';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=375';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=343';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=345';
import { grantReward } from './rewardGrants.js?v=183';
import { grantCharmBonus } from './bestiaryUseCases.js?v=344';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=354';
import { bumpMissionProgress } from './battlePassUseCases.js?v=343';
