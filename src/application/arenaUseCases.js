...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=55';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=55';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=55';
import { bumpMissionProgress } from './battlePassUseCases.js?v=55';
