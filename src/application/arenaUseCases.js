...
import { G } from './gameStore.js?v=220';
import { emit, EVENTS } from '../shared/eventBus.js?v=218';
import { getMagic, getMaxHp } from './stats.js?v=217';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=249';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=217';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=219';
import { grantReward } from './rewardGrants.js?v=57';
import { bumpMissionProgress } from './battlePassUseCases.js?v=217';
