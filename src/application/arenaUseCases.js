...
import { G } from './gameStore.js?v=252';
import { emit, EVENTS } from '../shared/eventBus.js?v=250';
import { getMagic, getMaxHp } from './stats.js?v=249';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=281';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=249';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=251';
import { grantReward } from './rewardGrants.js?v=89';
import { bumpMissionProgress } from './battlePassUseCases.js?v=249';
