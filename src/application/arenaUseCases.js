...
import { G } from './gameStore.js?v=161';
import { emit, EVENTS } from '../shared/eventBus.js?v=159';
import { getMagic, getMaxHp } from './stats.js?v=158';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=190';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=158';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=160';
import { bumpMissionProgress } from './battlePassUseCases.js?v=158';
