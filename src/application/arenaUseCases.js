...
import { getMagic, getMaxHp } from './stats.js?v=255';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=287';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=255';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=257';
import { grantReward } from './rewardGrants.js?v=95';
import { bumpMissionProgress } from './battlePassUseCases.js?v=255';
