...
import { getMagic, getMaxHp } from './stats.js?v=340';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=372';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=340';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=342';
import { grantReward } from './rewardGrants.js?v=180';
import { grantCharmBonus } from './bestiaryUseCases.js?v=341';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=351';
import { bumpMissionProgress } from './battlePassUseCases.js?v=340';
