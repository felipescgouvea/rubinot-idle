...
import { G } from './gameStore.js?v=204';
import { emit, EVENTS } from '../shared/eventBus.js?v=202';
import { getMagic, getMaxHp } from './stats.js?v=201';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=233';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=201';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=203';
import { grantReward } from './rewardGrants.js?v=41';
import { bumpMissionProgress } from './battlePassUseCases.js?v=201';
