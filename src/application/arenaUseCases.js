...
import { getMagic, getMaxHp } from './stats.js?v=254';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=286';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=254';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=256';
import { grantReward } from './rewardGrants.js?v=94';
import { bumpMissionProgress } from './battlePassUseCases.js?v=254';
