...
import { G } from './gameStore.js?v=148';
import { emit, EVENTS } from '../shared/eventBus.js?v=146';
import { getMagic, getMaxHp } from './stats.js?v=145';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=177';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=145';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=147';
import { bumpMissionProgress } from './battlePassUseCases.js?v=145';
