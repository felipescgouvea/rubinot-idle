...
import { getMagic, getMaxHp } from './stats.js?v=248';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=280';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=248';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=250';
import { grantReward } from './rewardGrants.js?v=88';
