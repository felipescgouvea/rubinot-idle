...
import { G } from './gameStore.js?v=264';
import { emit, EVENTS } from '../shared/eventBus.js?v=262';
import { getMagic, getMaxHp } from './stats.js?v=261';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=293';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=261';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=263';
import { grantReward } from './rewardGrants.js?v=101';
