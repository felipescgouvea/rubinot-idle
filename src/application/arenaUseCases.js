...
import { G } from './gameStore.js?v=133';
import { emit, EVENTS } from '../shared/eventBus.js?v=131';
import { getMagic, getMaxHp } from './stats.js?v=130';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=162';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=130';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=132';
import { bumpMissionProgress } from './battlePassUseCases.js?v=130';
