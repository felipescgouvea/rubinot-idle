...
import { G } from './gameStore.js?v=280';
import { emit, EVENTS } from '../shared/eventBus.js?v=278';
import { getMagic, getMaxHp } from './stats.js?v=277';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=309';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=277';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=279';
import { grantReward } from './rewardGrants.js?v=117';
import { bumpMissionProgress } from './battlePassUseCases.js?v=277';
