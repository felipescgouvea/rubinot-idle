...
import { G } from './gameStore.js?v=206';
import { emit, EVENTS } from '../shared/eventBus.js?v=204';
import { getMagic, getMaxHp } from './stats.js?v=203';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=235';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=203';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=205';
import { grantReward } from './rewardGrants.js?v=43';
import { bumpMissionProgress } from './battlePassUseCases.js?v=203';
