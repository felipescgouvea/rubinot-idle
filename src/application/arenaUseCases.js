...
import { G } from './gameStore.js?v=154';
import { emit, EVENTS } from '../shared/eventBus.js?v=152';
import { getMagic, getMaxHp } from './stats.js?v=151';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=183';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=151';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=153';
import { bumpMissionProgress } from './battlePassUseCases.js?v=151';
