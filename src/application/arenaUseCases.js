...
import { getMagic, getMaxHp } from './stats.js?v=195';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=227';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=195';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=197';
import { grantReward } from './rewardGrants.js?v=35';
import { bumpMissionProgress } from './battlePassUseCases.js?v=195';
