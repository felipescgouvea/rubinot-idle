...
import { G } from './gameStore.js?v=261';
import { emit, EVENTS } from '../shared/eventBus.js?v=259';
import { getMagic, getMaxHp } from './stats.js?v=258';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=290';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=258';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=260';
import { grantReward } from './rewardGrants.js?v=98';
import { bumpMissionProgress } from './battlePassUseCases.js?v=258';
