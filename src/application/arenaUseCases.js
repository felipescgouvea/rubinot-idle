...
import { G } from './gameStore.js?v=190';
import { emit, EVENTS } from '../shared/eventBus.js?v=188';
import { getMagic, getMaxHp } from './stats.js?v=187';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=219';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=187';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=189';
import { grantReward } from './rewardGrants.js?v=27';
import { bumpMissionProgress } from './battlePassUseCases.js?v=187';
