...
import { G } from './gameStore.js?v=226';
import { emit, EVENTS } from '../shared/eventBus.js?v=224';
import { getMagic, getMaxHp } from './stats.js?v=223';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=255';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=223';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=225';
import { grantReward } from './rewardGrants.js?v=63';
import { bumpMissionProgress } from './battlePassUseCases.js?v=223';
