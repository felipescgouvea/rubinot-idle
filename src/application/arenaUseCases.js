...
import { getMagic, getMaxHp } from './stats.js?v=306';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=338';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=306';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=308';
import { grantReward } from './rewardGrants.js?v=146';
import { grantCharmBonus } from './bestiaryUseCases.js?v=307';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=317';
import { bumpMissionProgress } from './battlePassUseCases.js?v=306';
