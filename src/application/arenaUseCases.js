...
import { G } from './gameStore.js?v=196';
import { emit, EVENTS } from '../shared/eventBus.js?v=194';
import { getMagic, getMaxHp } from './stats.js?v=193';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=225';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=193';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=195';
import { grantReward } from './rewardGrants.js?v=33';
import { bumpMissionProgress } from './battlePassUseCases.js?v=193';
