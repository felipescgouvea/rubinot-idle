...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=106';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=106';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=106';
import { bumpMissionProgress } from './battlePassUseCases.js?v=106';
