...
import { getMagic, getMaxHp } from './stats.js?v=314';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=346';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=314';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=316';
import { grantReward } from './rewardGrants.js?v=154';
import { grantCharmBonus } from './bestiaryUseCases.js?v=315';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=325';
import { bumpMissionProgress } from './battlePassUseCases.js?v=314';
