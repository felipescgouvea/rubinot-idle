...
import { G } from './gameStore.js?v=209';
import { emit, EVENTS } from '../shared/eventBus.js?v=207';
import { getMagic, getMaxHp } from './stats.js?v=206';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=238';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=206';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=208';
import { grantReward } from './rewardGrants.js?v=46';
import { bumpMissionProgress } from './battlePassUseCases.js?v=206';
