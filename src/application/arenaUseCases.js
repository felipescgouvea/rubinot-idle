...
import { getMagic, getMaxHp } from './stats.js?v=331';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=363';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=331';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=333';
import { grantReward } from './rewardGrants.js?v=171';
import { grantCharmBonus } from './bestiaryUseCases.js?v=332';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=342';
import { bumpMissionProgress } from './battlePassUseCases.js?v=331';
