...
import { G } from './gameStore.js?v=221';
import { emit, EVENTS } from '../shared/eventBus.js?v=219';
import { getMagic, getMaxHp } from './stats.js?v=218';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=250';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=218';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=220';
import { grantReward } from './rewardGrants.js?v=58';
import { bumpMissionProgress } from './battlePassUseCases.js?v=218';
