...
import { getMagic, getMaxHp } from './stats.js?v=293';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=325';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=293';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=295';
import { grantReward } from './rewardGrants.js?v=133';
import { bumpMissionProgress } from './battlePassUseCases.js?v=293';
