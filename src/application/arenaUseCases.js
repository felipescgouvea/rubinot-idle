...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=40';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=40';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=40';
import { bumpMissionProgress } from './battlePassUseCases.js?v=40';
import { addItemToInventory } from './inventoryCore.js?v=40';
import { ITEMS } from '../domain/items.js?v=40';
import { saveGame } from './saveGameUseCase.js?v=40';
