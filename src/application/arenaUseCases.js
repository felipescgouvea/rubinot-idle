...
import { getMagic, getMaxHp } from './stats.js?v=335';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=367';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=335';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=337';
import { grantReward } from './rewardGrants.js?v=175';
import { grantCharmBonus } from './bestiaryUseCases.js?v=336';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=346';
import { bumpMissionProgress } from './battlePassUseCases.js?v=335';
