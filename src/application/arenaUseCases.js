...
import { getMagic, getMaxHp } from './stats.js?v=207';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=239';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=207';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=209';
import { grantReward } from './rewardGrants.js?v=47';
import { bumpMissionProgress } from './battlePassUseCases.js?v=207';
