...
import { getMagic, getMaxHp } from './stats.js?v=325';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=357';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=325';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=327';
import { grantReward } from './rewardGrants.js?v=165';
import { grantCharmBonus } from './bestiaryUseCases.js?v=326';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=336';
import { bumpMissionProgress } from './battlePassUseCases.js?v=325';
