...
import { getMagic, getMaxHp } from './stats.js?v=317';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=349';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=317';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=319';
import { grantReward } from './rewardGrants.js?v=157';
import { grantCharmBonus } from './bestiaryUseCases.js?v=318';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=328';
import { bumpMissionProgress } from './battlePassUseCases.js?v=317';
