...
import { getMagic, getMaxHp } from './stats.js?v=342';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=374';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=342';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=344';
import { grantReward } from './rewardGrants.js?v=182';
import { grantCharmBonus } from './bestiaryUseCases.js?v=343';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=353';
import { bumpMissionProgress } from './battlePassUseCases.js?v=342';
