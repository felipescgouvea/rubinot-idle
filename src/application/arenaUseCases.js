...
import { G } from './gameStore.js?v=250';
import { emit, EVENTS } from '../shared/eventBus.js?v=248';
import { getMagic, getMaxHp } from './stats.js?v=247';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=279';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=247';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=249';
import { grantReward } from './rewardGrants.js?v=87';
import { bumpMissionProgress } from './battlePassUseCases.js?v=247';
