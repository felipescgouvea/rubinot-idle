...
import { G } from './gameStore.js?v=166';
import { emit, EVENTS } from '../shared/eventBus.js?v=164';
import { getMagic, getMaxHp } from './stats.js?v=163';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=195';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=163';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=165';
import { grantReward } from './rewardGrants.js?v=3';
import { bumpMissionProgress } from './battlePassUseCases.js?v=163';
