...
import { G } from './gameStore.js?v=132';
import { emit, EVENTS } from '../shared/eventBus.js?v=130';
import { getMagic, getMaxHp } from './stats.js?v=129';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=161';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=129';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=131';
import { bumpMissionProgress } from './battlePassUseCases.js?v=129';
