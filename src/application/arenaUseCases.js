...
import { G } from './gameStore.js?v=260';
import { emit, EVENTS } from '../shared/eventBus.js?v=258';
import { getMagic, getMaxHp } from './stats.js?v=257';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=289';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=257';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=259';
import { grantReward } from './rewardGrants.js?v=97';
import { bumpMissionProgress } from './battlePassUseCases.js?v=257';
