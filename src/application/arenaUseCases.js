...
import { G } from './gameStore.js?v=137';
import { emit, EVENTS } from '../shared/eventBus.js?v=135';
import { getMagic, getMaxHp } from './stats.js?v=134';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=166';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=134';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=136';
import { bumpMissionProgress } from './battlePassUseCases.js?v=134';
