...
import { G } from './gameStore.js?v=173';
import { emit, EVENTS } from '../shared/eventBus.js?v=171';
import { getMagic, getMaxHp } from './stats.js?v=170';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=202';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=170';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=172';
import { grantReward } from './rewardGrants.js?v=10';
import { bumpMissionProgress } from './battlePassUseCases.js?v=170';
