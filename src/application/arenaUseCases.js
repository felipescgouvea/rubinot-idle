...
import { getMagic, getMaxHp } from './stats.js?v=251';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=283';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=251';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=253';
import { grantReward } from './rewardGrants.js?v=91';
import { bumpMissionProgress } from './battlePassUseCases.js?v=251';
