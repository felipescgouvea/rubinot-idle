...
import { G } from './gameStore.js?v=256';
import { emit, EVENTS } from '../shared/eventBus.js?v=254';
import { getMagic, getMaxHp } from './stats.js?v=253';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=285';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=253';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=255';
import { grantReward } from './rewardGrants.js?v=93';
import { bumpMissionProgress } from './battlePassUseCases.js?v=253';
