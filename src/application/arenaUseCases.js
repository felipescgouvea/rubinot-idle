...
import { getMagic, getMaxHp } from './stats.js?v=334';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=366';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=334';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=336';
import { grantReward } from './rewardGrants.js?v=174';
import { grantCharmBonus } from './bestiaryUseCases.js?v=335';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=345';
import { bumpMissionProgress } from './battlePassUseCases.js?v=334';
