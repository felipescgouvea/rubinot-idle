...
import { G } from './gameStore.js?v=228';
import { emit, EVENTS } from '../shared/eventBus.js?v=226';
import { getMagic, getMaxHp } from './stats.js?v=225';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=257';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=225';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=227';
import { grantReward } from './rewardGrants.js?v=65';
import { bumpMissionProgress } from './battlePassUseCases.js?v=225';
