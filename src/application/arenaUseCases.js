...
import { G } from './gameStore.js?v=207';
import { emit, EVENTS } from '../shared/eventBus.js?v=205';
import { getMagic, getMaxHp } from './stats.js?v=204';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=236';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=204';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=206';
import { grantReward } from './rewardGrants.js?v=44';
import { bumpMissionProgress } from './battlePassUseCases.js?v=204';
