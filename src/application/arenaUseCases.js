...
import { getMagic, getMaxHp } from './stats.js?v=356';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=388';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=356';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=358';
import { grantReward } from './rewardGrants.js?v=196';
import { grantCharmBonus } from './bestiaryUseCases.js?v=357';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=367';
import { bumpMissionProgress } from './battlePassUseCases.js?v=356';
