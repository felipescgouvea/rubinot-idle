...
import { G } from './gameStore.js?v=299';
import { emit, EVENTS } from '../shared/eventBus.js?v=297';
import { getMagic, getMaxHp } from './stats.js?v=296';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=328';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=296';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=298';
import { grantReward } from './rewardGrants.js?v=136';
import { grantCharmBonus } from './bestiaryUseCases.js?v=297';
