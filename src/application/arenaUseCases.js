...
import { G } from './gameStore.js?v=274';
import { emit, EVENTS } from '../shared/eventBus.js?v=272';
import { getMagic, getMaxHp } from './stats.js?v=271';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=303';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=271';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=273';
import { grantReward } from './rewardGrants.js?v=111';
import { bumpMissionProgress } from './battlePassUseCases.js?v=271';
