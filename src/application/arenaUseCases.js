...
import { G } from './gameStore.js?v=288';
import { emit, EVENTS } from '../shared/eventBus.js?v=286';
import { getMagic, getMaxHp } from './stats.js?v=285';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=317';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=285';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=287';
import { grantReward } from './rewardGrants.js?v=125';
import { bumpMissionProgress } from './battlePassUseCases.js?v=285';
