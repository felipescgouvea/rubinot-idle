...
import { getMagic, getMaxHp } from './stats.js?v=173';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=205';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=173';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=175';
import { grantReward } from './rewardGrants.js?v=13';
import { bumpMissionProgress } from './battlePassUseCases.js?v=173';
