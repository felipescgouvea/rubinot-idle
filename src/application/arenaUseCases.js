...
import { getMagic, getMaxHp } from './stats.js?v=305';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=337';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=305';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=307';
import { grantReward } from './rewardGrants.js?v=145';
import { grantCharmBonus } from './bestiaryUseCases.js?v=306';
import { grantBoostOnServer } from '../infrastructure/authClient.js?v=316';
import { bumpMissionProgress } from './battlePassUseCases.js?v=305';
