...
import { getAtk, getDef, getMagic, getMaxHp } from './stats.js?v=41';
import { fetchArenaOpponentRequest } from '../infrastructure/highscoresApi.js?v=41';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=41';
import { bumpMissionProgress } from './battlePassUseCases.js?v=41';
import { addItemToInventory } from './inventoryCore.js?v=41';
import { ITEMS } from '../domain/items.js?v=41';
import { saveGame } from './saveGameUseCase.js?v=41';
