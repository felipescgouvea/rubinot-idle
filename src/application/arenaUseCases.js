...
import { getMagic, getMaxHp } from './stats.js?v=174';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=206';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=174';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=176';
import { grantReward } from './rewardGrants.js?v=14';
import { bumpMissionProgress } from './battlePassUseCases.js?v=174';
