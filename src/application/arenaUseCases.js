...
import { G } from './gameStore.js?v=144';
import { emit, EVENTS } from '../shared/eventBus.js?v=142';
import { getMagic, getMaxHp } from './stats.js?v=141';
import { rollPlayerAttack, reducePhysical, computePlayerArmor, computePlayerDefense, computeAtk, normalRandom } from '../domain/combatFormulas.js?v=173';
import { selectRequest } from '../infrastructure/supabaseClient.js?v=141';
import { ARENA_DAILY_LIMIT, ARENA_DIVISIONS, ARENA_DIVISION_REWARDS, arenaDivisionForPoints } from '../domain/progression.js?v=143';
import { bumpMissionProgress } from './battlePassUseCases.js?v=141';
