...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=342';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=343';
import { saveGame } from './saveGameUseCase.js?v=345';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=353';
