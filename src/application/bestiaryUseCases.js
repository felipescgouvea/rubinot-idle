...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=315';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=316';
import { saveGame } from './saveGameUseCase.js?v=318';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=326';
