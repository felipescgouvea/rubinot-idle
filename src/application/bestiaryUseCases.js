...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=297';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=298';
import { saveGame } from './saveGameUseCase.js?v=300';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=308';
