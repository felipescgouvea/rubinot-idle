...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=316';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=317';
import { saveGame } from './saveGameUseCase.js?v=319';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=327';
