...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=304';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=305';
import { saveGame } from './saveGameUseCase.js?v=307';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=315';
