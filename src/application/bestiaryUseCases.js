...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=345';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=346';
import { saveGame } from './saveGameUseCase.js?v=348';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=356';
