...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=300';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=301';
import { saveGame } from './saveGameUseCase.js?v=303';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=311';
