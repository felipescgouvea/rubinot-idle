...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=306';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=307';
import { saveGame } from './saveGameUseCase.js?v=309';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=317';
