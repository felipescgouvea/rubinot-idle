...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=338';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=339';
import { saveGame } from './saveGameUseCase.js?v=341';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=349';
