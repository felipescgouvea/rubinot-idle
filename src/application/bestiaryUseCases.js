...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=299';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=300';
import { saveGame } from './saveGameUseCase.js?v=302';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=310';
