...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=339';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=340';
import { saveGame } from './saveGameUseCase.js?v=342';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=350';
