...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=352';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=353';
import { saveGame } from './saveGameUseCase.js?v=355';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=363';
