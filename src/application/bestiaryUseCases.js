...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=303';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=304';
import { saveGame } from './saveGameUseCase.js?v=306';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=314';
