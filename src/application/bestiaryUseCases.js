...
import { CHARMS, CHARM_EQUIP_SLOTS } from '../domain/charms.js?v=324';
import { emit, on, EVENTS } from '../shared/eventBus.js?v=325';
import { saveGame } from './saveGameUseCase.js?v=327';
import { fetchCharmState, unlockCharmOnServer, grantCharmBonusOnServer } from '../infrastructure/authClient.js?v=335';
