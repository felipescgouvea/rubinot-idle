...
import { BP_REWARDS, BP_PREMIUM_REWARDS, BP_PREMIUM_COST_RUBINI, bpTierForXp, dailyMissionsFor, weeklyMissionsFor, bpWeekId, currentBpSeason } from '../domain/progression.js?v=327';
...
import { bpClaimOnServer, bpBuyPremiumOnServer } from '../infrastructure/authClient.js?v=334';
...
export async function claimBpReward(tier, kind = 'free') {
  ...
  // #R1: rubini reward de BP tier é creditado no servidor (/bp/claim já soma em
