...
import { VOCATIONS } from './domain/character.js?v=244';
import { emit, EVENTS } from './shared/eventBus.js?v=215';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=231';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=217';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=256';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=215';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=222';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=212';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=218';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=281';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=225';
import { startTask, cancelTask } from './application/taskUseCases.js?v=219';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=219';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=216';
import { buyShopItem } from './application/shopUseCases.js?v=221';
import { buyBlessing } from './application/blessingUseCases.js?v=215';
import { promoteVocation } from './application/promotionUseCases.js?v=213';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=249';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=217';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=217';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=214';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=215';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=215';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=215';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=221';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=220';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=225';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=234';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=218';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=222';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=215';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=214';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=216';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=222';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=249';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=219';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=218';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=214';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=225';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=213';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=220';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=220';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=223';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=216';
import { castConjureSpell } from './ui/spellsPanel.js?v=129';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=216';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=220';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=213';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=213';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=224';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=214';
import { openSettingsPanel } from './ui/settingsPanel.js?v=217';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=217';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=218';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=224';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=231';
import { applyDataIcons } from './ui/uiIcons.js?v=218';
