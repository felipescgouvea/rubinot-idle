...
import { VOCATIONS } from './domain/character.js?v=387';
import { emit, EVENTS } from './shared/eventBus.js?v=358';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=376';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=360';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=399';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=358';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=368';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=355';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=361';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=424';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=368';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=363';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=362';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=359';
import { buyShopItem } from './application/shopUseCases.js?v=364';
import { buyBlessing } from './application/blessingUseCases.js?v=358';
import { promoteVocation } from './application/promotionUseCases.js?v=356';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=392';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=361';
import { startOnlinePolling } from './application/onlineUseCases.js?v=130';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=360';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=357';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=359';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=359';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=358';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=364';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=363';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=368';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=377';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=361';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=365';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=358';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=357';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=359';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=365';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=392';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=362';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=361';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=357';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=368';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=356';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=363';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=363';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=366';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=359';
import { castConjureSpell } from './ui/spellsPanel.js?v=273';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=359';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=363';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=357';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=357';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=367';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=357';
import { openSettingsPanel } from './ui/settingsPanel.js?v=360';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=361';
import { wireDeathModal } from './ui/deathModal.js?v=78';
import { wireContextMenu } from './ui/contextMenu.js?v=18';
import { maybeStartOnboarding } from './ui/onboarding.js?v=13';
import { startQuestClick } from './ui/questsPanel.js?v=8';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=361';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=367';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=374';
import { applyDataIcons } from './ui/uiIcons.js?v=361';
