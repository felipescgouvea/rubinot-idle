...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=215';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=201';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=240';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=199';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=206';
import { selectVocation } from './application/characterUseCases.js?v=202';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=265';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=209';
import { startTask, cancelTask } from './application/taskUseCases.js?v=203';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=203';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=200';
import { buyShopItem } from './application/shopUseCases.js?v=205';
import { buyBlessing } from './application/blessingUseCases.js?v=199';
import { promoteVocation } from './application/promotionUseCases.js?v=197';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=233';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=201';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=201';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=198';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=199';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=199';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=199';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=205';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=204';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=209';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=218';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=202';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=206';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=199';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=198';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=200';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=206';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=233';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=203';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=202';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=198';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=209';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=197';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=204';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=204';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=207';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=200';
import { castConjureSpell } from './ui/spellsPanel.js?v=113';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=200';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=204';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=197';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=197';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=208';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=198';
import { openSettingsPanel } from './ui/settingsPanel.js?v=201';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=202';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=208';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=215';
import { applyDataIcons } from './ui/uiIcons.js?v=202';
