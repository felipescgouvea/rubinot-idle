...
import { G } from './application/gameStore.js?v=254';
import { VOCATIONS } from './domain/character.js?v=281';
import { emit, EVENTS } from './shared/eventBus.js?v=252';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=268';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=254';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=293';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=252';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=259';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=249';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=255';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=318';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=262';
import { startTask, cancelTask } from './application/taskUseCases.js?v=256';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=256';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=253';
import { buyShopItem } from './application/shopUseCases.js?v=258';
import { buyBlessing } from './application/blessingUseCases.js?v=252';
import { promoteVocation } from './application/promotionUseCases.js?v=250';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=286';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=254';
import { startOnlinePolling } from './application/onlineUseCases.js?v=23';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=254';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=251';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=252';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=252';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=252';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=258';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=257';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=262';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=271';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=255';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=259';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=252';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=251';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=253';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=259';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=286';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=256';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=255';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=251';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=262';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=250';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=257';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=257';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=260';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=253';
import { castConjureSpell } from './ui/spellsPanel.js?v=166';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=253';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=257';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=250';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=250';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=261';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=251';
import { openSettingsPanel } from './ui/settingsPanel.js?v=254';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=254';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=255';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=261';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=268';
import { applyDataIcons } from './ui/uiIcons.js?v=255';
