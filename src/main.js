...
import { VOCATIONS } from './domain/character.js?v=310';
import { emit, EVENTS } from './shared/eventBus.js?v=281';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=299';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=283';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=322';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=281';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=291';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=278';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=284';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=347';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=291';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=286';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=285';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=282';
import { buyShopItem } from './application/shopUseCases.js?v=287';
import { buyBlessing } from './application/blessingUseCases.js?v=281';
import { promoteVocation } from './application/promotionUseCases.js?v=279';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=315';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=284';
import { startOnlinePolling } from './application/onlineUseCases.js?v=53';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=283';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=280';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=282';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=282';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=281';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=287';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=286';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=291';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=300';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=284';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=288';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=281';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=280';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=282';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=288';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=315';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=285';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=284';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=280';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=291';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=279';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=286';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=286';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=289';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=282';
import { castConjureSpell } from './ui/spellsPanel.js?v=195';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=282';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=286';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=280';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=279';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=290';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=280';
import { openSettingsPanel } from './ui/settingsPanel.js?v=283';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=284';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=284';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=290';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=297';
import { applyDataIcons } from './ui/uiIcons.js?v=284';
