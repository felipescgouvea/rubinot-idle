...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=193';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=179';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=218';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=177';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=184';
import { selectVocation } from './application/characterUseCases.js?v=180';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=243';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=187';
import { startTask, cancelTask } from './application/taskUseCases.js?v=181';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=181';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=178';
import { buyShopItem } from './application/shopUseCases.js?v=183';
import { buyBlessing } from './application/blessingUseCases.js?v=177';
import { promoteVocation } from './application/promotionUseCases.js?v=175';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=211';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=179';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=179';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=176';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=177';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=177';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=177';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=183';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=182';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=187';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=196';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=180';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=184';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=177';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=176';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=178';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=184';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=211';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=181';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=180';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=176';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=187';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=175';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=182';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=182';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=185';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=178';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=178';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=182';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=175';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=175';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=186';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=176';
import { openSettingsPanel } from './ui/settingsPanel.js?v=179';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=180';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=186';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=193';
import { applyDataIcons } from './ui/uiIcons.js?v=180';
