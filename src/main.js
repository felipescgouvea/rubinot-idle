...
import { G } from './application/gameStore.js?v=318';
import { VOCATIONS } from './domain/character.js?v=345';
import { emit, EVENTS } from './shared/eventBus.js?v=316';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=334';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=318';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=357';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=316';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=326';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=313';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=319';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=382';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=326';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=321';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=320';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=317';
import { buyShopItem } from './application/shopUseCases.js?v=322';
import { buyBlessing } from './application/blessingUseCases.js?v=316';
import { promoteVocation } from './application/promotionUseCases.js?v=314';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=350';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=319';
import { startOnlinePolling } from './application/onlineUseCases.js?v=88';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=318';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=315';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=317';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=317';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=316';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=322';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=321';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=326';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=335';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=319';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=323';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=316';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=315';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=317';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=323';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=350';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=320';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=319';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=315';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=326';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=314';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=321';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=321';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=324';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=317';
import { castConjureSpell } from './ui/spellsPanel.js?v=231';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=317';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=321';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=315';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=315';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=325';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=315';
import { openSettingsPanel } from './ui/settingsPanel.js?v=318';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=319';
import { wireDeathModal } from './ui/deathModal.js?v=36';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=319';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=325';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=332';
import { applyDataIcons } from './ui/uiIcons.js?v=319';
