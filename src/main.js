...
import { VOCATIONS } from './domain/character.js?v=316';
import { emit, EVENTS } from './shared/eventBus.js?v=287';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=305';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=289';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=328';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=287';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=297';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=284';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=290';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=353';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=297';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=292';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=291';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=288';
import { buyShopItem } from './application/shopUseCases.js?v=293';
import { buyBlessing } from './application/blessingUseCases.js?v=287';
import { promoteVocation } from './application/promotionUseCases.js?v=285';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=321';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=290';
import { startOnlinePolling } from './application/onlineUseCases.js?v=59';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=289';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=286';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=288';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=288';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=287';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=293';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=292';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=297';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=306';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=290';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=294';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=287';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=286';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=288';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=294';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=321';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=291';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=290';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=286';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=297';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=285';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=292';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=292';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=295';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=288';
import { castConjureSpell } from './ui/spellsPanel.js?v=201';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=288';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=292';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=286';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=285';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=296';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=286';
import { openSettingsPanel } from './ui/settingsPanel.js?v=289';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=290';
import { wireDeathModal } from './ui/deathModal.js?v=6';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=290';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=296';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=303';
import { applyDataIcons } from './ui/uiIcons.js?v=290';
