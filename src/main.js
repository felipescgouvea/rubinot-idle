...
import { G } from './application/gameStore.js?v=342';
import { VOCATIONS } from './domain/character.js?v=369';
import { emit, EVENTS } from './shared/eventBus.js?v=340';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=358';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=342';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=381';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=340';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=350';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=337';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=343';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=406';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=350';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=345';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=344';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=341';
import { buyShopItem } from './application/shopUseCases.js?v=346';
import { buyBlessing } from './application/blessingUseCases.js?v=340';
import { promoteVocation } from './application/promotionUseCases.js?v=338';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=374';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=343';
import { startOnlinePolling } from './application/onlineUseCases.js?v=112';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=342';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=339';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=341';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=341';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=340';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=346';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=345';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=350';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=359';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=343';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=347';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=340';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=339';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=341';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=347';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=374';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=344';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=343';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=339';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=350';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=338';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=345';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=345';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=348';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=341';
import { castConjureSpell } from './ui/spellsPanel.js?v=255';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=341';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=345';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=339';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=339';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=349';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=339';
import { openSettingsPanel } from './ui/settingsPanel.js?v=342';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=343';
import { wireDeathModal } from './ui/deathModal.js?v=60';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=343';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=349';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=356';
import { applyDataIcons } from './ui/uiIcons.js?v=343';
