...
import { VOCATIONS } from './domain/character.js?v=381';
import { emit, EVENTS } from './shared/eventBus.js?v=352';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=370';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=354';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=393';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=352';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=362';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=349';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=355';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=418';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=362';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=357';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=356';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=353';
import { buyShopItem } from './application/shopUseCases.js?v=358';
import { buyBlessing } from './application/blessingUseCases.js?v=352';
import { promoteVocation } from './application/promotionUseCases.js?v=350';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=386';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=355';
import { startOnlinePolling } from './application/onlineUseCases.js?v=124';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=354';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=351';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=353';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=353';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=352';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=358';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=357';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=362';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=371';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=355';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=359';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=352';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=351';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=353';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=359';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=386';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=356';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=355';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=351';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=362';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=350';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=357';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=357';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=360';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=353';
import { castConjureSpell } from './ui/spellsPanel.js?v=267';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=353';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=357';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=351';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=351';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=361';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=351';
import { openSettingsPanel } from './ui/settingsPanel.js?v=354';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=355';
import { wireDeathModal } from './ui/deathModal.js?v=72';
import { wireContextMenu } from './ui/contextMenu.js?v=12';
import { maybeStartOnboarding } from './ui/onboarding.js?v=7';
import { startQuestClick } from './ui/questsPanel.js?v=2';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=355';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=361';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=368';
import { applyDataIcons } from './ui/uiIcons.js?v=355';
