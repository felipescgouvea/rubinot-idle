...
import { VOCATIONS } from './domain/character.js?v=159';
import { emit, EVENTS } from './shared/eventBus.js?v=130';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=146';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=132';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=171';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=130';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=137';
import { selectVocation } from './application/characterUseCases.js?v=133';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=196';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=140';
import { startTask, cancelTask } from './application/taskUseCases.js?v=134';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=134';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=131';
import { buyShopItem } from './application/shopUseCases.js?v=136';
import { buyBlessing } from './application/blessingUseCases.js?v=130';
import { promoteVocation } from './application/promotionUseCases.js?v=128';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=164';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=132';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=132';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=129';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=130';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=130';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=130';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=136';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=135';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=140';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=149';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=133';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=137';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=130';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=129';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=131';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=137';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=164';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=134';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=133';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=129';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=140';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=128';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=135';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=135';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=138';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=131';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=131';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=135';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=128';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=128';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=139';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=129';
import { openSettingsPanel } from './ui/settingsPanel.js?v=132';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=133';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=139';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=146';
