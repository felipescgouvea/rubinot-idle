...
import { G } from './application/gameStore.js?v=306';
import { VOCATIONS } from './domain/character.js?v=333';
import { emit, EVENTS } from './shared/eventBus.js?v=304';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=322';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=306';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=345';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=304';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=314';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=301';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=307';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=370';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=314';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=309';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=308';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=305';
import { buyShopItem } from './application/shopUseCases.js?v=310';
import { buyBlessing } from './application/blessingUseCases.js?v=304';
import { promoteVocation } from './application/promotionUseCases.js?v=302';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=338';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=307';
import { startOnlinePolling } from './application/onlineUseCases.js?v=76';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=306';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=303';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=305';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=305';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=304';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=310';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=309';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=314';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=323';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=307';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=311';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=304';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=303';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=305';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=311';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=338';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=308';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=307';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=303';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=314';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=302';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=309';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=309';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=312';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=305';
import { castConjureSpell } from './ui/spellsPanel.js?v=219';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=305';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=309';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=303';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=303';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=313';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=303';
import { openSettingsPanel } from './ui/settingsPanel.js?v=306';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=307';
import { wireDeathModal } from './ui/deathModal.js?v=24';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=307';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=313';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=320';
import { applyDataIcons } from './ui/uiIcons.js?v=307';
