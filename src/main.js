...
import { VOCATIONS } from './domain/character.js?v=170';
import { emit, EVENTS } from './shared/eventBus.js?v=141';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=157';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=143';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=182';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=141';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=148';
import { selectVocation } from './application/characterUseCases.js?v=144';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=207';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=151';
import { startTask, cancelTask } from './application/taskUseCases.js?v=145';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=145';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=142';
import { buyShopItem } from './application/shopUseCases.js?v=147';
import { buyBlessing } from './application/blessingUseCases.js?v=141';
import { promoteVocation } from './application/promotionUseCases.js?v=139';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=175';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=143';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=143';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=140';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=141';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=141';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=141';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=147';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=146';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=151';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=160';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=144';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=148';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=141';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=140';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=142';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=148';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=175';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=145';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=144';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=140';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=151';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=139';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=146';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=146';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=149';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=142';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=142';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=146';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=139';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=139';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=150';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=140';
import { openSettingsPanel } from './ui/settingsPanel.js?v=143';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=144';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=150';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=157';
import { applyDataIcons } from './ui/uiIcons.js?v=144';
