...
import { VOCATIONS } from './domain/character.js?v=218';
import { emit, EVENTS } from './shared/eventBus.js?v=189';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=205';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=191';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=230';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=189';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=196';
import { selectVocation } from './application/characterUseCases.js?v=192';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=255';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=199';
import { startTask, cancelTask } from './application/taskUseCases.js?v=193';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=193';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=190';
import { buyShopItem } from './application/shopUseCases.js?v=195';
import { buyBlessing } from './application/blessingUseCases.js?v=189';
import { promoteVocation } from './application/promotionUseCases.js?v=187';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=223';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=191';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=191';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=188';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=189';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=189';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=189';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=195';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=194';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=199';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=208';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=192';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=196';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=189';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=188';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=190';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=196';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=223';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=193';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=192';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=188';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=199';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=187';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=194';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=194';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=197';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=190';
import { castConjureSpell } from './ui/spellsPanel.js?v=103';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=190';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=194';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=187';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=187';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=198';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=188';
import { openSettingsPanel } from './ui/settingsPanel.js?v=191';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=192';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=198';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=205';
import { applyDataIcons } from './ui/uiIcons.js?v=192';
