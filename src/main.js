...
import { G } from './application/gameStore.js?v=235';
import { VOCATIONS } from './domain/character.js?v=262';
import { emit, EVENTS } from './shared/eventBus.js?v=233';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=249';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=235';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=274';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=233';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=240';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=230';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=236';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=299';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=243';
import { startTask, cancelTask } from './application/taskUseCases.js?v=237';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=237';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=234';
import { buyShopItem } from './application/shopUseCases.js?v=239';
import { buyBlessing } from './application/blessingUseCases.js?v=233';
import { promoteVocation } from './application/promotionUseCases.js?v=231';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=267';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=235';
import { startOnlinePolling } from './application/onlineUseCases.js?v=4';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=235';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=232';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=233';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=233';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=233';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=239';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=238';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=243';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=252';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=236';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=240';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=233';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=232';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=234';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=240';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=267';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=237';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=236';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=232';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=243';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=231';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=238';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=238';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=241';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=234';
import { castConjureSpell } from './ui/spellsPanel.js?v=147';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=234';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=238';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=231';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=231';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=242';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=232';
import { openSettingsPanel } from './ui/settingsPanel.js?v=235';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=235';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=236';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=242';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=249';
import { applyDataIcons } from './ui/uiIcons.js?v=236';
