...
import { VOCATIONS } from './domain/character.js?v=278';
import { emit, EVENTS } from './shared/eventBus.js?v=249';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=265';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=251';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=290';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=249';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=256';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=246';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=252';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=315';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=259';
import { startTask, cancelTask } from './application/taskUseCases.js?v=253';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=253';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=250';
import { buyShopItem } from './application/shopUseCases.js?v=255';
import { buyBlessing } from './application/blessingUseCases.js?v=249';
import { promoteVocation } from './application/promotionUseCases.js?v=247';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=283';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=251';
import { startOnlinePolling } from './application/onlineUseCases.js?v=20';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=251';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=248';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=249';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=249';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=249';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=255';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=254';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=259';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=268';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=252';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=256';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=249';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=248';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=250';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=256';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=283';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=253';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=252';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=248';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=259';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=247';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=254';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=254';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=257';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=250';
import { castConjureSpell } from './ui/spellsPanel.js?v=163';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=250';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=254';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=247';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=247';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=258';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=248';
import { openSettingsPanel } from './ui/settingsPanel.js?v=251';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=251';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=252';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=258';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=265';
import { applyDataIcons } from './ui/uiIcons.js?v=252';
