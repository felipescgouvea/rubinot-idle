...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=245';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=231';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=270';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=229';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=236';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=226';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=232';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=295';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=239';
import { startTask, cancelTask } from './application/taskUseCases.js?v=233';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=233';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=230';
import { buyShopItem } from './application/shopUseCases.js?v=235';
import { buyBlessing } from './application/blessingUseCases.js?v=229';
import { promoteVocation } from './application/promotionUseCases.js?v=227';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=263';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=231';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=231';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=228';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=229';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=229';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=229';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=235';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=234';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=239';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=248';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=232';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=236';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=229';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=228';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=230';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=236';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=263';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=233';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=232';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=228';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=239';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=227';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=234';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=234';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=237';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=230';
import { castConjureSpell } from './ui/spellsPanel.js?v=143';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=230';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=234';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=227';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=227';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=238';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=228';
import { openSettingsPanel } from './ui/settingsPanel.js?v=231';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=231';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=232';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=238';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=245';
import { applyDataIcons } from './ui/uiIcons.js?v=232';
