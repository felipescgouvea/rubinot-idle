...
import { G } from './application/gameStore.js?v=282';
import { VOCATIONS } from './domain/character.js?v=309';
import { emit, EVENTS } from './shared/eventBus.js?v=280';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=298';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=282';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=321';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=280';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=290';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=277';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=283';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=346';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=290';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=285';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=284';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=281';
import { buyShopItem } from './application/shopUseCases.js?v=286';
import { buyBlessing } from './application/blessingUseCases.js?v=280';
import { promoteVocation } from './application/promotionUseCases.js?v=278';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=314';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=283';
import { startOnlinePolling } from './application/onlineUseCases.js?v=52';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=282';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=279';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=281';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=281';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=280';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=286';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=285';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=290';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=299';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=283';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=287';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=280';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=279';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=281';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=287';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=314';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=284';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=283';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=279';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=290';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=278';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=285';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=285';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=288';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=281';
import { castConjureSpell } from './ui/spellsPanel.js?v=194';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=281';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=285';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=279';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=278';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=289';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=279';
import { openSettingsPanel } from './ui/settingsPanel.js?v=282';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=283';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=283';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=289';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=296';
import { applyDataIcons } from './ui/uiIcons.js?v=283';
