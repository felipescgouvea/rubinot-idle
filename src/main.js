...
import { G } from './application/gameStore.js?v=260';
import { VOCATIONS } from './domain/character.js?v=287';
import { emit, EVENTS } from './shared/eventBus.js?v=258';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=276';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=260';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=299';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=258';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=268';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=255';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=261';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=324';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=268';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=263';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=262';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=259';
import { buyShopItem } from './application/shopUseCases.js?v=264';
import { buyBlessing } from './application/blessingUseCases.js?v=258';
import { promoteVocation } from './application/promotionUseCases.js?v=256';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=292';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=261';
import { startOnlinePolling } from './application/onlineUseCases.js?v=30';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=260';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=257';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=259';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=259';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=258';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=264';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=263';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=268';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=277';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=261';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=265';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=258';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=257';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=259';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=265';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=292';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=262';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=261';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=257';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=268';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=256';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=263';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=263';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=266';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=259';
import { castConjureSpell } from './ui/spellsPanel.js?v=172';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=259';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=263';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=256';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=256';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=267';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=257';
import { openSettingsPanel } from './ui/settingsPanel.js?v=260';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=261';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=261';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=267';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=274';
import { applyDataIcons } from './ui/uiIcons.js?v=261';
