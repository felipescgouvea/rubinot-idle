...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=180';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=166';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=205';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=164';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=171';
import { selectVocation } from './application/characterUseCases.js?v=167';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=230';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=174';
import { startTask, cancelTask } from './application/taskUseCases.js?v=168';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=168';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=165';
import { buyShopItem } from './application/shopUseCases.js?v=170';
import { buyBlessing } from './application/blessingUseCases.js?v=164';
import { promoteVocation } from './application/promotionUseCases.js?v=162';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=198';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=166';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=166';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=163';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=164';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=164';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=164';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=170';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=169';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=174';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=183';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=167';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=171';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=164';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=163';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=165';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=171';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=198';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=168';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=167';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=163';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=174';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=162';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=169';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=169';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=172';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=165';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=165';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=169';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=162';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=162';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=173';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=163';
import { openSettingsPanel } from './ui/settingsPanel.js?v=166';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=167';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=173';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=180';
import { applyDataIcons } from './ui/uiIcons.js?v=167';
