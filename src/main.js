...
import { emit, EVENTS } from './shared/eventBus.js?v=326';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=344';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=328';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=367';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=326';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=336';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=323';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=329';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=392';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=336';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=331';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=330';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=327';
import { buyShopItem } from './application/shopUseCases.js?v=332';
import { buyBlessing } from './application/blessingUseCases.js?v=326';
import { promoteVocation } from './application/promotionUseCases.js?v=324';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=360';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=329';
import { startOnlinePolling } from './application/onlineUseCases.js?v=98';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=328';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=325';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=327';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=327';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=326';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=332';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=331';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=336';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=345';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=329';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=333';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=326';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=325';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=327';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=333';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=360';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=330';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=329';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=325';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=336';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=324';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=331';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=331';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=334';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=327';
import { castConjureSpell } from './ui/spellsPanel.js?v=241';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=327';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=331';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=325';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=325';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=335';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=325';
import { openSettingsPanel } from './ui/settingsPanel.js?v=328';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=329';
import { wireDeathModal } from './ui/deathModal.js?v=46';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=329';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=335';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=342';
import { applyDataIcons } from './ui/uiIcons.js?v=329';
