...
import { VOCATIONS } from './domain/character.js?v=294';
import { emit, EVENTS } from './shared/eventBus.js?v=265';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=283';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=267';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=306';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=265';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=275';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=262';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=268';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=331';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=275';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=270';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=269';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=266';
import { buyShopItem } from './application/shopUseCases.js?v=271';
import { buyBlessing } from './application/blessingUseCases.js?v=265';
import { promoteVocation } from './application/promotionUseCases.js?v=263';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=299';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=268';
import { startOnlinePolling } from './application/onlineUseCases.js?v=37';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=267';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=264';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=266';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=266';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=265';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=271';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=270';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=275';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=284';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=268';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=272';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=265';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=264';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=266';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=272';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=299';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=269';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=268';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=264';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=275';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=263';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=270';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=270';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=273';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=266';
import { castConjureSpell } from './ui/spellsPanel.js?v=179';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=266';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=270';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=264';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=263';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=274';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=264';
import { openSettingsPanel } from './ui/settingsPanel.js?v=267';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=268';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=268';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=274';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=281';
import { applyDataIcons } from './ui/uiIcons.js?v=268';
