...
import { G } from './application/gameStore.js?v=159';
import { VOCATIONS } from './domain/character.js?v=186';
import { emit, EVENTS } from './shared/eventBus.js?v=157';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=173';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=159';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=198';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=157';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=164';
import { selectVocation } from './application/characterUseCases.js?v=160';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=223';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=167';
import { startTask, cancelTask } from './application/taskUseCases.js?v=161';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=161';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=158';
import { buyShopItem } from './application/shopUseCases.js?v=163';
import { buyBlessing } from './application/blessingUseCases.js?v=157';
import { promoteVocation } from './application/promotionUseCases.js?v=155';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=191';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=159';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=159';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=156';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=157';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=157';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=157';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=163';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=162';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=167';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=176';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=160';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=164';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=157';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=156';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=158';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=164';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=191';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=161';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=160';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=156';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=167';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=155';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=162';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=162';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=165';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=158';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=158';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=162';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=155';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=155';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=166';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=156';
import { openSettingsPanel } from './ui/settingsPanel.js?v=159';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=160';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=166';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=173';
import { applyDataIcons } from './ui/uiIcons.js?v=160';
