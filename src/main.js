...
import { G } from './application/gameStore.js?v=130';
import { VOCATIONS } from './domain/character.js?v=157';
import { emit, EVENTS } from './shared/eventBus.js?v=128';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=144';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=130';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=169';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=128';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=135';
import { selectVocation } from './application/characterUseCases.js?v=131';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=194';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=138';
import { startTask, cancelTask } from './application/taskUseCases.js?v=132';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=132';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=129';
import { buyShopItem } from './application/shopUseCases.js?v=134';
import { buyBlessing } from './application/blessingUseCases.js?v=128';
import { promoteVocation } from './application/promotionUseCases.js?v=126';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=162';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=130';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=130';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=127';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=128';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=128';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=128';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=134';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=133';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=138';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=147';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=131';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=135';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=128';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=127';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=129';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=135';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=162';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=132';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=131';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=127';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=138';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=126';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=133';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=133';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=136';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=129';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=129';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=133';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=126';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=126';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=137';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=127';
import { openSettingsPanel } from './ui/settingsPanel.js?v=130';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=131';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=137';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=144';
