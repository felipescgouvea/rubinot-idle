...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=212';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=198';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=237';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=196';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=203';
import { selectVocation } from './application/characterUseCases.js?v=199';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=262';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=206';
import { startTask, cancelTask } from './application/taskUseCases.js?v=200';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=200';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=197';
import { buyShopItem } from './application/shopUseCases.js?v=202';
import { buyBlessing } from './application/blessingUseCases.js?v=196';
import { promoteVocation } from './application/promotionUseCases.js?v=194';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=230';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=198';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=198';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=195';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=196';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=196';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=196';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=202';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=201';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=206';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=215';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=199';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=203';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=196';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=195';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=197';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=203';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=230';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=200';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=199';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=195';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=206';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=194';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=201';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=201';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=204';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=197';
import { castConjureSpell } from './ui/spellsPanel.js?v=110';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=197';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=201';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=194';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=194';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=205';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=195';
import { openSettingsPanel } from './ui/settingsPanel.js?v=198';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=199';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=205';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=212';
import { applyDataIcons } from './ui/uiIcons.js?v=199';
