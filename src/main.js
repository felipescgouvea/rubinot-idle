...
import { emit, EVENTS } from './shared/eventBus.js?v=361';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=379';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=363';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=402';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=361';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=371';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=358';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=364';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=427';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=371';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=366';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=365';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=362';
import { buyShopItem } from './application/shopUseCases.js?v=367';
import { buyBlessing } from './application/blessingUseCases.js?v=361';
import { promoteVocation } from './application/promotionUseCases.js?v=359';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=395';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=364';
import { startOnlinePolling } from './application/onlineUseCases.js?v=133';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=363';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=360';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=362';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=362';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=361';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=367';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=366';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=371';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=380';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=364';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=368';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=361';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=360';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=362';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=368';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=395';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=365';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=364';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=360';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=371';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=359';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=366';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=366';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=369';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=362';
import { castConjureSpell } from './ui/spellsPanel.js?v=276';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=362';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=366';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=360';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=360';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=370';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=360';
import { openSettingsPanel } from './ui/settingsPanel.js?v=363';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=364';
import { wireDeathModal } from './ui/deathModal.js?v=81';
import { wireContextMenu } from './ui/contextMenu.js?v=21';
import { maybeStartOnboarding } from './ui/onboarding.js?v=16';
import { startQuestClick } from './ui/questsPanel.js?v=11';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=364';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=370';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=377';
import { applyDataIcons } from './ui/uiIcons.js?v=364';
