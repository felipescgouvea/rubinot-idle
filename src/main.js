...
import { VOCATIONS } from './domain/character.js?v=176';
import { emit, EVENTS } from './shared/eventBus.js?v=147';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=163';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=149';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=188';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=147';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=154';
import { selectVocation } from './application/characterUseCases.js?v=150';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=213';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=157';
import { startTask, cancelTask } from './application/taskUseCases.js?v=151';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=151';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=148';
import { buyShopItem } from './application/shopUseCases.js?v=153';
import { buyBlessing } from './application/blessingUseCases.js?v=147';
import { promoteVocation } from './application/promotionUseCases.js?v=145';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=181';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=149';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=149';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=146';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=147';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=147';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=147';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=153';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=152';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=157';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=166';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=150';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=154';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=147';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=146';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=148';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=154';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=181';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=151';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=150';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=146';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=157';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=145';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=152';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=152';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=155';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=148';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=148';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=152';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=145';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=145';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=156';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=146';
import { openSettingsPanel } from './ui/settingsPanel.js?v=149';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=150';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=156';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=163';
import { applyDataIcons } from './ui/uiIcons.js?v=150';
