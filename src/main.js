...
import { VOCATIONS } from './domain/character.js?v=194';
import { emit, EVENTS } from './shared/eventBus.js?v=165';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=181';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=167';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=206';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=165';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=172';
import { selectVocation } from './application/characterUseCases.js?v=168';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=231';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=175';
import { startTask, cancelTask } from './application/taskUseCases.js?v=169';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=169';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=166';
import { buyShopItem } from './application/shopUseCases.js?v=171';
import { buyBlessing } from './application/blessingUseCases.js?v=165';
import { promoteVocation } from './application/promotionUseCases.js?v=163';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=199';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=167';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=167';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=164';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=165';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=165';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=165';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=171';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=170';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=175';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=184';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=168';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=172';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=165';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=164';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=166';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=172';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=199';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=169';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=168';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=164';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=175';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=163';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=170';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=170';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=173';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=166';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=166';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=170';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=163';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=163';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=174';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=164';
import { openSettingsPanel } from './ui/settingsPanel.js?v=167';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=168';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=174';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=181';
import { applyDataIcons } from './ui/uiIcons.js?v=168';
