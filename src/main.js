...
import { G } from './application/gameStore.js?v=163';
import { VOCATIONS } from './domain/character.js?v=190';
import { emit, EVENTS } from './shared/eventBus.js?v=161';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=177';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=163';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=202';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=161';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=168';
import { selectVocation } from './application/characterUseCases.js?v=164';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=227';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=171';
import { startTask, cancelTask } from './application/taskUseCases.js?v=165';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=165';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=162';
import { buyShopItem } from './application/shopUseCases.js?v=167';
import { buyBlessing } from './application/blessingUseCases.js?v=161';
import { promoteVocation } from './application/promotionUseCases.js?v=159';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=195';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=163';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=163';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=160';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=161';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=161';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=161';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=167';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=166';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=171';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=180';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=164';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=168';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=161';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=160';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=162';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=168';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=195';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=165';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=164';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=160';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=171';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=159';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=166';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=166';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=169';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=162';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=162';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=166';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=159';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=159';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=170';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=160';
import { openSettingsPanel } from './ui/settingsPanel.js?v=163';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=164';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=170';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=177';
import { applyDataIcons } from './ui/uiIcons.js?v=164';
