...
import { VOCATIONS } from './domain/character.js?v=295';
import { emit, EVENTS } from './shared/eventBus.js?v=266';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=284';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=268';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=307';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=266';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=276';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=263';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=269';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=332';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=276';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=271';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=270';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=267';
import { buyShopItem } from './application/shopUseCases.js?v=272';
import { buyBlessing } from './application/blessingUseCases.js?v=266';
import { promoteVocation } from './application/promotionUseCases.js?v=264';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=300';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=269';
import { startOnlinePolling } from './application/onlineUseCases.js?v=38';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=268';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=265';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=267';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=267';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=266';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=272';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=271';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=276';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=285';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=269';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=273';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=266';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=265';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=267';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=273';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=300';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=270';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=269';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=265';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=276';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=264';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=271';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=271';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=274';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=267';
import { castConjureSpell } from './ui/spellsPanel.js?v=180';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=267';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=271';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=265';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=264';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=275';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=265';
import { openSettingsPanel } from './ui/settingsPanel.js?v=268';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=269';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=269';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=275';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=282';
import { applyDataIcons } from './ui/uiIcons.js?v=269';
