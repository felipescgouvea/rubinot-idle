...
import { G } from './application/gameStore.js?v=153';
import { VOCATIONS } from './domain/character.js?v=180';
import { emit, EVENTS } from './shared/eventBus.js?v=151';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=167';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=153';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=192';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=151';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=158';
import { selectVocation } from './application/characterUseCases.js?v=154';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=217';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=161';
import { startTask, cancelTask } from './application/taskUseCases.js?v=155';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=155';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=152';
import { buyShopItem } from './application/shopUseCases.js?v=157';
import { buyBlessing } from './application/blessingUseCases.js?v=151';
import { promoteVocation } from './application/promotionUseCases.js?v=149';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=185';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=153';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=153';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=150';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=151';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=151';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=151';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=157';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=156';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=161';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=170';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=154';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=158';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=151';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=150';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=152';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=158';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=185';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=155';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=154';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=150';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=161';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=149';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=156';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=156';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=159';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=152';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=152';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=156';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=149';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=149';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=160';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=150';
import { openSettingsPanel } from './ui/settingsPanel.js?v=153';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=154';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=160';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=167';
import { applyDataIcons } from './ui/uiIcons.js?v=154';
