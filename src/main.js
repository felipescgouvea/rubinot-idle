...
import { VOCATIONS } from './domain/character.js?v=279';
import { emit, EVENTS } from './shared/eventBus.js?v=250';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=266';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=252';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=291';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=250';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=257';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=247';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=253';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=316';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=260';
import { startTask, cancelTask } from './application/taskUseCases.js?v=254';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=254';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=251';
import { buyShopItem } from './application/shopUseCases.js?v=256';
import { buyBlessing } from './application/blessingUseCases.js?v=250';
import { promoteVocation } from './application/promotionUseCases.js?v=248';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=284';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=252';
import { startOnlinePolling } from './application/onlineUseCases.js?v=21';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=252';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=249';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=250';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=250';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=250';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=256';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=255';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=260';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=269';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=253';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=257';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=250';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=249';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=251';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=257';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=284';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=254';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=253';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=249';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=260';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=248';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=255';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=255';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=258';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=251';
import { castConjureSpell } from './ui/spellsPanel.js?v=164';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=251';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=255';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=248';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=248';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=259';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=249';
import { openSettingsPanel } from './ui/settingsPanel.js?v=252';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=252';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=253';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=259';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=266';
import { applyDataIcons } from './ui/uiIcons.js?v=253';
