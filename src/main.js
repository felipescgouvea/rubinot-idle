...
import { emit, EVENTS } from './shared/eventBus.js?v=235';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=251';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=237';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=276';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=235';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=242';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=232';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=238';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=301';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=245';
import { startTask, cancelTask } from './application/taskUseCases.js?v=239';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=239';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=236';
import { buyShopItem } from './application/shopUseCases.js?v=241';
import { buyBlessing } from './application/blessingUseCases.js?v=235';
import { promoteVocation } from './application/promotionUseCases.js?v=233';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=269';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=237';
import { startOnlinePolling } from './application/onlineUseCases.js?v=6';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=237';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=234';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=235';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=235';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=235';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=241';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=240';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=245';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=254';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=238';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=242';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=235';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=234';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=236';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=242';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=269';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=239';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=238';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=234';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=245';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=233';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=240';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=240';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=243';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=236';
import { castConjureSpell } from './ui/spellsPanel.js?v=149';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=236';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=240';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=233';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=233';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=244';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=234';
import { openSettingsPanel } from './ui/settingsPanel.js?v=237';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=237';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=238';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=244';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=251';
import { applyDataIcons } from './ui/uiIcons.js?v=238';
