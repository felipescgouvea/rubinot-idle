...
import { VOCATIONS } from './domain/character.js?v=288';
import { emit, EVENTS } from './shared/eventBus.js?v=259';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=277';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=261';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=300';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=259';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=269';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=256';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=262';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=325';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=269';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=264';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=263';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=260';
import { buyShopItem } from './application/shopUseCases.js?v=265';
import { buyBlessing } from './application/blessingUseCases.js?v=259';
import { promoteVocation } from './application/promotionUseCases.js?v=257';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=293';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=262';
import { startOnlinePolling } from './application/onlineUseCases.js?v=31';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=261';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=258';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=260';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=260';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=259';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=265';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=264';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=269';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=278';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=262';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=266';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=259';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=258';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=260';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=266';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=293';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=263';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=262';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=258';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=269';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=257';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=264';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=264';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=267';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=260';
import { castConjureSpell } from './ui/spellsPanel.js?v=173';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=260';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=264';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=258';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=257';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=268';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=258';
import { openSettingsPanel } from './ui/settingsPanel.js?v=261';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=262';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=262';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=268';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=275';
import { applyDataIcons } from './ui/uiIcons.js?v=262';
