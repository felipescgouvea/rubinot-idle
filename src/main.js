...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=224';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=210';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=249';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=208';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=215';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=211';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=274';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=218';
import { startTask, cancelTask } from './application/taskUseCases.js?v=212';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=212';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=209';
import { buyShopItem } from './application/shopUseCases.js?v=214';
import { buyBlessing } from './application/blessingUseCases.js?v=208';
import { promoteVocation } from './application/promotionUseCases.js?v=206';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=242';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=210';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=210';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=207';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=208';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=208';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=208';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=214';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=213';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=218';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=227';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=211';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=215';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=208';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=207';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=209';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=215';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=242';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=212';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=211';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=207';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=218';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=206';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=213';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=213';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=216';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=209';
import { castConjureSpell } from './ui/spellsPanel.js?v=122';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=209';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=213';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=206';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=206';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=217';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=207';
import { openSettingsPanel } from './ui/settingsPanel.js?v=210';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=210';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=211';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=217';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=224';
import { applyDataIcons } from './ui/uiIcons.js?v=211';
