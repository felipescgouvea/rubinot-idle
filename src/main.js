...
import { VOCATIONS } from './domain/character.js?v=377';
import { emit, EVENTS } from './shared/eventBus.js?v=348';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=366';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=350';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=389';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=348';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=358';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=345';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=351';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=414';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=358';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=353';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=352';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=349';
import { buyShopItem } from './application/shopUseCases.js?v=354';
import { buyBlessing } from './application/blessingUseCases.js?v=348';
import { promoteVocation } from './application/promotionUseCases.js?v=346';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=382';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=351';
import { startOnlinePolling } from './application/onlineUseCases.js?v=120';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=350';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=347';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=349';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=349';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=348';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=354';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=353';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=358';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=367';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=351';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=355';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=348';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=347';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=349';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=355';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=382';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=352';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=351';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=347';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=358';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=346';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=353';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=353';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=356';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=349';
import { castConjureSpell } from './ui/spellsPanel.js?v=263';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=349';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=353';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=347';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=347';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=357';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=347';
import { openSettingsPanel } from './ui/settingsPanel.js?v=350';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=351';
import { wireDeathModal } from './ui/deathModal.js?v=68';
import { wireContextMenu } from './ui/contextMenu.js?v=8';
import { maybeStartOnboarding } from './ui/onboarding.js?v=3';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=351';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=357';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=364';
import { applyDataIcons } from './ui/uiIcons.js?v=351';
