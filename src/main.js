...
import { G } from './application/gameStore.js?v=343';
import { VOCATIONS } from './domain/character.js?v=370';
import { emit, EVENTS } from './shared/eventBus.js?v=341';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=359';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=343';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=382';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=341';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=351';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=338';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=344';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=407';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=351';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=346';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=345';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=342';
import { buyShopItem } from './application/shopUseCases.js?v=347';
import { buyBlessing } from './application/blessingUseCases.js?v=341';
import { promoteVocation } from './application/promotionUseCases.js?v=339';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=375';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=344';
import { startOnlinePolling } from './application/onlineUseCases.js?v=113';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=343';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=340';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=342';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=342';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=341';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=347';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=346';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=351';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=360';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=344';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=348';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=341';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=340';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=342';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=348';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=375';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=345';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=344';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=340';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=351';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=339';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=346';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=346';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=349';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=342';
import { castConjureSpell } from './ui/spellsPanel.js?v=256';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=342';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=346';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=340';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=340';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=350';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=340';
import { openSettingsPanel } from './ui/settingsPanel.js?v=343';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=344';
import { wireDeathModal } from './ui/deathModal.js?v=61';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=344';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=350';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=357';
import { applyDataIcons } from './ui/uiIcons.js?v=344';
