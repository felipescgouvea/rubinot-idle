...
import { G } from './application/gameStore.js?v=151';
import { VOCATIONS } from './domain/character.js?v=178';
import { emit, EVENTS } from './shared/eventBus.js?v=149';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=165';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=151';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=190';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=149';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=156';
import { selectVocation } from './application/characterUseCases.js?v=152';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=215';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=159';
import { startTask, cancelTask } from './application/taskUseCases.js?v=153';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=153';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=150';
import { buyShopItem } from './application/shopUseCases.js?v=155';
import { buyBlessing } from './application/blessingUseCases.js?v=149';
import { promoteVocation } from './application/promotionUseCases.js?v=147';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=183';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=151';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=151';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=148';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=149';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=149';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=149';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=155';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=154';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=159';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=168';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=152';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=156';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=149';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=148';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=150';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=156';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=183';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=153';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=152';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=148';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=159';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=147';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=154';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=154';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=157';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=150';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=150';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=154';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=147';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=147';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=158';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=148';
import { openSettingsPanel } from './ui/settingsPanel.js?v=151';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=152';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=158';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=165';
import { applyDataIcons } from './ui/uiIcons.js?v=152';
