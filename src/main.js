...
import { G } from './application/gameStore.js?v=355';
import { VOCATIONS } from './domain/character.js?v=382';
import { emit, EVENTS } from './shared/eventBus.js?v=353';
import { getLocale, setLocale, applyStaticTranslations, t } from './i18n/i18n.js?v=371';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=355';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=394';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=353';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=363';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=350';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=356';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=419';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax, setAutoSellPreset } from './application/inventoryUseCases.js?v=363';
import { startTask, cancelTask, claimTaskReward, syncTaskState } from './application/taskUseCases.js?v=358';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=357';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=354';
import { buyShopItem } from './application/shopUseCases.js?v=359';
import { buyBlessing } from './application/blessingUseCases.js?v=353';
import { promoteVocation } from './application/promotionUseCases.js?v=351';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=387';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=356';
import { startOnlinePolling } from './application/onlineUseCases.js?v=125';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=355';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=352';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=354';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=354';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=353';
import { startTraining, stopTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=359';

// ui
import { closeModal, dismissModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=358';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=363';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=372';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=356';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=360';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=353';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=352';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=354';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=360';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=387';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=357';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats, selectMarketItem, marketSearchInput } from './ui/marketPanel.js?v=356';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=352';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=363';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=351';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=358';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents, bestiarySearchInput } from './ui/bestiaryPanel.js?v=358';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=361';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=354';
import { castConjureSpell } from './ui/spellsPanel.js?v=268';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=354';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=358';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=352';
import { openImbueModal, applyImbuementClick, selectImbueSlot } from './ui/imbuementPanel.js?v=352';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=362';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=352';
import { openSettingsPanel } from './ui/settingsPanel.js?v=355';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=356';
import { wireDeathModal } from './ui/deathModal.js?v=73';
import { wireContextMenu } from './ui/contextMenu.js?v=13';
import { maybeStartOnboarding } from './ui/onboarding.js?v=8';
import { startQuestClick } from './ui/questsPanel.js?v=3';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=356';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=362';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=369';
import { applyDataIcons } from './ui/uiIcons.js?v=356';
...
Object.assign(window, {
  ...
  saveGame, confirmReset, selectVocation, createCharacter, toggleHunt, selectTarget, startQuestClick, closeModal, dismissModal, setFightMode, setDensity,
  openItemModal, equipItem, unequipItem, sellItem, sellAllItem, useItem, setAutoSell, setAutoSellMax, setAutoSellPreset,
  ...
  startTraining, stopTraining, pickTrainingSpell, pickedTrainingSpellId,
...
document.addEventListener('keydown', (e) => {
  ...
  if (generic && generic.style.display !== 'none') dismissModal();
});
...
async function startAuthedSession() {
  ...
  await bootGame();
  hideAuthGate();
  // Onboarding do 1º minuto (coach-mark, uma vez só) — depois do boot, com a UI
  // já montada. Pequeno atraso pra os renders assentarem os alvos.
