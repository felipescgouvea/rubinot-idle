...
import { VOCATIONS } from './domain/character.js?v=212';
import { emit, EVENTS } from './shared/eventBus.js?v=183';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=199';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=185';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=224';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=183';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=190';
import { selectVocation } from './application/characterUseCases.js?v=186';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=249';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=193';
import { startTask, cancelTask } from './application/taskUseCases.js?v=187';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=187';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=184';
import { buyShopItem } from './application/shopUseCases.js?v=189';
import { buyBlessing } from './application/blessingUseCases.js?v=183';
import { promoteVocation } from './application/promotionUseCases.js?v=181';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=217';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=185';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=185';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=182';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=183';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=183';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=183';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=189';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=188';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=193';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=202';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=186';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=190';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=183';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=182';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=184';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=190';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=217';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=187';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=186';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=182';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=193';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=181';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=188';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=188';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=191';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=184';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=184';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=188';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=181';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=181';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=192';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=182';
import { openSettingsPanel } from './ui/settingsPanel.js?v=185';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=186';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=192';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=199';
import { applyDataIcons } from './ui/uiIcons.js?v=186';
