...
import { VOCATIONS } from './domain/character.js?v=245';
import { emit, EVENTS } from './shared/eventBus.js?v=216';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=232';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=218';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=257';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=216';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=223';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=213';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=219';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=282';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=226';
import { startTask, cancelTask } from './application/taskUseCases.js?v=220';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=220';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=217';
import { buyShopItem } from './application/shopUseCases.js?v=222';
import { buyBlessing } from './application/blessingUseCases.js?v=216';
import { promoteVocation } from './application/promotionUseCases.js?v=214';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=250';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=218';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=218';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=215';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=216';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=216';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=216';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=222';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=221';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=226';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=235';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=219';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=223';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=216';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=215';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=217';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=223';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=250';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=220';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=219';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=215';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=226';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=214';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=221';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=221';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=224';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=217';
import { castConjureSpell } from './ui/spellsPanel.js?v=130';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=217';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=221';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=214';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=214';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=225';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=215';
import { openSettingsPanel } from './ui/settingsPanel.js?v=218';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=218';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=219';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=225';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=232';
import { applyDataIcons } from './ui/uiIcons.js?v=219';
