...
import { VOCATIONS } from './domain/character.js?v=204';
import { emit, EVENTS } from './shared/eventBus.js?v=175';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=191';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=177';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=216';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=175';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=182';
import { selectVocation } from './application/characterUseCases.js?v=178';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=241';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=185';
import { startTask, cancelTask } from './application/taskUseCases.js?v=179';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=179';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=176';
import { buyShopItem } from './application/shopUseCases.js?v=181';
import { buyBlessing } from './application/blessingUseCases.js?v=175';
import { promoteVocation } from './application/promotionUseCases.js?v=173';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=209';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=177';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=177';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=174';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=175';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=175';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=175';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=181';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=180';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=185';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=194';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=178';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=182';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=175';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=174';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=176';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=182';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=209';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=179';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=178';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=174';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=185';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=173';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=180';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=180';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=183';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=176';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=176';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=180';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=173';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=173';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=184';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=174';
import { openSettingsPanel } from './ui/settingsPanel.js?v=177';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=178';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=184';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=191';
import { applyDataIcons } from './ui/uiIcons.js?v=178';
