...
import { G } from './application/gameStore.js?v=264';
import { VOCATIONS } from './domain/character.js?v=291';
import { emit, EVENTS } from './shared/eventBus.js?v=262';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=280';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=264';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=303';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=262';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=272';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=259';
import { selectVocation, graduate, checkGraduation, ensureStarterKitPending } from './application/characterUseCases.js?v=265';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=328';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=272';
import { startTask, cancelTask, syncTaskState } from './application/taskUseCases.js?v=267';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=266';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=263';
import { buyShopItem } from './application/shopUseCases.js?v=268';
import { buyBlessing } from './application/blessingUseCases.js?v=262';
import { promoteVocation } from './application/promotionUseCases.js?v=260';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=296';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=265';
import { startOnlinePolling } from './application/onlineUseCases.js?v=34';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=264';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=261';
import { rerollPrey, clearPrey, syncPreyState } from './application/preyUseCases.js?v=263';
import { unlockCharm, toggleCharmEquipped, syncCharmState } from './application/bestiaryUseCases.js?v=263';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=262';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=268';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=267';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=272';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=281';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=265';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=269';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=262';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=261';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=263';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=269';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=296';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=266';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=265';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=261';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=272';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=260';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=267';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=267';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=270';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=263';
import { castConjureSpell } from './ui/spellsPanel.js?v=176';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=263';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=267';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=261';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=260';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=271';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=261';
import { openSettingsPanel } from './ui/settingsPanel.js?v=264';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=265';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=265';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=271';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=278';
import { applyDataIcons } from './ui/uiIcons.js?v=265';
