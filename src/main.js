...
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=149';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=135';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=174';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=133';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect } from './infrastructure/authClient.js?v=140';
import { selectVocation } from './application/characterUseCases.js?v=136';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=199';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=143';
import { startTask, cancelTask } from './application/taskUseCases.js?v=137';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=137';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=134';
import { buyShopItem } from './application/shopUseCases.js?v=139';
import { buyBlessing } from './application/blessingUseCases.js?v=133';
import { promoteVocation } from './application/promotionUseCases.js?v=131';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold } from './application/rtcUseCases.js?v=167';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=135';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=135';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=132';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=133';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=133';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=133';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=139';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=138';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=143';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=152';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=136';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=140';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=133';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=132';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=134';
import { wireShopPanelEvents, setShopTab, setShopGroup, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=140';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell } from './ui/rtcPanel.js?v=167';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=137';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=136';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=132';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=143';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=131';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=138';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=138';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=141';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=134';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=134';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=138';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=131';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=131';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=142';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=132';
import { openSettingsPanel } from './ui/settingsPanel.js?v=135';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=136';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=142';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=149';
