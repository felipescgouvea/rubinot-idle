...
import { VOCATIONS } from './domain/character.js?v=266';
import { emit, EVENTS } from './shared/eventBus.js?v=237';
import { getLocale, setLocale, applyStaticTranslations } from './i18n/i18n.js?v=253';

// application
import { saveGame, flushCloudSave } from './application/saveGameUseCase.js?v=239';
import { loadGame, confirmReset, applyCloudSave } from './application/persistenceUseCases.js?v=278';
import { confirmSwitchCharacterSlot } from './application/accountUseCases.js?v=237';
import { isLoggedIn, ensureValidToken, loadCloudSave, consumeAuthRedirect, fetchSaveEpoch } from './infrastructure/authClient.js?v=244';
import { clearState, loadSaveEpoch, saveSaveEpoch } from './infrastructure/storage.js?v=234';
import { selectVocation, graduate, checkGraduation } from './application/characterUseCases.js?v=240';
import { toggleHunt, startRegen, selectTarget, checkAndResumeHuntSession, setFightMode, renderFightModeButtons, setDensity, renderDensityButtons } from './application/huntUseCases.js?v=303';
import { equipItem, unequipItem, sellItem, sellAllItem, useItem, equipRelic, sellRelic, setAutoSell, setAutoSellMax } from './application/inventoryUseCases.js?v=247';
import { startTask, cancelTask } from './application/taskUseCases.js?v=241';
import { selectWorld, checkWorldUnlocks } from './application/worldUseCases.js?v=241';
import { claimBpReward, claimMissionReward, buyBpPremium, claimWeeklyMissionReward } from './application/battlePassUseCases.js?v=238';
import { buyShopItem } from './application/shopUseCases.js?v=243';
import { buyBlessing } from './application/blessingUseCases.js?v=237';
import { promoteVocation } from './application/promotionUseCases.js?v=235';
import { setRtcAttackSpellSlot, clearRtcAttackSpellSlot, setRtcSmartElement, setRtcHealSpell, setRtcHealPotion, setRtcManaPotion, clearRtcPotion, setRtcThreshold, setRtcHealTierPct, clearRtcHealTier, setRtcTargetPriority, setRtcAreaMinTargets } from './application/rtcUseCases.js?v=271';
import { registerPlayerName, submitScore } from './application/highscoresUseCases.js?v=239';
import { startOnlinePolling } from './application/onlineUseCases.js?v=8';
import { depositToMarket, withdrawFromMarket, listItemOnMarket, cancelMyListing, buyMarketListing, postBuyOffer, fillBuyOffer } from './application/marketUseCases.js?v=239';
import { setOutfitGender, selectOutfit, buyOutfit, toggleOutfitAddon, setOutfitColor } from './application/outfitUseCases.js?v=236';
import { rerollPrey, clearPrey } from './application/preyUseCases.js?v=237';
import { unlockCharm, toggleCharmEquipped } from './application/bestiaryUseCases.js?v=237';
import { claimDailyReward } from './application/dailyRewardUseCases.js?v=237';
import { startTraining, stopTraining, startOnlineTraining, resumeTrainingOnLoad } from './application/trainingUseCases.js?v=243';

// ui
import { closeModal, setLogFilter, wireSharedEvents } from './ui/shared.js?v=242';
import { renderCharPanel, renderPlayerBattleSide, wireCharacterPanelEvents, createCharacter } from './ui/characterPanel.js?v=247';
import { renderMonsterDisplay, wireHuntPanelEvents } from './ui/huntPanel.js?v=256';
import { renderEquipmentSlots, openItemModal, openRelicModal, toggleBackpack, wireInventoryAndEquipmentEvents } from './ui/inventoryAndEquipmentPanel.js?v=240';
import { wireTasksPanelEvents, setTaskRoom } from './ui/tasksPanel.js?v=244';
import { handleArenaBattleClick, handleClaimArenaDivision } from './ui/arenaPanel.js?v=237';
import { wireWorldsPanelEvents } from './ui/worldsPanel.js?v=236';
import { wireBattlePassPanelEvents } from './ui/battlePassPanel.js?v=238';
import { wireShopPanelEvents, setShopTab, setShopGroup, selectShopItem, onShopQtyInput, stepShopQty, scrollShopQty, getShopQty, confirmBuyShopItem } from './ui/shopPanel.js?v=244';
import { wireRtcPanelEvents, setRtcSubTab, handleRtcPotionDrop, openRtcPotionPicker, pickRtcPotion, openRtcAttackSpellPicker, pickRtcAttackSpell, openRtcHealTierPicker, pickRtcHealTier } from './ui/rtcPanel.js?v=271';
import { refreshHighscoresClick, wireHighscoresPanelEvents, setHighscoresCategory } from './ui/highscoresPanel.js?v=241';
import { handleMarketRegisterClick, wireMarketPanelEvents, showMarketStats } from './ui/marketPanel.js?v=240';
import { openOutfitPicker, setActiveColorChannel, wireOutfitPickerEvents } from './ui/outfitPicker.js?v=236';
import { openZonePicker, pickZone, openCity, backToCities } from './ui/zonePicker.js?v=247';
import { openBattleModal, closeBattleModal } from './ui/battleModal.js?v=235';
import { challengeBoss, stopBossRushClick, wireBossRushPanelEvents } from './ui/bossRushPanel.js?v=242';
import { openPreySelect, pickPrey, wireBestiaryPanelEvents } from './ui/bestiaryPanel.js?v=242';
import { wireTrainingPanelEvents, pickTrainingSpell, pickedTrainingSpellId } from './ui/trainingPanel.js?v=245';
import { setSkillsSubtab } from './ui/skillsPanel.js?v=238';
import { castConjureSpell } from './ui/spellsPanel.js?v=151';
import { openDailyReward, renderDailyBadge, wireDailyRewardEvents } from './ui/dailyRewardPanel.js?v=238';
import { renderBoostedPanel } from './ui/boostedPanel.js?v=242';
import { openAchievements, setPlayerTitle } from './ui/achievementsPanel.js?v=235';
import { openImbueModal, applyImbuementClick } from './ui/imbuementPanel.js?v=235';
import { wireAdminPanelEvents } from './ui/adminPanel.js?v=246';
import { showAuthGate, showLoadingGate, hideAuthGate, setAuthSuccessHandler, renderAuthUser, logout } from './ui/authPanel.js?v=236';
import { openSettingsPanel } from './ui/settingsPanel.js?v=239';
import { wireGraduationEvents, pickGraduationVocation, confirmGraduation, openGraduationModal } from './ui/graduationModal.js?v=239';
import { setAdminRate, setRelicDropChancePct, setRarityPercent, resetAdminConfig, setUseZoneMultipliers, setZoneMultiplier, setMarketEnabled, setStaminaEnabled, setConsumeAmmo, setZoneSpawnWeight, setZonePackRange, setLootChance, resetLootChance, initGameConfig } from './application/adminUseCases.js?v=240';
import { setAdminSpawnZone, setAdminTab, setAdminLootZone } from './ui/adminPanel.js?v=246';
import { wireTabs, applyMarketVisibility, applyAdminTabVisibility } from './ui/tabs.js?v=253';
import { applyDataIcons } from './ui/uiIcons.js?v=240';
