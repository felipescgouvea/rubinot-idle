...
- 2026-07-27 — feat(quest): raid agora tem FIM real — vencer o chefe encerra a quest (para o respawn), mostra 'Quest complete + prêmio' e volta pra zona anterior (antes virava hunt infinita do chefe). Server sinaliza questEnded (state+push), cliente encerra e restaura a zona — `429975dc` — ✅ e2e prod: orc_fortress rodou, Orc Warlord caiu, log de conclusão, parou de caçar, voltou pra Rat Cave
