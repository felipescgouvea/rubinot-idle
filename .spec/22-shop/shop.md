...
## Objetivo
Reunir as lojas do jogo — equipamento e suprimentos com gold, boosts com Rubini Coins, pacotes de Rubini Coins com dinheiro real — reproduzindo a lógica de loja do Tibia/RubinOT (inclusive a Store premium).

## Quem usa
Todo jogador. O botão **Store** no cabeçalho abre a loja.

## O que o usuário precisa conseguir fazer
- Comprar equipamento e suprimentos com gold; boosts (XP, loot, gold) com Rubini Coins; pacotes de Rubini Coins com dinheiro real.
- Usar o **Supply Completo** (repõe HP/mana e suprimentos de uma vez).

## As quatro lojas
- **Loja Premium (dinheiro real)** — pacotes de Rubini Coins. **Única** que cobra dinheiro real, separada das demais.
...
- **Toda compra debita o preço exato na moeda certa antes de entregar**; nunca deixa a moeda negativa.
- **Compra de munição em lote** respeita a quantidade escolhida.
- **A Loja Premium ainda não está ligada a um meio de pagamento real** — o botão sinaliza isso; nenhuma cobrança acontece.
- Itens são os reais do Tibia, com nome real; boosts são temporários.
- O jogador também pode **vender** itens da mochila pelo valor real (npcvalue).
