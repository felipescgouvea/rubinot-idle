...
## Objetivo
Reproduzir os Imbuements do Tibia: aprimorar temporariamente uma peça de equipamento, pagando gold e materiais, para ganhar dano/roubo de vida/mana na arma ou resistência elemental no elmo/armadura. Dá um ralo de gold/materiais e uma camada de otimização de build.

## Quem usa
Todo jogador. A página de **Imbuements** (estilo do cliente do Tibia) é onde escolhe o item e o imbuement.

## O que o usuário precisa conseguir fazer
- Escolher qual item imbuir (arma, elmo ou armadura).
- Ver os imbuements possíveis para o tipo de item, com efeito, custo (gold + materiais) e duração.
- Aplicar um imbuement, pagando o custo, e ver o tempo restante.

## Regras de negócio
- **Aprimoramento temporário.** Dura um tempo fixo (horas) e **expira** — depois é preciso reaplicar. Enquanto ativo, o efeito é resolvido **no servidor** durante o combate.
...
- **Custo em gold + materiais reais do Tibia.** Cada imbuement pede gold e materiais específicos (poeiras, couros, sedas etc.), todos itens reais.
- **O imbuement mora no item.** Vinculado à peça equipada; trocar a peça perde o imbuement ativo.
