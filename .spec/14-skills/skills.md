...
## Objetivo
Reproduzir a evolução de habilidades do Tibia: cada skill melhora **por uso**, não por pontos distribuídos, e cada vocação evolui cada skill num ritmo próprio. Segunda camada de progressão além do nível.
...
- **Fist, Club, Sword, Axe Fighting** — corpo a corpo; sobem ao acertar com a arma correspondente (sem arma de melee, treina Fist).
- **Distance Fighting** — sobe ao acertar com arma à distância.
- **Shielding** — sobe ao ser atingido (defesa).

## Regras de negócio
- **Sobe por uso.** Atacar treina a skill da arma equipada; apanhar treina Shielding; gastar mana treina Magic Level. Sem distribuição manual de pontos.
- **A arma equipada decide a skill de melee** — não a vocação. Trocar de espada para machado passa a treinar Axe.
- **Ritmo por vocação, fiel ao Crystal Server.** Cada skill tem seu custo por vocação: knight treina as de arma rápido e Magic Level lentíssimo; mago treina Magic Level rápido e combate devagar; paladino no meio. Shielding é a mais cara; Distance a mais barata. É o que diferencia as builds no Tibia — nunca um "multiplicador único".
...
- Skills também podem ser evoluídas fora do combate pelo **Treino** (ver [../16-training/](../16-training/training.md)).
