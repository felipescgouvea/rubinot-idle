...
Jogador, numa aba própria ("Boss Rush"), separada da Caçada normal.
...
- Sair do Boss Rush a qualquer momento e retomar a Caçada normal sem que o personagem fique "preso" caçando na zona do boss.
...
- **Um desafio de Boss Rush enfrenta só o boss da zona**, nunca os monstros comuns dela — o jogador nunca é interrompido por um monstro aleatório no meio do desafio.
- **Os multiplicadores de gold/XP da zona continuam valendo normalmente** dentro do Boss Rush — não há penalidade nem bônus extra por escolher esse modo.
- **O drop de Relíquia continua valendo normalmente** para qualquer boss derrotado no Boss Rush, com a mesma regra de chance da Caçada normal.
- **Entrar no Boss Rush nunca perde a escolha de zona da Caçada normal** — ao sair do Boss Rush, o jogador volta pra zona (e o estado de caçada) que tinha antes de entrar.
...
- Escolher uma zona pelo seletor normal de Caçada, ou trocar de mundo, sempre encerra um Boss Rush em andamento — o jogador nunca fica sem querer "misturando" os dois modos.

## Critérios de aceitação

- [ ] Todo boss listado no Boss Rush pertence a uma zona que o jogador já tem acesso.
- [ ] Durante um desafio de Boss Rush, nenhum monstro comum da zona aparece — só o boss.
- [ ] Sair do Boss Rush restaura a zona de Caçada normal que estava ativa antes de entrar.
- [ ] Vencer um boss no Boss Rush segue exatamente as mesmas regras de recompensa (XP, gold, loot, Relíquia) de vencê-lo na Caçada normal.
