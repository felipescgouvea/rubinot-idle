...
- [~] **[UX] Busca no market e no bestiário** — market **já tem** typeahead (`marketPanel.js:21` `search` + filtro por nome). Falta só o filtro do **bestiário** ("perto do próximo charm point"). · S
